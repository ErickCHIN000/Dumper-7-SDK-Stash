...
class AEM_PearlSlime_C : public ASexyEventMarker
{
public:
	...
	uint8                                        Pad_105B[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FText                                  FailMessage;                                       // 0x3F8(0x18)(Edit, BlueprintVisible)

	static class UClass* StaticClass();
	static class AEM_PearlSlime_C* GetDefaultObj();

	void OnTrigger(bool bFromActivation);
	void OnBlock(bool bFromActivation);
	void Reset();
	void ExecuteUbergraph_EM_PearlSlime(int32 EntryPoint, bool K2Node_Event_bFromActivation_1, bool K2Node_Event_bFromActivation);
};
