...
{
public:
	uint8                                        Pad_70[0x8];                                       // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_9F[0x18];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A2[0x6];                                       // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DB[0x108];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_10E[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
