...
public:
	...
	uint8                                        Pad_1E4[0x44];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_204[0x2A8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_207[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_25D[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_295[0x70];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_29C[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2A5[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
