...
class UCC_MenuButtonV2_C : public URadioButton
{
public:
	...
	static class UCC_MenuButtonV2_C* GetDefaultObj();
	...
	void ExecuteUbergraph_CC_MenuButtonV2(int32 EntryPoint, bool K2Node_Event_InSelected, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue_1, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue_2);
};
