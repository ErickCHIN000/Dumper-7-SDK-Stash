...
public:
	...
	class UTexture2D* GetSteamFriendAvatarFromString(const class FString& SteamID, class FString* OutSteamID, enum class EBlueprintAsyncResultSwitch* Result, const class FString& InKrakenID, class FString* OutKrakenId, enum class ESteamAvatarSize AvatarSize);
...
public:
	...
	uint8                                        Pad_2AE[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	FMulticastInlineDelegateProperty_            OnSuccess;                                         // 0x30(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_            OnFailure;                                         // 0x40(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_2C1[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
