...
class UWBP_GlimpseButtonImage_C : public UUserWidget
{
public:
	...
	class UImage*                                ButtonForesight;                                   // 0x278(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UWBP_GlimpseButtonImage_C* GetDefaultObj();
