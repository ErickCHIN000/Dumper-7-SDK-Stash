...
class UWBP_GameHintModalQFPInfinite_C : public UUserWidget
{
public:
	...
	static class UWBP_GameHintModalQFPInfinite_C* GetDefaultObj();
	...
	void ExecuteUbergraph_WBP_GameHintModalQFPInfinite(int32 EntryPoint, class UUMGSequencePlayer* CallFunc_PlayAnimationForward_ReturnValue);
