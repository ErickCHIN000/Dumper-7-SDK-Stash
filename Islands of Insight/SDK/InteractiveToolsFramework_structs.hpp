...
{
public:
	uint8                                        Pad_1089[0xA8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_108A[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_108C[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
