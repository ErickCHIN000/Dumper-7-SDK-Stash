...
class UWBP_MapMenuRadioButton_C : public URadioButton
{
public:
	...
	static class UWBP_MapMenuRadioButton_C* GetDefaultObj();
	...
	void ExecuteUbergraph_WBP_MapMenuRadioButton(int32 EntryPoint);
};
