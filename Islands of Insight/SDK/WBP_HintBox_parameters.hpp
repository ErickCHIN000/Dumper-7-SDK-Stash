...
struct UWBP_HintBox_C_ExecuteUbergraph_WBP_HintBox_Params
{
public:
	...
	class UUMGSequencePlayer*                    CallFunc_PlayAnimationTimeRange_ReturnValue_1;     // 0x20(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
