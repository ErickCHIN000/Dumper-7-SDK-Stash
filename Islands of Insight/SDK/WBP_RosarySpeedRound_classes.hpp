...
class UWBP_RosarySpeedRound_C : public URosarySpeedRoundWidget
{
public:
	...
	class UWBP_ButtonPrompt_C*                   WBP_ButtonPrompt_1;                                // 0x300(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_MilestoneResultPopup_C*           ActivePopup;                                       // 0x308(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UWBP_RosarySpeedRound_C* GetDefaultObj();
