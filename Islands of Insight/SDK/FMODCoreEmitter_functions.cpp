...
class UClass* AFMODCoreEmitter_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FMODCoreEmitter_C");

	return Clss;
}


// FMODCoreEmitter_C FMODCoreEmitter.Default__FMODCoreEmitter_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AFMODCoreEmitter_C* AFMODCoreEmitter_C::GetDefaultObj()
{
	static class AFMODCoreEmitter_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AFMODCoreEmitter_C*>(AFMODCoreEmitter_C::StaticClass()->DefaultObject);
...
void AFMODCoreEmitter_C::ReceiveTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("FMODCoreEmitter_C", "ReceiveTick");

	Params::AFMODCoreEmitter_C_ReceiveTick_Params Parms{};
