...
// WidgetBlueprintGeneratedClass WBP_WingMeshOptions.WBP_WingMeshOptions_C
// (None)

class UClass* UWBP_WingMeshOptions_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WBP_WingMeshOptions_C");

	return Clss;
}


// WBP_WingMeshOptions_C WBP_WingMeshOptions.Default__WBP_WingMeshOptions_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWBP_WingMeshOptions_C* UWBP_WingMeshOptions_C::GetDefaultObj()
{
	static class UWBP_WingMeshOptions_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWBP_WingMeshOptions_C*>(UWBP_WingMeshOptions_C::StaticClass()->DefaultObject);

	return Default;
}


// Function WBP_WingMeshOptions.WBP_WingMeshOptions_C.Construct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)
// Parameters:

void UWBP_WingMeshOptions_C::Construct()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_WingMeshOptions_C", "Construct");
...
// Function WBP_WingMeshOptions.WBP_WingMeshOptions_C.OnValueChanged
...
void UWBP_WingMeshOptions_C::OnValueChanged(class UObject* Object, int32 Val, bool bUseIndex, const class FString& ID)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_WingMeshOptions_C", "OnValueChanged");

	Params::UWBP_WingMeshOptions_C_OnValueChanged_Params Parms{};
...
// Function WBP_WingMeshOptions.WBP_WingMeshOptions_C.ExecuteUbergraph_WBP_WingMeshOptions
