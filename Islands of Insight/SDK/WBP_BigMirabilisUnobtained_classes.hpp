...
class UWBP_BigMirabilisUnobtained_C : public UUserWidget
{
public:
	...
	static class UWBP_BigMirabilisUnobtained_C* GetDefaultObj();

	void PreConstruct(bool IsDesignTime);
	void ExecuteUbergraph_WBP_BigMirabilisUnobtained(int32 EntryPoint, const struct FVector2D& CallFunc_MakeVector2D_ReturnValue, bool K2Node_Event_IsDesignTime);
};
