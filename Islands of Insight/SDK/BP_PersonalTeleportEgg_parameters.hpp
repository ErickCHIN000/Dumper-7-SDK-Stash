...
struct ABP_PersonalTeleportEgg_C_BP_EggOnTickClient_Params
{
public:
	float                                        DeltaTime;                                         // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        DistanceToPlayer;                                  // 0x4(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x34 (0x34 - 0x0)
// Function BP_PersonalTeleportEgg.BP_PersonalTeleportEgg_C.ExecuteUbergraph_BP_PersonalTeleportEgg
struct ABP_PersonalTeleportEgg_C_ExecuteUbergraph_BP_PersonalTeleportEgg_Params
{
public:
	...
	float                                        K2Node_Event_DistanceToPlayer;                     // 0x14(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
