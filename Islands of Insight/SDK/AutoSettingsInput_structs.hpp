...
public:
	...
	uint8                                        Pad_40E[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	class UTexture*                              Icon;                                              // 0x18(0x8)(ZeroConstructor, Deprecated, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	bool                                         bIsDefault;                                        // 0x28(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_445[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_484[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
