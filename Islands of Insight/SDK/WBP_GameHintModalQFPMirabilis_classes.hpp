...
class UWBP_GameHintModalQFPMirabilis_C : public UUserWidget
{
public:
	...
	class UTextBlock*                            Line1Text;                                         // 0x298(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	static class UWBP_GameHintModalQFPMirabilis_C* GetDefaultObj();
	...
	void ExecuteUbergraph_WBP_GameHintModalQFPMirabilis(int32 EntryPoint, class UUMGSequencePlayer* CallFunc_PlayAnimationForward_ReturnValue);
