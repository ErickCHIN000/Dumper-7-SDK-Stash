...
public:
	...
	uint8                                        Pad_2EF[0x2];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	class UBinkMediaPlayer*                      InMediaPlayer;                                     // 0x0(0x8)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
