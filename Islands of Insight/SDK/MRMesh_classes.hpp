...
public:
	...
	uint8                                        Pad_7F6[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_898[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_8A2[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_8A9[0x80];                                     // Fixing Size Of Struct [ Dumper-7 ]
