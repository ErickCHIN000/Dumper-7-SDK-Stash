...
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable)
// Parameters:
// class FString                      SteamID                                                          (ConstParm, Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class FString                      OutSteamID                                                       (Parm, OutParm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// class FString                      InKrakenID                                                       (ConstParm, Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class FString                      OutKrakenId                                                      (Parm, OutParm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UTexture2D* UAdvancedSteamFriendsLibrary::GetSteamFriendAvatarFromString(const class FString& SteamID, class FString* OutSteamID, enum class EBlueprintAsyncResultSwitch* Result, const class FString& InKrakenID, class FString* OutKrakenId, enum class ESteamAvatarSize AvatarSize)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AdvancedSteamFriendsLibrary", "GetSteamFriendAvatarFromString");

	Params::UAdvancedSteamFriendsLibrary_GetSteamFriendAvatarFromString_Params Parms{};

	Parms.SteamID = SteamID;
	Parms.InKrakenID = InKrakenID;
	...
	if (OutSteamID != nullptr)
		*OutSteamID = std::move(Parms.OutSteamID);

	if (Result != nullptr)
		*Result = Parms.Result;

	if (OutKrakenId != nullptr)
		*OutKrakenId = std::move(Parms.OutKrakenId);
