...
struct ABP_JumpingPad_C_CalculateJumpPadHeight_Params
{
public:
	float                                        JumpPadHeight;                                     // 0x0(0x4)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct ABP_JumpingPad_C_TraceForObjects_Params
{
public:
	...
	struct FHitResult                            CallFunc_LineTraceSingleForObjects_OutHit;         // 0x7C(0x88)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                         CallFunc_LineTraceSingleForObjects_ReturnValue;    // 0x104(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	uint8                                        Pad_168E[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct ABP_JumpingPad_C_UserConstructionScript_Params
{
public:
...
struct ABP_JumpingPad_C_ExecuteUbergraph_BP_JumpingPad_Params
{
public:
