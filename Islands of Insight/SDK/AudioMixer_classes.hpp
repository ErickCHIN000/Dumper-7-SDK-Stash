...
public:
	...
	uint8                                        BitPad_2 : 4;                                      // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_4C[0x20];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4D[0x28];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_54[0x80];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_11F[0x140];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_120[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_130[0x38];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_139[0x68];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1F6[0x110];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_209[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
