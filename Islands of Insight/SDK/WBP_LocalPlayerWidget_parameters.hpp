...
struct UWBP_LocalPlayerWidget_C_Get_MasteryTitle_ColorAndOpacity_0_Params
{
public:
...
struct UWBP_LocalPlayerWidget_C_Get_MasteryTitle_Text_0_Params
{
public:
...
struct UWBP_LocalPlayerWidget_C_Get_Status_Image_Brush_0_Params
{
public:
...
struct UWBP_LocalPlayerWidget_C_PreConstruct_Params
{
public:
...
struct UWBP_LocalPlayerWidget_C_Tick_Params
{
public:
...
struct UWBP_LocalPlayerWidget_C_ExecuteUbergraph_WBP_LocalPlayerWidget_Params
{
public:
	...
	class UGISProgression*                       CallFunc_GetGameInstanceSubsystem_ReturnValue;     // 0x68(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UGISProgression*                       CallFunc_GetGameInstanceSubsystem_ReturnValue_1;   // 0x70(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_BPC_GetTotalMasteryLevel_ReturnValue;     // 0x78(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UGISSocial*                            CallFunc_GetGameInstanceSubsystem_ReturnValue_2;   // 0x88(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UBP_SophiaGameInstance_C*              K2Node_DynamicCast_AsBP_Sophia_Game_Instance;      // 0x90(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x98(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_10DC[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                CallFunc_GetKrakenID_ReturnValue;                  // 0xA0(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class UTexture2D*                            CallFunc_Map_Find_Value;                           // 0xB0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
