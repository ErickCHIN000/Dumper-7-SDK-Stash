...
class UWBP_ListenButton_C : public UTwoStateGenericGridButton
{
public:
	...
	class UWBP_ListenButtonImage_C*              WBP_ListenButtonImage;                             // 0x2B0(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UWBP_ListenButton_C* GetDefaultObj();
