...
struct UWBP_LoginScreenButton_C_UpdateLabel_Params
{
public:
	class FText                                  NewLabel;                                          // 0x0(0x18)(BlueprintVisible, BlueprintReadOnly, Parm)
};

// 0x1 (0x1 - 0x0)
// Function WBP_LoginScreenButton.WBP_LoginScreenButton_C.PreConstruct
struct UWBP_LoginScreenButton_C_PreConstruct_Params
{
public:
...
struct UWBP_LoginScreenButton_C_ExecuteUbergraph_WBP_LoginScreenButton_Params
{
public:
