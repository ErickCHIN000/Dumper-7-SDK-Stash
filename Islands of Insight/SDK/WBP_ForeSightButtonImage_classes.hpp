...
class UWBP_ForeSightButtonImage_C : public UUserWidget
{
public:
	...
	class UImage*                                ButtonTutorial;                                    // 0x280(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UWBP_ForeSightButtonImage_C* GetDefaultObj();
