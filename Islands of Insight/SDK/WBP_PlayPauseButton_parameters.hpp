...
struct UWBP_PlayPauseButton_C_BPI_GetButtons_Params
{
public:
	TArray<class UButton*>                       Buttons;                                           // 0x0(0x10)(Parm, OutParm, ContainsInstancedReference)
	TArray<class UButton*>                       K2Node_MakeArray_Array;                            // 0x10(0x10)(ReferenceParm, ContainsInstancedReference)
};

// 0x30 (0x30 - 0x0)
// Function WBP_PlayPauseButton.WBP_PlayPauseButton_C.Get Text
struct UWBP_PlayPauseButton_C_Get_Text_Params
{
public:
...
struct UWBP_PlayPauseButton_C_Get_Visibility_Params
{
public:
...
struct UWBP_PlayPauseButton_C_BP_PerformClickAnimation_Params
{
public:
...
struct UWBP_PlayPauseButton_C_ExecuteUbergraph_WBP_PlayPauseButton_Params
{
public:
	...
	bool                                         CallFunc_IsInBaseState_ReturnValue;                // 0x18(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_C3F[0x3];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        CallFunc_GetCorrespondingRenderOpacity_ReturnValue; // 0x1C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsButtonInteractable_ReturnValue;         // 0x20(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class UUMGSequencePlayer*                    CallFunc_PlayAnimationReverse_ReturnValue_1;       // 0x38(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class EGenericGridButtonType            K2Node_Event_type;                                 // 0x40(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_SwitchEnum_CmpSuccess;                      // 0x41(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_C4C[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
