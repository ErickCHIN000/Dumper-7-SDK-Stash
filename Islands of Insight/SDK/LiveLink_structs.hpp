...
public:
	...
	uint8                                        Pad_B16[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_B27[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_B31[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
