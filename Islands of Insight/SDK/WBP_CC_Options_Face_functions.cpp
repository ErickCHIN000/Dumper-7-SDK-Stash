...
// WidgetBlueprintGeneratedClass WBP_CC_Options_Face.WBP_CC_Options_Face_C
// (None)

class UClass* UWBP_CC_Options_Face_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WBP_CC_Options_Face_C");

	return Clss;
}


// WBP_CC_Options_Face_C WBP_CC_Options_Face.Default__WBP_CC_Options_Face_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWBP_CC_Options_Face_C* UWBP_CC_Options_Face_C::GetDefaultObj()
{
	static class UWBP_CC_Options_Face_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWBP_CC_Options_Face_C*>(UWBP_CC_Options_Face_C::StaticClass()->DefaultObject);

	return Default;
}


// Function WBP_CC_Options_Face.WBP_CC_Options_Face_C.Construct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)
// Parameters:

void UWBP_CC_Options_Face_C::Construct()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_CC_Options_Face_C", "Construct");
...
void UWBP_CC_Options_Face_C::OnValueChanged(class UObject* Object, int32 Val, bool bUseIndex, const class FString& ID)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_CC_Options_Face_C", "OnValueChanged");

	Params::UWBP_CC_Options_Face_C_OnValueChanged_Params Parms{};
