...
class UTradeBuy_C : public UBaseCharacterUIWidget_C
{
public:
	...
	class UInventory_v2_C*                       TradeBuyInventory;                                 // 0x320(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	static class UTradeBuy_C* GetDefaultObj();

	void FocusDefaultSlot(class USHUserWidget* CallFunc_GetSelectedWidget_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1);
