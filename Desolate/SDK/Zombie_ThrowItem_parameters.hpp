...
struct AZombie_ThrowItem_C_ReceiveActorEndOverlap_Params
{
public:
...
struct AZombie_ThrowItem_C_ReceiveActorBeginOverlap_Params
{
public:
	class AActor*                                OtherActor;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct AZombie_ThrowItem_C_ReceiveHit_Params
{
public:
...
struct AZombie_ThrowItem_C_ExecuteUbergraph_Zombie_ThrowItem_Params
{
public:
	...
	uint8                                        Pad_A32[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class AActor*                                K2Node_Event_OtherActor_1;                         // 0x18(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AMS_Character_New_C*                   K2Node_DynamicCast_AsMS_Character_New;             // 0x20(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AScout_C*                              K2Node_DynamicCast_AsScout;                        // 0x38(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                            K2Node_Event_Hit;                                  // 0x88(0x88)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	class AScout_C*                              K2Node_DynamicCast_AsScout_1;                      // 0x120(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_ApplyDamage_ReturnValue;                  // 0x138(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ASHAICharacter*                        K2Node_DynamicCast_AsSHAICharacter;                // 0x148(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
