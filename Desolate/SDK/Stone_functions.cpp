...
class UClass* AStone_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Stone_C");

	return Clss;
}


// Stone_C Stone.Default__Stone_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AStone_C* AStone_C::GetDefaultObj()
{
	static class AStone_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AStone_C*>(AStone_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Stone.Stone_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void AStone_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Stone_C", "ReceiveBeginPlay");
...
void AStone_C::ReceiveHit(class UPrimitiveComponent* MyComp, class AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, const struct FVector& HitLocation, const struct FVector& HitNormal, const struct FVector& NormalImpulse, struct FHitResult& Hit)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Stone_C", "ReceiveHit");

	Params::AStone_C_ReceiveHit_Params Parms{};
