...
class UClass* AMolotov_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Molotov_C");

	return Clss;
}


// Molotov_C Molotov.Default__Molotov_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AMolotov_C* AMolotov_C::GetDefaultObj()
{
	static class AMolotov_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AMolotov_C*>(AMolotov_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Molotov.Molotov_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void AMolotov_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Molotov_C", "ReceiveBeginPlay");
...
void AMolotov_C::ReceiveHit(class UPrimitiveComponent* MyComp, class AActor* Other, class UPrimitiveComponent* OtherComp, bool bSelfMoved, const struct FVector& HitLocation, const struct FVector& HitNormal, const struct FVector& NormalImpulse, struct FHitResult& Hit)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Molotov_C", "ReceiveHit");

	Params::AMolotov_C_ReceiveHit_Params Parms{};
...
void AMolotov_C::BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Molotov_C", "BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature");

	Params::AMolotov_C_BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params Parms{};
