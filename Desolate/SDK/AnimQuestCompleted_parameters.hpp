...
struct UAnimQuestCompleted_C_UpdateAnim_Params
{
public:
...
struct UAnimQuestCompleted_C_ExecuteUbergraph_AnimQuestCompleted_Params
{
public:
	...
	class FText                                  K2Node_CustomEvent_QuestName;                      // 0x70(0x18)(None)
