...
class AEffects_Anomaly_Kicker_C : public ASHEffect
{
public:
	...
	static class AEffects_Anomaly_Kicker_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_Effects_Anomaly_Kicker(int32 EntryPoint);
};
