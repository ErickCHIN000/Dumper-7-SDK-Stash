...
class ALostControl_Ignition_C : public AGenericLostControlEffect_C
{
public:
	...
	struct FWeaponAnimMontageInfo                CurrentPlayingMontage;                             // 0x318(0x18)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)

	static class UClass* StaticClass();
	static class ALostControl_Ignition_C* GetDefaultObj();
