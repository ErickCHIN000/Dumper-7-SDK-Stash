...
// 0x38 (0x280 - 0x248)
// WidgetBlueprintGeneratedClass KeyboardButtonSmall.KeyboardButtonSmall_C
class UKeyboardButtonSmall_C : public USHUserWidget
{
public:
	...
	static class UKeyboardButtonSmall_C* GetDefaultObj();
	...
	void ExecuteUbergraph_KeyboardButtonSmall(int32 EntryPoint, const struct FGeometry& K2Node_Event_MyGeometry, const struct FPointerEvent& K2Node_Event_MouseEvent, class FText CallFunc_TextToUpper_ReturnValue);
};
