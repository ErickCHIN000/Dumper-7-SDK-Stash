...
class UAnimLocationReached_C : public USHUserWidget
{
public:
	...
	class UTextBlock*                            PreText;                                           // 0x278(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
