...
class AEffects_Stress_Stage_4_C : public ASHEffect
{
public:
	...
	static class AEffects_Stress_Stage_4_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_Effects_Stress_Stage_4(int32 EntryPoint);
};
