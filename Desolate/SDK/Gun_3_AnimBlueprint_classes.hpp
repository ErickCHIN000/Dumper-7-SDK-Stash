...
class UGun_3_AnimBlueprint_C : public UAnimInstance
{
public:
	...
	static class UGun_3_AnimBlueprint_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_Gun_3_AnimBlueprint(int32 EntryPoint);
};
