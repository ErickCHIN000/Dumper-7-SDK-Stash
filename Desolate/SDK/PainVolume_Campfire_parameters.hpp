...
struct APainVolume_Campfire_C_ReceiveEndPlay_Params
{
public:
...
struct APainVolume_Campfire_C_BndEvt__Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params
{
public:
...
struct APainVolume_Campfire_C_ExecuteUbergraph_PainVolume_Campfire_Params
{
public:
	...
	class ASHAICharacter*                        K2Node_DynamicCast_AsSHAICharacter;                // 0xB0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                        CallFunc_Array_AddUnique_ReturnValue;              // 0xCC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_Array_AddUnique_ReturnValue_1;            // 0xD0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
