...
{
public:
	uint8                                        Pad_CB4[0xA8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_CB8[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_CBD[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_CC0[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
