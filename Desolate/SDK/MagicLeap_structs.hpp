...
{
public:
	uint8                                        Pad_41A[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_41C[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_420[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_421[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_422[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_426[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	TArray<struct FMagicLeapMeshBlockInfo>       BlockData;                                         // 0x8(0x10)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, EditConst, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
