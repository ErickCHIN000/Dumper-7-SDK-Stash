...
class UGetItemChance_C : public USHQuestTask
{
public:
	...
	float                                        Chance;                                            // 0x1A0(0x4)(Edit, BlueprintVisible, ZeroConstructor, SaveGame, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_10E2[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class AActor*>                        AlreadyRolled;                                     // 0x1A8(0x10)(Edit, BlueprintVisible, DisableEditOnTemplate, DisableEditOnInstance, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UGetItemChance_C* GetDefaultObj();
