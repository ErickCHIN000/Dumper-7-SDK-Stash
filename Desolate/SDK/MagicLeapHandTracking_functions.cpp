...
// Parameters:
// TArray<enum class EMagicLeapHandTrackingGesture>StaticGesturesToActivate                                         (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable)
// Parameters:
// TArray<enum class EMagicLeapHandTrackingGesture>ActiveStaticGestures                                             (Parm, OutParm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
