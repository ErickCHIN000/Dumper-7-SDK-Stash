...
{
public:
	int32                                        JitterLatencyFrames;                               // 0x6D0(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4E0[0xBC];                                     // Fixing Size Of Struct [ Dumper-7 ]
