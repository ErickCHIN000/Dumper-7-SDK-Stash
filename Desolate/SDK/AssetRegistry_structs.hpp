...
public:
	...
	uint8                                        Pad_A8A[0x50];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A8C[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_AA7[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
