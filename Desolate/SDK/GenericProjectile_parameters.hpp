...
struct AGenericProjectile_C_GetSelectionInfo_Params
{
public:
	...
	int32                                        CallFunc_GetDisassembleMoney_ReturnValue;          // 0x74(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UObject*                               CallFunc_GetDefaultObject_ReturnValue;             // 0xD8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AGenericItem_C*                        K2Node_DynamicCast_AsGeneric_Item;                 // 0xE0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TScriptInterface<class ISelectionInfo_C>     CallFunc_GetSelectionInfo_self_CastInput;          // 0xF0(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FS_Selection                          CallFunc_GetSelectionInfo_result;                  // 0x100(0x59)(HasGetValueTypeHash)
