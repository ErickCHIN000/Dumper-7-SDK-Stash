...
struct UAnimNotify_PlaySoundWithIntegerParameter_C_Received_Notify_Params
{
public:
	...
	class ASHAICharacter*                        K2Node_DynamicCast_AsSHAICharacter;                // 0x20(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
