...
public:
	...
	uint8                                        Pad_89[0x20];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_8B[0x30];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_8D[0x80];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1FA[0x78];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_210[0x38];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_249[0x5C];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_276[0x60];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_281[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
