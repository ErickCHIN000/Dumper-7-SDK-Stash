...
class AGenericInteractiveActor_C : public AActor
{
public:
	...
	FMulticastInlineDelegateProperty_            OnChangeState;                                     // 0x228(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)

	static class UClass* StaticClass();
	static class AGenericInteractiveActor_C* GetDefaultObj();
