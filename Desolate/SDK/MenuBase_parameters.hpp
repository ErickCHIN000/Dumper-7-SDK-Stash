...
struct UMenuBase_C_GetSelectedWidget_Params
{
public:
...
struct UMenuBase_C_OnKeyUp_Params
{
public:
...
struct UMenuBase_C_UpdateSelection_Params
{
public:
...
struct UMenuBase_C_Tick_Params
{
public:
	struct FGeometry                             MyGeometry;                                        // 0x0(0x38)(BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
...
struct UMenuBase_C_ExecuteUbergraph_MenuBase_Params
{
public:
	...
	struct FLinearColor                          CallFunc_MakeColor_ReturnValue;                    // 0x54(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
