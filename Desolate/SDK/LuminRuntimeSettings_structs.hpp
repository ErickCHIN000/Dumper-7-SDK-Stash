...
{
public:
	TArray<struct FLocalizedIconInfo>            IconData;                                          // 0x0(0x10)(Edit, ZeroConstructor, Config, GlobalConfig, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<struct FLuminComponentSubElement>     ExtraComponentSubElements;                         // 0x38(0x10)(Edit, ZeroConstructor, Config, GlobalConfig, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
