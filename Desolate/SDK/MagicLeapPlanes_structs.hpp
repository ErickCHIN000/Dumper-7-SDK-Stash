...
public:
	...
	TArray<struct FMagicLeapPolygon>             Holes;                                             // 0x10(0x10)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<struct FMagicLeapPlaneBoundary>       Boundaries;                                        // 0x10(0x10)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<enum class EMagicLeapPlaneQueryFlags> PlaneFlags;                                        // 0x30(0x10)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	TArray<enum class EMagicLeapPlaneQueryFlags> Flags;                                             // 0x0(0x10)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_377[0xE];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
