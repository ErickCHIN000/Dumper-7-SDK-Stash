...
class AEffects_CarryingCapacity_LowWeight_C : public ASHEffect
{
public:
	...
	static class AEffects_CarryingCapacity_LowWeight_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_Effects_CarryingCapacity_LowWeight(int32 EntryPoint);
};
