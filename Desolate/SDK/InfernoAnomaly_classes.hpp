...
class AInfernoAnomaly_C : public ABaseAnomaly_C
{
public:
	uint8                                        Pad_C02[0x7];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class AInfernoAnomaly_C* GetDefaultObj();
	...
	void ExecuteUbergraph_InfernoAnomaly(int32 EntryPoint, class AActor* K2Node_Event_OtherActor);
};
