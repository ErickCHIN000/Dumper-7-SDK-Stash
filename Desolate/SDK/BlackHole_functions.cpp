...
class UClass* ABlackHole_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BlackHole_C");

	return Clss;
}


// BlackHole_C BlackHole.Default__BlackHole_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABlackHole_C* ABlackHole_C::GetDefaultObj()
{
	static class ABlackHole_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABlackHole_C*>(ABlackHole_C::StaticClass()->DefaultObject);
...
void ABlackHole_C::BndEvt__InteractTrigger_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BlackHole_C", "BndEvt__InteractTrigger_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature");

	Params::ABlackHole_C_BndEvt__InteractTrigger_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params Parms{};
