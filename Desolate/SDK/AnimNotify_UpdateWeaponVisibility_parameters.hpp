...
struct UAnimNotify_UpdateWeaponVisibility_C_Received_Notify_Params
{
public:
	...
	class ASHWeapon*                             CallFunc_GetWeapon_ReturnValue;                    // 0x38(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
