...
class AEffects_Stress_Stage_1_C : public ASHEffect
{
public:
	...
	static class AEffects_Stress_Stage_1_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_Effects_Stress_Stage_1(int32 EntryPoint);
};
