...
struct USubtitleLine_C_GetVisibility_0_Params
{
public:
...
struct USubtitleLine_C_HideLine_Params
{
public:
...
struct USubtitleLine_C_ShowLine_Params
{
public:
	class UUMGSequencePlayer*                    CallFunc_PlayAnimation_ReturnValue;                // 0x0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct USubtitleLine_C_ExecuteUbergraph_SubtitleLine_Params
{
public:
