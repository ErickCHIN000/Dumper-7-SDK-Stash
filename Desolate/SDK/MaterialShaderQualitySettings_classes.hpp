...
{
public:
	struct FMaterialQualityOverrides             QualityOverrides[0x3];                             // 0x28(0x1B)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_60F[0x15];                                     // Fixing Size Of Struct [ Dumper-7 ]
