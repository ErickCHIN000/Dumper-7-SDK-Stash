...
class ANPC_Mikhail_C : public AGenericQuestNPC_C
{
public:
	...
	static class ANPC_Mikhail_C* GetDefaultObj();
	...
	void ExecuteUbergraph_NPC_Mikhail(int32 EntryPoint, class ASHPlayerCharacter* K2Node_Event_Character, TScriptInterface<class IBPI_CharInventory_C> K2Node_DynamicCast_AsBPI_Char_Inventory, bool K2Node_DynamicCast_bSuccess, TScriptInterface<class IBPI_CharInventory_C> K2Node_DynamicCast_AsBPI_Char_Inventory_1, bool K2Node_DynamicCast_bSuccess_1);
};
