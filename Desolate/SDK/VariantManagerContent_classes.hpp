...
{
public:
	uint8                                        Pad_18B[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1C7[0x60];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1D7[0x6F];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_243[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_298[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	class FText                                  DisplayText;                                       // 0x28(0x18)(Deprecated, NativeAccessSpecifierPrivate)
	uint8                                        Pad_2F2[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
