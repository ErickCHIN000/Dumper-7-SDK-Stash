...
class UClass* AGenericAmmo_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GenericAmmo_C");

	return Clss;
}


// GenericAmmo_C GenericAmmo.Default__GenericAmmo_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGenericAmmo_C* AGenericAmmo_C::GetDefaultObj()
{
	static class AGenericAmmo_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGenericAmmo_C*>(AGenericAmmo_C::StaticClass()->DefaultObject);
