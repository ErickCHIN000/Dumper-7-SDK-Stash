...
class UClass* AGenericMeleeWeapon_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GenericMeleeWeapon_C");

	return Clss;
}


// GenericMeleeWeapon_C GenericMeleeWeapon.Default__GenericMeleeWeapon_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGenericMeleeWeapon_C* AGenericMeleeWeapon_C::GetDefaultObj()
{
	static class AGenericMeleeWeapon_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGenericMeleeWeapon_C*>(AGenericMeleeWeapon_C::StaticClass()->DefaultObject);

	return Default;
}


// Function GenericMeleeWeapon.GenericMeleeWeapon_C.GetSelectionInfo
