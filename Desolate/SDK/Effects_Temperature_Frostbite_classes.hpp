...
class AEffects_Temperature_Frostbite_C : public ASHEffect
{
public:
	...
	static class AEffects_Temperature_Frostbite_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_Effects_Temperature_Frostbite(int32 EntryPoint);
};
