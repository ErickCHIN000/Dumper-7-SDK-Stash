...
public:
	...
	uint8                                        Pad_BE4[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_C2A[0x14];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_C65[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_C7B[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
