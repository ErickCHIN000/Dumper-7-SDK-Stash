...
class UChatWidget_C : public UBaseAutoHideWidget_C
{
public:
	...
	class UImage*                                Image_94;                                          // 0x2B0(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class UTextBlock*                            TextBlock_4;                                       // 0x2C0(0x8)(ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class FText Get_TextBlock_6_Text_0(class FText CallFunc_FindTextInLocalizationTable_OutText, bool CallFunc_FindTextInLocalizationTable_ReturnValue);
	class FText Get_TextBlock_4_Text_0(class FText CallFunc_FindTextInLocalizationTable_OutText, bool CallFunc_FindTextInLocalizationTable_ReturnValue);
	struct FEventReply OnFocusReceived(const struct FGeometry& MyGeometry, const struct FFocusEvent& InFocusEvent, const struct FEventReply& CallFunc_Handled_ReturnValue);
	void EndReadMessage(class APlayerController* CallFunc_GetPlayerController_ReturnValue);
	...
	void ReadMessage(class APlayerController* CallFunc_GetPlayerController_ReturnValue);
