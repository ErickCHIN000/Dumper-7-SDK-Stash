...
class AGenericAlcoholCraft_C : public AGenericMedicine_C
{
public:
	...
	static class AGenericAlcoholCraft_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void OnUse(class ASHPlayerCharacter* Character);
	void ExecuteUbergraph_GenericAlcoholCraft(int32 EntryPoint, bool CallFunc_HasAuthority_ReturnValue, class ASHPlayerCharacter* K2Node_Event_Character, float CallFunc_GetMaxValue_ReturnValue, float CallFunc_GetValue_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue, bool CallFunc_LessEqual_FloatFloat_ReturnValue);
};
