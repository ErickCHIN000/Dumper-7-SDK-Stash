...
public:
	...
	uint8                                        Pad_C8A[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
