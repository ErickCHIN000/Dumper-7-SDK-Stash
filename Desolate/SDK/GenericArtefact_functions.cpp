...
// BlueprintGeneratedClass GenericArtefact.GenericArtefact_C
// (Actor)

class UClass* AGenericArtefact_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GenericArtefact_C");

	return Clss;
}


// GenericArtefact_C GenericArtefact.Default__GenericArtefact_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGenericArtefact_C* AGenericArtefact_C::GetDefaultObj()
{
	static class AGenericArtefact_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGenericArtefact_C*>(AGenericArtefact_C::StaticClass()->DefaultObject);

	return Default;
}


// Function GenericArtefact.GenericArtefact_C.GetSelectionInfo
