...
class UInventoryFilterButton_C : public USHUserWidget
{
public:
	...
	enum class EUIInventoryFilterType            FilterType;                                        // 0x270(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UInventoryFilterButton_C* GetDefaultObj();
	...
	void ExecuteUbergraph_InventoryFilterButton(int32 EntryPoint);
};
