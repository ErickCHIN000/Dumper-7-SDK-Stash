...
class AEffects_Temperature_Heat_C : public ASHEffect
{
public:
	...
	static class AEffects_Temperature_Heat_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_Effects_Temperature_Heat(int32 EntryPoint);
};
