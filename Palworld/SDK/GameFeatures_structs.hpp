...
public:
	...
	uint8                                        Pad_56D[0x3];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_574[0x88];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_577[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_57B[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_583[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
