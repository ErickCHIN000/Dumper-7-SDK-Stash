...
public:
	...
	uint8                                        Pad_76E[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_918[0xA8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_93C[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B8A[0xF];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_BA0[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_100F[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1070[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
