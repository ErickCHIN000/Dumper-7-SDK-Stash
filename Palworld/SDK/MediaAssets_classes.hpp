...
{
public:
	uint8                                        Pad_807[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_8F2[0xB8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_987[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_99D[0xB8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_10BD[0x28];                                    // Fixing Size After Last Property  [ Dumper-7 ]
