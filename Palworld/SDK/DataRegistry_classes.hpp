...
public:
	...
	uint8                                        Pad_4B2[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4CB[0x48];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4D3[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4E8[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4FE[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_527[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6BF[0x98];                                     // Fixing Size Of Struct [ Dumper-7 ]
