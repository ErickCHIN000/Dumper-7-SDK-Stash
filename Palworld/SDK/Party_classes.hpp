...
public:
	...
	uint8                                        Pad_6B4[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6CB[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6CF[0x140];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6DD[0x40];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6E5[0x50];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6ED[0x1C8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_709[0x50];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_718[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_72D[0xC0];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_744[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_766[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_7AE[0x38];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7BF[0x57];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7C5[0x74];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7D0[0x2C];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7D8[0x124];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_7F0[0x48];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7F3[0x98];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_802[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_846[0x198];                                    // Fixing Size Of Struct [ Dumper-7 ]
