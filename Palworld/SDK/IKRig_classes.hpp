...
{
public:
	uint8                                        Pad_DB[0x18];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_EC[0xD8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_165[0x148];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_167[0x1F8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_192[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1A9[0x68];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1B2[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1BB[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
