...
public:
	...
	uint8                                        Pad_9A8[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_9B6[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_9B8[0xB8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_9CC[0xB8];                                     // Fixing Size Of Struct [ Dumper-7 ]
