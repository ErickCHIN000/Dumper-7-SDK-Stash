...
{
public:
	uint8                                        Pad_696[0x130];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_6BA[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6C7[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6D3[0x48];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_786[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_7E3[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
