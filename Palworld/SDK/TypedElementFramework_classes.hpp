...
{
public:
	uint8                                        Pad_16B2[0x920];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_17C5[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_17E3[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_17FC[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
