...
{
public:
	uint8                                        Pad_AB8[0x20];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_ACB[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_BB8[0xF8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_BBB[0x3F];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_BC1[0x38];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_BC4[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C5A[0x48];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_C5C[0x20];                                     // Fixing Size After Last Property  [ Dumper-7 ]
