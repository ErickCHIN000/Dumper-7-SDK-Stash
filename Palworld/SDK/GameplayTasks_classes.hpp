...
{
public:
	uint8                                        Pad_14FE[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1507[0x25];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_15EF[0x14];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	uint8                                        BitPad_7B : 1;                                     // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_1600[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_17DD[0x30];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1811[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
