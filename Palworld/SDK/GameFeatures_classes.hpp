...
public:
	...
	uint8                                        Pad_4B5[0xF];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4B7[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4C5[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4D1[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_506[0xE8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_538[0x50];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_53D[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
