...
{
public:
	uint8                                        Pad_6AD[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6B3[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6C3[0x20];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6CC[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_703[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
