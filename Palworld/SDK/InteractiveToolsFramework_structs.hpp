...
public:
	...
	uint8                                        Pad_1B79[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1BBE[0x128];                                   // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1BD0[0x38];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
