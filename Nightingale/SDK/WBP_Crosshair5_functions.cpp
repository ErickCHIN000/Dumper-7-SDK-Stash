...
// WidgetBlueprintGeneratedClass WBP_Crosshair5.WBP_Crosshair5_C
// (None)

class UClass* UWBP_Crosshair5_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WBP_Crosshair5_C");

	return Clss;
}


// WBP_Crosshair5_C WBP_Crosshair5.Default__WBP_Crosshair5_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWBP_Crosshair5_C* UWBP_Crosshair5_C::GetDefaultObj()
{
	static class UWBP_Crosshair5_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWBP_Crosshair5_C*>(UWBP_Crosshair5_C::StaticClass()->DefaultObject);
...
void UWBP_Crosshair5_C::OnSpreadChanged(double NewSpread, bool CallFunc_IsVisible_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, float CallFunc_PlayAnimation_StartAtTime_ImplicitCast)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_Crosshair5_C", "OnSpreadChanged");

	Params::UWBP_Crosshair5_C_OnSpreadChanged_Params Parms{};
...
// Function WBP_Crosshair5.WBP_Crosshair5_C.DisplayRecoil
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UWBP_Crosshair5_C::DisplayRecoil()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_Crosshair5_C", "DisplayRecoil");
...
// Function WBP_Crosshair5.WBP_Crosshair5_C.Construct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)
// Parameters:

void UWBP_Crosshair5_C::Construct()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_Crosshair5_C", "Construct");
...
// Function WBP_Crosshair5.WBP_Crosshair5_C.SingleRecoil_Event_0
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UWBP_Crosshair5_C::SingleRecoil_Event_0()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_Crosshair5_C", "SingleRecoil_Event_0");
...
// Function WBP_Crosshair5.WBP_Crosshair5_C.Destruct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)
// Parameters:

void UWBP_Crosshair5_C::Destruct()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_Crosshair5_C", "Destruct");
