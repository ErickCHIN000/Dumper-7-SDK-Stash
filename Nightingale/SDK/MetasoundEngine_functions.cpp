...
struct FMetaSoundNodeHandle UMetaSoundBuilderBase::AddNode(TScriptInterface<class IMetaSoundDocumentInterface>& NodeClass, enum class EMetaSoundBuilderResult* OutResult)
{
	static class UFunction* Func = nullptr;
