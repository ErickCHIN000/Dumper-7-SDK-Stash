...
public:
	...
	uint8                                        Pad_1CF3[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1D3D[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1E73[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1FFB[0xB0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2003[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
