...
struct UWBP_sw_RealmInfo_GenericImageWithDescriptionHolder_C_DisplayNoInfoText_Params
{
public:
...
struct UWBP_sw_RealmInfo_GenericImageWithDescriptionHolder_C_AddImgAndDescription_Params
{
public:
	...
	class UWBP_sw_RealmInfo_GenericImageWithDescription_C* CallFunc_Create_ReturnValue;                       // 0x58(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
struct UWBP_sw_RealmInfo_GenericImageWithDescriptionHolder_C_ExecuteUbergraph_WBP_sw_RealmInfo_GenericImageWithDescriptionHolder_Params
{
public:
