...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// bool                               bWantHideNameplateInstance                                       (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UWidgetComponent::SetHideNameplateInstance(bool bWantHideNameplateInstance)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WidgetComponent", "SetHideNameplateInstance");

	Params::UWidgetComponent_SetHideNameplateInstance_Params Parms{};

	Parms.bWantHideNameplateInstance = bWantHideNameplateInstance;
...
bool UWidgetComponent::GetHideNameplateInstance()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WidgetComponent", "GetHideNameplateInstance");

	Params::UWidgetComponent_GetHideNameplateInstance_Params Parms{};
