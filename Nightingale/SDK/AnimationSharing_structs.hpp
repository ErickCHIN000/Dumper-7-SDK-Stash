...
public:
	...
	uint8                                        Pad_1B66[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1B6A[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1B8D[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
