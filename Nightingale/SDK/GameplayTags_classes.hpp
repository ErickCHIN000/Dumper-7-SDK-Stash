...
public:
	...
	uint8                                        Pad_CFB[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_D5D[0x160];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TMap<class FName, struct FGameplayTagSource> TagSources;                                        // 0x188(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_D5F[0xB0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
