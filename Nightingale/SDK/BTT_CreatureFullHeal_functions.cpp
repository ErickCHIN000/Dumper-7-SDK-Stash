...
// BlueprintGeneratedClass BTT_CreatureFullHeal.BTT_CreatureFullHeal_C
// (None)

class UClass* UBTT_CreatureFullHeal_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BTT_CreatureFullHeal_C");

	return Clss;
}


// BTT_CreatureFullHeal_C BTT_CreatureFullHeal.Default__BTT_CreatureFullHeal_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBTT_CreatureFullHeal_C* UBTT_CreatureFullHeal_C::GetDefaultObj()
{
	static class UBTT_CreatureFullHeal_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBTT_CreatureFullHeal_C*>(UBTT_CreatureFullHeal_C::StaticClass()->DefaultObject);
...
void UBTT_CreatureFullHeal_C::ReceiveExecuteAI(class AAIController* OwnerController, class APawn* ControlledPawn)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BTT_CreatureFullHeal_C", "ReceiveExecuteAI");

	Params::UBTT_CreatureFullHeal_C_ReceiveExecuteAI_Params Parms{};
