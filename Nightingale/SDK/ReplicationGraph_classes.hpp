...
public:
	...
	uint8                                        Pad_107B[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_107E[0x4B8];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_10AF[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_10BB[0x80];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_10D5[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_10EF[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1102[0x80];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_111D[0x40];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_112E[0x230];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1189[0x144];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_118D[0xB0];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_118E[0x120];                                   // Fixing Size Of Struct [ Dumper-7 ]
