...
class UClass* IOptimusDeprecatedExecutionDataInterface::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class IOptimusDeprecatedExecutionDataInterface* IOptimusDeprecatedExecutionDataInterface::GetDefaultObj()
{
	static class IOptimusDeprecatedExecutionDataInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<IOptimusDeprecatedExecutionDataInterface*>(IOptimusDeprecatedExecutionDataInterface::StaticClass()->DefaultObject);
