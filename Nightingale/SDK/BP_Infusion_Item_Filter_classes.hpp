...
class UBP_Infusion_Item_Filter_C : public UWidgetInventoryEntryFilterStructureConstraints
{
public:
	...
	static class UBP_Infusion_Item_Filter_C* GetDefaultObj();

	bool ShouldShowEntry(struct FInventoryEntry& Entry, bool CallFunc_CanSlotInfusionOnItem_ReturnValue, bool CallFunc_CanEnchantItem_CanEnchant, bool CallFunc_IsValid_ReturnValue, bool CallFunc_BooleanAND_ReturnValue);
	void Initialize();
	void ExecuteUbergraph_BP_Infusion_Item_Filter(int32 EntryPoint, TArray<struct FGameplayTag>& CallFunc_GetAllLayerTags_ReturnValue, class ANWXPlayerController* CallFunc_GetOwningPlayerController_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UNWXCommonWindowWidget* CallFunc_FindWindowInLayers_ReturnValue, class UWBP_ActionSlots_Popup_C* K2Node_DynamicCast_AsWBP_Action_Slots_Popup, bool K2Node_DynamicCast_bSuccess);
};
