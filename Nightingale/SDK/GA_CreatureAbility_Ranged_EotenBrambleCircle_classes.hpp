...
class UGA_CreatureAbility_Ranged_EotenBrambleCircle_C : public UGA_CreatureAbilityBase_C
{
public:
	...
	static class UGA_CreatureAbility_Ranged_EotenBrambleCircle_C* GetDefaultObj();
	...
	void ExecuteUbergraph_GA_CreatureAbility_Ranged_EotenBrambleCircle(int32 EntryPoint, const struct FGameplayTag& Temp_struct_Variable, bool K2Node_Event_bWasCancelled, bool CallFunc_IsValid_ReturnValue, TScriptInterface<class IAICCreatureDataInterface> CallFunc_GetRangedAttackCooldown_self_CastInput, float CallFunc_GetRangedAttackCooldown_ReturnValue);
};
