...
class UClass* UWBP_WSkin_Button_BlackPanel_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WBP_WSkin_Button_BlackPanel_C");

	return Clss;
}


// WBP_WSkin_Button_BlackPanel_C WBP_WSkin_Button_BlackPanel.Default__WBP_WSkin_Button_BlackPanel_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWBP_WSkin_Button_BlackPanel_C* UWBP_WSkin_Button_BlackPanel_C::GetDefaultObj()
{
	static class UWBP_WSkin_Button_BlackPanel_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWBP_WSkin_Button_BlackPanel_C*>(UWBP_WSkin_Button_BlackPanel_C::StaticClass()->DefaultObject);

	return Default;
}


// Function WBP_WSkin_Button_BlackPanel.WBP_WSkin_Button_BlackPanel_C.RetrieveButtonStyle
...
void UWBP_WSkin_Button_BlackPanel_C::RetrieveButtonStyle(struct FS_WidgetStyle_Button* ButtonStyleStruct, const struct FTextBlockStyle& K2Node_MakeStruct_TextBlockStyle, const struct FS_WidgetStyle_Button& K2Node_MakeStruct_S_WidgetStyle_Button, const struct FDeprecateSlateVector2D& K2Node_MakeStruct_ShadowOffset_ImplicitCast)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_WSkin_Button_BlackPanel_C", "RetrieveButtonStyle");

	Params::UWBP_WSkin_Button_BlackPanel_C_RetrieveButtonStyle_Params Parms{};
