...
// BlueprintGeneratedClass GC_Spell_PrimalRoar.GC_Spell_PrimalRoar_C
// (Actor)

class UClass* AGC_Spell_PrimalRoar_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_Spell_PrimalRoar_C");

	return Clss;
}


// GC_Spell_PrimalRoar_C GC_Spell_PrimalRoar.Default__GC_Spell_PrimalRoar_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGC_Spell_PrimalRoar_C* AGC_Spell_PrimalRoar_C::GetDefaultObj()
{
	static class AGC_Spell_PrimalRoar_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGC_Spell_PrimalRoar_C*>(AGC_Spell_PrimalRoar_C::StaticClass()->DefaultObject);
...
bool AGC_Spell_PrimalRoar_C::OnRemove(class AActor* MyTarget, struct FGameplayCueParameters& Parameters, bool CallFunc_OnRemove_ReturnValue, bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GC_Spell_PrimalRoar_C", "OnRemove");

	Params::AGC_Spell_PrimalRoar_C_OnRemove_Params Parms{};
