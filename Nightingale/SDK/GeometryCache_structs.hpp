...
{
public:
	uint8                                        Pad_19C6[0xC0];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_19CA[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_19D1[0x9];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_19D6[0xC8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
