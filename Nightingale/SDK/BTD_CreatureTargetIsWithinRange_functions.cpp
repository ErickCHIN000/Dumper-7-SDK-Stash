...
class UClass* UBTD_CreatureTargetIsWithinRange_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BTD_CreatureTargetIsWithinRange_C");

	return Clss;
}


// BTD_CreatureTargetIsWithinRange_C BTD_CreatureTargetIsWithinRange.Default__BTD_CreatureTargetIsWithinRange_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBTD_CreatureTargetIsWithinRange_C* UBTD_CreatureTargetIsWithinRange_C::GetDefaultObj()
{
	static class UBTD_CreatureTargetIsWithinRange_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBTD_CreatureTargetIsWithinRange_C*>(UBTD_CreatureTargetIsWithinRange_C::StaticClass()->DefaultObject);
