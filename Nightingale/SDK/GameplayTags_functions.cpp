...
// struct FGameplayTagQuery           GameplayTagQuery                                                 (Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct FGameplayTagContainer       TagContainer                                                     (Parm, OutParm, NativeAccessSpecifierPublic)

void UBlueprintGameplayTagLibrary::UpdateTagContainerWithTagQuery(class UObject* Obj, struct FGameplayTagQuery& GameplayTagQuery, struct FGameplayTagContainer* TagContainer)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BlueprintGameplayTagLibrary", "UpdateTagContainerWithTagQuery");

	Params::UBlueprintGameplayTagLibrary_UpdateTagContainerWithTagQuery_Params Parms{};
