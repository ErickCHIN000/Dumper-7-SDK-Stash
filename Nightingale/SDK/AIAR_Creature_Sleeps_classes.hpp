...
class UAIAR_Creature_Sleeps_C : public UAIActionRequirement
{
public:
	...
	static class UAIAR_Creature_Sleeps_C* GetDefaultObj();

	bool CheckOwnerRequirements(const struct FGameplayTag& Temp_struct_Variable, bool CallFunc_ActorHasTag_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue);
