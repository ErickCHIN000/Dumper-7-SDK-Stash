...
class UClass* IMovieSceneBoundObjectProxy::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class IMovieSceneBoundObjectProxy* IMovieSceneBoundObjectProxy::GetDefaultObj()
{
	static class IMovieSceneBoundObjectProxy* Default = nullptr;

	if (!Default)
		Default = static_cast<IMovieSceneBoundObjectProxy*>(IMovieSceneBoundObjectProxy::StaticClass()->DefaultObject);
...
class UObject* IMovieSceneBoundObjectProxy::BP_GetBoundObjectForSequencer(class UObject* ResolvedObject)
{
	...
	Params::IMovieSceneBoundObjectProxy_BP_GetBoundObjectForSequencer_Params Parms{};
...
class UClass* IMovieSceneMetaDataInterface::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class IMovieSceneMetaDataInterface* IMovieSceneMetaDataInterface::GetDefaultObj()
{
	static class IMovieSceneMetaDataInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<IMovieSceneMetaDataInterface*>(IMovieSceneMetaDataInterface::StaticClass()->DefaultObject);
