...
class UAIA_Creature_Combat_Wildlife_Melee_Jumper_C : public UAIA_Creature_Combat_Wildlife_Melee_C
{
public:

	static class UClass* StaticClass();
	static class UAIA_Creature_Combat_Wildlife_Melee_Jumper_C* GetDefaultObj();
