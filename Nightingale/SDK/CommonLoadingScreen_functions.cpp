...
// enum class ELoadingReason          LoadingReason                                                    (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void ULoadingProcessTask::SetShowLoadingScreenReason(const class FString& InReason, enum class ELoadingReason& LoadingReason)
{
	static class UFunction* Func = nullptr;
	...
	Parms.LoadingReason = LoadingReason;
...
class ULoadingProcessTask* ULoadingProcessTask::CreateLoadingScreenProcessTask(class UObject* WorldContextObject, const class FString& ShowLoadingScreenReason, enum class ELoadingReason& LoadingReason)
{
	static class UFunction* Func = nullptr;
