...
class UClass* UANS_PaleDissolve_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ANS_PaleDissolve_C");

	return Clss;
}


// ANS_PaleDissolve_C ANS_PaleDissolve.Default__ANS_PaleDissolve_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UANS_PaleDissolve_C* UANS_PaleDissolve_C::GetDefaultObj()
{
	static class UANS_PaleDissolve_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UANS_PaleDissolve_C*>(UANS_PaleDissolve_C::StaticClass()->DefaultObject);
