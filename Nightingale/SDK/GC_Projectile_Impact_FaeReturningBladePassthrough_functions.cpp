...
class UClass* UGC_Projectile_Impact_FaeReturningBladePassthrough_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_Projectile_Impact_FaeReturningBladePassthrough_C");

	return Clss;
}


// GC_Projectile_Impact_FaeReturningBladePassthrough_C GC_Projectile_Impact_FaeReturningBladePassthrough.Default__GC_Projectile_Impact_FaeReturningBladePassthrough_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGC_Projectile_Impact_FaeReturningBladePassthrough_C* UGC_Projectile_Impact_FaeReturningBladePassthrough_C::GetDefaultObj()
{
	static class UGC_Projectile_Impact_FaeReturningBladePassthrough_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGC_Projectile_Impact_FaeReturningBladePassthrough_C*>(UGC_Projectile_Impact_FaeReturningBladePassthrough_C::StaticClass()->DefaultObject);
