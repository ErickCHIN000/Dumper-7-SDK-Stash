...
class UWBP_HitIndicator_Backstab_C : public UNWXUserWidget
{
public:
	...
	class UImage*                                Img_crit_inidcator;                                // 0x350(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UWBP_HitIndicator_Backstab_C* GetDefaultObj();

	void RemoveHitIndication();
	void Construct();
	void AddHitIndication();
	void Destruct();
	void ExecuteUbergraph_WBP_HitIndicator_Backstab(int32 EntryPoint, bool CallFunc_IsVisible_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, TArray<class UWBP_CrosshairBase_C*>& CallFunc_GetAllWidgetsOfClass_FoundWidgets, class UWBP_CrosshairBase_C* CallFunc_Array_Get_Item, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue_1, bool CallFunc_IsVisible_ReturnValue_1);
};
