...
class UClass* UBPFL_Debug_Creature_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BPFL_Debug_Creature_C");

	return Clss;
}


// BPFL_Debug_Creature_C BPFL_Debug_Creature.Default__BPFL_Debug_Creature_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBPFL_Debug_Creature_C* UBPFL_Debug_Creature_C::GetDefaultObj()
{
	static class UBPFL_Debug_Creature_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBPFL_Debug_Creature_C*>(UBPFL_Debug_Creature_C::StaticClass()->DefaultObject);
...
// int32                              NumberOfRounds                                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UBPFL_Debug_Creature_C::DebugTriggerSimRounds(class UObject* WorldContextObject, int32 NumberOfRounds, class UObject* __WorldContext, class AGameModeBase* CallFunc_GetGameMode_ReturnValue, int32 Temp_int_Variable, class ABP_GameMode_C* K2Node_DynamicCast_AsBP_Game_Mode, bool K2Node_DynamicCast_bSuccess, class ABP_SimulationStateManager_C* CallFunc_GetManager_ReturnValue, bool CallFunc_LessEqual_IntInt_ReturnValue, bool CallFunc_IsValid_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BPFL_Debug_Creature_C", "DebugTriggerSimRounds");

	Params::UBPFL_Debug_Creature_C_DebugTriggerSimRounds_Params Parms{};
...
// class FString                      AbilityName                                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
// class UObject*                     __WorldContext                                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UBPFL_Debug_Creature_C::DebugAbilityMessage(class AActor* Instigator, const class FString& AbilityName, class UObject* __WorldContext, class FString* DebugText, const class FString& CallFunc_GetDisplayName_ReturnValue, class FText CallFunc_Conv_StringToText_ReturnValue, class FText CallFunc_Conv_StringToText_ReturnValue_1, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData_1, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, class FText CallFunc_Format_ReturnValue, const class FString& CallFunc_Conv_TextToString_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BPFL_Debug_Creature_C", "debugAbilityMessage");

	Params::UBPFL_Debug_Creature_C_DebugAbilityMessage_Params Parms{};
...
// Parameters:
// class UObject*                     __WorldContext                                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class FName                        Catgeory                                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBPFL_Debug_Creature_C::DebugVislogAbilitiesCategory(class UObject* __WorldContext, class FName* Catgeory)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BPFL_Debug_Creature_C", "debugVislogAbilitiesCategory");

	Params::UBPFL_Debug_Creature_C_DebugVislogAbilitiesCategory_Params Parms{};
