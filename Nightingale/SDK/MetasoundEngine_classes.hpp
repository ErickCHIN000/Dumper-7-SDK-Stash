...
{
public:
	uint8                                        Pad_157B[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_18B1[0x70];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1941[0x198];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2F65[0x70];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2F87[0xD4];                                    // Fixing Size Of Struct [ Dumper-7 ]
