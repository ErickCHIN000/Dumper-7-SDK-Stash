...
// WidgetBlueprintGeneratedClass WBP_sw_AbilityBar_MainHand.WBP_sw_AbilityBar_MainHand_C
// (None)

class UClass* UWBP_sw_AbilityBar_MainHand_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WBP_sw_AbilityBar_MainHand_C");

	return Clss;
}


// WBP_sw_AbilityBar_MainHand_C WBP_sw_AbilityBar_MainHand.Default__WBP_sw_AbilityBar_MainHand_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWBP_sw_AbilityBar_MainHand_C* UWBP_sw_AbilityBar_MainHand_C::GetDefaultObj()
{
	static class UWBP_sw_AbilityBar_MainHand_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWBP_sw_AbilityBar_MainHand_C*>(UWBP_sw_AbilityBar_MainHand_C::StaticClass()->DefaultObject);
...
void UWBP_sw_AbilityBar_MainHand_C::OnItemDataInitialized(class ABP_EquippableItemBase_C* Equippable)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_sw_AbilityBar_MainHand_C", "OnItemDataInitialized");

	Params::UWBP_sw_AbilityBar_MainHand_C_OnItemDataInitialized_Params Parms{};
...
void UWBP_sw_AbilityBar_MainHand_C::SetupLoadoutEvent(class AEquippableItem* Temp_object_Variable, const struct FGameplayTag& CallFunc_MakeLiteralGameplayTag_ReturnValue, class APawn* CallFunc_GetOwningPlayerPawn_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, TScriptInterface<class ILoadoutReadInterface> K2Node_DynamicCast_AsLoadout_Read_Interface, bool K2Node_DynamicCast_bSuccess, class ANWXPlayerController* CallFunc_GetOwningPlayerController_ReturnValue, class AEquippableItem* CallFunc_GetItemInLoadoutSlot_ReturnValue, class UBP_LoadoutComponent_C* CallFunc_GetComponentByClass_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_sw_AbilityBar_MainHand_C", "SetupLoadoutEvent");

	Params::UWBP_sw_AbilityBar_MainHand_C_SetupLoadoutEvent_Params Parms{};
...
void UWBP_sw_AbilityBar_MainHand_C::OnLoadoutSlotChanged(enum class ELoadoutSlotType SlotType, class AEquippableItem* Item, class ABP_EquippableItemBase_C* K2Node_DynamicCast_AsBP_Equippable_Item_Base, bool K2Node_DynamicCast_bSuccess, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_IsValid_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_sw_AbilityBar_MainHand_C", "OnLoadoutSlotChanged");

	Params::UWBP_sw_AbilityBar_MainHand_C_OnLoadoutSlotChanged_Params Parms{};
...
// Function WBP_sw_AbilityBar_MainHand.WBP_sw_AbilityBar_MainHand_C.Construct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)
// Parameters:

void UWBP_sw_AbilityBar_MainHand_C::Construct()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_sw_AbilityBar_MainHand_C", "Construct");
...
void UWBP_sw_AbilityBar_MainHand_C::ExecuteUbergraph_WBP_sw_AbilityBar_MainHand(int32 EntryPoint, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class ANWXPlayerController* CallFunc_GetOwningPlayerController_ReturnValue, class UBP_LoadoutComponent_C* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_IsInitialized_bInitialized)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_sw_AbilityBar_MainHand_C", "ExecuteUbergraph_WBP_sw_AbilityBar_MainHand");

	Params::UWBP_sw_AbilityBar_MainHand_C_ExecuteUbergraph_WBP_sw_AbilityBar_MainHand_Params Parms{};
