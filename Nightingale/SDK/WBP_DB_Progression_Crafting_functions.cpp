...
class UClass* UWBP_DB_Progression_Crafting_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WBP_DB_Progression_Crafting_C");

	return Clss;
}


// WBP_DB_Progression_Crafting_C WBP_DB_Progression_Crafting.Default__WBP_DB_Progression_Crafting_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWBP_DB_Progression_Crafting_C* UWBP_DB_Progression_Crafting_C::GetDefaultObj()
{
	static class UWBP_DB_Progression_Crafting_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWBP_DB_Progression_Crafting_C*>(UWBP_DB_Progression_Crafting_C::StaticClass()->DefaultObject);

	return Default;
}


// Function WBP_DB_Progression_Crafting.WBP_DB_Progression_Crafting_C.Construct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)
// Parameters:

void UWBP_DB_Progression_Crafting_C::Construct()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_DB_Progression_Crafting_C", "Construct");
...
void UWBP_DB_Progression_Crafting_C::ExecuteUbergraph_WBP_DB_Progression_Crafting(int32 EntryPoint, int32 Temp_int_Variable, const struct FResourceDistributionList& CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, bool CallFunc_LessEqual_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class ANWXPlayerController* K2Node_DynamicCast_AsNWXPlayer_Controller, bool K2Node_DynamicCast_bSuccess, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_1, class UWBP_DB_Progression_List_C* CallFunc_Create_ReturnValue, class UNWXCheatManager* K2Node_DynamicCast_AsNWXCheat_Manager, bool K2Node_DynamicCast_bSuccess_1, class UCraftingCheats* CallFunc_GetCraftingCheatManager_ReturnValue, TMap<int32, struct FResourceDistributionList> CallFunc_GetResourceDistributionForCrafting_OutResourceDistribution, class UPanelSlot* CallFunc_AddChild_ReturnValue)
{
	...
	Parms.CallFunc_GetCraftingCheatManager_ReturnValue = CallFunc_GetCraftingCheatManager_ReturnValue;
	Parms.CallFunc_GetResourceDistributionForCrafting_OutResourceDistribution = CallFunc_GetResourceDistributionForCrafting_OutResourceDistribution;
