...
class UClass* IMetaSoundDocumentInterface::StaticClass()
{
...
class IMetaSoundDocumentInterface* IMetaSoundDocumentInterface::GetDefaultObj()
{
	static class IMetaSoundDocumentInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<IMetaSoundDocumentInterface*>(IMetaSoundDocumentInterface::StaticClass()->DefaultObject);
