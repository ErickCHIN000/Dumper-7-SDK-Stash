...
class UClass* UAIA_Creature_Combat_Wildlife_Melee_NoRetreat_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AIA_Creature_Combat_Wildlife_Melee_NoRetreat_C");

	return Clss;
}


// AIA_Creature_Combat_Wildlife_Melee_NoRetreat_C AIA_Creature_Combat_Wildlife_Melee_NoRetreat.Default__AIA_Creature_Combat_Wildlife_Melee_NoRetreat_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAIA_Creature_Combat_Wildlife_Melee_NoRetreat_C* UAIA_Creature_Combat_Wildlife_Melee_NoRetreat_C::GetDefaultObj()
{
	static class UAIA_Creature_Combat_Wildlife_Melee_NoRetreat_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAIA_Creature_Combat_Wildlife_Melee_NoRetreat_C*>(UAIA_Creature_Combat_Wildlife_Melee_NoRetreat_C::StaticClass()->DefaultObject);
