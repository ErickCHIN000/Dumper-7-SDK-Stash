...
void UAgonesComponent::SetLabel(class FString* Key, class FString* Value, FDelegateProperty_ SuccessDelegate, FDelegateProperty_ ErrorDelegate)
{
	static class UFunction* Func = nullptr;
...
void UAgonesComponent::SetAnnotation(class FString* Key, class FString* Value, FDelegateProperty_ SuccessDelegate, FDelegateProperty_ ErrorDelegate)
{
	static class UFunction* Func = nullptr;
