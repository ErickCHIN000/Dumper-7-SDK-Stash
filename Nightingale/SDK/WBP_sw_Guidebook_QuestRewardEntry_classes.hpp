...
class UWBP_sw_Guidebook_QuestRewardEntry_C : public UNWXUserWidget
{
public:
	...
	class UTextBlock*                            RewardQuantityText;                                // 0x358(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UWBP_Horizontal_AutoScrollingText_C*   TXT_RewardName;                                    // 0x360(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	static class UWBP_sw_Guidebook_QuestRewardEntry_C* GetDefaultObj();
	...
	void Construct();
	void Refresh();
	void ExecuteUbergraph_WBP_sw_Guidebook_QuestRewardEntry(int32 EntryPoint);
};
