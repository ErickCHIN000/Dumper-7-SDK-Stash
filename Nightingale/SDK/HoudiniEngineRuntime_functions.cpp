...
class UClass* UHoudiniNodeSyncComponent::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("HoudiniNodeSyncComponent");

	return Clss;
}


// HoudiniNodeSyncComponent HoudiniEngineRuntime.Default__HoudiniNodeSyncComponent
// (Public, ClassDefaultObject, ArchetypeObject)

class UHoudiniNodeSyncComponent* UHoudiniNodeSyncComponent::GetDefaultObj()
{
	static class UHoudiniNodeSyncComponent* Default = nullptr;

	if (!Default)
		Default = static_cast<UHoudiniNodeSyncComponent*>(UHoudiniNodeSyncComponent::StaticClass()->DefaultObject);
...
// (Final, Native, Public, Const)
// Parameters:
// TArray<struct FVector2f>           ReturnValue                                                      (ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)
...
bool UHoudiniToolData::ConvertToJSONData(class FString* JSONData)
{
	static class UFunction* Func = nullptr;
