...
{
public:
	uint8                                        Pad_1A[0x54];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1B[0xA8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1C[0x7];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1F[0x3];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_21[0x8];                                       // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_24[0x1];                                       // Fixing Size After Last Property  [ Dumper-7 ]
