...
{
public:
	uint8                                        Pad_79F[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FPartyMemberPlatformData              PlatformData;                                      // 0x28(0x98)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_7A3[0x90];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7A8[0x37];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                JoinMethod;                                        // 0x188(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_7AD[0x30];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_7E0[0x9];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	struct FPartyPrivacySettings                 PrivacySettings;                                   // 0x21(0x3)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_7E4[0x34];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7E7[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_7F2[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
