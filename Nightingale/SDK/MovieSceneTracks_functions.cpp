...
class UClass* IMovieSceneConsoleVariableTrackInterface::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class IMovieSceneConsoleVariableTrackInterface* IMovieSceneConsoleVariableTrackInterface::GetDefaultObj()
{
	static class IMovieSceneConsoleVariableTrackInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<IMovieSceneConsoleVariableTrackInterface*>(IMovieSceneConsoleVariableTrackInterface::StaticClass()->DefaultObject);
