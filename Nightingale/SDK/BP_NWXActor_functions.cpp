...
class UClass* ABP_NWXActor_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_NWXActor_C");

	return Clss;
}


// BP_NWXActor_C BP_NWXActor.Default__BP_NWXActor_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_NWXActor_C* ABP_NWXActor_C::GetDefaultObj()
{
	static class ABP_NWXActor_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_NWXActor_C*>(ABP_NWXActor_C::StaticClass()->DefaultObject);
...
void ABP_NWXActor_C::OnDamageReceived(float Damage, class AActor* Target, class AActor* Source, struct FGameplayTagContainer& EffectTags, struct FHitResult& HitResult, struct FTagValueContainer& TagValueContainer)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_NWXActor_C", "OnDamageReceived");

	Params::ABP_NWXActor_C_OnDamageReceived_Params Parms{};
...
void ABP_NWXActor_C::ExecuteUbergraph_BP_NWXActor(int32 EntryPoint, float K2Node_Event_Damage, class AActor* K2Node_Event_Target, class AActor* K2Node_Event_Source, const struct FGameplayTagContainer& K2Node_Event_EffectTags, const struct FHitResult& K2Node_Event_HitResult, const struct FTagValueContainer& K2Node_Event_TagValueContainer, double CallFunc_OnDamageReceived_Base_Damage_ImplicitCast)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_NWXActor_C", "ExecuteUbergraph_BP_NWXActor");

	Params::ABP_NWXActor_C_ExecuteUbergraph_BP_NWXActor_Params Parms{};
