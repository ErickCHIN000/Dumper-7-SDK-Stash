...
{
public:
	bool                                         bIsPassthrough;                                    // 0x1AD0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_416[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
