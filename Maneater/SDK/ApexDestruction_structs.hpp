...
public:
	...
	uint8                                        Pad_44[0x2];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_47[0x4];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FDestructibleDepthParameters>  DepthParameters;                                   // 0x70(0x10)(Edit, EditFixedSize, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
