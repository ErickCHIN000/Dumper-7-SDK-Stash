...
{
public:
	uint8                                        Pad_753[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_770[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	TArray<struct FVehicleGearData>              ForwardGears;                                      // 0x10(0x10)(Edit, ZeroConstructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_783[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_78C[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
