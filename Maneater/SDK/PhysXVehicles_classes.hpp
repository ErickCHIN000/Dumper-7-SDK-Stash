...
{
public:
	uint8                                        Pad_561[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        BitPad_2E : 2;                                     // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	TArray<struct FWheelSetup>                   WheelSetups;                                       // 0x150(0x10)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	TArray<class UVehicleWheel*>                 Wheels;                                            // 0x1A8(0x10)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, DuplicateTransient, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_58C[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5D7[0x24];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	TArray<struct FTireConfigMaterialFriction>   TireFrictionScales;                                // 0x38(0x10)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_674[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_688[0x708];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_70D[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
