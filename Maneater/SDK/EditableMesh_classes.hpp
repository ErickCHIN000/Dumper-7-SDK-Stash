...
public:
	...
	uint8                                        Pad_1CA[0x9C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_881[0x390];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_886[0x148];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_888[0x1E4];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_911[0xA4];                                     // Fixing Size Of Struct [ Dumper-7 ]
