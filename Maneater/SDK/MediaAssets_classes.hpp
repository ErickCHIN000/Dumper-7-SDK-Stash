...
{
public:
	uint8                                        Pad_1C4[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1DE[0x17];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_5C0[0x2C];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5C1[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	TArray<class UMediaSource*>                  Items;                                             // 0x28(0x10)(Edit, ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_781[0x1D8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_7BE[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         EnableGenMips;                                     // 0xCC(0x1)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        NumMips;                                           // 0xCD(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_7C5[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_7C6[0xB0];                                     // Fixing Size Of Struct [ Dumper-7 ]
