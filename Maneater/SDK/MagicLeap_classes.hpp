...
public:
	...
	uint8                                        Pad_2B8[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3A4[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3BD[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_427[0x68];                                     // Fixing Size Of Struct [ Dumper-7 ]
