...
// (Final, Native, Public, BlueprintCallable)
// Parameters:
// UDelegateProperty_                 OnSucceeded                                                      (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
// UDelegateProperty_                 OnFailed                                                         (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)

void UMobilePendingContent::StartInstall(UDelegateProperty_ OnSucceeded, UDelegateProperty_ OnFailed)
{
	static class UFunction* Func = nullptr;
...
void UMobilePatchingLibrary::RequestContent(const class FString& RemoteManifestURL, const class FString& CloudURL, const class FString& InstallDirectory, UDelegateProperty_ OnSucceeded, UDelegateProperty_ OnFailed)
{
	static class UFunction* Func = nullptr;
