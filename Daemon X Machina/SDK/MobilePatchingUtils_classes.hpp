...
{
public:
	uint8                                        Pad_2A2[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]

	static class UClass* StaticClass();
	static class UMobilePendingContent* GetDefaultObj();

	void StartInstall(UDelegateProperty_ OnSucceeded, UDelegateProperty_ OnFailed);
...
public:
	...
	void RequestContent(const class FString& RemoteManifestURL, const class FString& CloudURL, const class FString& InstallDirectory, UDelegateProperty_ OnSucceeded, UDelegateProperty_ OnFailed);
