...
{
public:
	uint8                                        Pad_D4[0x8];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DC[0x18];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        BitPad_F : 5;                                      // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_E7[0x2B];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_104[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_10B[0x608];                                    // Fixing Size After Last Property  [ Dumper-7 ]
