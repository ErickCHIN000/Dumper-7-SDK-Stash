...
{
public:
	UDelegateProperty_                           OnSucceeded;                                       // 0x0(0x10)(Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
	UDelegateProperty_                           OnFailed;                                          // 0x10(0x10)(Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	UDelegateProperty_                           OnSucceeded;                                       // 0x30(0x10)(Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
	UDelegateProperty_                           OnFailed;                                          // 0x40(0x10)(Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)
};
