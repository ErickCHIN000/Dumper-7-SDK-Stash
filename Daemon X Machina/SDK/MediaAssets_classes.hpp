...
{
public:
	uint8                                        Pad_213[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_688[0x78];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_6D6[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6D9[0x70];                                     // Fixing Size Of Struct [ Dumper-7 ]
