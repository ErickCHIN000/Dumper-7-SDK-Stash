...
// BlueprintGeneratedClass npc_ranno.npc_ranno_C
// (Actor, Pawn)

class UClass* ANpc_ranno_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_ranno_C");

	return Clss;
}


// npc_ranno_C npc_ranno.Default__npc_ranno_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_ranno_C* ANpc_ranno_C::GetDefaultObj()
{
	static class ANpc_ranno_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_ranno_C*>(ANpc_ranno_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_ranno.npc_ranno_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_ranno_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_ranno_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_ranno_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_ranno.npc_ranno_C.ExecuteUbergraph_npc_ranno
