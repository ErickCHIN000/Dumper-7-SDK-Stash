...
// BlueprintGeneratedClass de_ahmes_quest_hscene1.de_ahmes_quest_hscene1_C
// (Actor)

class UClass* ADe_ahmes_quest_hscene1_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_ahmes_quest_hscene1_C");

	return Clss;
}


// de_ahmes_quest_hscene1_C de_ahmes_quest_hscene1.Default__de_ahmes_quest_hscene1_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_ahmes_quest_hscene1_C* ADe_ahmes_quest_hscene1_C::GetDefaultObj()
{
	static class ADe_ahmes_quest_hscene1_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_ahmes_quest_hscene1_C*>(ADe_ahmes_quest_hscene1_C::StaticClass()->DefaultObject);
...
void ADe_ahmes_quest_hscene1_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_ahmes_quest_hscene1_C", "call_event");

	Params::ADe_ahmes_quest_hscene1_C_Call_event_Params Parms{};
