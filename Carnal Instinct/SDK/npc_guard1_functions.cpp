...
class UClass* ANpc_guard1_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_guard1_C");

	return Clss;
}


// npc_guard1_C npc_guard1.Default__npc_guard1_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_guard1_C* ANpc_guard1_C::GetDefaultObj()
{
	static class ANpc_guard1_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_guard1_C*>(ANpc_guard1_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_guard1.npc_guard1_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ANpc_guard1_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_guard1_C", "ReceiveBeginPlay");
...
// Function npc_guard1.npc_guard1_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_guard1_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_guard1_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_guard1_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_guard1.npc_guard1_C.START DLG
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void ANpc_guard1_C::START_DLG()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_guard1_C", "START DLG");
...
// Function npc_guard1.npc_guard1_C.ExecuteUbergraph_npc_guard1
