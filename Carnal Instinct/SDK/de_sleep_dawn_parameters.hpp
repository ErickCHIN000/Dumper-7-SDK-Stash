...
struct ADe_sleep_dawn_C_Call_event_Params
{
public:
	class Abp_dlg_actor_C*                       Dlg_actor;                                         // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FS_dlg_event_info                     Event_data;                                        // 0x8(0x2D)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
	uint8                                        Pad_1D0D[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};

// 0x79 (0x79 - 0x0)
// Function de_sleep_dawn.de_sleep_dawn_C.ExecuteUbergraph_de_sleep_dawn
struct ADe_sleep_dawn_C_ExecuteUbergraph_de_sleep_dawn_Params
{
public:
	...
	float                                        CallFunc_GetMaxValue_Value;                        // 0x10(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AUltra_Dynamic_Sky_C*                  CallFunc_GetActorOfClass_ReturnValue;              // 0x50(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ABP_DungeonLighting_C*                 CallFunc_GetActorOfClass_ReturnValue_1;            // 0x70(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
