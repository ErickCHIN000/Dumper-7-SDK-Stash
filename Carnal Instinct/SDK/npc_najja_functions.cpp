...
// BlueprintGeneratedClass npc_najja.npc_najja_C
// (Actor, Pawn)

class UClass* ANpc_najja_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_najja_C");

	return Clss;
}


// npc_najja_C npc_najja.Default__npc_najja_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_najja_C* ANpc_najja_C::GetDefaultObj()
{
	static class ANpc_najja_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_najja_C*>(ANpc_najja_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_najja.npc_najja_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ANpc_najja_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_najja_C", "ReceiveBeginPlay");
...
// Function npc_najja.npc_najja_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_najja_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_najja_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_najja_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_najja.npc_najja_C.ExecuteUbergraph_npc_najja
