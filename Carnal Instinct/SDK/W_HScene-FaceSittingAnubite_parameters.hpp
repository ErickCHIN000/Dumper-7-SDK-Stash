...
struct UW_HSceneMinusFaceSittingAnubite_C_ExecuteUbergraph_W_HSceneMinusFaceSittingAnubite_Params
{
public:
	...
	class ASEQ_MasterHSceneMinusFaceSittingAnubite_C* CallFunc_GetActorOfClass_ReturnValue;              // 0x90(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
