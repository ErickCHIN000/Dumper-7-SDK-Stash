...
struct UAN_DynamicSex_ClimaxEnd_Centaur_C_Received_Notify_Params
{
public:
	...
	class ABP_DynamicSex_Base_Centaur_C*         CallFunc_GetActorOfClass_ReturnValue;              // 0x18(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
