...
public:
	...
	class ULowEntryLong*                         LongBytesValue;                                    // 0x30(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class ULowEntryDouble*                       DoubleBytesValue;                                  // 0x40(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                         BooleanValue;                                      // 0x48(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_185[0x7];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                StringUtf8Value;                                   // 0x50(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<uint8>                                ByteArrayValue;                                    // 0x60(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<int32>                                IntegerArrayValue;                                 // 0x70(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class ULowEntryLong*>                 LongBytesArrayValue;                               // 0x80(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<float>                                FloatArrayValue;                                   // 0x90(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class ULowEntryDouble*>               DoubleBytesArrayValue;                             // 0xA0(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<bool>                                 BooleanArrayValue;                                 // 0xB0(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<class FString>                        StringUtf8ArrayValue;                              // 0xC0(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_33F5[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_342B[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_34A8[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
