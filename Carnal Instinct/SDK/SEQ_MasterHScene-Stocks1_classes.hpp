...
class ASEQ_MasterHSceneMinusStocks1_C : public ALevelSequenceActor
{
public:
	...
	class UW_HSceneMinusStocks1_C*               NewVar_3;                                          // 0x2E8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class ASEQ_MasterHSceneMinusStocks1_C* GetDefaultObj();
