...
// BlueprintGeneratedClass choiceClass_hidden_cock.choiceClass_hidden_cock_C
// (Actor)

class UClass* AChoiceClass_hidden_cock_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("choiceClass_hidden_cock_C");

	return Clss;
}


// choiceClass_hidden_cock_C choiceClass_hidden_cock.Default__choiceClass_hidden_cock_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AChoiceClass_hidden_cock_C* AChoiceClass_hidden_cock_C::GetDefaultObj()
{
	static class AChoiceClass_hidden_cock_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AChoiceClass_hidden_cock_C*>(AChoiceClass_hidden_cock_C::StaticClass()->DefaultObject);

	return Default;
}


// Function choiceClass_hidden_cock.choiceClass_hidden_cock_C.choice_info_condition
