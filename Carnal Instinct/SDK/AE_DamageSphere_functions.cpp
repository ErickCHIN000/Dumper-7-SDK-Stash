...
// BlueprintGeneratedClass AE_DamageSphere.AE_DamageSphere_C
// (Actor)

class UClass* AAE_DamageSphere_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AE_DamageSphere_C");

	return Clss;
}


// AE_DamageSphere_C AE_DamageSphere.Default__AE_DamageSphere_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AAE_DamageSphere_C* AAE_DamageSphere_C::GetDefaultObj()
{
	static class AAE_DamageSphere_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AAE_DamageSphere_C*>(AAE_DamageSphere_C::StaticClass()->DefaultObject);

	return Default;
}


// Function AE_DamageSphere.AE_DamageSphere_C.ApplyImpulseToCharacter
...
void AAE_DamageSphere_C::ApplyImpulseToCharacter(class AActor* Actor, const struct FVector& Normal, class ACharacter* K2Node_DynamicCast_AsCharacter, bool K2Node_DynamicCast_bSuccess, const struct FVector& CallFunc_Multiply_VectorFloat_ReturnValue, bool CallFunc_IsAnySimulatingPhysics_ReturnValue, const struct FVector& CallFunc_Multiply_VectorFloat_ReturnValue_1)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AE_DamageSphere_C", "ApplyImpulseToCharacter");

	Params::AAE_DamageSphere_C_ApplyImpulseToCharacter_Params Parms{};
...
// Function AE_DamageSphere.AE_DamageSphere_C.IsEnemy
...
void AAE_DamageSphere_C::IsEnemy(class AActor* Target, bool* Result, TScriptInterface<class II_CanBeAttacked_C> K2Node_DynamicCast_AsI_Can_be_Attacked, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsAlive_Result, class AActor* CallFunc_GetOwner_ReturnValue, class UBehaviorComponent_C* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsEnemy_Return)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AE_DamageSphere_C", "IsEnemy");

	Params::AAE_DamageSphere_C_IsEnemy_Params Parms{};
...
// Function AE_DamageSphere.AE_DamageSphere_C.DamageSphere
...
// Function AE_DamageSphere.AE_DamageSphere_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void AAE_DamageSphere_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AE_DamageSphere_C", "ReceiveBeginPlay");
...
// Function AE_DamageSphere.AE_DamageSphere_C.ExecuteUbergraph_AE_DamageSphere
// (Final, UbergraphFunction)
// Parameters:
// int32                              EntryPoint                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AAE_DamageSphere_C::ExecuteUbergraph_AE_DamageSphere(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AE_DamageSphere_C", "ExecuteUbergraph_AE_DamageSphere");

	Params::AAE_DamageSphere_C_ExecuteUbergraph_AE_DamageSphere_Params Parms{};
