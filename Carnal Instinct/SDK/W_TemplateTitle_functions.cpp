...
void UW_TemplateTitle_C::ExecuteUbergraph_W_TemplateTitle(int32 EntryPoint, bool Temp_bool_Variable, float CallFunc_FClamp_ReturnValue, float Temp_float_Variable, bool K2Node_Event_IsDesignTime, float K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
