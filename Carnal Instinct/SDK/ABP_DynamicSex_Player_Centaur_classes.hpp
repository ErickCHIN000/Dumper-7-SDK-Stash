...
class UABP_DynamicSex_Player_Centaur_C : public UAnimInstance
{
public:
	...
	static class UABP_DynamicSex_Player_Centaur_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void BlueprintUpdateAnimation(float DeltaTimeX);
	void BlueprintInitializeAnimation();
	void ExecuteUbergraph_ABP_DynamicSex_Player_Centaur(int32 EntryPoint, class ABP_DynamicSex_Base_Centaur_C* CallFunc_GetActorOfClass_ReturnValue, bool CallFunc_IsValid_ReturnValue, float K2Node_Event_DeltaTimeX, bool CallFunc_IsValid_ReturnValue_1);
};
