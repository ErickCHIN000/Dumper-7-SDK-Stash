...
// BlueprintGeneratedClass npc_stranger.npc_stranger_C
// (Actor, Pawn)

class UClass* ANpc_stranger_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_stranger_C");

	return Clss;
}


// npc_stranger_C npc_stranger.Default__npc_stranger_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_stranger_C* ANpc_stranger_C::GetDefaultObj()
{
	static class ANpc_stranger_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_stranger_C*>(ANpc_stranger_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_stranger.npc_stranger_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_stranger_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_stranger_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_stranger_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_stranger.npc_stranger_C.START DLG
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void ANpc_stranger_C::START_DLG()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_stranger_C", "START DLG");
...
// Function npc_stranger.npc_stranger_C.Game Load
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:

void ANpc_stranger_C::Game_Load()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_stranger_C", "Game Load");
...
// Function npc_stranger.npc_stranger_C.New Start DLG
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void ANpc_stranger_C::New_Start_DLG()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_stranger_C", "New Start DLG");
...
// Function npc_stranger.npc_stranger_C.ExecuteUbergraph_npc_stranger
