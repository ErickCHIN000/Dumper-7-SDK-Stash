...
// BlueprintGeneratedClass de_bast_kill.de_bast_kill_C
// (Actor)

class UClass* ADe_bast_kill_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_bast_kill_C");

	return Clss;
}


// de_bast_kill_C de_bast_kill.Default__de_bast_kill_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_bast_kill_C* ADe_bast_kill_C::GetDefaultObj()
{
	static class ADe_bast_kill_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_bast_kill_C*>(ADe_bast_kill_C::StaticClass()->DefaultObject);

	return Default;
}


// Function de_bast_kill.de_bast_kill_C.call_event
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class Abp_dlg_actor_C*             Dlg_actor                                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FS_dlg_event_info           Event_data                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)

void ADe_bast_kill_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_bast_kill_C", "call_event");

	Params::ADe_bast_kill_C_Call_event_Params Parms{};
...
// Function de_bast_kill.de_bast_kill_C.ExecuteUbergraph_de_bast_kill
