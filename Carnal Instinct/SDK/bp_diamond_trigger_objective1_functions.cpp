...
class UClass* Abp_diamond_trigger_objective1_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("bp_diamond_trigger_objective1_C");

	return Clss;
}


// bp_diamond_trigger_objective1_C bp_diamond_trigger_objective1.Default__bp_diamond_trigger_objective1_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class Abp_diamond_trigger_objective1_C* Abp_diamond_trigger_objective1_C::GetDefaultObj()
{
	static class Abp_diamond_trigger_objective1_C* Default = nullptr;

	if (!Default)
		Default = static_cast<Abp_diamond_trigger_objective1_C*>(Abp_diamond_trigger_objective1_C::StaticClass()->DefaultObject);

	return Default;
}


// Function bp_diamond_trigger_objective1.bp_diamond_trigger_objective1_C.BndEvt__InteractableArea_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature
...
void Abp_diamond_trigger_objective1_C::BndEvt__InteractableArea_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("bp_diamond_trigger_objective1_C", "BndEvt__InteractableArea_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature");

	Params::Abp_diamond_trigger_objective1_C_BndEvt__InteractableArea_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params Parms{};
...
// Function bp_diamond_trigger_objective1.bp_diamond_trigger_objective1_C.ExecuteUbergraph_bp_diamond_trigger_objective1
