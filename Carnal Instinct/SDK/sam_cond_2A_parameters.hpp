...
struct ASam_cond_2A_C_Choice_info_condition_Params
{
public:
...
struct ASam_cond_2A_C_Choice_data_condition_Params
{
public:
...
struct ASam_cond_2A_C_Reply_info_condition_Params
{
public:
	...
	bool                                         CallFunc_get_storage_choice_is_valid;              // 0x1E0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_6E2[0x3];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        CallFunc_get_storage_choice_branch_index;          // 0x1E4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_get_storage_choice_storage_index;         // 0x1E8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FS_dlg_choice_storage                 CallFunc_get_storage_choice_choice_storage;        // 0x1EC(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FS_dlg_event_info                     K2Node_MakeStruct_s_dlg_event_info;                // 0x200(0x2D)(ZeroConstructor, HasGetValueTypeHash)
	uint8                                        Pad_6ED[0x3];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FS_dlg_event_info>             K2Node_MakeArray_Array;                            // 0x230(0x10)(ReferenceParm)
	struct FS_dlg_shared                         K2Node_MakeStruct_s_dlg_shared;                    // 0x240(0x40)(HasGetValueTypeHash)
};

// 0x570 (0x570 - 0x0)
// Function sam_cond_2A.sam_cond_2A_C.branch_info_condition
struct ASam_cond_2A_C_branch_info_condition_Params
{
public:
...
struct ASam_cond_2A_C_ExecuteUbergraph_sam_cond_2A_Params
{
public:
