...
class ANpc_eleia_C : public AExample_npc_base_C
{
public:
	uint8                                        Pad_15A0[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class ANpc_eleia_C* GetDefaultObj();
