...
struct ABP_SpellIndicator_C_SetMaterial_Params
{
public:
	class UMaterialInterface*                    NewMaterial;                                       // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x20 (0x20 - 0x0)
// Function BP_SpellIndicator.BP_SpellIndicator_C.SetRadius
struct ABP_SpellIndicator_C_SetRadius_Params
{
public:
