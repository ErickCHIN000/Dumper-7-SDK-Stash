...
// BlueprintGeneratedClass npc_shrine.npc_shrine_C
// (Actor, Pawn)

class UClass* ANpc_shrine_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_shrine_C");

	return Clss;
}


// npc_shrine_C npc_shrine.Default__npc_shrine_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_shrine_C* ANpc_shrine_C::GetDefaultObj()
{
	static class ANpc_shrine_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_shrine_C*>(ANpc_shrine_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_shrine.npc_shrine_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_shrine_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_shrine_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_shrine_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_shrine.npc_shrine_C.ExecuteUbergraph_npc_shrine
