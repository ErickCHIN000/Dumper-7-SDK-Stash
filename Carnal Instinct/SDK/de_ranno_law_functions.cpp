...
class UClass* ADe_ranno_law_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_ranno_law_C");

	return Clss;
}


// de_ranno_law_C de_ranno_law.Default__de_ranno_law_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_ranno_law_C* ADe_ranno_law_C::GetDefaultObj()
{
	static class ADe_ranno_law_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_ranno_law_C*>(ADe_ranno_law_C::StaticClass()->DefaultObject);
...
void ADe_ranno_law_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_ranno_law_C", "call_event");

	Params::ADe_ranno_law_C_Call_event_Params Parms{};
