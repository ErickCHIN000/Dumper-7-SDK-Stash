...
public:
	...
	uint8                                        Pad_CCA[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_D74[0x98];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<struct FGameplayTagSource>            TagSources;                                        // 0xC0(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_D7A[0xE0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DD2[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
