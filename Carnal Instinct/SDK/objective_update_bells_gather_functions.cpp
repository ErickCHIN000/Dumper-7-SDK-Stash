...
class UClass* AObjective_update_bells_gather_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("objective_update_bells_gather_C");

	return Clss;
}


// objective_update_bells_gather_C objective_update_bells_gather.Default__objective_update_bells_gather_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AObjective_update_bells_gather_C* AObjective_update_bells_gather_C::GetDefaultObj()
{
	static class AObjective_update_bells_gather_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AObjective_update_bells_gather_C*>(AObjective_update_bells_gather_C::StaticClass()->DefaultObject);
...
void AObjective_update_bells_gather_C::Call_event(class Abp_quest_actor_C* Quest_actor, const struct FS_quest_event& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("objective_update_bells_gather_C", "call_event");

	Params::AObjective_update_bells_gather_C_Call_event_Params Parms{};
...
void AObjective_update_bells_gather_C::ExecuteUbergraph_objective_update_bells_gather(int32 EntryPoint, class ABP_CombatCharacter_C* CallFunc_Get_Player_Reference_Player, bool CallFunc_IsValid_ReturnValue, class Ubp_quest_component_C* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, bool CallFunc_get_quest_is_valid, int32 CallFunc_get_quest_found_index, class Abp_quest_actor_C* CallFunc_get_quest_quest_actor, class Abp_quest_actor_C* K2Node_Event_quest_actor, const struct FS_quest_event& K2Node_Event_event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("objective_update_bells_gather_C", "ExecuteUbergraph_objective_update_bells_gather");

	Params::AObjective_update_bells_gather_C_ExecuteUbergraph_objective_update_bells_gather_Params Parms{};
