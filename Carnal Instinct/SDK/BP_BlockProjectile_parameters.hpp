...
struct ABP_BlockProjectile_C_SpawnImpaledArrow_Params
{
public:
	...
	uint8                                        Pad_10C3[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct ABP_BlockProjectile_C_IsEnemy_Params
{
public:
...
struct ABP_BlockProjectile_C_OnArrowHit_Params
{
public:
	...
	uint8                                        Pad_1320[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TScriptInterface<class II_CanBeAttacked_C>   K2Node_DynamicCast_AsI_Can_be_Attacked_1;          // 0x1C8(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper)
	...
	class AActor*                                CallFunc_GetOwner_ReturnValue_3;                   // 0x1E0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        K2Node_Select_Default;                             // 0x1E8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1352[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FF_HitData                            K2Node_MakeStruct_F_HitData;                       // 0x1F0(0x1F)(IsPlainOldData, NoDestructor, ContainsInstancedReference, HasGetValueTypeHash)
	uint8                                        Pad_1353[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	bool                                         CallFunc_TakeDamage_Result;                        // 0x210(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class E_AttackResult                    CallFunc_TakeDamage_ResultType;                    // 0x211(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct ABP_BlockProjectile_C_ApplyHitImpulse_Params
{
public:
...
struct ABP_BlockProjectile_C_BndEvt__BPC_CollisionHandler_K2Node_ComponentBoundEvent_10_OnHit__DelegateSignature_Params
{
public:
...
struct ABP_BlockProjectile_C_ExecuteUbergraph_BP_BlockProjectile_Params
{
public:
