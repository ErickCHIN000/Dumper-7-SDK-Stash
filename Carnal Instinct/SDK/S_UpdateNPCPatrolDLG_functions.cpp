...
// BlueprintGeneratedClass S_UpdateNPCPatrolDLG.S_UpdateNPCPatrolDLG_C
// (None)

class UClass* US_UpdateNPCPatrolDLG_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("S_UpdateNPCPatrolDLG_C");

	return Clss;
}


// S_UpdateNPCPatrolDLG_C S_UpdateNPCPatrolDLG.Default__S_UpdateNPCPatrolDLG_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class US_UpdateNPCPatrolDLG_C* US_UpdateNPCPatrolDLG_C::GetDefaultObj()
{
	static class US_UpdateNPCPatrolDLG_C* Default = nullptr;

	if (!Default)
		Default = static_cast<US_UpdateNPCPatrolDLG_C*>(US_UpdateNPCPatrolDLG_C::StaticClass()->DefaultObject);
...
void US_UpdateNPCPatrolDLG_C::UpdateActivities(bool CallFunc_RandomBoolWithWeight_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, uint8 CallFunc_GetBlackboardValueAsEnum_ReturnValue, uint8 CallFunc_GetValidValue_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("S_UpdateNPCPatrolDLG_C", "UpdateActivities");

	Params::US_UpdateNPCPatrolDLG_C_UpdateActivities_Params Parms{};
...
void US_UpdateNPCPatrolDLG_C::UpdateBehavior(int32 L_ReceivedHitsCount, float L_StaminaPercent, float L_DotProductToTarget, class AActor* L_Target, float L_DistanceToTarget, uint8 CallFunc_MakeLiteralByte_ReturnValue, uint8 CallFunc_MakeLiteralByte_ReturnValue_1, uint8 CallFunc_MakeLiteralByte_ReturnValue_2, TScriptInterface<class II_CanBeAttacked_C> K2Node_DynamicCast_AsI_Can_be_Attacked, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsAlive_Result, bool CallFunc_IsValid_ReturnValue, uint8 CallFunc_MakeLiteralByte_ReturnValue_3, bool CallFunc_IsValid_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_2, TScriptInterface<class II_CombatState_C> K2Node_DynamicCast_AsI_Combat_State, bool K2Node_DynamicCast_bSuccess_1, bool CallFunc_GetIsInCombat_Value, TScriptInterface<class II_CombatState_C> K2Node_DynamicCast_AsI_Combat_State_1, bool K2Node_DynamicCast_bSuccess_2, enum class E_CombatType CallFunc_GetCombatType_Type, uint8 CallFunc_MakeLiteralByte_ReturnValue_4, TScriptInterface<class II_CombatState_C> K2Node_DynamicCast_AsI_Combat_State_2, bool K2Node_DynamicCast_bSuccess_3, enum class E_CombatType CallFunc_GetCombatType_Type_1, bool CallFunc_RandomBoolWithWeight_ReturnValue, bool CallFunc_RandomBoolWithWeight_ReturnValue_1, uint8 CallFunc_MakeLiteralByte_ReturnValue_5, TArray<enum class E_CombatType>& K2Node_MakeArray_Array, bool CallFunc_Array_Contains_ReturnValue, float CallFunc_Add_FloatFloat_ReturnValue, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue, bool CallFunc_LessEqual_FloatFloat_ReturnValue, uint8 CallFunc_MakeLiteralByte_ReturnValue_6, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_BooleanOR_ReturnValue_1, uint8 CallFunc_MakeLiteralByte_ReturnValue_7, uint8 CallFunc_MakeLiteralByte_ReturnValue_8, bool CallFunc_LessEqual_FloatFloat_ReturnValue_1, bool CallFunc_LessEqual_FloatFloat_ReturnValue_2, float CallFunc_GetMaxValue_Value, float CallFunc_GetCurrentValue_CurrentValue, int32 CallFunc_GetRecentlyReceivedHitsCount_Value, float CallFunc_Divide_FloatFloat_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue, uint8 CallFunc_MakeLiteralByte_ReturnValue_9, enum class E_State CallFunc_GetState_State, bool CallFunc_EqualEqual_ByteByte_ReturnValue, float CallFunc_GetDotProductTo_ReturnValue, uint8 CallFunc_MakeLiteralByte_ReturnValue_10, float CallFunc_GetDistanceTo_ReturnValue, uint8 CallFunc_MakeLiteralByte_ReturnValue_11, class AActor* CallFunc_GetBlackboardValueAsActor_ReturnValue, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue_1, bool CallFunc_LessEqual_FloatFloat_ReturnValue_3, TArray<enum class E_CombatType>& K2Node_MakeArray_Array_1, bool CallFunc_Array_Contains_ReturnValue_1)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("S_UpdateNPCPatrolDLG_C", "UpdateBehavior");

	Params::US_UpdateNPCPatrolDLG_C_UpdateBehavior_Params Parms{};
...
void US_UpdateNPCPatrolDLG_C::ReceiveSearchStartAI(class AAIController* OwnerController, class APawn* ControlledPawn)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("S_UpdateNPCPatrolDLG_C", "ReceiveSearchStartAI");

	Params::US_UpdateNPCPatrolDLG_C_ReceiveSearchStartAI_Params Parms{};
...
void US_UpdateNPCPatrolDLG_C::OnStateChanged(enum class E_State PrevState, enum class E_State NewState)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("S_UpdateNPCPatrolDLG_C", "OnStateChanged");

	Params::US_UpdateNPCPatrolDLG_C_OnStateChanged_Params Parms{};
...
void US_UpdateNPCPatrolDLG_C::ReceiveTickAI(class AAIController* OwnerController, class APawn* ControlledPawn, float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("S_UpdateNPCPatrolDLG_C", "ReceiveTickAI");

	Params::US_UpdateNPCPatrolDLG_C_ReceiveTickAI_Params Parms{};
...
void US_UpdateNPCPatrolDLG_C::OnStaminaValueChanged(float NewValue, float MaxValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("S_UpdateNPCPatrolDLG_C", "OnStaminaValueChanged");

	Params::US_UpdateNPCPatrolDLG_C_OnStaminaValueChanged_Params Parms{};
...
// Function S_UpdateNPCPatrolDLG.S_UpdateNPCPatrolDLG_C.Update
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void US_UpdateNPCPatrolDLG_C::Update()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("S_UpdateNPCPatrolDLG_C", "Update");
