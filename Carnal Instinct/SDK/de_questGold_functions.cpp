...
class UClass* ADe_questGold_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_questGold_C");

	return Clss;
}


// de_questGold_C de_questGold.Default__de_questGold_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_questGold_C* ADe_questGold_C::GetDefaultObj()
{
	static class ADe_questGold_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_questGold_C*>(ADe_questGold_C::StaticClass()->DefaultObject);
...
void ADe_questGold_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_questGold_C", "call_event");

	Params::ADe_questGold_C_Call_event_Params Parms{};
