...
struct UW_HSceneMinusTail_Fuck_Ahmes_C_ExecuteUbergraph_W_HSceneMinusTail_Fuck_Ahmes_Params
{
public:
	...
	class ASEQ_MasterHSceneMinusTail_Fuck_Ahmes_C* CallFunc_GetActorOfClass_ReturnValue;              // 0x88(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
