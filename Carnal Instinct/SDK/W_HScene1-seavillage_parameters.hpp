...
struct UW_HScene1Minusseavillage_C_ExecuteUbergraph_W_HScene1Minusseavillage_Params
{
public:
	...
	class ASEQ_MasterHSceneMinusseavillage_C*    CallFunc_GetActorOfClass_ReturnValue;              // 0x38(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
