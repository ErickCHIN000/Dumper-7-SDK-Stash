...
struct ADe_khaba_servant_C_Call_event_Params
{
public:
...
struct ADe_khaba_servant_C_ExecuteUbergraph_de_khaba_servant_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_13CD[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class ABP_Loot_KhabaServant_C*               CallFunc_GetActorOfClass_ReturnValue;              // 0x8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_13D1[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
