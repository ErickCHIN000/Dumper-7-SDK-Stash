...
class UW_HSceneMinusAhmes_Oral_Quest_C : public UUserWidget
{
public:
	...
	class ASEQ_MasterHSceneMinusAhmes_Oral_Quest_C* NewVar_0;                                          // 0x290(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UW_HSceneMinusAhmes_Oral_Quest_C* GetDefaultObj();
