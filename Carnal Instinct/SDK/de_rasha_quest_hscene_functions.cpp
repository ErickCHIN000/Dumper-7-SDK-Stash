...
// BlueprintGeneratedClass de_rasha_quest_hscene.de_rasha_quest_hscene_C
// (Actor)

class UClass* ADe_rasha_quest_hscene_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_rasha_quest_hscene_C");

	return Clss;
}


// de_rasha_quest_hscene_C de_rasha_quest_hscene.Default__de_rasha_quest_hscene_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_rasha_quest_hscene_C* ADe_rasha_quest_hscene_C::GetDefaultObj()
{
	static class ADe_rasha_quest_hscene_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_rasha_quest_hscene_C*>(ADe_rasha_quest_hscene_C::StaticClass()->DefaultObject);

	return Default;
}


// Function de_rasha_quest_hscene.de_rasha_quest_hscene_C.call_event
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class Abp_dlg_actor_C*             Dlg_actor                                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FS_dlg_event_info           Event_data                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)

void ADe_rasha_quest_hscene_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_rasha_quest_hscene_C", "call_event");

	Params::ADe_rasha_quest_hscene_C_Call_event_Params Parms{};
...
// Function de_rasha_quest_hscene.de_rasha_quest_hscene_C.ExecuteUbergraph_de_rasha_quest_hscene
// (Final, UbergraphFunction)
// Parameters:
// int32                              EntryPoint                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class Abp_dlg_actor_C*             K2Node_Event_dlg_actor                                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FS_dlg_event_info           K2Node_Event_event_data                                          (ZeroConstructor, HasGetValueTypeHash)
// class ASEQ_MasterHSceneMinusGOTG_BigCockSex_C*CallFunc_GetActorOfClass_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
