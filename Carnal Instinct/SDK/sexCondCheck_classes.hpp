...
class ASexCondCheck_C : public AObject_dlg_condition_parent_C
{
public:
	...
	static class ASexCondCheck_C* GetDefaultObj();
	...
	void ExecuteUbergraph_sexCondCheck(int32 EntryPoint);
};
