...
class ASEQ_MasterHSceneMinusBells_On_Anal_C : public ALevelSequenceActor
{
public:
	...
	class UW_HScene_Bells_On_Anal_C*             NewVar_0;                                          // 0x2D0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class ASEQ_MasterHSceneMinusBells_On_Anal_C* GetDefaultObj();
