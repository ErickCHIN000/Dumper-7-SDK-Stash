...
struct AChoiceClass_hidden_cock_C_Choice_info_condition_Params
{
public:
	...
	class UAC_Inventory_C*                       CallFunc_Get_AC_Inventory_AC_Inventory;            // 0x2E0(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_NotEqual_ClassClass_ReturnValue;          // 0x2E8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	uint8                                        Pad_1B1A[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
