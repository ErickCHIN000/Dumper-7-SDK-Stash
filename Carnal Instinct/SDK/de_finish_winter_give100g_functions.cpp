...
class UClass* ADe_finish_winter_give100g_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_finish_winter_give100g_C");

	return Clss;
}


// de_finish_winter_give100g_C de_finish_winter_give100g.Default__de_finish_winter_give100g_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_finish_winter_give100g_C* ADe_finish_winter_give100g_C::GetDefaultObj()
{
	static class ADe_finish_winter_give100g_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_finish_winter_give100g_C*>(ADe_finish_winter_give100g_C::StaticClass()->DefaultObject);
...
void ADe_finish_winter_give100g_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_finish_winter_give100g_C", "call_event");

	Params::ADe_finish_winter_give100g_C_Call_event_Params Parms{};
