...
struct ADe_inqbast_bed_C_Call_event_Params
{
public:
...
struct ADe_inqbast_bed_C_ExecuteUbergraph_de_inqbast_bed_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1DD9[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class Abp_inq_cagebed_C*                     CallFunc_GetActorOfClass_ReturnValue;              // 0x8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
