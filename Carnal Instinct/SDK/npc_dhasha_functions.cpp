...
// BlueprintGeneratedClass npc_dhasha.npc_dhasha_C
// (Actor, Pawn)

class UClass* ANpc_dhasha_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_dhasha_C");

	return Clss;
}


// npc_dhasha_C npc_dhasha.Default__npc_dhasha_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_dhasha_C* ANpc_dhasha_C::GetDefaultObj()
{
	static class ANpc_dhasha_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_dhasha_C*>(ANpc_dhasha_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_dhasha.npc_dhasha_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_dhasha_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_dhasha_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_dhasha_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_dhasha.npc_dhasha_C.ExecuteUbergraph_npc_dhasha
