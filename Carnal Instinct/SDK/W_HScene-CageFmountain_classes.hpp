...
class UW_HSceneMinusCageFmountain_C : public UUserWidget
{
public:
	...
	class ASEQ_MasterHSceneMinusCageFMountain_C* NewVar_2;                                          // 0x2A0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UW_HSceneMinusCageFmountain_C* GetDefaultObj();
