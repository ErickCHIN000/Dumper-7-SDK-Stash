...
class UWB_LockIcon_C : public UUserWidget
{
public:
	...
	static class UWB_LockIcon_C* GetDefaultObj();

	void Construct();
	void ExecuteUbergraph_WB_LockIcon(int32 EntryPoint, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue);
};
