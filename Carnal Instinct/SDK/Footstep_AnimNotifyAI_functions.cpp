...
class UClass* UFootstep_AnimNotifyAI_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Footstep_AnimNotifyAI_C");

	return Clss;
}


// Footstep_AnimNotifyAI_C Footstep_AnimNotifyAI.Default__Footstep_AnimNotifyAI_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFootstep_AnimNotifyAI_C* UFootstep_AnimNotifyAI_C::GetDefaultObj()
{
	static class UFootstep_AnimNotifyAI_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFootstep_AnimNotifyAI_C*>(UFootstep_AnimNotifyAI_C::StaticClass()->DefaultObject);
