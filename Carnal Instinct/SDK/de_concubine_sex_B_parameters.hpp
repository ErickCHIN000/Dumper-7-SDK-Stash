...
struct ADe_concubine_sex_B_C_Call_event_Params
{
public:
	class Abp_dlg_actor_C*                       Dlg_actor;                                         // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FS_dlg_event_info                     Event_data;                                        // 0x8(0x2D)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
	uint8                                        Pad_1CA1[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};

// 0x59 (0x59 - 0x0)
// Function de_concubine_sex_B.de_concubine_sex_B_C.ExecuteUbergraph_de_concubine_sex_B
struct ADe_concubine_sex_B_C_ExecuteUbergraph_de_concubine_sex_B_Params
{
public:
	...
	class ASEQ_MasterHSceneMinusLOPMinusTablePlayerFuck_C* CallFunc_GetActorOfClass_ReturnValue;              // 0x50(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
