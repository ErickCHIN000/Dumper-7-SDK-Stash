...
// BlueprintGeneratedClass npc_hscenenoCock.npc_hscenenoCock_C
// (Actor, Pawn)

class UClass* ANpc_hscenenoCock_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_hscenenoCock_C");

	return Clss;
}


// npc_hscenenoCock_C npc_hscenenoCock.Default__npc_hscenenoCock_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_hscenenoCock_C* ANpc_hscenenoCock_C::GetDefaultObj()
{
	static class ANpc_hscenenoCock_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_hscenenoCock_C*>(ANpc_hscenenoCock_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_hscenenoCock.npc_hscenenoCock_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_hscenenoCock_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_hscenenoCock_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_hscenenoCock_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_hscenenoCock.npc_hscenenoCock_C.ExecuteUbergraph_npc_hscenenoCock
