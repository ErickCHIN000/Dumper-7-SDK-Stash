...
class UClass* UAN_GetBackstabDmg_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AN_GetBackstabDmg_C");

	return Clss;
}


// AN_GetBackstabDmg_C AN_GetBackstabDmg.Default__AN_GetBackstabDmg_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAN_GetBackstabDmg_C* UAN_GetBackstabDmg_C::GetDefaultObj()
{
	static class UAN_GetBackstabDmg_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAN_GetBackstabDmg_C*>(UAN_GetBackstabDmg_C::StaticClass()->DefaultObject);

	return Default;
}


// Function AN_GetBackstabDmg.AN_GetBackstabDmg_C.GetNotifyName
// (Event, Public, HasOutParams, BlueprintCallable, BlueprintEvent, Const)
// Parameters:
// class FString                      ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash)

class FString UAN_GetBackstabDmg_C::GetNotifyName()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AN_GetBackstabDmg_C", "GetNotifyName");

	Params::UAN_GetBackstabDmg_C_GetNotifyName_Params Parms{};
...
// Function AN_GetBackstabDmg.AN_GetBackstabDmg_C.Received_Notify
