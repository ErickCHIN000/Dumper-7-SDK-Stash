...
struct ADe_liquid_update12_C_Call_event_Params
{
public:
...
struct ADe_liquid_update12_C_ExecuteUbergraph_de_liquid_update12_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1D7A[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class ANpc_nefi_C*                           CallFunc_GetActorOfClass_ReturnValue;              // 0x8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
