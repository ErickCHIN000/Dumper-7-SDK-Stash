...
class UClass* ADe_weaponsmith_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_weaponsmith_C");

	return Clss;
}


// de_weaponsmith_C de_weaponsmith.Default__de_weaponsmith_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_weaponsmith_C* ADe_weaponsmith_C::GetDefaultObj()
{
	static class ADe_weaponsmith_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_weaponsmith_C*>(ADe_weaponsmith_C::StaticClass()->DefaultObject);
...
void ADe_weaponsmith_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_weaponsmith_C", "call_event");

	Params::ADe_weaponsmith_C_Call_event_Params Parms{};
...
// class ANpc_weaponsmith_C*          CallFunc_GetActorOfClass_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ADe_weaponsmith_C::ExecuteUbergraph_de_weaponsmith(int32 EntryPoint, class ANpc_weaponsmith_C* CallFunc_GetActorOfClass_ReturnValue, class Abp_dlg_actor_C* K2Node_Event_dlg_actor, const struct FS_dlg_event_info& K2Node_Event_event_data, bool CallFunc_get_dlg_actor_is_valid, bool CallFunc_get_dlg_actor_is_component_valid, int32 CallFunc_get_dlg_actor_actor_index, class AActor* CallFunc_get_dlg_actor_actor_reference, class Ubp_dlg_component_C* CallFunc_get_dlg_actor_dlg_component, const struct FS_dlg_bind_actor_info& CallFunc_get_dlg_actor_actor_dynamic, class UAC_Inventory_C* CallFunc_GetComponentByClass_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_weaponsmith_C", "ExecuteUbergraph_de_weaponsmith");

	Params::ADe_weaponsmith_C_ExecuteUbergraph_de_weaponsmith_Params Parms{};
