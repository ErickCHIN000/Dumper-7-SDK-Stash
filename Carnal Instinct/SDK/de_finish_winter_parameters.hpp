...
struct ADe_finish_winter_C_Call_event_Params
{
public:
...
struct ADe_finish_winter_C_ExecuteUbergraph_de_finish_winter_Params
{
public:
	...
	bool                                         CallFunc_get_layout_widget_is_valid;               // 0x48(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_146C[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UW_01_quest_layout_C*                  CallFunc_get_layout_widget_quest_widget;           // 0x50(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
