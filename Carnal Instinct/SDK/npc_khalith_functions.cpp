...
// BlueprintGeneratedClass npc_khalith.npc_khalith_C
// (Actor, Pawn)

class UClass* ANpc_khalith_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_khalith_C");

	return Clss;
}


// npc_khalith_C npc_khalith.Default__npc_khalith_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_khalith_C* ANpc_khalith_C::GetDefaultObj()
{
	static class ANpc_khalith_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_khalith_C*>(ANpc_khalith_C::StaticClass()->DefaultObject);
...
void ANpc_khalith_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_khalith_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_khalith_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// bool                               CallFunc_msl_get_actor_by_id_is_valid_2                          (ZeroConstructor, IsPlainOldData, NoDestructor)
// class AActor*                      CallFunc_msl_get_actor_by_id_actor_reference_2                   (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ANpc_khalith_C::ExecuteUbergraph_npc_khalith(int32 EntryPoint, bool CallFunc_msl_get_actor_by_id_is_valid, class AActor* CallFunc_msl_get_actor_by_id_actor_reference, class FName K2Node_ComponentBoundEvent_instigator_id, class AActor* K2Node_ComponentBoundEvent_instigator_actor, bool K2Node_SwitchName_CmpSuccess, TArray<class FName>& K2Node_MakeArray_Array, bool CallFunc_msl_get_actor_by_id_is_valid_1, class AActor* CallFunc_msl_get_actor_by_id_actor_reference_1, bool CallFunc_msl_get_actor_by_id_is_valid_2, class AActor* CallFunc_msl_get_actor_by_id_actor_reference_2, TArray<class AActor*>& K2Node_MakeArray_Array_1, const struct FS_dlg_bind_actor_settings& K2Node_MakeStruct_s_dlg_bind_actor_settings, bool CallFunc_add_dlg_is_valid, bool CallFunc_add_dlg_is_spawned, class Abp_dlg_actor_C* CallFunc_add_dlg_dlg_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_khalith_C", "ExecuteUbergraph_npc_khalith");

	Params::ANpc_khalith_C_ExecuteUbergraph_npc_khalith_Params Parms{};
	...
	Parms.CallFunc_msl_get_actor_by_id_is_valid_2 = CallFunc_msl_get_actor_by_id_is_valid_2;
	Parms.CallFunc_msl_get_actor_by_id_actor_reference_2 = CallFunc_msl_get_actor_by_id_actor_reference_2;
