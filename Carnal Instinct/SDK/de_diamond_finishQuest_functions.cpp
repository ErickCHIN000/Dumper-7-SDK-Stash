...
class UClass* ADe_diamond_finishQuest_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_diamond_finishQuest_C");

	return Clss;
}


// de_diamond_finishQuest_C de_diamond_finishQuest.Default__de_diamond_finishQuest_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_diamond_finishQuest_C* ADe_diamond_finishQuest_C::GetDefaultObj()
{
	static class ADe_diamond_finishQuest_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_diamond_finishQuest_C*>(ADe_diamond_finishQuest_C::StaticClass()->DefaultObject);
...
void ADe_diamond_finishQuest_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_diamond_finishQuest_C", "call_event");

	Params::ADe_diamond_finishQuest_C_Call_event_Params Parms{};
