...
public:
	...
	float                                        CustomSize;                                        // 0x294(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	...
	void ExecuteUbergraph_W_TemplateTitle(int32 EntryPoint, bool Temp_bool_Variable, float CallFunc_FClamp_ReturnValue, float Temp_float_Variable, bool K2Node_Event_IsDesignTime, float K2Node_Select_Default);
};
