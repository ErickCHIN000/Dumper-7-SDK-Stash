...
struct ASEQ_MasterHSceneMinusAhmes_Oral_Quest_C_ExecuteUbergraph_SEQ_MasterHSceneMinusAhmes_Oral_Quest_Params
{
public:
	...
	class UW_HSceneMinusAhmes_Oral_Quest_C*      CallFunc_Create_ReturnValue;                       // 0x30(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
