...
struct ADe_remove50GandUnaggro_C_Call_event_Params
{
public:
...
struct ADe_remove50GandUnaggro_C_ExecuteUbergraph_de_remove50GandUnaggro_Params
{
public:
	...
	TArray<class ABP_AnubiteAIMinusGuard_C*>     CallFunc_GetAllActorsOfClass_OutActors;            // 0x50(0x10)(ReferenceParm)
	class ABP_AnubiteAIMinusGuard_C*             CallFunc_Array_Get_Item;                           // 0x60(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
