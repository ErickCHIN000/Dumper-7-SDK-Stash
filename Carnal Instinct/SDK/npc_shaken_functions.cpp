...
// BlueprintGeneratedClass npc_shaken.npc_shaken_C
// (Actor, Pawn)

class UClass* ANpc_shaken_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_shaken_C");

	return Clss;
}


// npc_shaken_C npc_shaken.Default__npc_shaken_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_shaken_C* ANpc_shaken_C::GetDefaultObj()
{
	static class ANpc_shaken_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_shaken_C*>(ANpc_shaken_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_shaken.npc_shaken_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_shaken_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_shaken_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_shaken_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_shaken.npc_shaken_C.ExecuteUbergraph_npc_shaken
