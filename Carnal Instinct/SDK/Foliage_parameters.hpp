...
public:
	...
	uint8                                        Pad_7FC[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FHitResult                            OverlapInfo;                                       // 0x20(0x8C)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
