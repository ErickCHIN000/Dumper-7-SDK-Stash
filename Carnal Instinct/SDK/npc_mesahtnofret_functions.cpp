...
// BlueprintGeneratedClass npc_mesahtnofret.npc_mesahtnofret_C
// (Actor, Pawn)

class UClass* ANpc_mesahtnofret_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_mesahtnofret_C");

	return Clss;
}


// npc_mesahtnofret_C npc_mesahtnofret.Default__npc_mesahtnofret_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_mesahtnofret_C* ANpc_mesahtnofret_C::GetDefaultObj()
{
	static class ANpc_mesahtnofret_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_mesahtnofret_C*>(ANpc_mesahtnofret_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_mesahtnofret.npc_mesahtnofret_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ANpc_mesahtnofret_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_mesahtnofret_C", "ReceiveBeginPlay");
...
// Function npc_mesahtnofret.npc_mesahtnofret_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_mesahtnofret_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_mesahtnofret_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_mesahtnofret_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_mesahtnofret.npc_mesahtnofret_C.ExecuteUbergraph_npc_mesahtnofret
