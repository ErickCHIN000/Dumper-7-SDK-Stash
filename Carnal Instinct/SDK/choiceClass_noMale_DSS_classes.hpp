...
class AChoiceClass_noMale_DSS_C : public AObject_dlg_condition_parent_C
{
public:
	...
	uint8                                        Pad_1F8A[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
