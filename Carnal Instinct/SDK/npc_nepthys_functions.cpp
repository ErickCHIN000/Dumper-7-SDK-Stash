...
// BlueprintGeneratedClass npc_nepthys.npc_nepthys_C
// (Actor, Pawn)

class UClass* ANpc_nepthys_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_nepthys_C");

	return Clss;
}


// npc_nepthys_C npc_nepthys.Default__npc_nepthys_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_nepthys_C* ANpc_nepthys_C::GetDefaultObj()
{
	static class ANpc_nepthys_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_nepthys_C*>(ANpc_nepthys_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_nepthys.npc_nepthys_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_nepthys_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_nepthys_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_nepthys_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_nepthys.npc_nepthys_C.ExecuteUbergraph_npc_nepthys
