...
// BlueprintGeneratedClass npc_renshet.npc_renshet_C
// (Actor, Pawn)

class UClass* ANpc_renshet_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_renshet_C");

	return Clss;
}


// npc_renshet_C npc_renshet.Default__npc_renshet_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_renshet_C* ANpc_renshet_C::GetDefaultObj()
{
	static class ANpc_renshet_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_renshet_C*>(ANpc_renshet_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_renshet.npc_renshet_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ANpc_renshet_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_renshet_C", "ReceiveBeginPlay");
...
void ANpc_renshet_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_renshet_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_renshet_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_renshet.npc_renshet_C.ReStockVendor
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void ANpc_renshet_C::ReStockVendor()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_renshet_C", "ReStockVendor");
...
void ANpc_renshet_C::BndEvt__InteractableArea_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_renshet_C", "BndEvt__InteractableArea_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature");

	Params::ANpc_renshet_C_BndEvt__InteractableArea_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature_Params Parms{};
