...
class UClass* US_UpdateTombGuardianBehavior_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("S_UpdateTombGuardianBehavior_C");

	return Clss;
}


// S_UpdateTombGuardianBehavior_C S_UpdateTombGuardianBehavior.Default__S_UpdateTombGuardianBehavior_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class US_UpdateTombGuardianBehavior_C* US_UpdateTombGuardianBehavior_C::GetDefaultObj()
{
	static class US_UpdateTombGuardianBehavior_C* Default = nullptr;

	if (!Default)
		Default = static_cast<US_UpdateTombGuardianBehavior_C*>(US_UpdateTombGuardianBehavior_C::StaticClass()->DefaultObject);
...
void US_UpdateTombGuardianBehavior_C::UpdateActivities(bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, uint8 CallFunc_GetBlackboardValueAsEnum_ReturnValue, uint8 CallFunc_GetValidValue_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("S_UpdateTombGuardianBehavior_C", "UpdateActivities");

	Params::US_UpdateTombGuardianBehavior_C_UpdateActivities_Params Parms{};
...
void US_UpdateTombGuardianBehavior_C::ReceiveSearchStartAI(class AAIController* OwnerController, class APawn* ControlledPawn)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("S_UpdateTombGuardianBehavior_C", "ReceiveSearchStartAI");

	Params::US_UpdateTombGuardianBehavior_C_ReceiveSearchStartAI_Params Parms{};
...
void US_UpdateTombGuardianBehavior_C::OnStateChanged(enum class E_State PrevState, enum class E_State NewState)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("S_UpdateTombGuardianBehavior_C", "OnStateChanged");

	Params::US_UpdateTombGuardianBehavior_C_OnStateChanged_Params Parms{};
...
void US_UpdateTombGuardianBehavior_C::ReceiveTickAI(class AAIController* OwnerController, class APawn* ControlledPawn, float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("S_UpdateTombGuardianBehavior_C", "ReceiveTickAI");

	Params::US_UpdateTombGuardianBehavior_C_ReceiveTickAI_Params Parms{};
...
void US_UpdateTombGuardianBehavior_C::OnStaminaValueChanged(float NewValue, float MaxValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("S_UpdateTombGuardianBehavior_C", "OnStaminaValueChanged");

	Params::US_UpdateTombGuardianBehavior_C_OnStaminaValueChanged_Params Parms{};
...
// Function S_UpdateTombGuardianBehavior.S_UpdateTombGuardianBehavior_C.Update
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void US_UpdateTombGuardianBehavior_C::Update()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("S_UpdateTombGuardianBehavior_C", "Update");
