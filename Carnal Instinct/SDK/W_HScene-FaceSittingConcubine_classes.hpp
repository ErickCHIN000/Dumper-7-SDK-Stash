...
// 0x60 (0x2C0 - 0x260)
// WidgetBlueprintGeneratedClass W_HScene-FaceSittingConcubine.W_HScene-FaceSittingConcubine_C
class UW_HSceneMinusFaceSittingConcubine_C : public UUserWidget
{
public:
	...
	class ASEQ_MasterHSceneMinusFaceSittingConcubine_C* NewVar_3;                                          // 0x2B8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UW_HSceneMinusFaceSittingConcubine_C* GetDefaultObj();
