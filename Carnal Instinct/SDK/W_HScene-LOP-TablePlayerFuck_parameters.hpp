...
struct UW_HSceneMinusLOPMinusTablePlayerFuck_C_ExecuteUbergraph_W_HSceneMinusLOPMinusTablePlayerFuck_Params
{
public:
	...
	class ASEQ_MasterHSceneMinusLOPMinusTablePlayerFuck_C* CallFunc_GetActorOfClass_ReturnValue;              // 0x88(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
