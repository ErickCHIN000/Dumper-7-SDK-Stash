...
// BlueprintGeneratedClass npc_hscene_missionary_top.npc_hscene_missionary_top_C
// (Actor, Pawn)

class UClass* ANpc_hscene_missionary_top_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_hscene_missionary_top_C");

	return Clss;
}


// npc_hscene_missionary_top_C npc_hscene_missionary_top.Default__npc_hscene_missionary_top_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_hscene_missionary_top_C* ANpc_hscene_missionary_top_C::GetDefaultObj()
{
	static class ANpc_hscene_missionary_top_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_hscene_missionary_top_C*>(ANpc_hscene_missionary_top_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_hscene_missionary_top.npc_hscene_missionary_top_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_hscene_missionary_top_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_hscene_missionary_top_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_hscene_missionary_top_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_hscene_missionary_top.npc_hscene_missionary_top_C.ExecuteUbergraph_npc_hscene_missionary_top
