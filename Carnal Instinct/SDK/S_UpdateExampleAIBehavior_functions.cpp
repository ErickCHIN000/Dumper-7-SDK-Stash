...
// BlueprintGeneratedClass S_UpdateExampleAIBehavior.S_UpdateExampleAIBehavior_C
// (None)

class UClass* US_UpdateExampleAIBehavior_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("S_UpdateExampleAIBehavior_C");

	return Clss;
}


// S_UpdateExampleAIBehavior_C S_UpdateExampleAIBehavior.Default__S_UpdateExampleAIBehavior_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class US_UpdateExampleAIBehavior_C* US_UpdateExampleAIBehavior_C::GetDefaultObj()
{
	static class US_UpdateExampleAIBehavior_C* Default = nullptr;

	if (!Default)
		Default = static_cast<US_UpdateExampleAIBehavior_C*>(US_UpdateExampleAIBehavior_C::StaticClass()->DefaultObject);
...
void US_UpdateExampleAIBehavior_C::ReceiveSearchStartAI(class AAIController* OwnerController, class APawn* ControlledPawn)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("S_UpdateExampleAIBehavior_C", "ReceiveSearchStartAI");

	Params::US_UpdateExampleAIBehavior_C_ReceiveSearchStartAI_Params Parms{};
...
void US_UpdateExampleAIBehavior_C::OnStateChanged(enum class E_State PrevState, enum class E_State NewState)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("S_UpdateExampleAIBehavior_C", "OnStateChanged");

	Params::US_UpdateExampleAIBehavior_C_OnStateChanged_Params Parms{};
...
void US_UpdateExampleAIBehavior_C::ReceiveTickAI(class AAIController* OwnerController, class APawn* ControlledPawn, float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("S_UpdateExampleAIBehavior_C", "ReceiveTickAI");

	Params::US_UpdateExampleAIBehavior_C_ReceiveTickAI_Params Parms{};
...
void US_UpdateExampleAIBehavior_C::OnStaminaValueChanged(float NewValue, float MaxValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("S_UpdateExampleAIBehavior_C", "OnStaminaValueChanged");

	Params::US_UpdateExampleAIBehavior_C_OnStaminaValueChanged_Params Parms{};
...
// Function S_UpdateExampleAIBehavior.S_UpdateExampleAIBehavior_C.Update
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void US_UpdateExampleAIBehavior_C::Update()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("S_UpdateExampleAIBehavior_C", "Update");
