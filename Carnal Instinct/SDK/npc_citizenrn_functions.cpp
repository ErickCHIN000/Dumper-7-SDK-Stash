...
class UClass* ANpc_citizenrn_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_citizenrn_C");

	return Clss;
}


// npc_citizenrn_C npc_citizenrn.Default__npc_citizenrn_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_citizenrn_C* ANpc_citizenrn_C::GetDefaultObj()
{
	static class ANpc_citizenrn_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_citizenrn_C*>(ANpc_citizenrn_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_citizenrn.npc_citizenrn_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ANpc_citizenrn_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_citizenrn_C", "ReceiveBeginPlay");
...
// Function npc_citizenrn.npc_citizenrn_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_citizenrn_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_citizenrn_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_citizenrn_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_citizenrn.npc_citizenrn_C.ExecuteUbergraph_npc_citizenrn
