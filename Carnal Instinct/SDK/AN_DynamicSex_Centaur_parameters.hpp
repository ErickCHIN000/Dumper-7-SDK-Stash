...
struct UAN_DynamicSex_Centaur_C_Received_Notify_Params
{
public:
	...
	TArray<class UWB_DynamicSex_Centaur_C*>      CallFunc_GetAllWidgetsOfClass_FoundWidgets;        // 0x30(0x10)(ReferenceParm, ContainsInstancedReference)
	class UWB_DynamicSex_Centaur_C*              CallFunc_Array_Get_Item;                           // 0x40(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
