...
// BlueprintGeneratedClass npc_anubite_sex.npc_anubite_sex_C
// (Actor, Pawn)

class UClass* ANpc_anubite_sex_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_anubite_sex_C");

	return Clss;
}


// npc_anubite_sex_C npc_anubite_sex.Default__npc_anubite_sex_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_anubite_sex_C* ANpc_anubite_sex_C::GetDefaultObj()
{
	static class ANpc_anubite_sex_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_anubite_sex_C*>(ANpc_anubite_sex_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_anubite_sex.npc_anubite_sex_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_anubite_sex_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_anubite_sex_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_anubite_sex_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_anubite_sex.npc_anubite_sex_C.ExecuteUbergraph_npc_anubite_sex
