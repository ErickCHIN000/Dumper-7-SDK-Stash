...
// BlueprintGeneratedClass de_vendor.de_vendor_C
// (Actor)

class UClass* ADe_vendor_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_vendor_C");

	return Clss;
}


// de_vendor_C de_vendor.Default__de_vendor_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_vendor_C* ADe_vendor_C::GetDefaultObj()
{
	static class ADe_vendor_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_vendor_C*>(ADe_vendor_C::StaticClass()->DefaultObject);
...
void ADe_vendor_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_vendor_C", "call_event");

	Params::ADe_vendor_C_Call_event_Params Parms{};
