...
class UClass* UMovieScenePreAnimatedComponentTransformSystem::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MovieScenePreAnimatedComponentTransformSystem");

	return Clss;
}


// MovieScenePreAnimatedComponentTransformSystem MovieSceneTracks.Default__MovieScenePreAnimatedComponentTransformSystem
// (Public, ClassDefaultObject, ArchetypeObject)

class UMovieScenePreAnimatedComponentTransformSystem* UMovieScenePreAnimatedComponentTransformSystem::GetDefaultObj()
{
	static class UMovieScenePreAnimatedComponentTransformSystem* Default = nullptr;

	if (!Default)
		Default = static_cast<UMovieScenePreAnimatedComponentTransformSystem*>(UMovieScenePreAnimatedComponentTransformSystem::StaticClass()->DefaultObject);
