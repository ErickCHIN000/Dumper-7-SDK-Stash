...
class ABP_InternalCervix_C : public AActor
{
public:
	...
	class UStaticMeshComponent*                  SM_InternalsFull;                                  // 0x230(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	static class ABP_InternalCervix_C* GetDefaultObj();
