...
{
public:
	uint8                                        Pad_11A3[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_12AF[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_12D1[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
