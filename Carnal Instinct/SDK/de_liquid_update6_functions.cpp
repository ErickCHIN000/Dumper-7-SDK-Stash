...
// BlueprintGeneratedClass de_liquid_update6.de_liquid_update6_C
// (Actor)

class UClass* ADe_liquid_update6_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_liquid_update6_C");

	return Clss;
}


// de_liquid_update6_C de_liquid_update6.Default__de_liquid_update6_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_liquid_update6_C* ADe_liquid_update6_C::GetDefaultObj()
{
	static class ADe_liquid_update6_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_liquid_update6_C*>(ADe_liquid_update6_C::StaticClass()->DefaultObject);

	return Default;
}


// Function de_liquid_update6.de_liquid_update6_C.call_event
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class Abp_dlg_actor_C*             Dlg_actor                                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FS_dlg_event_info           Event_data                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)

void ADe_liquid_update6_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_liquid_update6_C", "call_event");

	Params::ADe_liquid_update6_C_Call_event_Params Parms{};
...
// Function de_liquid_update6.de_liquid_update6_C.ExecuteUbergraph_de_liquid_update6
...
// class ANpc_assistant_C*            CallFunc_GetActorOfClass_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ADe_liquid_update6_C::ExecuteUbergraph_de_liquid_update6(int32 EntryPoint, class Abp_dlg_actor_C* K2Node_Event_dlg_actor, const struct FS_dlg_event_info& K2Node_Event_event_data, class ABP_CombatCharacter_C* CallFunc_Get_Player_Reference_Player, class ANpc_assistant_C* CallFunc_GetActorOfClass_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, bool CallFunc_get_quest_is_valid, int32 CallFunc_get_quest_found_index, class Abp_quest_actor_C* CallFunc_get_quest_quest_actor, bool CallFunc_get_sub_objective_Successful, bool CallFunc_remove_sub_objective_Successful, bool CallFunc_add_sub_objective_Successful)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_liquid_update6_C", "ExecuteUbergraph_de_liquid_update6");

	Params::ADe_liquid_update6_C_ExecuteUbergraph_de_liquid_update6_Params Parms{};
