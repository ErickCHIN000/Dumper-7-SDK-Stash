...
class UW_HSceneMinusNaga_Oral_C : public UUserWidget
{
public:
	...
	class ASEQ_MasterHSceneMinusNaga_Oral_C*     NewVar_3;                                          // 0x2B8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UW_HSceneMinusNaga_Oral_C* GetDefaultObj();
