...
class UClass* UWBP_NPC_DebugTOD_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WBP_NPC_DebugTOD_C");

	return Clss;
}


// WBP_NPC_DebugTOD_C WBP_NPC_DebugTOD.Default__WBP_NPC_DebugTOD_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWBP_NPC_DebugTOD_C* UWBP_NPC_DebugTOD_C::GetDefaultObj()
{
	static class UWBP_NPC_DebugTOD_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWBP_NPC_DebugTOD_C*>(UWBP_NPC_DebugTOD_C::StaticClass()->DefaultObject);
...
void UWBP_NPC_DebugTOD_C::ExecuteUbergraph_WBP_NPC_DebugTOD(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WBP_NPC_DebugTOD_C", "ExecuteUbergraph_WBP_NPC_DebugTOD");

	Params::UWBP_NPC_DebugTOD_C_ExecuteUbergraph_WBP_NPC_DebugTOD_Params Parms{};
