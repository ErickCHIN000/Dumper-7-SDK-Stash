...
// BlueprintGeneratedClass npc_rasha.npc_rasha_C
// (Actor, Pawn)

class UClass* ANpc_rasha_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_rasha_C");

	return Clss;
}


// npc_rasha_C npc_rasha.Default__npc_rasha_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_rasha_C* ANpc_rasha_C::GetDefaultObj()
{
	static class ANpc_rasha_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_rasha_C*>(ANpc_rasha_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_rasha.npc_rasha_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_rasha_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_rasha_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_rasha_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_rasha.npc_rasha_C.ExecuteUbergraph_npc_rasha
