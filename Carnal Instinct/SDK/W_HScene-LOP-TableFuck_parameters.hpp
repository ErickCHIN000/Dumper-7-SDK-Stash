...
struct UW_HSceneMinusLOPMinusTableFuck_C_ExecuteUbergraph_W_HSceneMinusLOPMinusTableFuck_Params
{
public:
	...
	class ASEQ_MasterHSceneMinusLOPMinusTableFuck_C* CallFunc_GetActorOfClass_ReturnValue;              // 0x88(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
