...
// BlueprintGeneratedClass de_liquid_update17.de_liquid_update17_C
// (Actor)

class UClass* ADe_liquid_update17_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_liquid_update17_C");

	return Clss;
}


// de_liquid_update17_C de_liquid_update17.Default__de_liquid_update17_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_liquid_update17_C* ADe_liquid_update17_C::GetDefaultObj()
{
	static class ADe_liquid_update17_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_liquid_update17_C*>(ADe_liquid_update17_C::StaticClass()->DefaultObject);
...
void ADe_liquid_update17_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_liquid_update17_C", "call_event");

	Params::ADe_liquid_update17_C_Call_event_Params Parms{};
