...
class ABP_BasicArrowProjectile_C : public AActor
{
public:
	...
	static class ABP_BasicArrowProjectile_C* GetDefaultObj();
	...
	void ExecuteUbergraph_BP_BasicArrowProjectile(int32 EntryPoint, TArray<class FName>& CallFunc_GetAllSocketNames_ReturnValue, const struct FHitResult& K2Node_ComponentBoundEvent_HitResult, bool CallFunc_OnArrowHit_Dummy, const struct FVector& CallFunc_GetActorForwardVector_ReturnValue, const struct FVector& CallFunc_Multiply_VectorFloat_ReturnValue);
};
