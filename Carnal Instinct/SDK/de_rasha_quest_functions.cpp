...
class UClass* ADe_rasha_quest_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_rasha_quest_C");

	return Clss;
}


// de_rasha_quest_C de_rasha_quest.Default__de_rasha_quest_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_rasha_quest_C* ADe_rasha_quest_C::GetDefaultObj()
{
	static class ADe_rasha_quest_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_rasha_quest_C*>(ADe_rasha_quest_C::StaticClass()->DefaultObject);
...
void ADe_rasha_quest_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_rasha_quest_C", "call_event");

	Params::ADe_rasha_quest_C_Call_event_Params Parms{};
...
// class ANpc_rasha_C*                CallFunc_GetActorOfClass_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class ABP_Item_interactable_JarVeranus_C*CallFunc_GetActorOfClass_ReturnValue_2                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
