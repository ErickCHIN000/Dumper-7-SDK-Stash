...
class UClass* ADe_iraya_release_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_iraya_release_C");

	return Clss;
}


// de_iraya_release_C de_iraya_release.Default__de_iraya_release_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_iraya_release_C* ADe_iraya_release_C::GetDefaultObj()
{
	static class ADe_iraya_release_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_iraya_release_C*>(ADe_iraya_release_C::StaticClass()->DefaultObject);
...
void ADe_iraya_release_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_iraya_release_C", "call_event");

	Params::ADe_iraya_release_C_Call_event_Params Parms{};
