...
class UClass* ADe_shrine_quest_jarRemoval_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_shrine_quest_jarRemoval_C");

	return Clss;
}


// de_shrine_quest_jarRemoval_C de_shrine_quest_jarRemoval.Default__de_shrine_quest_jarRemoval_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_shrine_quest_jarRemoval_C* ADe_shrine_quest_jarRemoval_C::GetDefaultObj()
{
	static class ADe_shrine_quest_jarRemoval_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_shrine_quest_jarRemoval_C*>(ADe_shrine_quest_jarRemoval_C::StaticClass()->DefaultObject);
...
void ADe_shrine_quest_jarRemoval_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_shrine_quest_jarRemoval_C", "call_event");

	Params::ADe_shrine_quest_jarRemoval_C_Call_event_Params Parms{};
