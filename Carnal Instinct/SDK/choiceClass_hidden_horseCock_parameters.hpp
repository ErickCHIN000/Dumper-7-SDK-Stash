...
struct AChoiceClass_hidden_horseCock_C_Choice_info_condition_Params
{
public:
	...
	bool                                         CallFunc_EqualEqual_ByteByte_ReturnValue;          // 0x3F8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
