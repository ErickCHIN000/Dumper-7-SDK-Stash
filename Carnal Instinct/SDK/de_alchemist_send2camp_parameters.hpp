...
struct ADe_alchemist_send2camp_C_Call_event_Params
{
public:
...
struct ADe_alchemist_send2camp_C_ExecuteUbergraph_de_alchemist_send2camp_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1ED0[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class AAlchemist_placeholder_C*              CallFunc_GetActorOfClass_ReturnValue;              // 0x8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ANpc_alchemist_C*                      CallFunc_GetActorOfClass_ReturnValue_1;            // 0x70(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
