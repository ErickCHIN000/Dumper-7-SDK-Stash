...
class UClass* ASecret_admirers_quest_update_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("secret_admirers_quest_update_C");

	return Clss;
}


// secret_admirers_quest_update_C secret_admirers_quest_update.Default__secret_admirers_quest_update_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ASecret_admirers_quest_update_C* ASecret_admirers_quest_update_C::GetDefaultObj()
{
	static class ASecret_admirers_quest_update_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ASecret_admirers_quest_update_C*>(ASecret_admirers_quest_update_C::StaticClass()->DefaultObject);

	return Default;
}


// Function secret_admirers_quest_update.secret_admirers_quest_update_C.call_event
...
void ASecret_admirers_quest_update_C::Call_event(class Abp_quest_actor_C* Quest_actor, const struct FS_quest_event& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("secret_admirers_quest_update_C", "call_event");

	Params::ASecret_admirers_quest_update_C_Call_event_Params Parms{};
...
// Function secret_admirers_quest_update.secret_admirers_quest_update_C.ExecuteUbergraph_secret_admirers_quest_update
...
void ASecret_admirers_quest_update_C::ExecuteUbergraph_secret_admirers_quest_update(int32 EntryPoint, class ABP_CombatCharacter_C* CallFunc_Get_Player_Reference_Player, bool CallFunc_IsValid_ReturnValue, class Ubp_quest_component_C* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, bool CallFunc_get_quest_is_valid, int32 CallFunc_get_quest_found_index, class Abp_quest_actor_C* CallFunc_get_quest_quest_actor, class Abp_quest_actor_C* K2Node_Event_quest_actor, const struct FS_quest_event& K2Node_Event_event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("secret_admirers_quest_update_C", "ExecuteUbergraph_secret_admirers_quest_update");

	Params::ASecret_admirers_quest_update_C_ExecuteUbergraph_secret_admirers_quest_update_Params Parms{};
