...
class AChoiceClass_noMale_C : public AObject_dlg_condition_parent_C
{
public:
	...
	uint8                                        Pad_BC0[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class AChoiceClass_noMale_C* GetDefaultObj();
