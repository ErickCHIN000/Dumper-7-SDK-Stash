...
// 0x78 (0x2D8 - 0x260)
// WidgetBlueprintGeneratedClass W_HScene-NagaHCFuck.W_HScene-NagaHCFuck_C
class UW_HSceneMinusNagaHCFuck_C : public UUserWidget
{
public:
	...
	static class UW_HSceneMinusNagaHCFuck_C* GetDefaultObj();
