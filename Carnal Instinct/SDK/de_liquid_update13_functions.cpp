...
// BlueprintGeneratedClass de_liquid_update13.de_liquid_update13_C
// (Actor)

class UClass* ADe_liquid_update13_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_liquid_update13_C");

	return Clss;
}


// de_liquid_update13_C de_liquid_update13.Default__de_liquid_update13_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_liquid_update13_C* ADe_liquid_update13_C::GetDefaultObj()
{
	static class ADe_liquid_update13_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_liquid_update13_C*>(ADe_liquid_update13_C::StaticClass()->DefaultObject);

	return Default;
}


// Function de_liquid_update13.de_liquid_update13_C.call_event
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class Abp_dlg_actor_C*             Dlg_actor                                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FS_dlg_event_info           Event_data                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)

void ADe_liquid_update13_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_liquid_update13_C", "call_event");

	Params::ADe_liquid_update13_C_Call_event_Params Parms{};
...
// Function de_liquid_update13.de_liquid_update13_C.ExecuteUbergraph_de_liquid_update13
// (Final, UbergraphFunction)
// Parameters:
// int32                              EntryPoint                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class ANpc_sokkwi_C*               CallFunc_GetActorOfClass_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
