...
struct ASexCondCheck_C_Choice_info_condition_Params
{
public:
	...
	uint8                                        Pad_5F2[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};

// 0xF0 (0xF0 - 0x0)
// Function sexCondCheck.sexCondCheck_C.choice_data_condition
struct ASexCondCheck_C_Choice_data_condition_Params
{
public:
...
struct ASexCondCheck_C_Reply_info_condition_Params
{
public:
	...
	bool                                         CallFunc_EqualEqual_ClassClass_ReturnValue;        // 0x1F9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

// 0x570 (0x570 - 0x0)
// Function sexCondCheck.sexCondCheck_C.branch_info_condition
struct ASexCondCheck_C_branch_info_condition_Params
{
public:
...
struct ASexCondCheck_C_ExecuteUbergraph_sexCondCheck_Params
{
public:
