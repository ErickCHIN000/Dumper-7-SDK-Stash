...
struct ASEQ_MasterHSceneMinusLOPMinusTablePlayerFuck_C_ExecuteUbergraph_SEQ_MasterHSceneMinusLOPMinusTablePlayerFuck_Params
{
public:
	...
	class UW_HSceneMinusLOPMinusTablePlayerFuck_C* CallFunc_Create_ReturnValue;                       // 0x30(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
