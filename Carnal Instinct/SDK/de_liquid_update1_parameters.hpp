...
struct ADe_liquid_update1_C_Call_event_Params
{
public:
	class Abp_dlg_actor_C*                       Dlg_actor;                                         // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FS_dlg_event_info                     Event_data;                                        // 0x8(0x2D)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
	uint8                                        Pad_1C73[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};

// 0x212 (0x212 - 0x0)
// Function de_liquid_update1.de_liquid_update1_C.ExecuteUbergraph_de_liquid_update1
struct ADe_liquid_update1_C_ExecuteUbergraph_de_liquid_update1_Params
{
public:
	...
	uint8                                        Pad_1D96[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         CallFunc_find_objective_is_valid;                  // 0x78(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_1DF0[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FS_quest_objective_data               CallFunc_find_objective_objective_data;            // 0x80(0x188)(HasGetValueTypeHash)
	...
	int32                                        CallFunc_Array_Find_ReturnValue;                   // 0x20C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_EqualEqual_IntInt_ReturnValue;            // 0x210(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_add_sub_objective_Successful;             // 0x211(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
