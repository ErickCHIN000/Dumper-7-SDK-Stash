...
// BlueprintGeneratedClass npc_nefi.npc_nefi_C
// (Actor, Pawn)

class UClass* ANpc_nefi_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_nefi_C");

	return Clss;
}


// npc_nefi_C npc_nefi.Default__npc_nefi_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_nefi_C* ANpc_nefi_C::GetDefaultObj()
{
	static class ANpc_nefi_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_nefi_C*>(ANpc_nefi_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_nefi.npc_nefi_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ANpc_nefi_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_nefi_C", "ReceiveBeginPlay");
...
// Function npc_nefi.npc_nefi_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_nefi_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_nefi_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_nefi_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_nefi.npc_nefi_C.ExecuteUbergraph_npc_nefi
