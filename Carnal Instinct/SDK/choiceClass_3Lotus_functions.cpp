...
class UClass* AChoiceClass_3Lotus_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("choiceClass_3Lotus_C");

	return Clss;
}


// choiceClass_3Lotus_C choiceClass_3Lotus.Default__choiceClass_3Lotus_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AChoiceClass_3Lotus_C* AChoiceClass_3Lotus_C::GetDefaultObj()
{
	static class AChoiceClass_3Lotus_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AChoiceClass_3Lotus_C*>(AChoiceClass_3Lotus_C::StaticClass()->DefaultObject);
...
void AChoiceClass_3Lotus_C::Choice_info_condition(const struct FS_dlg_branch_choice_info& Choice_info, struct FS_dlg_branch_choice_info* Return_value, const struct FS_ItemData& CallFunc_GetDataTableRowFromName_OutRow, bool CallFunc_GetDataTableRowFromName_ReturnValue, class UAC_Inventory_C* CallFunc_Get_AC_Inventory_AC_Inventory, bool CallFunc_IsValid_ReturnValue, const struct FS_ItemData& CallFunc_Get_Inventory_Item_by_Data_Item, bool CallFunc_Get_Inventory_Item_by_Data_Found, bool CallFunc_GreaterEqual_IntInt_ReturnValue, const struct FS_dlg_branch_choice_info& K2Node_MakeStruct_s_dlg_branch_choice_info, bool CallFunc_BooleanAND_ReturnValue, const struct FS_dlg_branch_choice_info& CallFunc_choice_info_condition_return_value)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("choiceClass_3Lotus_C", "choice_info_condition");

	Params::AChoiceClass_3Lotus_C_Choice_info_condition_Params Parms{};
