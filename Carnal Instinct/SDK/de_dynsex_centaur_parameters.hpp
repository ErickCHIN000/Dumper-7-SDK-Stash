...
struct ADe_dynsex_centaur_C_Call_event_Params
{
public:
	class Abp_dlg_actor_C*                       Dlg_actor;                                         // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FS_dlg_event_info                     Event_data;                                        // 0x8(0x2D)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
	uint8                                        Pad_1C27[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};

// 0xB4 (0xB4 - 0x0)
// Function de_dynsex_centaur.de_dynsex_centaur_C.ExecuteUbergraph_de_dynsex_centaur
struct ADe_dynsex_centaur_C_ExecuteUbergraph_de_dynsex_centaur_Params
{
public:
	...
	class ABP_DynamicSex_Base_Centaur_C*         CallFunc_GetActorOfClass_ReturnValue;              // 0x68(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
