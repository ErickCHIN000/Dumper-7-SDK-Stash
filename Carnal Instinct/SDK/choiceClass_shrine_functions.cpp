...
// BlueprintGeneratedClass choiceClass_shrine.choiceClass_shrine_C
// (Actor)

class UClass* AChoiceClass_shrine_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("choiceClass_shrine_C");

	return Clss;
}


// choiceClass_shrine_C choiceClass_shrine.Default__choiceClass_shrine_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AChoiceClass_shrine_C* AChoiceClass_shrine_C::GetDefaultObj()
{
	static class AChoiceClass_shrine_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AChoiceClass_shrine_C*>(AChoiceClass_shrine_C::StaticClass()->DefaultObject);

	return Default;
}


// Function choiceClass_shrine.choiceClass_shrine_C.choice_info_condition
