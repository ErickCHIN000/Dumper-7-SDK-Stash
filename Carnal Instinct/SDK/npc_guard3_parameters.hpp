...
struct ANpc_guard3_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params
{
public:
...
struct ANpc_guard3_C_ExecuteUbergraph_npc_guard3_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FName                                  CallFunc_set_id_actor_id;                          // 0x4(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_set_id_success;                           // 0xC(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                         CallFunc_msl_get_actor_by_id_is_valid;             // 0x21(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TArray<class FName>                          K2Node_MakeArray_Array_1;                          // 0x40(0x10)(ReferenceParm)
