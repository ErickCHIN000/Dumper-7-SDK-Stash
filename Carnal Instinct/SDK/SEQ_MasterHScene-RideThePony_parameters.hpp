...
struct ASEQ_MasterHSceneMinusRideThePony_C_ExecuteUbergraph_SEQ_MasterHSceneMinusRideThePony_Params
{
public:
	...
	class UW_HSceneMinusRideThePony_C*           CallFunc_Create_ReturnValue;                       // 0x18(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
