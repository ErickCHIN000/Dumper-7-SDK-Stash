...
// BlueprintGeneratedClass npc_nessos.npc_nessos_C
// (Actor, Pawn)

class UClass* ANpc_nessos_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_nessos_C");

	return Clss;
}


// npc_nessos_C npc_nessos.Default__npc_nessos_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_nessos_C* ANpc_nessos_C::GetDefaultObj()
{
	static class ANpc_nessos_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_nessos_C*>(ANpc_nessos_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_nessos.npc_nessos_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_nessos_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_nessos_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_nessos_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_nessos.npc_nessos_C.ExecuteUbergraph_npc_nessos
