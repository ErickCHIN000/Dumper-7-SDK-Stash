...
class UClass* ABP_BlockProjectile_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_BlockProjectile_C");

	return Clss;
}


// BP_BlockProjectile_C BP_BlockProjectile.Default__BP_BlockProjectile_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_BlockProjectile_C* ABP_BlockProjectile_C::GetDefaultObj()
{
	static class ABP_BlockProjectile_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_BlockProjectile_C*>(ABP_BlockProjectile_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_BlockProjectile.BP_BlockProjectile_C.SpawnImpaledArrow
...
// Function BP_BlockProjectile.BP_BlockProjectile_C.IsEnemy
...
void ABP_BlockProjectile_C::IsEnemy(class AActor* Target, bool* Result, class AActor* CallFunc_GetOwner_ReturnValue, class UBehaviorComponent_C* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_IsEnemy_Return, bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BlockProjectile_C", "IsEnemy");

	Params::ABP_BlockProjectile_C_IsEnemy_Params Parms{};
...
// Function BP_BlockProjectile.BP_BlockProjectile_C.OnArrowHit
...
// Function BP_BlockProjectile.BP_BlockProjectile_C.ApplyHitImpulse
...
void ABP_BlockProjectile_C::ApplyHitImpulse(class UPrimitiveComponent* Component, const struct FVector& HitNormal, class FName BoneName, bool CallFunc_IsAnySimulatingPhysics_ReturnValue, const struct FVector& CallFunc_Multiply_VectorFloat_ReturnValue, const struct FVector& CallFunc_Multiply_VectorFloat_ReturnValue_1)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BlockProjectile_C", "ApplyHitImpulse");

	Params::ABP_BlockProjectile_C_ApplyHitImpulse_Params Parms{};
...
// Function BP_BlockProjectile.BP_BlockProjectile_C.BndEvt__BPC_CollisionHandler_K2Node_ComponentBoundEvent_10_OnHit__DelegateSignature
// (BlueprintEvent)
// Parameters:
// struct FHitResult                  HitResult                                                        (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, ContainsInstancedReference)

void ABP_BlockProjectile_C::BndEvt__BPC_CollisionHandler_K2Node_ComponentBoundEvent_10_OnHit__DelegateSignature(const struct FHitResult& HitResult)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BlockProjectile_C", "BndEvt__BPC_CollisionHandler_K2Node_ComponentBoundEvent_10_OnHit__DelegateSignature");

	Params::ABP_BlockProjectile_C_BndEvt__BPC_CollisionHandler_K2Node_ComponentBoundEvent_10_OnHit__DelegateSignature_Params Parms{};
...
// Function BP_BlockProjectile.BP_BlockProjectile_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ABP_BlockProjectile_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BlockProjectile_C", "ReceiveBeginPlay");
...
// Function BP_BlockProjectile.BP_BlockProjectile_C.ExecuteUbergraph_BP_BlockProjectile
...
void ABP_BlockProjectile_C::ExecuteUbergraph_BP_BlockProjectile(int32 EntryPoint, TArray<class FName>& CallFunc_GetAllSocketNames_ReturnValue, const struct FHitResult& K2Node_ComponentBoundEvent_HitResult, bool CallFunc_OnArrowHit_Dummy, const struct FVector& CallFunc_GetActorForwardVector_ReturnValue, const struct FVector& CallFunc_Multiply_VectorFloat_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BlockProjectile_C", "ExecuteUbergraph_BP_BlockProjectile");

	Params::ABP_BlockProjectile_C_ExecuteUbergraph_BP_BlockProjectile_Params Parms{};
