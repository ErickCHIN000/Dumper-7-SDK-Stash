...
class UClass* ANpc_tome_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_tome_C");

	return Clss;
}


// npc_tome_C npc_tome.Default__npc_tome_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_tome_C* ANpc_tome_C::GetDefaultObj()
{
	static class ANpc_tome_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_tome_C*>(ANpc_tome_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_tome.npc_tome_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ANpc_tome_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_tome_C", "ReceiveBeginPlay");
...
// Function npc_tome.npc_tome_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_tome_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_tome_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_tome_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_tome.npc_tome_C.START DLG
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void ANpc_tome_C::START_DLG()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_tome_C", "START DLG");
...
// Function npc_tome.npc_tome_C.ExecuteUbergraph_npc_tome
