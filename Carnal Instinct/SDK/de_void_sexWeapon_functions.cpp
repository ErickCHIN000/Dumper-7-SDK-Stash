...
class UClass* ADe_void_sexWeapon_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_void_sexWeapon_C");

	return Clss;
}


// de_void_sexWeapon_C de_void_sexWeapon.Default__de_void_sexWeapon_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_void_sexWeapon_C* ADe_void_sexWeapon_C::GetDefaultObj()
{
	static class ADe_void_sexWeapon_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_void_sexWeapon_C*>(ADe_void_sexWeapon_C::StaticClass()->DefaultObject);
...
void ADe_void_sexWeapon_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_void_sexWeapon_C", "call_event");

	Params::ADe_void_sexWeapon_C_Call_event_Params Parms{};
...
// class ABP_Item_interactable_VoidJar_NEW_C*CallFunc_GetActorOfClass_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
