...
public:
	...
	struct FHitResult                            CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult; // 0x5C(0x8C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FHitResult                            CallFunc_K2_SetWorldLocation_SweepHitResult;       // 0xE8(0x8C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	float                                        K2Node_Event_DeltaSeconds;                         // 0x174(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                              CallFunc_RInterpTo_ReturnValue;                    // 0x178(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_994[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                CallFunc_ARPinIdToString_ReturnValue;              // 0x188(0x10)(ZeroConstructor, HasGetValueTypeHash)
	...
	struct FHitResult                            CallFunc_K2_SetWorldRotation_SweepHitResult;       // 0x1CC(0x8C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FMagicLeapARPinState                  CallFunc_GetARPinState_State;                      // 0x258(0x14)(NoDestructor)
	enum class EMagicLeapPassableWorldError      CallFunc_GetARPinState_ReturnValue;                // 0x26C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_EqualEqual_ByteByte_ReturnValue;          // 0x26D(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_9A6[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                CallFunc_GetEnumeratorUserFriendlyName_ReturnValue; // 0x270(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FText                                  CallFunc_Conv_FloatToText_ReturnValue;             // 0x280(0x18)(None)
	class FText                                  CallFunc_Conv_StringToText_ReturnValue_1;          // 0x298(0x18)(None)
	class FText                                  CallFunc_Conv_FloatToText_ReturnValue_1;           // 0x2B0(0x18)(None)
	class FText                                  CallFunc_Conv_FloatToText_ReturnValue_2;           // 0x2C8(0x18)(None)
};
