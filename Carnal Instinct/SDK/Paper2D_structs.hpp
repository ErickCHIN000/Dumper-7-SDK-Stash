...
public:
	...
	uint8                                        Pad_C82[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_CA3[0x40];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
