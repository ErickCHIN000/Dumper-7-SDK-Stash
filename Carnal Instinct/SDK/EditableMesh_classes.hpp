...
public:
	...
	uint8                                        Pad_395[0x9C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13D4[0x390];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_13DB[0x148];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_13E2[0x1E4];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_161F[0xA4];                                    // Fixing Size Of Struct [ Dumper-7 ]
