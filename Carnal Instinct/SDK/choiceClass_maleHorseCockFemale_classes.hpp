...
class AChoiceClass_maleHorseCockFemale_C : public AObject_dlg_condition_parent_C
{
public:
	...
	uint8                                        Pad_177F[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class AChoiceClass_maleHorseCockFemale_C* GetDefaultObj();
