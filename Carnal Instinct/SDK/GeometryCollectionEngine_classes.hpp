...
public:
	...
	uint8                                        Pad_B84[0x108];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_D2C[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_D30[0xE0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<class AFieldSystemActor*>             InitializationFields;                              // 0x560(0x10)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoClear, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_D4E[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<float>                                DamageThreshold;                                   // 0x588(0x10)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_DA9[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DD4[0x218];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DD8[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_ECA[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F0B[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_F28[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_FEE[0x86];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1034[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1091[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1149[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
