...
class ANpc_eleia_dss_C : public ANPC_DynamicSex_Base_C
{
public:
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0x560(0x8)(ZeroConstructor, Transient, DuplicateTransient)
	TArray<struct FDataTableRowHandle>           Position_0;                                        // 0x568(0x10)(Edit, BlueprintVisible, DisableEditOnInstance)

	static class UClass* StaticClass();
	static class ANpc_eleia_dss_C* GetDefaultObj();
