...
// 0x50 (0x2B0 - 0x260)
// WidgetBlueprintGeneratedClass W_HScene-PlayerGooSlave.W_HScene-PlayerGooSlave_C
class UW_HSceneMinusPlayerGooSlave_C : public UUserWidget
{
public:
	...
	class ASEQ_MasterHSceneMinusStocks1_C*       NewVar_5;                                          // 0x2A0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ASEQ_MasterHSceneMinusPlayerGooSlave_C* NewVar_6;                                          // 0x2A8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UW_HSceneMinusPlayerGooSlave_C* GetDefaultObj();
