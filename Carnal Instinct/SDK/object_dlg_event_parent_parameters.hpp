...
struct AObject_dlg_event_parent_C_Init_event_object_Params
{
public:
...
struct AObject_dlg_event_parent_C_Call_event_Params
{
public:
	class Abp_dlg_actor_C*                       Dlg_actor;                                         // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FS_dlg_event_info                     Event_data;                                        // 0x8(0x2D)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
	uint8                                        Pad_1C19[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};

// 0x40 (0x40 - 0x0)
// Function object_dlg_event_parent.object_dlg_event_parent_C.ExecuteUbergraph_object_dlg_event_parent
struct AObject_dlg_event_parent_C_ExecuteUbergraph_object_dlg_event_parent_Params
{
public:
	...
	struct FS_dlg_event_info                     K2Node_CustomEvent_event_data;                     // 0x10(0x2D)(ZeroConstructor, HasGetValueTypeHash)
	uint8                                        Pad_1C7B[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
