...
class ADe_liquid_update18_C : public AObject_dlg_event_child_C
{
public:
	...
	static class ADe_liquid_update18_C* GetDefaultObj();

	void Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data);
	void ExecuteUbergraph_de_liquid_update18(int32 EntryPoint, class ANpc_sekerti_C* CallFunc_GetActorOfClass_ReturnValue, class Abp_dlg_actor_C* K2Node_Event_dlg_actor, const struct FS_dlg_event_info& K2Node_Event_event_data);
};
