...
class ANpc_renshet_C : public AExample_npc_base_C
{
public:
	...
	TArray<struct FS_SingleDTItem>               Single_DT_Item;                                    // 0x5A8(0x10)(Edit, BlueprintVisible, DisableEditOnInstance)
	TArray<class UDataTable*>                    All_Items_from_DT;                                 // 0x5B8(0x10)(Edit, BlueprintVisible, DisableEditOnInstance)

	static class UClass* StaticClass();
	static class ANpc_renshet_C* GetDefaultObj();
