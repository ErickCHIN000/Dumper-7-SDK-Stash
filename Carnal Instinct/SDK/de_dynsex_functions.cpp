...
// BlueprintGeneratedClass de_dynsex.de_dynsex_C
// (Actor)

class UClass* ADe_dynsex_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_dynsex_C");

	return Clss;
}


// de_dynsex_C de_dynsex.Default__de_dynsex_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_dynsex_C* ADe_dynsex_C::GetDefaultObj()
{
	static class ADe_dynsex_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_dynsex_C*>(ADe_dynsex_C::StaticClass()->DefaultObject);
...
void ADe_dynsex_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_dynsex_C", "call_event");

	Params::ADe_dynsex_C_Call_event_Params Parms{};
