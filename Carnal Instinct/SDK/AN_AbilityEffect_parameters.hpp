...
struct UAN_AbilityEffect_C_GetNotifyName_Params
{
public:
...
struct UAN_AbilityEffect_C_Received_Notify_Params
{
public:
	...
	class UAbilityComponent_C*                   CallFunc_GetComponentByClass_ReturnValue;          // 0x20(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
