...
// BlueprintGeneratedClass de_bells_quest_update_mistletoe.de_bells_quest_update_mistletoe_C
// (Actor)

class UClass* ADe_bells_quest_update_mistletoe_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_bells_quest_update_mistletoe_C");

	return Clss;
}


// de_bells_quest_update_mistletoe_C de_bells_quest_update_mistletoe.Default__de_bells_quest_update_mistletoe_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_bells_quest_update_mistletoe_C* ADe_bells_quest_update_mistletoe_C::GetDefaultObj()
{
	static class ADe_bells_quest_update_mistletoe_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_bells_quest_update_mistletoe_C*>(ADe_bells_quest_update_mistletoe_C::StaticClass()->DefaultObject);

	return Default;
}


// Function de_bells_quest_update_mistletoe.de_bells_quest_update_mistletoe_C.call_event
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class Abp_dlg_actor_C*             Dlg_actor                                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FS_dlg_event_info           Event_data                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)

void ADe_bells_quest_update_mistletoe_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_bells_quest_update_mistletoe_C", "call_event");

	Params::ADe_bells_quest_update_mistletoe_C_Call_event_Params Parms{};
...
// Function de_bells_quest_update_mistletoe.de_bells_quest_update_mistletoe_C.ExecuteUbergraph_de_bells_quest_update_mistletoe
// (Final, UbergraphFunction, HasDefaults)
// Parameters:
// int32                              EntryPoint                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class ABP_Item_interactable_bells_obelisk_C*CallFunc_GetActorOfClass_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
