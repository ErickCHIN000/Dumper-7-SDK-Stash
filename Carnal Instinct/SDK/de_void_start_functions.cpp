...
// BlueprintGeneratedClass de_void_start.de_void_start_C
// (Actor)

class UClass* ADe_void_start_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("de_void_start_C");

	return Clss;
}


// de_void_start_C de_void_start.Default__de_void_start_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ADe_void_start_C* ADe_void_start_C::GetDefaultObj()
{
	static class ADe_void_start_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ADe_void_start_C*>(ADe_void_start_C::StaticClass()->DefaultObject);
...
void ADe_void_start_C::Call_event(class Abp_dlg_actor_C* Dlg_actor, const struct FS_dlg_event_info& Event_data)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_void_start_C", "call_event");

	Params::ADe_void_start_C_Call_event_Params Parms{};
...
// class ANpc_khaba_C*                CallFunc_GetActorOfClass_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class ANpc_esi_C*                  CallFunc_GetActorOfClass_ReturnValue_1                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ADe_void_start_C::ExecuteUbergraph_de_void_start(int32 EntryPoint, class Abp_dlg_actor_C* K2Node_Event_dlg_actor, const struct FS_dlg_event_info& K2Node_Event_event_data, class ANpc_khaba_C* CallFunc_GetActorOfClass_ReturnValue, bool CallFunc_get_dlg_actor_is_valid, bool CallFunc_get_dlg_actor_is_component_valid, int32 CallFunc_get_dlg_actor_actor_index, class AActor* CallFunc_get_dlg_actor_actor_reference, class Ubp_dlg_component_C* CallFunc_get_dlg_actor_dlg_component, const struct FS_dlg_bind_actor_info& CallFunc_get_dlg_actor_actor_dynamic, class Ubp_quest_component_C* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_get_layout_widget_is_valid, class UW_01_quest_layout_C* CallFunc_get_layout_widget_quest_widget, bool CallFunc_add_quest_is_valid, bool CallFunc_add_quest_is_spawned, class Abp_quest_actor_C* CallFunc_add_quest_quest_actor, class ANpc_esi_C* CallFunc_GetActorOfClass_ReturnValue_1)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("de_void_start_C", "ExecuteUbergraph_de_void_start");

	Params::ADe_void_start_C_ExecuteUbergraph_de_void_start_Params Parms{};
