...
class UAC_Leveling_C : public UActorComponent
{
public:
	...
	float                                        Level_Max_Experience;                              // 0xC0(0x4)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash)
	...
	static class UAC_Leveling_C* GetDefaultObj();
