...
// BlueprintGeneratedClass npc_ahmes.npc_ahmes_C
// (Actor, Pawn)

class UClass* ANpc_ahmes_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_ahmes_C");

	return Clss;
}


// npc_ahmes_C npc_ahmes.Default__npc_ahmes_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_ahmes_C* ANpc_ahmes_C::GetDefaultObj()
{
	static class ANpc_ahmes_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_ahmes_C*>(ANpc_ahmes_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_ahmes.npc_ahmes_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_ahmes_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_ahmes_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_ahmes_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_ahmes.npc_ahmes_C.ExecuteUbergraph_npc_ahmes
