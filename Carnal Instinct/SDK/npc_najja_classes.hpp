...
class ANpc_najja_C : public AExample_npc_base_C
{
public:
	uint8                                        Pad_1585[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class ANpc_najja_C* GetDefaultObj();
