...
class UWB_DynamicSex_Centaur_C : public UUserWidget
{
public:
	...
	class ABP_DynamicSex_Base_Centaur_C*         BP_DynamicSex;                                     // 0x338(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	static class UWB_DynamicSex_Centaur_C* GetDefaultObj();
