...
struct ADe_diamond_speak_nesi_C_Call_event_Params
{
public:
...
struct ADe_diamond_speak_nesi_C_ExecuteUbergraph_de_diamond_speak_nesi_Params
{
public:
	...
	uint8                                        Pad_1DF4[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
