...
// BlueprintGeneratedClass npc_hscene_rock.npc_hscene_rock_C
// (Actor, Pawn)

class UClass* ANpc_hscene_rock_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_hscene_rock_C");

	return Clss;
}


// npc_hscene_rock_C npc_hscene_rock.Default__npc_hscene_rock_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_hscene_rock_C* ANpc_hscene_rock_C::GetDefaultObj()
{
	static class ANpc_hscene_rock_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_hscene_rock_C*>(ANpc_hscene_rock_C::StaticClass()->DefaultObject);
...
void ANpc_hscene_rock_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_hscene_rock_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_hscene_rock_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
