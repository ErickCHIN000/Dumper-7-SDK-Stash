...
struct ADe_milkandhoney_statue_update2_C_Call_event_Params
{
public:
...
struct ADe_milkandhoney_statue_update2_C_ExecuteUbergraph_de_milkandhoney_statue_update2_Params
{
public:
	...
	class ANpc_statue_C*                         CallFunc_GetActorOfClass_ReturnValue_1;            // 0x50(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ABP_Interactable_Boss_Bast_C*          CallFunc_GetActorOfClass_ReturnValue_2;            // 0x68(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UAC_Inventory_C*                       CallFunc_Get_AC_Inventory_AC_Inventory;            // 0x80(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FS_ItemData                           CallFunc_Get_Inventory_Item_by_ID_item;            // 0x88(0xE8)(ContainsInstancedReference, HasGetValueTypeHash)
	bool                                         CallFunc_Get_Inventory_Item_by_ID_Found;           // 0x170(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
