...
struct ADe_slaverQuest_C_Call_event_Params
{
public:
...
struct ADe_slaverQuest_C_ExecuteUbergraph_de_slaverQuest_Params
{
public:
	...
	class Ubp_quest_component_C*                 CallFunc_GetComponentByClass_ReturnValue_1;        // 0xA0(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
