...
class ANpc_djeda_C : public AExample_npc_base_C
{
public:
	uint8                                        Pad_15D1[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0x5A0(0x8)(ZeroConstructor, Transient, DuplicateTransient)

	static class UClass* StaticClass();
	static class ANpc_djeda_C* GetDefaultObj();
