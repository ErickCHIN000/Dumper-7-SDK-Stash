...
class UABP_DynamicSex_NPC_C : public UAnimInstance
{
public:
	...
	static class UABP_DynamicSex_NPC_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void BlueprintUpdateAnimation(float DeltaTimeX);
	void BlueprintInitializeAnimation();
	void ExecuteUbergraph_ABP_DynamicSex_NPC(int32 EntryPoint, float K2Node_Event_DeltaTimeX, class ABP_DynamicSex_Base_C* CallFunc_GetActorOfClass_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1);
};
