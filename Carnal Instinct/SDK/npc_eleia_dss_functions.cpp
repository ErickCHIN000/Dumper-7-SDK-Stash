...
// BlueprintGeneratedClass npc_eleia_dss.npc_eleia_dss_C
// (Actor, Pawn)

class UClass* ANpc_eleia_dss_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_eleia_dss_C");

	return Clss;
}


// npc_eleia_dss_C npc_eleia_dss.Default__npc_eleia_dss_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_eleia_dss_C* ANpc_eleia_dss_C::GetDefaultObj()
{
	static class ANpc_eleia_dss_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_eleia_dss_C*>(ANpc_eleia_dss_C::StaticClass()->DefaultObject);
...
void ANpc_eleia_dss_C::UserConstructionScript(const struct FDataTableRowHandle& CallFunc_Array_Random_OutItem, int32 CallFunc_Array_Random_OutIndex, int32 CallFunc_Array_Add_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_eleia_dss_C", "UserConstructionScript");

	Params::ANpc_eleia_dss_C_UserConstructionScript_Params Parms{};
...
void ANpc_eleia_dss_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_eleia_dss_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_eleia_dss_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
