...
// BlueprintGeneratedClass npc_sokkwi.npc_sokkwi_C
// (Actor, Pawn)

class UClass* ANpc_sokkwi_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_sokkwi_C");

	return Clss;
}


// npc_sokkwi_C npc_sokkwi.Default__npc_sokkwi_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_sokkwi_C* ANpc_sokkwi_C::GetDefaultObj()
{
	static class ANpc_sokkwi_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_sokkwi_C*>(ANpc_sokkwi_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_sokkwi.npc_sokkwi_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ANpc_sokkwi_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_sokkwi_C", "ReceiveBeginPlay");
...
// Function npc_sokkwi.npc_sokkwi_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_sokkwi_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_sokkwi_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_sokkwi_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_sokkwi.npc_sokkwi_C.ExecuteUbergraph_npc_sokkwi
