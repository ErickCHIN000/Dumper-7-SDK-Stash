...
class US_UpdateLivingStatueAIBehavior_C : public UBTService_BlueprintBase
{
public:
	...
	static class US_UpdateLivingStatueAIBehavior_C* GetDefaultObj();
