...
struct ADe_update_shrinetoscribe_C_Call_event_Params
{
public:
	class Abp_dlg_actor_C*                       Dlg_actor;                                         // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FS_dlg_event_info                     Event_data;                                        // 0x8(0x2D)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
	uint8                                        Pad_F1A[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};

// 0x231 (0x231 - 0x0)
// Function de_update_shrinetoscribe.de_update_shrinetoscribe_C.ExecuteUbergraph_de_update_shrinetoscribe
struct ADe_update_shrinetoscribe_C_ExecuteUbergraph_de_update_shrinetoscribe_Params
{
public:
	...
	bool                                         CallFunc_get_dlg_branch_is_valid;                  // 0x58(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                         K2Node_SwitchName_CmpSuccess;                      // 0x230(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
