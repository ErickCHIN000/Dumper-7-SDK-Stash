...
struct ADe_stocks_fuckMale_C_Call_event_Params
{
public:
	class Abp_dlg_actor_C*                       Dlg_actor;                                         // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FS_dlg_event_info                     Event_data;                                        // 0x8(0x2D)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
	uint8                                        Pad_F29[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};

// 0x49 (0x49 - 0x0)
// Function de_stocks_fuckMale.de_stocks_fuckMale_C.ExecuteUbergraph_de_stocks_fuckMale
struct ADe_stocks_fuckMale_C_ExecuteUbergraph_de_stocks_fuckMale_Params
{
public:
