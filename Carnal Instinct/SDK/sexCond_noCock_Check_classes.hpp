...
class ASexCond_noCock_Check_C : public AObject_dlg_condition_parent_C
{
public:
	...
	static class ASexCond_noCock_Check_C* GetDefaultObj();
	...
	void Reply_info_condition(const struct FS_dlg_branch_reply& Reply_info, struct FS_dlg_branch_reply* Return_value, const struct FS_dlg_branch_reply& Local_reply_info, class ABP_CombatCharacter_C* CallFunc_Get_Player_Reference_Player, const struct FS_dlg_lead_info& K2Node_MakeStruct_s_dlg_lead_info, bool CallFunc_NotEqual_ClassClass_ReturnValue);
	...
	void ExecuteUbergraph_sexCond_noCock_Check(int32 EntryPoint);
};
