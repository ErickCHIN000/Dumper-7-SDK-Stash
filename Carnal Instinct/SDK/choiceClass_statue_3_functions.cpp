...
// BlueprintGeneratedClass choiceClass_statue_3.choiceClass_statue_3_C
// (Actor)

class UClass* AChoiceClass_statue_3_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("choiceClass_statue_3_C");

	return Clss;
}


// choiceClass_statue_3_C choiceClass_statue_3.Default__choiceClass_statue_3_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AChoiceClass_statue_3_C* AChoiceClass_statue_3_C::GetDefaultObj()
{
	static class AChoiceClass_statue_3_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AChoiceClass_statue_3_C*>(AChoiceClass_statue_3_C::StaticClass()->DefaultObject);

	return Default;
}


// Function choiceClass_statue_3.choiceClass_statue_3_C.choice_info_condition
...
void AChoiceClass_statue_3_C::Choice_info_condition(const struct FS_dlg_branch_choice_info& Choice_info, struct FS_dlg_branch_choice_info* Return_value, const struct FS_dlg_branch_reply& Reply_info, class UAC_Inventory_C* CallFunc_Get_AC_Inventory_AC_Inventory, const struct FS_ItemData& CallFunc_Get_Inventory_Item_by_ID_item, bool CallFunc_Get_Inventory_Item_by_ID_Found, bool CallFunc_dlg_convert_dlg_condition_return_condition, const struct FS_dlg_branch_choice_info& K2Node_MakeStruct_s_dlg_branch_choice_info, const struct FS_dlg_branch_choice_info& CallFunc_choice_info_condition_return_value)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("choiceClass_statue_3_C", "choice_info_condition");

	Params::AChoiceClass_statue_3_C_Choice_info_condition_Params Parms{};
