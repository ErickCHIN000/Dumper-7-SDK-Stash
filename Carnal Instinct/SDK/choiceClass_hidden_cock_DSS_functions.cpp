...
// BlueprintGeneratedClass choiceClass_hidden_cock_DSS.choiceClass_hidden_cock_DSS_C
// (Actor)

class UClass* AChoiceClass_hidden_cock_DSS_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("choiceClass_hidden_cock_DSS_C");

	return Clss;
}


// choiceClass_hidden_cock_DSS_C choiceClass_hidden_cock_DSS.Default__choiceClass_hidden_cock_DSS_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AChoiceClass_hidden_cock_DSS_C* AChoiceClass_hidden_cock_DSS_C::GetDefaultObj()
{
	static class AChoiceClass_hidden_cock_DSS_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AChoiceClass_hidden_cock_DSS_C*>(AChoiceClass_hidden_cock_DSS_C::StaticClass()->DefaultObject);

	return Default;
}


// Function choiceClass_hidden_cock_DSS.choiceClass_hidden_cock_DSS_C.choice_info_condition
...
void AChoiceClass_hidden_cock_DSS_C::Choice_info_condition(const struct FS_dlg_branch_choice_info& Choice_info, struct FS_dlg_branch_choice_info* Return_value, class FName Choice_Line, const struct FS_dlg_branch_reply& Reply_info, bool CallFunc_dlg_convert_dlg_condition_return_condition, class UAC_Inventory_C* CallFunc_Get_AC_Inventory_AC_Inventory, bool CallFunc_NotEqual_ClassClass_ReturnValue, const struct FS_dlg_branch_choice_info& K2Node_MakeStruct_s_dlg_branch_choice_info, const struct FS_dlg_branch_choice_info& CallFunc_choice_info_condition_return_value)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("choiceClass_hidden_cock_DSS_C", "choice_info_condition");

	Params::AChoiceClass_hidden_cock_DSS_C_Choice_info_condition_Params Parms{};
