...
public:
	...
	TArray<class FName>                          ReturnValue;                                       // 0x50(0x10)(Parm, OutParm, ZeroConstructor, ReturnParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_65F[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
