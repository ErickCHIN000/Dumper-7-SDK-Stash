...
struct ADe_law_start_C_Call_event_Params
{
public:
	class Abp_dlg_actor_C*                       Dlg_actor;                                         // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FS_dlg_event_info                     Event_data;                                        // 0x8(0x2D)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
	uint8                                        Pad_E88[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};

// 0xF9 (0xF9 - 0x0)
// Function de_law_start.de_law_start_C.ExecuteUbergraph_de_law_start
struct ADe_law_start_C_ExecuteUbergraph_de_law_start_Params
{
public:
	...
	class ANpc_guard1_C*                         CallFunc_GetActorOfClass_ReturnValue;              // 0x48(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_F7F[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         CallFunc_add_quest_is_valid;                       // 0xB8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_add_quest_is_spawned;                     // 0xB9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_FB4[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class Abp_quest_actor_C*                     CallFunc_add_quest_quest_actor;                    // 0xC0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
