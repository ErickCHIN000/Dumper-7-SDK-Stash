...
class US_UpdateInquisitorOfBastBehavior_C : public UBTService_BlueprintBase
{
public:
	...
	class ABP_InquisitorOfBast_C*                ControlledCharacter;                               // 0xF8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	static class US_UpdateInquisitorOfBastBehavior_C* GetDefaultObj();
