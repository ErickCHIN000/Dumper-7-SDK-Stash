...
// 0x30 (0x2D0 - 0x2A0)
// BlueprintGeneratedClass SEQ_MasterHScene-GOTG_BigCockSex.SEQ_MasterHScene-GOTG_BigCockSex_C
class ASEQ_MasterHSceneMinusGOTG_BigCockSex_C : public ALevelSequenceActor
{
public:
