...
class UClass* AAE_DamageTrap_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AE_DamageTrap_C");

	return Clss;
}


// AE_DamageTrap_C AE_DamageTrap.Default__AE_DamageTrap_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AAE_DamageTrap_C* AAE_DamageTrap_C::GetDefaultObj()
{
	static class AAE_DamageTrap_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AAE_DamageTrap_C*>(AAE_DamageTrap_C::StaticClass()->DefaultObject);
...
void AAE_DamageTrap_C::ApplyImpulseToCharacter(class AActor* Actor, const struct FVector& Normal, class ACharacter* K2Node_DynamicCast_AsCharacter, bool K2Node_DynamicCast_bSuccess, const struct FVector& CallFunc_Multiply_VectorFloat_ReturnValue, bool CallFunc_IsAnySimulatingPhysics_ReturnValue, const struct FVector& CallFunc_Multiply_VectorFloat_ReturnValue_1)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AE_DamageTrap_C", "ApplyImpulseToCharacter");

	Params::AAE_DamageTrap_C_ApplyImpulseToCharacter_Params Parms{};
...
void AAE_DamageTrap_C::IsEnemy(class AActor* Target, bool* Result, TScriptInterface<class II_CanBeAttacked_C> K2Node_DynamicCast_AsI_Can_be_Attacked, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsAlive_Result, class AActor* CallFunc_GetOwner_ReturnValue, class UBehaviorComponent_C* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsEnemy_Return)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AE_DamageTrap_C", "IsEnemy");

	Params::AAE_DamageTrap_C_IsEnemy_Params Parms{};
...
// Function AE_DamageTrap.AE_DamageTrap_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void AAE_DamageTrap_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AE_DamageTrap_C", "ReceiveBeginPlay");
...
void AAE_DamageTrap_C::BndEvt__Sphere_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AE_DamageTrap_C", "BndEvt__Sphere_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature");

	Params::AAE_DamageTrap_C_BndEvt__Sphere_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature_Params Parms{};
...
// Function AE_DamageTrap.AE_DamageTrap_C.DisableTrap
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void AAE_DamageTrap_C::DisableTrap()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AE_DamageTrap_C", "DisableTrap");
...
// Function AE_DamageTrap.AE_DamageTrap_C.SpawnHitParticle
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void AAE_DamageTrap_C::SpawnHitParticle()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AE_DamageTrap_C", "SpawnHitParticle");
...
// Function AE_DamageTrap.AE_DamageTrap_C.UpdateDecal
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void AAE_DamageTrap_C::UpdateDecal()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AE_DamageTrap_C", "UpdateDecal");
...
// Function AE_DamageTrap.AE_DamageTrap_C.EnableTrap
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void AAE_DamageTrap_C::EnableTrap()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AE_DamageTrap_C", "EnableTrap");
...
// Function AE_DamageTrap.AE_DamageTrap_C.PlaySound
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void AAE_DamageTrap_C::PlaySound()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AE_DamageTrap_C", "PlaySound");
