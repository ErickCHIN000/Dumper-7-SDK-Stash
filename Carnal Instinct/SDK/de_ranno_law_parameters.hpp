...
// 0x38 (0x38 - 0x0)
// Function de_ranno_law.de_ranno_law_C.call_event
struct ADe_ranno_law_C_Call_event_Params
{
public:
	class Abp_dlg_actor_C*                       Dlg_actor;                                         // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FS_dlg_event_info                     Event_data;                                        // 0x8(0x2D)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, HasGetValueTypeHash)
	uint8                                        Pad_1C9B[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};

// 0xC8 (0xC8 - 0x0)
// Function de_ranno_law.de_ranno_law_C.ExecuteUbergraph_de_ranno_law
struct ADe_ranno_law_C_ExecuteUbergraph_de_ranno_law_Params
{
public:
	...
	bool                                         CallFunc_get_dlg_actor_is_valid;                   // 0x61(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_get_dlg_actor_is_component_valid;         // 0x62(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_1DBD[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
