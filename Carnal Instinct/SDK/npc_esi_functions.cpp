...
// BlueprintGeneratedClass npc_esi.npc_esi_C
// (Actor, Pawn)

class UClass* ANpc_esi_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_esi_C");

	return Clss;
}


// npc_esi_C npc_esi.Default__npc_esi_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_esi_C* ANpc_esi_C::GetDefaultObj()
{
	static class ANpc_esi_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_esi_C*>(ANpc_esi_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_esi.npc_esi_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_esi_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_esi_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_esi_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_esi.npc_esi_C.Chat with Esi
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void ANpc_esi_C::Chat_with_Esi()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_esi_C", "Chat with Esi");
...
// Function npc_esi.npc_esi_C.ExecuteUbergraph_npc_esi
