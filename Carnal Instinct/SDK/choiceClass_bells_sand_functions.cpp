...
// BlueprintGeneratedClass choiceClass_bells_sand.choiceClass_bells_sand_C
// (Actor)

class UClass* AChoiceClass_bells_sand_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("choiceClass_bells_sand_C");

	return Clss;
}


// choiceClass_bells_sand_C choiceClass_bells_sand.Default__choiceClass_bells_sand_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AChoiceClass_bells_sand_C* AChoiceClass_bells_sand_C::GetDefaultObj()
{
	static class AChoiceClass_bells_sand_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AChoiceClass_bells_sand_C*>(AChoiceClass_bells_sand_C::StaticClass()->DefaultObject);
