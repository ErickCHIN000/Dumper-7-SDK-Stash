...
struct ASEQ_MasterHSceneMinusCageFMountain_C_ExecuteUbergraph_SEQ_MasterHSceneMinusCageFMountain_Params
{
public:
	...
	class UW_HSceneMinusCageFmountain_C*         CallFunc_Create_ReturnValue;                       // 0x30(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
