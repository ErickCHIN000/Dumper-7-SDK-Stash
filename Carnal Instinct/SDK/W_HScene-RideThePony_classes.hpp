...
// 0x68 (0x2C8 - 0x260)
// WidgetBlueprintGeneratedClass W_HScene-RideThePony.W_HScene-RideThePony_C
class UW_HSceneMinusRideThePony_C : public UUserWidget
{
public:
	...
	class ASEQ_MasterHSceneMinusRideThePony_C*   NewVar_2;                                          // 0x2C0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UW_HSceneMinusRideThePony_C* GetDefaultObj();
