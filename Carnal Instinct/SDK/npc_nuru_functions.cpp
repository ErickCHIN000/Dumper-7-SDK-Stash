...
// BlueprintGeneratedClass npc_nuru.npc_nuru_C
// (Actor, Pawn)

class UClass* ANpc_nuru_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_nuru_C");

	return Clss;
}


// npc_nuru_C npc_nuru.Default__npc_nuru_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_nuru_C* ANpc_nuru_C::GetDefaultObj()
{
	static class ANpc_nuru_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_nuru_C*>(ANpc_nuru_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_nuru.npc_nuru_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_nuru_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_nuru_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_nuru_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_nuru.npc_nuru_C.ExecuteUbergraph_npc_nuru
