...
// BlueprintGeneratedClass choiceClass_djeda_locked.choiceClass_djeda_locked_C
// (Actor)

class UClass* AChoiceClass_djeda_locked_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("choiceClass_djeda_locked_C");

	return Clss;
}


// choiceClass_djeda_locked_C choiceClass_djeda_locked.Default__choiceClass_djeda_locked_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AChoiceClass_djeda_locked_C* AChoiceClass_djeda_locked_C::GetDefaultObj()
{
	static class AChoiceClass_djeda_locked_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AChoiceClass_djeda_locked_C*>(AChoiceClass_djeda_locked_C::StaticClass()->DefaultObject);

	return Default;
}


// Function choiceClass_djeda_locked.choiceClass_djeda_locked_C.choice_info_condition
...
void AChoiceClass_djeda_locked_C::Choice_info_condition(const struct FS_dlg_branch_choice_info& Choice_info, struct FS_dlg_branch_choice_info* Return_value, const struct FS_dlg_branch_reply& Reply_info, bool CallFunc_dlg_convert_dlg_condition_return_condition, const struct FS_dlg_branch_choice_info& K2Node_MakeStruct_s_dlg_branch_choice_info, const struct FS_dlg_branch_choice_info& CallFunc_choice_info_condition_return_value)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("choiceClass_djeda_locked_C", "choice_info_condition");

	Params::AChoiceClass_djeda_locked_C_Choice_info_condition_Params Parms{};
