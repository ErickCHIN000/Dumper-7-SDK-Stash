...
// BlueprintGeneratedClass choiceClass_Havar_c2.choiceClass_Havar_c2_C
// (Actor)

class UClass* AChoiceClass_Havar_c2_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("choiceClass_Havar_c2_C");

	return Clss;
}


// choiceClass_Havar_c2_C choiceClass_Havar_c2.Default__choiceClass_Havar_c2_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AChoiceClass_Havar_c2_C* AChoiceClass_Havar_c2_C::GetDefaultObj()
{
	static class AChoiceClass_Havar_c2_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AChoiceClass_Havar_c2_C*>(AChoiceClass_Havar_c2_C::StaticClass()->DefaultObject);
...
void AChoiceClass_Havar_c2_C::Choice_info_condition(const struct FS_dlg_branch_choice_info& Choice_info, struct FS_dlg_branch_choice_info* Return_value, class ABP_CombatCharacter_C* CallFunc_Get_Player_Reference_Player, class Ubp_quest_component_C* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_get_quest_is_valid, int32 CallFunc_get_quest_found_index, class Abp_quest_actor_C* CallFunc_get_quest_quest_actor, bool CallFunc_get_objective_objective_exist, bool CallFunc_get_objective_objective_is_current, int32 CallFunc_get_objective_objective_index, const struct FS_quest_objective_data& CallFunc_get_objective_objective_data, bool CallFunc_get_objective_sub_objective_exist, int32 CallFunc_get_objective_sub_objective_index, const struct FS_quest_sub_objective_data& CallFunc_get_objective_sub_objective_data, const struct FS_dlg_branch_choice_info& K2Node_MakeStruct_s_dlg_branch_choice_info, const struct FS_dlg_branch_choice_info& CallFunc_choice_info_condition_return_value)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("choiceClass_Havar_c2_C", "choice_info_condition");

	Params::AChoiceClass_Havar_c2_C_Choice_info_condition_Params Parms{};
