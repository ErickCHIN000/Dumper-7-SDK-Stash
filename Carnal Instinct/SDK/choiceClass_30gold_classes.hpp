...
// 0x1 (0x322 - 0x321)
// BlueprintGeneratedClass choiceClass_30gold.choiceClass_30gold_C
class AChoiceClass_30gold_C : public AObject_dlg_condition_parent_C
{
public:
	...
	static class AChoiceClass_30gold_C* GetDefaultObj();
