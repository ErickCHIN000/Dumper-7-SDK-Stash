...
// BlueprintGeneratedClass npc_bed.npc_bed_C
// (Actor, Pawn)

class UClass* ANpc_bed_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_bed_C");

	return Clss;
}


// npc_bed_C npc_bed.Default__npc_bed_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_bed_C* ANpc_bed_C::GetDefaultObj()
{
	static class ANpc_bed_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_bed_C*>(ANpc_bed_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_bed.npc_bed_C.UserConstructionScript
// (Event, Public, BlueprintCallable, BlueprintEvent)
// Parameters:

void ANpc_bed_C::UserConstructionScript()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_bed_C", "UserConstructionScript");
...
// Function npc_bed.npc_bed_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_bed_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_bed_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_bed_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_bed.npc_bed_C.ExecuteUbergraph_npc_bed
