...
class UClass* ANpc_assistant_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_assistant_C");

	return Clss;
}


// npc_assistant_C npc_assistant.Default__npc_assistant_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_assistant_C* ANpc_assistant_C::GetDefaultObj()
{
	static class ANpc_assistant_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_assistant_C*>(ANpc_assistant_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_assistant.npc_assistant_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_assistant_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_assistant_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_assistant_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_assistant.npc_assistant_C.ExecuteUbergraph_npc_assistant
