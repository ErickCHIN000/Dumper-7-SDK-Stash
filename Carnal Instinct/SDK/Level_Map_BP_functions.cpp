...
class UClass* ALevel_Map_BP_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Level_Map_BP_C");

	return Clss;
}


// Level_Map_BP_C Level_Map_BP.Default__Level_Map_BP_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ALevel_Map_BP_C* ALevel_Map_BP_C::GetDefaultObj()
{
	static class ALevel_Map_BP_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ALevel_Map_BP_C*>(ALevel_Map_BP_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Level_Map_BP.Level_Map_BP_C.UserConstructionScript
...
// struct FMap_Parts_Arrays_Struct    CallFunc_Array_Get_Item                                          (ContainsInstancedReference, HasGetValueTypeHash)
