...
class UClass* AChoiceClass_hidden_smallCock_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("choiceClass_hidden_smallCock_C");

	return Clss;
}


// choiceClass_hidden_smallCock_C choiceClass_hidden_smallCock.Default__choiceClass_hidden_smallCock_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AChoiceClass_hidden_smallCock_C* AChoiceClass_hidden_smallCock_C::GetDefaultObj()
{
	static class AChoiceClass_hidden_smallCock_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AChoiceClass_hidden_smallCock_C*>(AChoiceClass_hidden_smallCock_C::StaticClass()->DefaultObject);
...
void AChoiceClass_hidden_smallCock_C::Choice_info_condition(const struct FS_dlg_branch_choice_info& Choice_info, struct FS_dlg_branch_choice_info* Return_value, class FName Choice_Line, const struct FS_dlg_branch_reply& Reply_info, class UAC_Inventory_C* CallFunc_Get_AC_Inventory_AC_Inventory, const struct FS_dlg_branch_choice_info& K2Node_MakeStruct_s_dlg_branch_choice_info, bool CallFunc_NotEqual_ByteByte_ReturnValue, const struct FS_dlg_branch_choice_info& CallFunc_choice_info_condition_return_value, bool CallFunc_NotEqual_ClassClass_ReturnValue, bool CallFunc_BooleanAND_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("choiceClass_hidden_smallCock_C", "choice_info_condition");

	Params::AChoiceClass_hidden_smallCock_C_Choice_info_condition_Params Parms{};
