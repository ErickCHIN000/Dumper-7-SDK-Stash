...
// BlueprintGeneratedClass npc_euthymius.npc_euthymius_C
// (Actor, Pawn)

class UClass* ANpc_euthymius_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_euthymius_C");

	return Clss;
}


// npc_euthymius_C npc_euthymius.Default__npc_euthymius_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_euthymius_C* ANpc_euthymius_C::GetDefaultObj()
{
	static class ANpc_euthymius_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_euthymius_C*>(ANpc_euthymius_C::StaticClass()->DefaultObject);

	return Default;
}


// Function npc_euthymius.npc_euthymius_C.BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature
// (BlueprintEvent)
// Parameters:
...
void ANpc_euthymius_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_euthymius_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_euthymius_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
...
// Function npc_euthymius.npc_euthymius_C.ExecuteUbergraph_npc_euthymius
