...
struct ASEQ_MasterHSceneMinusLOPMinusTableFuck_C_ExecuteUbergraph_SEQ_MasterHSceneMinusLOPMinusTableFuck_Params
{
public:
	...
	class UW_HSceneMinusLOPMinusTableFuck_C*     CallFunc_Create_ReturnValue;                       // 0x30(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
