...
// BlueprintGeneratedClass choiceClass_Mehlva_Note.choiceClass_Mehlva_Note_C
// (Actor)

class UClass* AChoiceClass_Mehlva_Note_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("choiceClass_Mehlva_Note_C");

	return Clss;
}


// choiceClass_Mehlva_Note_C choiceClass_Mehlva_Note.Default__choiceClass_Mehlva_Note_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AChoiceClass_Mehlva_Note_C* AChoiceClass_Mehlva_Note_C::GetDefaultObj()
{
	static class AChoiceClass_Mehlva_Note_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AChoiceClass_Mehlva_Note_C*>(AChoiceClass_Mehlva_Note_C::StaticClass()->DefaultObject);
...
void AChoiceClass_Mehlva_Note_C::Choice_info_condition(const struct FS_dlg_branch_choice_info& Choice_info, struct FS_dlg_branch_choice_info* Return_value, class UAC_Inventory_C* CallFunc_Get_AC_Inventory_AC_Inventory, const struct FS_ItemData& CallFunc_Get_Inventory_Item_by_ID_item, bool CallFunc_Get_Inventory_Item_by_ID_Found, const struct FS_dlg_branch_choice_info& K2Node_MakeStruct_s_dlg_branch_choice_info, const struct FS_dlg_branch_choice_info& CallFunc_choice_info_condition_return_value)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("choiceClass_Mehlva_Note_C", "choice_info_condition");

	Params::AChoiceClass_Mehlva_Note_C_Choice_info_condition_Params Parms{};
