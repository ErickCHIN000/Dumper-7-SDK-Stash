...
class UClass* ANpc_iraya_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("npc_iraya_C");

	return Clss;
}


// npc_iraya_C npc_iraya.Default__npc_iraya_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ANpc_iraya_C* ANpc_iraya_C::GetDefaultObj()
{
	static class ANpc_iraya_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ANpc_iraya_C*>(ANpc_iraya_C::StaticClass()->DefaultObject);
...
void ANpc_iraya_C::BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature(class FName Instigator_id, class AActor* Instigator_actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("npc_iraya_C", "BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature");

	Params::ANpc_iraya_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params Parms{};
