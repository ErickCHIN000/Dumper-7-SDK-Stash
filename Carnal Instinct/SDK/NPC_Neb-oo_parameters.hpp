...
struct ANPC_NebMinusoo_C_BndEvt__bp_dlg_component_K2Node_ComponentBoundEvent_0_ed_dlg_interact__DelegateSignature_Params
{
public:
...
struct ANPC_NebMinusoo_C_ReceiveTick_Params
{
public:
...
struct ANPC_NebMinusoo_C_BndEvt__NPC_NebMinusoo_Sphere_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature_Params
{
public:
...
struct ANPC_NebMinusoo_C_BndEvt__NPC_NebMinusoo_Sphere_K2Node_ComponentBoundEvent_2_ComponentEndOverlapSignature__DelegateSignature_Params
{
public:
	class UPrimitiveComponent*                   OverlappedComponent;                               // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AActor*                                OtherActor;                                        // 0x8(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct ANPC_NebMinusoo_C_ExecuteUbergraph_NPC_NebMinusoo_Params
{
public:
	...
	struct FS_dlg_bind_actor_settings            K2Node_MakeStruct_s_dlg_bind_actor_settings;       // 0x50(0x20)(UObjectWrapper, HasGetValueTypeHash)
	...
	struct FHitResult                            K2Node_ComponentBoundEvent_SweepResult;            // 0xA8(0x8C)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
