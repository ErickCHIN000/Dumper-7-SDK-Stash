...
// BlueprintGeneratedClass ba_bfgProjectile_Makarov.ba_bfgProjectile_Makarov_C
// (Actor)

class UClass* Aba_bfgProjectile_Makarov_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ba_bfgProjectile_Makarov_C");

	return Clss;
}


// ba_bfgProjectile_Makarov_C ba_bfgProjectile_Makarov.Default__ba_bfgProjectile_Makarov_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class Aba_bfgProjectile_Makarov_C* Aba_bfgProjectile_Makarov_C::GetDefaultObj()
{
	static class Aba_bfgProjectile_Makarov_C* Default = nullptr;

	if (!Default)
		Default = static_cast<Aba_bfgProjectile_Makarov_C*>(Aba_bfgProjectile_Makarov_C::StaticClass()->DefaultObject);

	return Default;
}


// Function ba_bfgProjectile_Makarov.ba_bfgProjectile_Makarov_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void Aba_bfgProjectile_Makarov_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("ba_bfgProjectile_Makarov_C", "ReceiveBeginPlay");
...
void Aba_bfgProjectile_Makarov_C::OnTakeDamage(class AActor* DamagedActor, float Damage, class UDamageType* DamageType, class AController* InstigatedBy, class AActor* DamageCauser)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("ba_bfgProjectile_Makarov_C", "OnTakeDamage");

	Params::Aba_bfgProjectile_Makarov_C_OnTakeDamage_Params Parms{};
...
// Function ba_bfgProjectile_Makarov.ba_bfgProjectile_Makarov_C.ReceiveDestroyed
// (Event, Public, BlueprintEvent)
// Parameters:

void Aba_bfgProjectile_Makarov_C::ReceiveDestroyed()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("ba_bfgProjectile_Makarov_C", "ReceiveDestroyed");
...
void Aba_bfgProjectile_Makarov_C::ReceiveTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("ba_bfgProjectile_Makarov_C", "ReceiveTick");

	Params::Aba_bfgProjectile_Makarov_C_ReceiveTick_Params Parms{};
...
// Function ba_bfgProjectile_Makarov.ba_bfgProjectile_Makarov_C.SpawnExplosionParticle
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void Aba_bfgProjectile_Makarov_C::SpawnExplosionParticle()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("ba_bfgProjectile_Makarov_C", "SpawnExplosionParticle");
...
// class ABP_PS_BlackStalkerProjectile_Makarov_C*K2Node_DynamicCast_AsBP_PS_Black_Stalker_Projectile_Makarov      (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
...
// class ABP_PS_BlackStalkerProjectile_Makarov_C*K2Node_DynamicCast_AsBP_PS_Black_Stalker_Projectile_Makarov_1    (ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
...
void Aba_bfgProjectile_Makarov_C::ExecuteUbergraph_ba_bfgProjectile_Makarov(int32 EntryPoint, float CallFunc_GetWorldDeltaSeconds_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FVector& CallFunc_GetActorForwardVector_ReturnValue, class AActor* K2Node_CustomEvent_DamagedActor, float K2Node_CustomEvent_Damage, class UDamageType* K2Node_CustomEvent_DamageType, class AController* K2Node_CustomEvent_InstigatedBy, class AActor* K2Node_CustomEvent_DamageCauser, bool Temp_bool_Variable, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue_1, const struct FVector& CallFunc_Add_VectorVector_ReturnValue, class ACh_Hero_00_C* CallFunc_GetCGPlayerCharacter_CGPlayerCharacter, TArray<class AActor*>& K2Node_MakeArray_Array, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue_2, TArray<enum class EObjectTypeQuery>& K2Node_MakeArray_Array_1, class ACh_Hero_00_C* CallFunc_GetCGPlayerCharacter_CGPlayerCharacter_1, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue_3, class AController* CallFunc_GetController_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue_4, bool CallFunc_GreaterEqual_IntInt_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue, float K2Node_Event_DeltaSeconds, const struct FVector& CallFunc_Multiply_VectorFloat_ReturnValue, const struct FVector& CallFunc_Add_VectorVector_ReturnValue_1, int32 Temp_int_Loop_Counter_Variable, const struct FHitResult& CallFunc_K2_SetActorLocation_SweepHitResult, bool CallFunc_K2_SetActorLocation_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, class FName CallFunc_MakeLiteralName_ReturnValue, class FName CallFunc_MakeLiteralName_ReturnValue_1, class FName CallFunc_MakeLiteralName_ReturnValue_2, class FName CallFunc_MakeLiteralName_ReturnValue_3, class FName CallFunc_MakeLiteralName_ReturnValue_4, class FName CallFunc_MakeLiteralName_ReturnValue_5, class FName CallFunc_MakeLiteralName_ReturnValue_6, class FName CallFunc_MakeLiteralName_ReturnValue_7, class FName CallFunc_MakeLiteralName_ReturnValue_8, TArray<class FName>& K2Node_MakeArray_Array_2, int32 CallFunc_Array_Length_ReturnValue, class ABP_PS_BlackStalkerProjectile_Makarov_C* K2Node_DynamicCast_AsBP_PS_Black_Stalker_Projectile_Makarov, bool K2Node_DynamicCast_bSuccess, int32 CallFunc_Subtract_IntInt_ReturnValue, bool CallFunc_IsValid_ReturnValue, int32 CallFunc_GetRandomIntInRangeWithExclusion_ReturnValue, int32 CallFunc_RandomIntegerInRange_ReturnValue, int32 K2Node_Select_Default, class FName CallFunc_Array_Get_Item, bool CallFunc_IsValid_ReturnValue_1, const struct FHitResult& CallFunc_MakeHitResult_ReturnValue, TArray<class AActor*>& Temp_object_Variable, class ABP_PS_BlackStalkerProjectile_Makarov_C* K2Node_DynamicCast_AsBP_PS_Black_Stalker_Projectile_Makarov_1, bool K2Node_DynamicCast_bSuccess_1, bool CallFunc_IsValid_ReturnValue_2, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue_5, class UAkComponent* CallFunc_SpawnAkComponentAtLocation_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FHitResult& CallFunc_SphereTraceSingle_OutHit, bool CallFunc_SphereTraceSingle_ReturnValue, TArray<class AActor*>& CallFunc_SphereOverlapActors_OutActors, bool CallFunc_SphereOverlapActors_ReturnValue, int32 CallFunc_Array_Length_ReturnValue_1, bool CallFunc_Less_IntInt_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue_6, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue_7, int32 Temp_int_Array_Index_Variable, const struct FHitResult& CallFunc_SphereTraceSingle_OutHit_1, bool CallFunc_SphereTraceSingle_ReturnValue_1, class AActor* CallFunc_Array_Get_Item_1, class ACGAICharacter* K2Node_DynamicCast_AsCGAICharacter, bool K2Node_DynamicCast_bSuccess_2, enum class EAIWorldType CallFunc_GetAIWorldType_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue_8, bool CallFunc_EqualEqual_ByteByte_ReturnValue, const struct FVector& CallFunc_Subtract_VectorVector_ReturnValue, float CallFunc_SelectFloat_ReturnValue, const struct FVector& CallFunc_Normal_ReturnValue, float CallFunc_SelectFloat_ReturnValue_1, const struct FCGDamageEvent& K2Node_MakeStruct_CGDamageEvent, float CallFunc_RandomFloatInRange_ReturnValue, float CallFunc_CGApplyDamage_ReturnValue, const struct FVector& CallFunc_K2_GetComponentLocation_ReturnValue, class UParticleSystemComponent* CallFunc_SpawnEmitterAtLocation_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("ba_bfgProjectile_Makarov_C", "ExecuteUbergraph_ba_bfgProjectile_Makarov");

	Params::Aba_bfgProjectile_Makarov_C_ExecuteUbergraph_ba_bfgProjectile_Makarov_Params Parms{};
	...
	Parms.K2Node_DynamicCast_AsBP_PS_Black_Stalker_Projectile_Makarov = K2Node_DynamicCast_AsBP_PS_Black_Stalker_Projectile_Makarov;
	...
	Parms.K2Node_DynamicCast_AsBP_PS_Black_Stalker_Projectile_Makarov_1 = K2Node_DynamicCast_AsBP_PS_Black_Stalker_Projectile_Makarov_1;
