...
class UClass* UWid_FoodPanel_Tutorial_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("wid_FoodPanel_Tutorial_C");

	return Clss;
}


// wid_FoodPanel_Tutorial_C wid_FoodPanel_Tutorial.Default__wid_FoodPanel_Tutorial_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWid_FoodPanel_Tutorial_C* UWid_FoodPanel_Tutorial_C::GetDefaultObj()
{
	static class UWid_FoodPanel_Tutorial_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWid_FoodPanel_Tutorial_C*>(UWid_FoodPanel_Tutorial_C::StaticClass()->DefaultObject);
...
// Parameters:
// bool                               IsMissionTutorial                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UWid_FoodPanel_Tutorial_C::SetType(bool IsMissionTutorial)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("wid_FoodPanel_Tutorial_C", "SetType");

	Params::UWid_FoodPanel_Tutorial_C_SetType_Params Parms{};

	Parms.IsMissionTutorial = IsMissionTutorial;
...
void UWid_FoodPanel_Tutorial_C::PreConstruct(bool IsDesignTime)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("wid_FoodPanel_Tutorial_C", "PreConstruct");

	Params::UWid_FoodPanel_Tutorial_C_PreConstruct_Params Parms{};
...
// Function wid_FoodPanel_Tutorial.wid_FoodPanel_Tutorial_C.Construct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)
// Parameters:

void UWid_FoodPanel_Tutorial_C::Construct()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("wid_FoodPanel_Tutorial_C", "Construct");
...
void UWid_FoodPanel_Tutorial_C::InputDeviceChanged(bool NewInputIsGamepad)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("wid_FoodPanel_Tutorial_C", "InputDeviceChanged");

	Params::UWid_FoodPanel_Tutorial_C_InputDeviceChanged_Params Parms{};
...
// Function wid_FoodPanel_Tutorial.wid_FoodPanel_Tutorial_C.Destruct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)
// Parameters:

void UWid_FoodPanel_Tutorial_C::Destruct()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("wid_FoodPanel_Tutorial_C", "Destruct");
...
void UWid_FoodPanel_Tutorial_C::ExecuteUbergraph_wid_FoodPanel_Tutorial(int32 EntryPoint, class ACGGameModeBase* CallFunc_GetCGGameMode_AsFirst_Person_Game_Mode, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool K2Node_Event_IsDesignTime, class ACGGameModeBase* CallFunc_GetCGGameMode_AsFirst_Person_Game_Mode_1, bool K2Node_CustomEvent_NewInputIsGamepad)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("wid_FoodPanel_Tutorial_C", "ExecuteUbergraph_wid_FoodPanel_Tutorial");

	Params::UWid_FoodPanel_Tutorial_C_ExecuteUbergraph_wid_FoodPanel_Tutorial_Params Parms{};
