...
{
public:
	uint8                                        Pad_1532[0xAC];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1541[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1545[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
