...
struct UWid_Loading_ProgressBar_C_SetIsTransitional_Params
{
public:
	bool                                         IsTransitional;                                    // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};

// 0x4 (0x4 - 0x0)
// Function wid_Loading_ProgressBar.wid_Loading_ProgressBar_C.UpdateProgressBarValue
struct UWid_Loading_ProgressBar_C_UpdateProgressBarValue_Params
{
public:
...
struct UWid_Loading_ProgressBar_C_TryAcceptUnshownFill_Params
{
public:
	...
	float                                        CallFunc_SelectFloat_ReturnValue_2;                // 0xC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_SelectFloat_ReturnValue_3;                // 0x10(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UWid_Loading_ProgressBar_C_UpdateUnshownFill_Params
{
public:
	float                                        FillSpeed;                                         // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_GetFillCheckDelta_ReturnValue;            // 0x4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UWid_Loading_ProgressBar_C_GetFillCheckDelta_Params
{
public:
...
struct UWid_Loading_ProgressBar_C_UpdateLastFillCheck_Params
{
public:
...
struct UWid_Loading_ProgressBar_C_MakeNewUpdateAtDifference_Params
{
public:
...
struct UWid_Loading_ProgressBar_C_Start_Params
{
public:
...
struct UWid_Loading_ProgressBar_C_Progress_Params
{
public:
	float                                        CallFunc_RandomFloatInRange_ReturnValue;           // 0x0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UWid_Loading_ProgressBar_C_Tick_Params
{
public:
...
struct UWid_Loading_ProgressBar_C_ExecuteUbergraph_wid_Loading_ProgressBar_Params
{
public:
	...
	bool                                         CallFunc_GreaterEqual_FloatFloat_ReturnValue_1;    // 0x46(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
