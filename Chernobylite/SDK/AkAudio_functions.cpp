...
// Function AkAudio.AkGameplayStatics.SetLanguage
// (Final, Native, Static, Public, BlueprintCallable)
// Parameters:
// enum class EWWiseLanguage          Value                                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UAkGameplayStatics::SetLanguage(enum class EWWiseLanguage Value)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AkGameplayStatics", "SetLanguage");

	Params::UAkGameplayStatics_SetLanguage_Params Parms{};
