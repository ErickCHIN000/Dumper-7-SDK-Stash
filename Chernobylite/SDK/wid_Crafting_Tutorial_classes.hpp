...
class UWid_Crafting_Tutorial_C : public UUserWidget
{
public:
	...
	static class UWid_Crafting_Tutorial_C* GetDefaultObj();

	void UpdateTextBasedOnInput(bool Temp_bool_Variable, bool CallFunc_LastInputWasFromGamepad_Gamepad, class FText K2Node_Select_Default);
	void PreConstruct(bool IsDesignTime);
	void Construct();
	void InputDeviceChanged(bool NewInputIsGamepad);
	void Destruct();
	void ExecuteUbergraph_wid_Crafting_Tutorial(int32 EntryPoint, class ACGGameModeBase* CallFunc_GetCGGameMode_AsFirst_Person_Game_Mode, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool K2Node_Event_IsDesignTime, class ACGGameModeBase* CallFunc_GetCGGameMode_AsFirst_Person_Game_Mode_1, bool K2Node_CustomEvent_NewInputIsGamepad);
};
