...
struct Ubc_SkyLightModificator_01_C_GetCurrentValue_Params
{
public:
...
struct Ubc_SkyLightModificator_01_C_AdjustMaterialForSkyLightModificator_Params
{
public:
	float                                        Modificator;                                       // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UMaterialInstanceDynamic*              K2Node_DynamicCast_AsMaterial_Instance_Dynamic;    // 0x50(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
