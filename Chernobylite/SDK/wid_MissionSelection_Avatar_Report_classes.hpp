...
class UWid_MissionSelection_Avatar_Report_C : public UUserWidget
{
public:
	...
	class UTexture2D*                            AvatarImg;                                         // 0x270(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	class FText                                  Name;                                              // 0x278(0x18)(Edit, BlueprintVisible, ExposeOnSpawn)

	static class UClass* StaticClass();
	static class UWid_MissionSelection_Avatar_Report_C* GetDefaultObj();
	...
	void Construct();
	void ExecuteUbergraph_wid_MissionSelection_Avatar_Report(int32 EntryPoint, class UMaterialInstanceDynamic* CallFunc_GetDynamicMaterial_ReturnValue);
};
