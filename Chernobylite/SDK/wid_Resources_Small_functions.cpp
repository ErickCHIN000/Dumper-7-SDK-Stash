...
class UClass* UWid_Resources_Small_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("wid_Resources_Small_C");

	return Clss;
}


// wid_Resources_Small_C wid_Resources_Small.Default__wid_Resources_Small_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWid_Resources_Small_C* UWid_Resources_Small_C::GetDefaultObj()
{
	static class UWid_Resources_Small_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWid_Resources_Small_C*>(UWid_Resources_Small_C::StaticClass()->DefaultObject);
...
void UWid_Resources_Small_C::CheckIfAllResourceRequirementsAreMet(class UPanelWidget* Self2, bool* RequirementsMet, bool Requiriments_met, int32 Temp_int_Variable, int32 CallFunc_GetChildrenCount_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, bool CallFunc_LessEqual_IntInt_ReturnValue, class UWidget* CallFunc_GetChildAt_ReturnValue, class UWid_Resources_Entry_C* K2Node_DynamicCast_AsWid_Resources_Entry, bool K2Node_DynamicCast_bSuccess, enum class ESlateVisibility CallFunc_GetVisibility_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("wid_Resources_Small_C", "CheckIfAllResourceRequirementsAreMet");

	Params::UWid_Resources_Small_C_CheckIfAllResourceRequirementsAreMet_Params Parms{};
...
void UWid_Resources_Small_C::UpdateBorderColor(bool* RequirementsMet, bool CallFunc_CheckIfAllResourceRequirementsAreMet_RequirementsMet)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("wid_Resources_Small_C", "UpdateBorderColor");

	Params::UWid_Resources_Small_C_UpdateBorderColor_Params Parms{};
...
void UWid_Resources_Small_C::GetResourceWidget(enum class EResourceType Enum, class UWid_Resources_Entry_C** Widget, bool K2Node_SwitchEnum_CmpSuccess)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("wid_Resources_Small_C", "GetResourceWidget");

	Params::UWid_Resources_Small_C_GetResourceWidget_Params Parms{};
...
void UWid_Resources_Small_C::PreConstruct(bool IsDesignTime)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("wid_Resources_Small_C", "PreConstruct");

	Params::UWid_Resources_Small_C_PreConstruct_Params Parms{};
...
void UWid_Resources_Small_C::ExecuteUbergraph_wid_Resources_Small(int32 EntryPoint, bool K2Node_Event_IsDesignTime)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("wid_Resources_Small_C", "ExecuteUbergraph_wid_Resources_Small");

	Params::UWid_Resources_Small_C_ExecuteUbergraph_wid_Resources_Small_Params Parms{};
