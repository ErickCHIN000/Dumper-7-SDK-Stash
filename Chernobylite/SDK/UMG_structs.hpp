...
{
public:
	uint8                                        Pad_38BE[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_38C0[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	struct FMovieSceneFloatChannel               TopCurve;                                          // 0x38(0xA0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel               LeftCurve;                                         // 0xD8(0xA0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel               RightCurve;                                        // 0x178(0xA0)(NativeAccessSpecifierPrivate)
	struct FMovieSceneFloatChannel               BottomCurve;                                       // 0x218(0xA0)(NativeAccessSpecifierPrivate)
	enum class EMovieSceneBlendType              BlendType;                                         // 0x2B8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_38C6[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	bool                                         bDistributeItemsEvenly;                            // 0x0(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_38C8[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        AngleBetweenItems;                                 // 0x4(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        StartingAngle;                                     // 0x8(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_38CB[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_38D0[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_38D1[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_38D4[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_38D8[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_38DA[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
