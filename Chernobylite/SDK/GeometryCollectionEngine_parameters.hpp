...
public:
	...
	struct FHitResult                            OutHit;                                            // 0x18(0x8C)(Parm, OutParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_2E4[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_37A[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
