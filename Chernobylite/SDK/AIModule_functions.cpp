...
// Parameters:
// class UObject*                     WorldContextObject                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TSoftClassPtr<class APawn>         PawnClass                                                        (Parm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TSoftObjectPtr<class UBehaviorTree>BehaviorTree                                                     (Parm, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class APawn* UAIBlueprintHelperLibrary::SpawnAIFromSoftClass(class UObject* WorldContextObject, TSoftClassPtr<class APawn> PawnClass, TSoftObjectPtr<class UBehaviorTree> BehaviorTree, const struct FVector& Location, const struct FRotator& Rotation, bool bNoCollisionFail, class AActor* Owner)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AIBlueprintHelperLibrary", "SpawnAIFromSoftClass");

	Params::UAIBlueprintHelperLibrary_SpawnAIFromSoftClass_Params Parms{};
