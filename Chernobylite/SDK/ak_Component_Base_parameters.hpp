...
struct UAk_Component_Base_C_SetFootstepSwitch_Params
{
public:
	...
	struct FHitResult                            CallFunc_LineTraceSingle_OutHit;                   // 0x3C(0x8C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	uint8                                        Pad_1975[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class UCGPhysicalMaterial*                   K2Node_DynamicCast_AsCGPhysical_Material;          // 0x148(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	...
	class FString                                CallFunc_GetPhysMaterialtoAkSwitchMapping_Value;   // 0x158(0x10)(ZeroConstructor, HasGetValueTypeHash)
};

// 0x10 (0x10 - 0x0)
// Function ak_Component_Base.ak_Component_Base_C.ExecuteUbergraph_ak_Component_Base
struct UAk_Component_Base_C_ExecuteUbergraph_ak_Component_Base_Params
{
public:
