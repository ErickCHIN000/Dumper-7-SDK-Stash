...
public:
	...
	uint8                                        Pad_6[0x9C];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_128[0x390];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_12A[0x148];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_12B[0x1E4];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_15E[0xA4];                                     // Fixing Size Of Struct [ Dumper-7 ]
