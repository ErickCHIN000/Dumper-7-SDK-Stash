...
class UWid_Resources_C : public UUserWidget
{
public:
	...
	static class UWid_Resources_C* GetDefaultObj();

	void UpdateForScrap(enum class EResourceType Enum, float ComparedAmount, float Amount, bool IsFirstItem, class FName RowName, bool Temp_bool_Variable, bool CallFunc_Greater_FloatFloat_ReturnValue, class UWid_Resources_Entry_C* CallFunc_GetResourceWidget_Widget, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, enum class ESlateVisibility K2Node_Select_Default, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, TArray<enum class EResourceType>& K2Node_MakeArray_Array, enum class EResourceType CallFunc_Array_Get_Item, int32 CallFunc_Array_Length_ReturnValue, class UWid_Resources_Entry_C* CallFunc_GetResourceWidget_Widget_1, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, bool CallFunc_UpdateBorderColor_RequirementsMet);
	...
	void ExecuteUbergraph_wid_Resources(int32 EntryPoint, bool K2Node_Event_IsDesignTime);
};
