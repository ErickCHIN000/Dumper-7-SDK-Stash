...
public:
	...
	uint8                                        Pad_802[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_842[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_85F[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	enum class EGooglePADErrorCode               ReturnValue;                                       // 0x14(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_8AA[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
