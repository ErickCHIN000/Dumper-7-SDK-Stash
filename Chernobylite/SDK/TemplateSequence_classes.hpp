...
public:
	...
	uint8                                        Pad_696[0x3C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6D3[0x458];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_6D9[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_755[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_762[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_7B2[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_7C6[0x70];                                     // Fixing Size Of Struct [ Dumper-7 ]
