...
class UWid_DialogueTimelinePayload_Entry_C : public UUserWidget
{
public:
	...
	enum class EBasicResultType                  ReactionType;                                      // 0x288(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	bool                                         IsBold;                                            // 0x289(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)

	static class UClass* StaticClass();
	static class UWid_DialogueTimelinePayload_Entry_C* GetDefaultObj();
	...
	void ExecuteUbergraph_wid_DialogueTimelinePayload_Entry(int32 EntryPoint, bool K2Node_Event_IsDesignTime);
};
