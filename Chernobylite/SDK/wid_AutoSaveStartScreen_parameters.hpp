...
struct UWid_AutoSaveStartScreen_C_Input_Params
{
public:
...
struct UWid_AutoSaveStartScreen_C_Start_Params
{
public:
	class UUMGSequencePlayer*                    CallFunc_PlayAnimation_ReturnValue;                // 0x0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct UWid_AutoSaveStartScreen_C_ExecuteUbergraph_wid_AutoSaveStartScreen_Params
{
public:
	...
	class ACGMovementState*                      CallFunc_SetNewMovementState_ReturnValue;          // 0x10(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
