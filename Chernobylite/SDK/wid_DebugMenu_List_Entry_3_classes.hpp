...
class UWid_DebugMenu_List_Entry_3_C : public UUserWidget
{
public:
	...
	class FName                                  MoodName;                                          // 0x298(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UWid_DebugMenu_List_Entry_3_C* GetDefaultObj();
