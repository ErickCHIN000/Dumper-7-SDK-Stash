...
class UClass* USequenceCameraShake::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("SequenceCameraShake");

	return Clss;
}


// SequenceCameraShake TemplateSequence.Default__SequenceCameraShake
// (Public, ClassDefaultObject, ArchetypeObject)

class USequenceCameraShake* USequenceCameraShake::GetDefaultObj()
{
	static class USequenceCameraShake* Default = nullptr;

	if (!Default)
		Default = static_cast<USequenceCameraShake*>(USequenceCameraShake::StaticClass()->DefaultObject);
