...
class UAn_akAudioNotify_Makarov_Insert_drum_magazine_C : public UAn_akAudioNotify_Base_C
{
public:
	...
	static class UAn_akAudioNotify_Makarov_Insert_drum_magazine_C* GetDefaultObj();
