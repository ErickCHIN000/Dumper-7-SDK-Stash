...
{
public:
	uint8                                        Pad_40E[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_410[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_413[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_414[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_416[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_41D[0x3];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_46A[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
