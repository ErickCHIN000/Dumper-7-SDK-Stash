...
class UWid_MissionSelection_Avatar_Food_V3_C : public UUserWidget
{
public:
	...
	class UImage*                                AvatarColor;                                       // 0x270(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	static class UWid_MissionSelection_Avatar_Food_V3_C* GetDefaultObj();

	void ChangeAvatarColor(enum class Enum_MissionSelection_Avatar_Type Selection, bool K2Node_SwitchEnum_CmpSuccess);
	...
	void Construct();
	void ExecuteUbergraph_wid_MissionSelection_Avatar_Food_V3(int32 EntryPoint, class UMaterialInstanceDynamic* CallFunc_GetDynamicMaterial_ReturnValue);
};
