...
class UBP_BuildableBuildCraftingWidget_C : public UUserWidget
{
public:
	...
	class ABuildable_BuildingBench_C*            StationOwner;                                      // 0x390(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	...
	static class UBP_BuildableBuildCraftingWidget_C* GetDefaultObj();
