...
class UClass* USC_Respirator_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("SC_Respirator_C");

	return Clss;
}


// SC_Respirator_C SC_Respirator.Default__SC_Respirator_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class USC_Respirator_C* USC_Respirator_C::GetDefaultObj()
{
	static class USC_Respirator_C* Default = nullptr;

	if (!Default)
		Default = static_cast<USC_Respirator_C*>(USC_Respirator_C::StaticClass()->DefaultObject);

	return Default;
}


// Function SC_Respirator.SC_Respirator_C.SetActionbarFollower
...
void USC_Respirator_C::SetActionbarFollower(class UJSI_Slot_C* JigRef, bool* Return)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_Respirator_C", "SetActionbarFollower");

	Params::USC_Respirator_C_SetActionbarFollower_Params Parms{};
...
// Function SC_Respirator.SC_Respirator_C.GetAllAttachments
...
// Function SC_Respirator.SC_Respirator_C.GetListOfNonAddContainers
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// TArray<class UJSIContainer_C*>     Containers                                                       (Parm, OutParm, ContainsInstancedReference)

void USC_Respirator_C::GetListOfNonAddContainers(TArray<class UJSIContainer_C*>* Containers)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_Respirator_C", "GetListOfNonAddContainers");

	Params::USC_Respirator_C_GetListOfNonAddContainers_Params Parms{};
...
// Function SC_Respirator.SC_Respirator_C.GetJSIContainerByPlayerSlots
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void USC_Respirator_C::GetJSIContainerByPlayerSlots(enum class EPlayerSlots Slot, class UJSIContainer_C** Container, class UJSI_Slot_C** EquippedItem, bool* IsPending_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_Respirator_C", "GetJSIContainerByPlayerSlots");

	Params::USC_Respirator_C_GetJSIContainerByPlayerSlots_Params Parms{};
...
// Function SC_Respirator.SC_Respirator_C.GetDropWidget
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UDropItemBackGwidget_C*      DropWRef                                                         (Parm, OutParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)

void USC_Respirator_C::GetDropWidget(class UDropItemBackGwidget_C** DropWRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_Respirator_C", "GetDropWidget");

	Params::USC_Respirator_C_GetDropWidget_Params Parms{};
...
// Function SC_Respirator.SC_Respirator_C.GetContainerByAttachmentType
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void USC_Respirator_C::GetContainerByAttachmentType(enum class EAttachmentType Type, class UJSIContainer_C** JigContainer, int32* ContainerIndex, enum class EAttachmentType Temp_byte_Variable, class UJSIContainer_C* Temp_object_Variable, class UJSIContainer_C* Temp_object_Variable_1, class UJSIContainer_C* Temp_object_Variable_2, class UJSIContainer_C* Temp_object_Variable_3, class UJSIContainer_C* Temp_object_Variable_4, class UJSIContainer_C* Temp_object_Variable_5, class UJSIContainer_C* Temp_object_Variable_6, class UJSIContainer_C* Temp_object_Variable_7, class UJSIContainer_C* Temp_object_Variable_8, TArray<class UJSIContainer_C*>& CallFunc_GetListOfContainers_Containers, class UJSIContainer_C* K2Node_Select_Default, int32 CallFunc_Array_Find_ReturnValue)
{
	...
	if (!Func)
		Func = Class->GetFunction("SC_Respirator_C", "GetContainerByAttachmentType");

	Params::USC_Respirator_C_GetContainerByAttachmentType_Params Parms{};
...
// Function SC_Respirator.SC_Respirator_C.GetListOfContainers
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// TArray<class UJSIContainer_C*>     Containers                                                       (Parm, OutParm, ContainsInstancedReference)
// TArray<class UJSIContainer_C*>     K2Node_MakeArray_Array                                           (ReferenceParm, ContainsInstancedReference)

void USC_Respirator_C::GetListOfContainers(TArray<class UJSIContainer_C*>* Containers, TArray<class UJSIContainer_C*>& K2Node_MakeArray_Array)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_Respirator_C", "GetListOfContainers");

	Params::USC_Respirator_C_GetListOfContainers_Params Parms{};
...
// Function SC_Respirator.SC_Respirator_C.GetIDIfEquipped
...
void USC_Respirator_C::GetIDIfEquipped(class UJSIContainer_C* Container, class FName* ItemId, bool CallFunc_GetEquippedItemRef_Found_, class UJSI_Slot_C* CallFunc_GetEquippedItemRef_ItemRef, class FName CallFunc_GetItemID_ItemID)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_Respirator_C", "GetIDIfEquipped");

	Params::USC_Respirator_C_GetIDIfEquipped_Params Parms{};
...
// Function SC_Respirator.SC_Respirator_C.SetActorOwner
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AActor*                      ActorRef                                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void USC_Respirator_C::SetActorOwner(class AActor* ActorRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_Respirator_C", "SetActorOwner");

	Params::USC_Respirator_C_SetActorOwner_Params Parms{};
...
// Function SC_Respirator.SC_Respirator_C.JSICheckStatus
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:

void USC_Respirator_C::JSICheckStatus()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_Respirator_C", "JSICheckStatus");
...
// Function SC_Respirator.SC_Respirator_C.JSIOnWeightUpdated
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// double                             NewWeight                                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void USC_Respirator_C::JSIOnWeightUpdated(double NewWeight)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_Respirator_C", "JSIOnWeightUpdated");

	Params::USC_Respirator_C_JSIOnWeightUpdated_Params Parms{};
...
// Function SC_Respirator.SC_Respirator_C.SetItemReference
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void USC_Respirator_C::SetItemReference(class UJSI_Slot_C* ItemRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_Respirator_C", "SetItemReference");

	Params::USC_Respirator_C_SetItemReference_Params Parms{};
...
// Function SC_Respirator.SC_Respirator_C.EventOnAttachmentEquipped
...
void USC_Respirator_C::EventOnAttachmentEquipped(class UJSIContainer_C* FromContainer, class UJSIContainer_C* ToContainer, class UJSI_Slot_C* SlotRef, bool Equipped_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_Respirator_C", "EventOnAttachmentEquipped");

	Params::USC_Respirator_C_EventOnAttachmentEquipped_Params Parms{};
...
// Function SC_Respirator.SC_Respirator_C.UpdateSnap
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void USC_Respirator_C::UpdateSnap()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_Respirator_C", "UpdateSnap");
...
void USC_Respirator_C::ExecuteUbergraph_SC_Respirator(int32 EntryPoint, class AActor* K2Node_Event_ActorRef, double K2Node_Event_NewWeight, class UJSI_Slot_C* K2Node_Event_ItemRef, class UJSIContainer_C* K2Node_CustomEvent_FromContainer, class UJSIContainer_C* K2Node_CustomEvent_ToContainer, class UJSI_Slot_C* K2Node_CustomEvent_SlotRef, bool K2Node_CustomEvent_Equipped_, bool CallFunc_IsValid_ReturnValue, class UBP_InspectorWindowWidget_C* K2Node_DynamicCast_AsBP_Inspector_Window_Widget, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsVisible_ReturnValue, class AGameStateBase* CallFunc_GetGameState_ReturnValue, TScriptInterface<class IIT_ItemSnapCaptor_C> K2Node_DynamicCast_AsIT_Item_Snap_Captor, bool K2Node_DynamicCast_bSuccess_1, bool CallFunc_IsPendingSnap__PendingSnap, bool CallFunc_AddItemToQueue_Result, bool CallFunc_IsValid_ReturnValue_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class APawn* CallFunc_GetPlayerPawn_ReturnValue, TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface, bool K2Node_DynamicCast_bSuccess_2, bool CallFunc_OnSpecialContainerattachmentUpdated_Result)
{
	...
	Params::USC_Respirator_C_ExecuteUbergraph_SC_Respirator_Params Parms{};
