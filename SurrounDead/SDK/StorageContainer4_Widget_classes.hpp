...
public:
	...
	void ExecuteUbergraph_StorageContainer4_Widget(int32 EntryPoint, double K2Node_Event_NewWeight, class UJSI_Slot_C* K2Node_Event_ItemRef, class AActor* K2Node_Event_ActorRef);
};
