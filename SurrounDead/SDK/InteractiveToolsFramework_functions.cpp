...
class UClass* IInteractiveToolEditorGizmoAPI::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class IInteractiveToolEditorGizmoAPI* IInteractiveToolEditorGizmoAPI::GetDefaultObj()
{
	static class IInteractiveToolEditorGizmoAPI* Default = nullptr;

	if (!Default)
		Default = static_cast<IInteractiveToolEditorGizmoAPI*>(IInteractiveToolEditorGizmoAPI::StaticClass()->DefaultObject);
