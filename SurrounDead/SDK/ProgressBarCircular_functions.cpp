...
void UProgressBarCircular_C::GetEntryIndex(int32 Index, double* Value)
{
	static class UFunction* Func = nullptr;
...
// double                             CallFunc_GetTargetPercent_TargetPercent                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UProgressBarCircular_C::PB_GetTargetPercent(double* TargetPercent, double CallFunc_GetTargetPercent_TargetPercent)
{
	static class UFunction* Func = nullptr;
...
void UProgressBarCircular_C::PB_GetPercent(double* Percent, double CallFunc_GetPercent_Percent)
{
	static class UFunction* Func = nullptr;
...
void UProgressBarCircular_C::Count_Percent(double Time, double* Value, bool Temp_bool_Variable, bool CallFunc_LessEqual_DoubleDouble_ReturnValue, bool Temp_bool_Variable_1, double Temp_real_Variable, bool Temp_bool_Variable_2, double K2Node_Select_Default, double Temp_real_Variable_1, double CallFunc_Divide_DoubleDouble_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue, bool CallFunc_Greater_DoubleDouble_ReturnValue, double CallFunc_Divide_DoubleDouble_ReturnValue_1, double K2Node_Select_Default_1, double CallFunc_Add_DoubleDouble_ReturnValue, bool CallFunc_Greater_DoubleDouble_ReturnValue_1, double K2Node_Select_Default_2)
{
	static class UFunction* Func = nullptr;
...
void UProgressBarCircular_C::Transfer_CurrentPercent(double Percent, bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UProgressBarCircular_C::Transfer_TargetPercent(double TargetPercent, bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
double UProgressBarCircular_C::GetInterpolationTime(bool Temp_bool_Variable, double Temp_real_Variable, double CallFunc_MakeLiteralDouble_ReturnValue, double K2Node_Select_Default, double CallFunc_Add_DoubleDouble_ReturnValue, double CallFunc_Add_DoubleDouble_ReturnValue_1)
{
	static class UFunction* Func = nullptr;
...
void UProgressBarCircular_C::PB_SetTargetPercent(double TargetPercent)
{
	static class UFunction* Func = nullptr;
...
void UProgressBarCircular_C::PB_SetThickness(double Thickness)
{
	static class UFunction* Func = nullptr;
...
void UProgressBarCircular_C::SetSize(double Size)
{
	static class UFunction* Func = nullptr;
...
void UProgressBarCircular_C::SetUseGradient(bool UseGradient, double GradientOpacity, enum class EGradientTypes GradientType)
{
	static class UFunction* Func = nullptr;
...
void UProgressBarCircular_C::SetTargetPercent(bool UseTargetPercent, double TargetPercent)
{
	static class UFunction* Func = nullptr;
...
void UProgressBarCircular_C::SetPercentInterpolated(double NewPercent)
{
	static class UFunction* Func = nullptr;
...
void UProgressBarCircular_C::SetThickness(double Thickness)
{
	static class UFunction* Func = nullptr;
...
void UProgressBarCircular_C::SetDensity(double Density)
{
	static class UFunction* Func = nullptr;
...
void UProgressBarCircular_C::SetFillColor(const struct FLinearColor& FillColorCurrent, double GradientPower)
{
	static class UFunction* Func = nullptr;
...
// class UTexture2D*                  CustomMarqueeMask                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void UProgressBarCircular_C::AddEntry(double NewPercent)
{
	static class UFunction* Func = nullptr;
...
// struct FS_Effects                  CallFunc_Array_Get_Item_1                                        (NoDestructor, HasGetValueTypeHash)
...
// bool                               K2Node_CustomEvent_AbsoluteFillMethod                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_Greater_DoubleDouble_ReturnValue                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// bool                               K2Node_CustomEvent_UseMarquee                                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UTexture2D*                  K2Node_CustomEvent_CustomMarqueeMask                             (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// class UWB_Effect_Circular_C*       CallFunc_Create_ReturnValue                                      (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
// class UOverlay*                    CallFunc_Array_Get_Item_2                                        (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void UProgressBarCircular_C::OnPercentChanged__DelegateSignature(double Percent)
{
	static class UFunction* Func = nullptr;
