...
struct ABuildable_CeilingLight_C_GetPickupName_Params
{
public:
...
struct ABuildable_CeilingLight_C_LightCallback_Params
{
public:
...
struct ABuildable_CeilingLight_C_BndEvt__BP_CookingStation_AIOSubject_K2Node_ComponentBoundEvent_0_OnOptimizationUpdate__DelegateSignature_Params
{
public:
...
struct ABuildable_CeilingLight_C_ExecuteUbergraph_Buildable_CeilingLight_Params
{
public:
	...
	uint8                                        Pad_26AC[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
