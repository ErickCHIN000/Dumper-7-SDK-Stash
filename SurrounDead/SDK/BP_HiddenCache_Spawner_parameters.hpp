...
struct ABP_HiddenCache_Spawner_C_ExecuteUbergraph_BP_HiddenCache_Spawner_Params
{
public:
	...
	class AContainer_HiddenCache_C*              CallFunc_FinishSpawningActor_ReturnValue;          // 0xA8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
