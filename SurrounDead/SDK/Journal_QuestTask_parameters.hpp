...
struct UJournal_QuestTask_C_Tick_Params
{
public:
...
struct UJournal_QuestTask_C_ExecuteUbergraph_Journal_QuestTask_Params
{
public:
	...
	class FText                                  CallFunc_GetTaskDescription_ReturnValue;           // 0xE8(0x18)(None)
	...
	class FText                                  CallFunc_GetTaskProgressText_ReturnValue;          // 0x1C8(0x18)(None)
	...
	bool                                         CallFunc_GreaterEqual_IntInt_ReturnValue;          // 0x2C4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_127D[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	float                                        CallFunc_SetRenderOpacity_InOpacity_ImplicitCast;  // 0x2C8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_SetRenderOpacity_InOpacity_ImplicitCast_1; // 0x2CC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
