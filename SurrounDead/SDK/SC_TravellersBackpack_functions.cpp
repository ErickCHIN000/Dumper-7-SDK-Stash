...
// WidgetBlueprintGeneratedClass SC_TravellersBackpack.SC_TravellersBackpack_C
// (None)

class UClass* USC_TravellersBackpack_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("SC_TravellersBackpack_C");

	return Clss;
}


// SC_TravellersBackpack_C SC_TravellersBackpack.Default__SC_TravellersBackpack_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class USC_TravellersBackpack_C* USC_TravellersBackpack_C::GetDefaultObj()
{
	static class USC_TravellersBackpack_C* Default = nullptr;

	if (!Default)
		Default = static_cast<USC_TravellersBackpack_C*>(USC_TravellersBackpack_C::StaticClass()->DefaultObject);
...
void USC_TravellersBackpack_C::SetActionbarFollower(class UJSI_Slot_C* JigRef, bool* Return)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_TravellersBackpack_C", "SetActionbarFollower");

	Params::USC_TravellersBackpack_C_SetActionbarFollower_Params Parms{};
...
void USC_TravellersBackpack_C::GetListOfContainers(TArray<class UJSIContainer_C*>* Containers, TArray<class UJSIContainer_C*>& K2Node_MakeArray_Array)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_TravellersBackpack_C", "GetListOfContainers");

	Params::USC_TravellersBackpack_C_GetListOfContainers_Params Parms{};
...
void USC_TravellersBackpack_C::GetContainerByAttachmentType(enum class EAttachmentType Type, class UJSIContainer_C** JigContainer, int32* ContainerIndex)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_TravellersBackpack_C", "GetContainerByAttachmentType");

	Params::USC_TravellersBackpack_C_GetContainerByAttachmentType_Params Parms{};
...
void USC_TravellersBackpack_C::GetDropWidget(class UDropItemBackGwidget_C** DropWRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_TravellersBackpack_C", "GetDropWidget");

	Params::USC_TravellersBackpack_C_GetDropWidget_Params Parms{};
...
void USC_TravellersBackpack_C::GetJSIContainerByPlayerSlots(enum class EPlayerSlots Slot, class UJSIContainer_C** Container, class UJSI_Slot_C** EquippedItem, bool* IsPending_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_TravellersBackpack_C", "GetJSIContainerByPlayerSlots");

	Params::USC_TravellersBackpack_C_GetJSIContainerByPlayerSlots_Params Parms{};
...
void USC_TravellersBackpack_C::GetListOfNonAddContainers(TArray<class UJSIContainer_C*>* Containers)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_TravellersBackpack_C", "GetListOfNonAddContainers");

	Params::USC_TravellersBackpack_C_GetListOfNonAddContainers_Params Parms{};
...
void USC_TravellersBackpack_C::GetAllAttachments(TArray<class FName>* Attachments)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_TravellersBackpack_C", "GetAllAttachments");

	Params::USC_TravellersBackpack_C_GetAllAttachments_Params Parms{};
...
void USC_TravellersBackpack_C::SetActorOwner(class AActor* ActorRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_TravellersBackpack_C", "SetActorOwner");

	Params::USC_TravellersBackpack_C_SetActorOwner_Params Parms{};
...
// Function SC_TravellersBackpack.SC_TravellersBackpack_C.JSICheckStatus
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:

void USC_TravellersBackpack_C::JSICheckStatus()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_TravellersBackpack_C", "JSICheckStatus");
...
void USC_TravellersBackpack_C::JSIOnWeightUpdated(double NewWeight)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_TravellersBackpack_C", "JSIOnWeightUpdated");

	Params::USC_TravellersBackpack_C_JSIOnWeightUpdated_Params Parms{};
...
void USC_TravellersBackpack_C::SetItemReference(class UJSI_Slot_C* ItemRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_TravellersBackpack_C", "SetItemReference");

	Params::USC_TravellersBackpack_C_SetItemReference_Params Parms{};
...
void USC_TravellersBackpack_C::Event_Callback(bool NewValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_TravellersBackpack_C", "Event_Callback");

	Params::USC_TravellersBackpack_C_Event_Callback_Params Parms{};
...
void USC_TravellersBackpack_C::ExecuteUbergraph_SC_TravellersBackpack(int32 EntryPoint, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class AActor* K2Node_Event_ActorRef, double K2Node_Event_NewWeight, class UJSI_Slot_C* K2Node_Event_ItemRef, bool K2Node_CustomEvent_NewValue, bool CallFunc_Not_PreBool_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_TravellersBackpack_C", "ExecuteUbergraph_SC_TravellersBackpack");

	Params::USC_TravellersBackpack_C_ExecuteUbergraph_SC_TravellersBackpack_Params Parms{};
