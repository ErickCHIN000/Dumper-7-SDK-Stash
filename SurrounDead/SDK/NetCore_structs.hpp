...
{
public:
	uint8                                        Pad_16B[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_17C[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_185[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_190[0x54];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_192[0xA8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
