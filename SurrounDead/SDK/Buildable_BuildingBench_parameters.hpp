...
struct ABuildable_BuildingBench_C_OnInteractBuildable_Params
{
public:
...
struct ABuildable_BuildingBench_C_BndEvt__BP_CookingStation_AIOSubject_K2Node_ComponentBoundEvent_0_OnOptimizationUpdate__DelegateSignature_Params
{
public:
...
struct ABuildable_BuildingBench_C_ExecuteUbergraph_Buildable_BuildingBench_Params
{
public:
	...
	class UBP_BuildableBuildCraftingWidget_C*    K2Node_DynamicCast_AsBP_Buildable_Build_Crafting_Widget; // 0x10(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_1B6[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
