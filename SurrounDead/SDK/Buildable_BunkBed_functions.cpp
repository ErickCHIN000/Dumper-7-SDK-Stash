...
// BlueprintGeneratedClass Buildable_BunkBed.Buildable_BunkBed_C
// (Actor)

class UClass* ABuildable_BunkBed_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Buildable_BunkBed_C");

	return Clss;
}


// Buildable_BunkBed_C Buildable_BunkBed.Default__Buildable_BunkBed_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABuildable_BunkBed_C* ABuildable_BunkBed_C::GetDefaultObj()
{
	static class ABuildable_BunkBed_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABuildable_BunkBed_C*>(ABuildable_BunkBed_C::StaticClass()->DefaultObject);
...
void ABuildable_BunkBed_C::SetSpawnPoint(class ABP_MPPlayerController_C* CallFunc_CastToController_Controller, const struct FTransform& CallFunc_K2_GetComponentToWorld_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Buildable_BunkBed_C", "SetSpawnPoint");

	Params::ABuildable_BunkBed_C_SetSpawnPoint_Params Parms{};
...
// Function Buildable_BunkBed.Buildable_BunkBed_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ABuildable_BunkBed_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Buildable_BunkBed_C", "ReceiveBeginPlay");
...
void ABuildable_BunkBed_C::OnServerExecuteInteract(int32 OptionIndex, class AActor* ByActor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Buildable_BunkBed_C", "OnServerExecuteInteract");

	Params::ABuildable_BunkBed_C_OnServerExecuteInteract_Params Parms{};
...
// Function Buildable_BunkBed.Buildable_BunkBed_C.OnEndInteract
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:

void ABuildable_BunkBed_C::OnEndInteract()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Buildable_BunkBed_C", "OnEndInteract");
...
void ABuildable_BunkBed_C::OnBeginInteract(class AActor* InteractingActor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Buildable_BunkBed_C", "OnBeginInteract");

	Params::ABuildable_BunkBed_C_OnBeginInteract_Params Parms{};
...
void ABuildable_BunkBed_C::BndEvt__BP_CookingStation_AIOSubject_K2Node_ComponentBoundEvent_0_OnOptimizationUpdate__DelegateSignature(bool bIsBeyondLastLayer, int32 LayerIndex, bool bIsSeen)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Buildable_BunkBed_C", "BndEvt__BP_CookingStation_AIOSubject_K2Node_ComponentBoundEvent_0_OnOptimizationUpdate__DelegateSignature");

	Params::ABuildable_BunkBed_C_BndEvt__BP_CookingStation_AIOSubject_K2Node_ComponentBoundEvent_0_OnOptimizationUpdate__DelegateSignature_Params Parms{};
