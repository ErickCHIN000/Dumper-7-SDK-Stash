...
// WidgetBlueprintGeneratedClass BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C
// (None)

class UClass* UBP_BuildableCookingStationWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_BuildableCookingStationWidget_C");

	return Clss;
}


// BP_BuildableCookingStationWidget_C BP_BuildableCookingStationWidget.Default__BP_BuildableCookingStationWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_BuildableCookingStationWidget_C* UBP_BuildableCookingStationWidget_C::GetDefaultObj()
{
	static class UBP_BuildableCookingStationWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_BuildableCookingStationWidget_C*>(UBP_BuildableCookingStationWidget_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.SetActionbarFollower
...
void UBP_BuildableCookingStationWidget_C::SetActionbarFollower(class UJSI_Slot_C* JigRef, bool* Return)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "SetActionbarFollower");

	Params::UBP_BuildableCookingStationWidget_C_SetActionbarFollower_Params Parms{};
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.GetListOfContainers
...
void UBP_BuildableCookingStationWidget_C::GetListOfContainers(TArray<class UJSIContainer_C*>* Containers, TArray<class UJSIContainer_C*>& K2Node_MakeArray_Array)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "GetListOfContainers");

	Params::UBP_BuildableCookingStationWidget_C_GetListOfContainers_Params Parms{};
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.GetContainerByAttachmentType
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void UBP_BuildableCookingStationWidget_C::GetContainerByAttachmentType(enum class EAttachmentType Type, class UJSIContainer_C** JigContainer, int32* ContainerIndex)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "GetContainerByAttachmentType");

	Params::UBP_BuildableCookingStationWidget_C_GetContainerByAttachmentType_Params Parms{};
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.GetDropWidget
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UDropItemBackGwidget_C*      DropWRef                                                         (Parm, OutParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)

void UBP_BuildableCookingStationWidget_C::GetDropWidget(class UDropItemBackGwidget_C** DropWRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "GetDropWidget");

	Params::UBP_BuildableCookingStationWidget_C_GetDropWidget_Params Parms{};
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.GetJSIContainerByPlayerSlots
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void UBP_BuildableCookingStationWidget_C::GetJSIContainerByPlayerSlots(enum class EPlayerSlots Slot, class UJSIContainer_C** Container, class UJSI_Slot_C** EquippedItem, bool* IsPending_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "GetJSIContainerByPlayerSlots");

	Params::UBP_BuildableCookingStationWidget_C_GetJSIContainerByPlayerSlots_Params Parms{};
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.GetListOfNonAddContainers
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// TArray<class UJSIContainer_C*>     Containers                                                       (Parm, OutParm, ContainsInstancedReference)

void UBP_BuildableCookingStationWidget_C::GetListOfNonAddContainers(TArray<class UJSIContainer_C*>* Containers)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "GetListOfNonAddContainers");

	Params::UBP_BuildableCookingStationWidget_C_GetListOfNonAddContainers_Params Parms{};
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.GetAllAttachments
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// TArray<class FName>                Attachments                                                      (Parm, OutParm)

void UBP_BuildableCookingStationWidget_C::GetAllAttachments(TArray<class FName>* Attachments)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "GetAllAttachments");

	Params::UBP_BuildableCookingStationWidget_C_GetAllAttachments_Params Parms{};
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.GetText
...
class FText UBP_BuildableCookingStationWidget_C::GetText(class FText CallFunc_Conv_IntToText_ReturnValue, class FText CallFunc_Append_Text_Return_Value, class FText CallFunc_Append_Text_Return_Value_1)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "GetText");

	Params::UBP_BuildableCookingStationWidget_C_GetText_Params Parms{};
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.CheckIfCountButNotStack
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.CheckIngredientsAvailability
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void UBP_BuildableCookingStationWidget_C::CheckIngredientsAvailability(bool* Proceed, const struct FRepItemInfo& CurrentInfo, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Array_Index_Variable_1, int32 Temp_int_Loop_Counter_Variable_1, int32 CallFunc_Add_IntInt_ReturnValue_1, int32 CallFunc_Array_Length_ReturnValue, const struct FRepItemInfo& CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue, const struct FRepItemInfo& K2Node_MakeStruct_RepItemInfo, TArray<class UJSI_Slot_C*>& CallFunc_CheckCraftingIngredients_ItemFound_Element, bool CallFunc_Array_IsValidIndex_ReturnValue, class UJSI_Slot_C* CallFunc_Array_Get_Item_1, int32 CallFunc_GetUniqueID_UniqueServerID, int32 CallFunc_Array_Length_ReturnValue_1, int32 CallFunc_Array_Add_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue_1)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "CheckIngredientsAvailability");

	Params::UBP_BuildableCookingStationWidget_C_CheckIngredientsAvailability_Params Parms{};
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.AddRequiredItems
...
void UBP_BuildableCookingStationWidget_C::AddRequiredItems(const struct FRepItemInfo& CurrentInfo, bool CanCraft_, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable_1, int32 Temp_int_Loop_Counter_Variable_1, int32 CallFunc_Add_IntInt_ReturnValue_1, int32 CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, const struct FRepItemInfo& CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Multiply_IntInt_ReturnValue, bool CallFunc_AddNewInventoryItem_Added, int32 CallFunc_AddNewInventoryItem_SlotIndex, const struct FFItemInfo& CallFunc_AddNewInventoryItem_ItemInfo, class UJSI_Slot_C* CallFunc_AddNewInventoryItem_SlotItemRef, bool CallFunc_AddNewInventoryItem_Stacked_, const struct FRepItemInfo& K2Node_MakeStruct_RepItemInfo, TArray<class UJSI_Slot_C*>& CallFunc_CheckCraftingIngredients_ItemFound_Element, bool CallFunc_Array_IsValidIndex_ReturnValue, class UJSI_Slot_C* CallFunc_Array_Get_Item_1, int32 CallFunc_GetUniqueID_UniqueServerID, int32 CallFunc_Array_Length_ReturnValue_1, int32 CallFunc_Array_Add_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue_1)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "AddRequiredItems");

	Params::UBP_BuildableCookingStationWidget_C_AddRequiredItems_Params Parms{};
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.InitializeInventory
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.SetItemReference
...
void UBP_BuildableCookingStationWidget_C::SetItemReference(class UJSI_Slot_C* ItemRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "SetItemReference");

	Params::UBP_BuildableCookingStationWidget_C_SetItemReference_Params Parms{};
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.SetActorOwner
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AActor*                      ActorRef                                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UBP_BuildableCookingStationWidget_C::SetActorOwner(class AActor* ActorRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "SetActorOwner");

	Params::UBP_BuildableCookingStationWidget_C_SetActorOwner_Params Parms{};
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.JSICheckStatus
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:

void UBP_BuildableCookingStationWidget_C::JSICheckStatus()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "JSICheckStatus");
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.JSIOnWeightUpdated
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// double                             NewWeight                                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_BuildableCookingStationWidget_C::JSIOnWeightUpdated(double NewWeight)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "JSIOnWeightUpdated");

	Params::UBP_BuildableCookingStationWidget_C_JSIOnWeightUpdated_Params Parms{};
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.BindEvents
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UBP_BuildableCookingStationWidget_C::BindEvents()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "BindEvents");
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.EventOnMouseButtonDown
// (BlueprintCallable, BlueprintEvent)
// Parameters:
...
void UBP_BuildableCookingStationWidget_C::EventOnMouseButtonDown(class UJSIContainer_C* Container, class UJSI_Slot_C* SlotRef, const struct FKey& Button)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "EventOnMouseButtonDown");

	Params::UBP_BuildableCookingStationWidget_C_EventOnMouseButtonDown_Params Parms{};
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.BndEvt__Button_81_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature
// (BlueprintEvent)
// Parameters:

void UBP_BuildableCookingStationWidget_C::BndEvt__Button_81_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "BndEvt__Button_81_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.Construct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)
// Parameters:

void UBP_BuildableCookingStationWidget_C::Construct()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "Construct");
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.BndEvt__BP_CraftingWidget_Button_Decrease_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature
// (BlueprintEvent)
// Parameters:

void UBP_BuildableCookingStationWidget_C::BndEvt__BP_CraftingWidget_Button_Decrease_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "BndEvt__BP_CraftingWidget_Button_Decrease_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature");
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.BndEvt__BP_CraftingWidget_Button_Increase_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature
// (BlueprintEvent)
// Parameters:

void UBP_BuildableCookingStationWidget_C::BndEvt__BP_CraftingWidget_Button_Increase_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "BndEvt__BP_CraftingWidget_Button_Increase_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature");
...
// Function BP_BuildableCookingStationWidget.BP_BuildableCookingStationWidget_C.ExecuteUbergraph_BP_BuildableCookingStationWidget
...
void UBP_BuildableCookingStationWidget_C::ExecuteUbergraph_BP_BuildableCookingStationWidget(int32 EntryPoint, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, int32 Temp_int_Variable, int32 Temp_int_Variable_1, int32 CallFunc_Add_IntInt_ReturnValue, class UJSI_Slot_C* K2Node_Event_ItemRef, class AActor* K2Node_Event_ActorRef, double K2Node_Event_NewWeight, class UJSIContainer_C* K2Node_CustomEvent_Container, class UJSI_Slot_C* K2Node_CustomEvent_SlotRef, const struct FKey& K2Node_CustomEvent_Button, bool CallFunc_EqualEqual_KeyKey_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool Temp_bool_IsClosed_Variable, bool CallFunc_CheckIngredientsAvailability_Proceed, bool CallFunc_CheckIngredientsAvailability_Proceed_1, bool CallFunc_Greater_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue_1, int32 Temp_int_Variable_2, int32 CallFunc_Subtract_IntInt_ReturnValue, bool CallFunc_GetIsEnabled_ReturnValue, bool Temp_bool_Has_Been_Initd_Variable, int32 CallFunc_Multiply_IntInt_ReturnValue, bool CallFunc_LessEqual_IntInt_ReturnValue, const struct FRepItemInfo& K2Node_MakeStruct_RepItemInfo, class UJSI_Slot_C* CallFunc_JigTryAddGetPendingRef_OutputPin, bool CallFunc_isRotated__ReturnValue, int32 CallFunc_GetUniqueID_UniqueServerID, bool CallFunc_IsValid_ReturnValue_1, class ULevellingComponent_C* CallFunc_GetLevellingComponent_LevellingComponent, double CallFunc_Multiply_IntFloat_ReturnValue, bool CallFunc_IsValid_ReturnValue_2, double CallFunc_AddXP_XPOutput, int32 CallFunc_FTrunc_ReturnValue, int64 CallFunc_Conv_IntToInt64_ReturnValue, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, class FText CallFunc_Format_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableCookingStationWidget_C", "ExecuteUbergraph_BP_BuildableCookingStationWidget");

	Params::UBP_BuildableCookingStationWidget_C_ExecuteUbergraph_BP_BuildableCookingStationWidget_Params Parms{};
