...
class UBP_CreditsVendorWidget_C : public UUserWidget
{
public:
	...
	static class UBP_CreditsVendorWidget_C* GetDefaultObj();
	...
	void ExecuteUbergraph_BP_CreditsVendorWidget(int32 EntryPoint, double K2Node_Event_NewWeight, class UJSI_Slot_C* K2Node_Event_ItemRef, class AActor* K2Node_Event_ActorRef);
};
