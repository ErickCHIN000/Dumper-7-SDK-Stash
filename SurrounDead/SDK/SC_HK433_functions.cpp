...
// WidgetBlueprintGeneratedClass SC_HK433.SC_HK433_C
// (None)

class UClass* USC_HK433_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("SC_HK433_C");

	return Clss;
}


// SC_HK433_C SC_HK433.Default__SC_HK433_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class USC_HK433_C* USC_HK433_C::GetDefaultObj()
{
	static class USC_HK433_C* Default = nullptr;

	if (!Default)
		Default = static_cast<USC_HK433_C*>(USC_HK433_C::StaticClass()->DefaultObject);

	return Default;
}


// Function SC_HK433.SC_HK433_C.SetActionbarFollower
...
void USC_HK433_C::SetActionbarFollower(class UJSI_Slot_C* JigRef, bool* Return)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_HK433_C", "SetActionbarFollower");

	Params::USC_HK433_C_SetActionbarFollower_Params Parms{};
...
// Function SC_HK433.SC_HK433_C.GetAllAttachments
...
void USC_HK433_C::GetAllAttachments(TArray<class FName>* Attachments, const TArray<class FName>& AllAtt, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, TArray<class UJSIContainer_C*>& K2Node_MakeArray_Array, int32 CallFunc_Array_Length_ReturnValue, class UJSIContainer_C* CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue, bool CallFunc_GetEquippedItemRef_Found_, class UJSI_Slot_C* CallFunc_GetEquippedItemRef_ItemRef, class FName CallFunc_GetItemID_ItemID, int32 CallFunc_Array_Add_ReturnValue)
{
	...
	if (!Func)
		Func = Class->GetFunction("SC_HK433_C", "GetAllAttachments");

	Params::USC_HK433_C_GetAllAttachments_Params Parms{};
...
// Function SC_HK433.SC_HK433_C.GetListOfNonAddContainers
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// TArray<class UJSIContainer_C*>     Containers                                                       (Parm, OutParm, ContainsInstancedReference)

void USC_HK433_C::GetListOfNonAddContainers(TArray<class UJSIContainer_C*>* Containers)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_HK433_C", "GetListOfNonAddContainers");

	Params::USC_HK433_C_GetListOfNonAddContainers_Params Parms{};
...
// Function SC_HK433.SC_HK433_C.GetJSIContainerByPlayerSlots
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void USC_HK433_C::GetJSIContainerByPlayerSlots(enum class EPlayerSlots Slot, class UJSIContainer_C** Container, class UJSI_Slot_C** EquippedItem, bool* IsPending_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_HK433_C", "GetJSIContainerByPlayerSlots");

	Params::USC_HK433_C_GetJSIContainerByPlayerSlots_Params Parms{};
...
// Function SC_HK433.SC_HK433_C.GetDropWidget
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UDropItemBackGwidget_C*      DropWRef                                                         (Parm, OutParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)

void USC_HK433_C::GetDropWidget(class UDropItemBackGwidget_C** DropWRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_HK433_C", "GetDropWidget");

	Params::USC_HK433_C_GetDropWidget_Params Parms{};
...
// Function SC_HK433.SC_HK433_C.GetContainerByAttachmentType
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void USC_HK433_C::GetContainerByAttachmentType(enum class EAttachmentType Type, class UJSIContainer_C** JigContainer, int32* ContainerIndex, enum class EAttachmentType Temp_byte_Variable, class UJSIContainer_C* Temp_object_Variable, class UJSIContainer_C* Temp_object_Variable_1, class UJSIContainer_C* Temp_object_Variable_2, class UJSIContainer_C* Temp_object_Variable_3, class UJSIContainer_C* Temp_object_Variable_4, TArray<class UJSIContainer_C*>& CallFunc_GetListOfContainers_Containers, class UJSIContainer_C* K2Node_Select_Default, int32 CallFunc_Array_Find_ReturnValue)
{
	...
	if (!Func)
		Func = Class->GetFunction("SC_HK433_C", "GetContainerByAttachmentType");

	Params::USC_HK433_C_GetContainerByAttachmentType_Params Parms{};
...
// Function SC_HK433.SC_HK433_C.GetListOfContainers
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// TArray<class UJSIContainer_C*>     Containers                                                       (Parm, OutParm, ContainsInstancedReference)
// TArray<class UJSIContainer_C*>     K2Node_MakeArray_Array                                           (ReferenceParm, ContainsInstancedReference)

void USC_HK433_C::GetListOfContainers(TArray<class UJSIContainer_C*>* Containers, TArray<class UJSIContainer_C*>& K2Node_MakeArray_Array)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_HK433_C", "GetListOfContainers");

	Params::USC_HK433_C_GetListOfContainers_Params Parms{};
...
// Function SC_HK433.SC_HK433_C.GetIDIfEquipped
...
void USC_HK433_C::GetIDIfEquipped(class UJSIContainer_C* Container, class FName* ItemId, bool CallFunc_GetEquippedItemRef_Found_, class UJSI_Slot_C* CallFunc_GetEquippedItemRef_ItemRef, class FName CallFunc_GetItemID_ItemID)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_HK433_C", "GetIDIfEquipped");

	Params::USC_HK433_C_GetIDIfEquipped_Params Parms{};
...
// Function SC_HK433.SC_HK433_C.SetActorOwner
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AActor*                      ActorRef                                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void USC_HK433_C::SetActorOwner(class AActor* ActorRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_HK433_C", "SetActorOwner");

	Params::USC_HK433_C_SetActorOwner_Params Parms{};
...
// Function SC_HK433.SC_HK433_C.JSIOnWeightUpdated
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// double                             NewWeight                                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void USC_HK433_C::JSIOnWeightUpdated(double NewWeight)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_HK433_C", "JSIOnWeightUpdated");

	Params::USC_HK433_C_JSIOnWeightUpdated_Params Parms{};
...
// Function SC_HK433.SC_HK433_C.SetItemReference
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void USC_HK433_C::SetItemReference(class UJSI_Slot_C* ItemRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_HK433_C", "SetItemReference");

	Params::USC_HK433_C_SetItemReference_Params Parms{};
...
// Function SC_HK433.SC_HK433_C.DropInfo_OnItemEquippedChange_Event_0
...
void USC_HK433_C::DropInfo_OnItemEquippedChange_Event_0(class UJSIContainer_C* FromContainer, class UJSIContainer_C* ToContainer, class UJSI_Slot_C* SlotRef, bool Equipped_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_HK433_C", "DropInfo_OnItemEquippedChange_Event_0");

	Params::USC_HK433_C_DropInfo_OnItemEquippedChange_Event_0_Params Parms{};
...
// Function SC_HK433.SC_HK433_C.JSICheckStatus
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:

void USC_HK433_C::JSICheckStatus()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_HK433_C", "JSICheckStatus");
...
// Function SC_HK433.SC_HK433_C.EventOnAttachmentEquipped
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class UJSIContainer_C*             FromContainer                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// class UJSIContainer_C*             ToContainer                                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void USC_HK433_C::EventOnAttachmentEquipped(class UJSIContainer_C* FromContainer, class UJSIContainer_C* ToContainer, class UJSI_Slot_C* SlotRef, bool Equipped_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_HK433_C", "EventOnAttachmentEquipped");

	Params::USC_HK433_C_EventOnAttachmentEquipped_Params Parms{};
...
// Function SC_HK433.SC_HK433_C.DropInfo_OnItemEquippedChange_Event_1
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class UJSIContainer_C*             FromContainer                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// class UJSIContainer_C*             ToContainer                                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void USC_HK433_C::DropInfo_OnItemEquippedChange_Event_1(class UJSIContainer_C* FromContainer, class UJSIContainer_C* ToContainer, class UJSI_Slot_C* SlotRef, bool Equipped_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_HK433_C", "DropInfo_OnItemEquippedChange_Event_1");

	Params::USC_HK433_C_DropInfo_OnItemEquippedChange_Event_1_Params Parms{};
...
// Function SC_HK433.SC_HK433_C.OnHandguardEquipped
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class UJSIContainer_C*             FromContainer                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// class UJSIContainer_C*             ToContainer                                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void USC_HK433_C::OnHandguardEquipped(class UJSIContainer_C* FromContainer, class UJSIContainer_C* ToContainer, class UJSI_Slot_C* SlotRef, bool Equipped_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_HK433_C", "OnHandguardEquipped");

	Params::USC_HK433_C_OnHandguardEquipped_Params Parms{};
...
// Function SC_HK433.SC_HK433_C.UpdateSnap
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void USC_HK433_C::UpdateSnap()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_HK433_C", "UpdateSnap");
...
// Function SC_HK433.SC_HK433_C.OnHandguardAttachment
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class UJSIContainer_C*             FromContainer                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// class UJSIContainer_C*             ToContainer                                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void USC_HK433_C::OnHandguardAttachment(class UJSIContainer_C* FromContainer, class UJSIContainer_C* ToContainer, class UJSI_Slot_C* SlotRef, bool Equipped_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_HK433_C", "OnHandguardAttachment");

	Params::USC_HK433_C_OnHandguardAttachment_Params Parms{};
...
// Function SC_HK433.SC_HK433_C.ExecuteUbergraph_SC_HK433
