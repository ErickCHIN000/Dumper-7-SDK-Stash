...
public:
	...
	uint8                                        Pad_1104[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1110[0x74];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1121[0x270];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1124[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1177[0x70];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_117D[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_118F[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
