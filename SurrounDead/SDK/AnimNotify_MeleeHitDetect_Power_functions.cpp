...
class UClass* UAnimNotify_MeleeHitDetect_Power_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AnimNotify_MeleeHitDetect_Power_C");

	return Clss;
}


// AnimNotify_MeleeHitDetect_Power_C AnimNotify_MeleeHitDetect_Power.Default__AnimNotify_MeleeHitDetect_Power_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAnimNotify_MeleeHitDetect_Power_C* UAnimNotify_MeleeHitDetect_Power_C::GetDefaultObj()
{
	static class UAnimNotify_MeleeHitDetect_Power_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAnimNotify_MeleeHitDetect_Power_C*>(UAnimNotify_MeleeHitDetect_Power_C::StaticClass()->DefaultObject);
...
bool UAnimNotify_MeleeHitDetect_Power_C::Received_NotifyEnd(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, struct FAnimNotifyEventReference& EventReference, class AActor* CallFunc_GetOwner_ReturnValue, class ABP_PlayerCharacter_C* K2Node_DynamicCast_AsBP_Player_Character, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsValid_ReturnValue)
{
	...
	Params::UAnimNotify_MeleeHitDetect_Power_C_Received_NotifyEnd_Params Parms{};
...
bool UAnimNotify_MeleeHitDetect_Power_C::Received_NotifyBegin(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, float TotalDuration, struct FAnimNotifyEventReference& EventReference, class AActor* CallFunc_GetOwner_ReturnValue, class ABP_PlayerCharacter_C* K2Node_DynamicCast_AsBP_Player_Character, bool K2Node_DynamicCast_bSuccess, double CallFunc_GetWorldDeltaSeconds_ReturnValue, const struct FTimerHandle& CallFunc_K2_SetTimer_ReturnValue, bool CallFunc_IsValid_ReturnValue, float CallFunc_K2_SetTimer_Time_ImplicitCast)
{
	...
	Params::UAnimNotify_MeleeHitDetect_Power_C_Received_NotifyBegin_Params Parms{};
