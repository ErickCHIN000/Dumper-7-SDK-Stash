...
{
public:
	uint8                                        Pad_1084[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_10B2[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_10B8[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_10CA[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_10DE[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_10FA[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_10FD[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1122[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
