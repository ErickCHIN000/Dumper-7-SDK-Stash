...
class ABP_Marker_Death_C : public AActor
{
public:
	...
	TArray<class UW_POIMarker_C*>                Markers;                                           // 0x2F0(0x10)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)

	static class UClass* StaticClass();
	static class ABP_Marker_Death_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void AddMarker();
	void ExecuteUbergraph_BP_Marker_Death(int32 EntryPoint, class UW_POIMarker_C* CallFunc_Array_Get_Item, class APlayerController* CallFunc_GetPlayerController_ReturnValue, TArray<enum class E_MarkerType>& K2Node_MakeArray_Array, class UBPC_MinimapSystem_C* CallFunc_Get_Minimap_Component_ReturnValue, const struct FS_MarkerData& K2Node_MakeStruct_S_MarkerData, TArray<class UW_POIMarker_C*>& CallFunc_Add_POI_Marker_Markers);
};
