...
public:
	...
	uint8                                        Pad_F7E[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F9C[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	TArray<struct FConfigActionKeyMapping>       ActionMappings;                                    // 0x0(0x10)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	TArray<struct FConfigAxisKeyMapping>         AxisMappings;                                      // 0x10(0x10)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, NativeAccessSpecifierPublic)
...
{
public:
	TArray<struct FInputMappingGroup>            MappingGroups;                                     // 0x0(0x10)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, NativeAccessSpecifierPublic)
...
public:
	...
	struct FInputMappingLayout                   InputLayout;                                       // 0x10(0x20)(Edit, BlueprintVisible, BlueprintReadOnly, Config, NativeAccessSpecifierPublic)
...
public:
	...
	struct FInputMappingLayout                   MappingOverrides;                                  // 0x20(0x20)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_FC4[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
