...
// WidgetBlueprintGeneratedClass BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C
// (None)

class UClass* UBP_BuildableBuildCraftingWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_BuildableBuildCraftingWidget_C");

	return Clss;
}


// BP_BuildableBuildCraftingWidget_C BP_BuildableBuildCraftingWidget.Default__BP_BuildableBuildCraftingWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_BuildableBuildCraftingWidget_C* UBP_BuildableBuildCraftingWidget_C::GetDefaultObj()
{
	static class UBP_BuildableBuildCraftingWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_BuildableBuildCraftingWidget_C*>(UBP_BuildableBuildCraftingWidget_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.SetActionbarFollower
...
void UBP_BuildableBuildCraftingWidget_C::SetActionbarFollower(class UJSI_Slot_C* JigRef, bool* Return)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "SetActionbarFollower");

	Params::UBP_BuildableBuildCraftingWidget_C_SetActionbarFollower_Params Parms{};
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.GetListOfContainers
...
void UBP_BuildableBuildCraftingWidget_C::GetListOfContainers(TArray<class UJSIContainer_C*>* Containers, TArray<class UJSIContainer_C*>& K2Node_MakeArray_Array)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "GetListOfContainers");

	Params::UBP_BuildableBuildCraftingWidget_C_GetListOfContainers_Params Parms{};
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.GetContainerByAttachmentType
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void UBP_BuildableBuildCraftingWidget_C::GetContainerByAttachmentType(enum class EAttachmentType Type, class UJSIContainer_C** JigContainer, int32* ContainerIndex)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "GetContainerByAttachmentType");

	Params::UBP_BuildableBuildCraftingWidget_C_GetContainerByAttachmentType_Params Parms{};
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.GetDropWidget
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UDropItemBackGwidget_C*      DropWRef                                                         (Parm, OutParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)

void UBP_BuildableBuildCraftingWidget_C::GetDropWidget(class UDropItemBackGwidget_C** DropWRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "GetDropWidget");

	Params::UBP_BuildableBuildCraftingWidget_C_GetDropWidget_Params Parms{};
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.GetJSIContainerByPlayerSlots
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void UBP_BuildableBuildCraftingWidget_C::GetJSIContainerByPlayerSlots(enum class EPlayerSlots Slot, class UJSIContainer_C** Container, class UJSI_Slot_C** EquippedItem, bool* IsPending_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "GetJSIContainerByPlayerSlots");

	Params::UBP_BuildableBuildCraftingWidget_C_GetJSIContainerByPlayerSlots_Params Parms{};
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.GetListOfNonAddContainers
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// TArray<class UJSIContainer_C*>     Containers                                                       (Parm, OutParm, ContainsInstancedReference)

void UBP_BuildableBuildCraftingWidget_C::GetListOfNonAddContainers(TArray<class UJSIContainer_C*>* Containers)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "GetListOfNonAddContainers");

	Params::UBP_BuildableBuildCraftingWidget_C_GetListOfNonAddContainers_Params Parms{};
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.GetAllAttachments
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// TArray<class FName>                Attachments                                                      (Parm, OutParm)

void UBP_BuildableBuildCraftingWidget_C::GetAllAttachments(TArray<class FName>* Attachments)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "GetAllAttachments");

	Params::UBP_BuildableBuildCraftingWidget_C_GetAllAttachments_Params Parms{};
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.GetText
...
class FText UBP_BuildableBuildCraftingWidget_C::GetText(class FText CallFunc_Conv_IntToText_ReturnValue, class FText CallFunc_Append_Text_Return_Value, class FText CallFunc_Append_Text_Return_Value_1)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "GetText");

	Params::UBP_BuildableBuildCraftingWidget_C_GetText_Params Parms{};
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.CheckIfCountButNotStack
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.CheckIngredientsAvailability
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void UBP_BuildableBuildCraftingWidget_C::CheckIngredientsAvailability(bool* Proceed, const struct FRepItemInfo& CurrentInfo, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Array_Index_Variable_1, int32 Temp_int_Loop_Counter_Variable_1, int32 CallFunc_Add_IntInt_ReturnValue_1, int32 CallFunc_Array_Length_ReturnValue, const struct FRepItemInfo& CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue, const struct FRepItemInfo& K2Node_MakeStruct_RepItemInfo, TArray<class UJSI_Slot_C*>& CallFunc_CheckCraftingIngredients_ItemFound_Element, bool CallFunc_Array_IsValidIndex_ReturnValue, class UJSI_Slot_C* CallFunc_Array_Get_Item_1, int32 CallFunc_GetUniqueID_UniqueServerID, int32 CallFunc_Array_Length_ReturnValue_1, int32 CallFunc_Array_Add_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue_1)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "CheckIngredientsAvailability");

	Params::UBP_BuildableBuildCraftingWidget_C_CheckIngredientsAvailability_Params Parms{};
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.Add Required Items
...
void UBP_BuildableBuildCraftingWidget_C::Add_Required_Items(const struct FRepItemInfo& CurrentInfo, bool CanCraft_, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable_1, int32 Temp_int_Loop_Counter_Variable_1, int32 CallFunc_Add_IntInt_ReturnValue_1, int32 CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, const struct FRepItemInfo& CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Multiply_IntInt_ReturnValue, bool CallFunc_AddNewInventoryItem_Added, int32 CallFunc_AddNewInventoryItem_SlotIndex, const struct FFItemInfo& CallFunc_AddNewInventoryItem_ItemInfo, class UJSI_Slot_C* CallFunc_AddNewInventoryItem_SlotItemRef, bool CallFunc_AddNewInventoryItem_Stacked_, const struct FRepItemInfo& K2Node_MakeStruct_RepItemInfo, TArray<class UJSI_Slot_C*>& CallFunc_CheckCraftingIngredients_ItemFound_Element, bool CallFunc_Array_IsValidIndex_ReturnValue, class UJSI_Slot_C* CallFunc_Array_Get_Item_1, int32 CallFunc_GetUniqueID_UniqueServerID, int32 CallFunc_Array_Length_ReturnValue_1, int32 CallFunc_Array_Add_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue_1)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "Add Required Items");

	Params::UBP_BuildableBuildCraftingWidget_C_Add_Required_Items_Params Parms{};
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.InitializeInventory
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.SetItemReference
...
void UBP_BuildableBuildCraftingWidget_C::SetItemReference(class UJSI_Slot_C* ItemRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "SetItemReference");

	Params::UBP_BuildableBuildCraftingWidget_C_SetItemReference_Params Parms{};
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.SetActorOwner
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AActor*                      ActorRef                                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UBP_BuildableBuildCraftingWidget_C::SetActorOwner(class AActor* ActorRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "SetActorOwner");

	Params::UBP_BuildableBuildCraftingWidget_C_SetActorOwner_Params Parms{};
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.JSICheckStatus
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:

void UBP_BuildableBuildCraftingWidget_C::JSICheckStatus()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "JSICheckStatus");
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.JSIOnWeightUpdated
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// double                             NewWeight                                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_BuildableBuildCraftingWidget_C::JSIOnWeightUpdated(double NewWeight)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "JSIOnWeightUpdated");

	Params::UBP_BuildableBuildCraftingWidget_C_JSIOnWeightUpdated_Params Parms{};
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.BindEvents
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UBP_BuildableBuildCraftingWidget_C::BindEvents()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "BindEvents");
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.EventOnMouseButtonDown
// (BlueprintCallable, BlueprintEvent)
// Parameters:
...
void UBP_BuildableBuildCraftingWidget_C::EventOnMouseButtonDown(class UJSIContainer_C* Container, class UJSI_Slot_C* SlotRef, const struct FKey& Button)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "EventOnMouseButtonDown");

	Params::UBP_BuildableBuildCraftingWidget_C_EventOnMouseButtonDown_Params Parms{};
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.BndEvt__Button_81_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature
// (BlueprintEvent)
// Parameters:

void UBP_BuildableBuildCraftingWidget_C::BndEvt__Button_81_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "BndEvt__Button_81_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.Construct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)
// Parameters:

void UBP_BuildableBuildCraftingWidget_C::Construct()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "Construct");
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.BndEvt__BP_CraftingWidget_Button_Decrease_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature
// (BlueprintEvent)
// Parameters:

void UBP_BuildableBuildCraftingWidget_C::BndEvt__BP_CraftingWidget_Button_Decrease_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "BndEvt__BP_CraftingWidget_Button_Decrease_K2Node_ComponentBoundEvent_2_OnButtonClickedEvent__DelegateSignature");
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.BndEvt__BP_CraftingWidget_Button_Increase_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature
// (BlueprintEvent)
// Parameters:

void UBP_BuildableBuildCraftingWidget_C::BndEvt__BP_CraftingWidget_Button_Increase_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BuildableBuildCraftingWidget_C", "BndEvt__BP_CraftingWidget_Button_Increase_K2Node_ComponentBoundEvent_3_OnButtonClickedEvent__DelegateSignature");
...
// Function BP_BuildableBuildCraftingWidget.BP_BuildableBuildCraftingWidget_C.ExecuteUbergraph_BP_BuildableBuildCraftingWidget
