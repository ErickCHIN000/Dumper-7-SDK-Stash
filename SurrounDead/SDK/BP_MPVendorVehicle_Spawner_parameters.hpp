...
struct ABP_MPVendorVehicle_Spawner_C_ExecuteUbergraph_BP_MPVendorVehicle_Spawner_Params
{
public:
	...
	class ABP_MPVendorVehicle_C*                 CallFunc_FinishSpawningActor_ReturnValue;          // 0x98(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
