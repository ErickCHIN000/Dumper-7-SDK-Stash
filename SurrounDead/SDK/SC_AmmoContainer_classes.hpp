...
class USC_AmmoContainer_C : public UUserWidget
{
public:
	...
	class UJSI_Slot_C*                           SecureContainer_Ref;                               // 0x2D0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class USC_AmmoContainer_C* GetDefaultObj();
	...
	void ExecuteUbergraph_SC_AmmoContainer(int32 EntryPoint, class UJSI_Slot_C* K2Node_Event_ItemRef, class AActor* K2Node_Event_ActorRef, double K2Node_Event_NewWeight);
};
