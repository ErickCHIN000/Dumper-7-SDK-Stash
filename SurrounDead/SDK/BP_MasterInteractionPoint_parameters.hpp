...
struct ABP_MasterInteractionPoint_C_UserConstructionScript_Params
{
public:
	struct FSingleAnimationPlayData              K2Node_MakeStruct_SingleAnimationPlayData;         // 0x0(0x18)(NoDestructor)
