...
class USC_MilitaryJacket_C : public UUserWidget
{
public:
	...
	void ExecuteUbergraph_SC_MilitaryJacket(int32 EntryPoint, class UJSI_Slot_C* K2Node_Event_ItemRef, class AActor* K2Node_Event_ActorRef, double K2Node_Event_NewWeight);
};
