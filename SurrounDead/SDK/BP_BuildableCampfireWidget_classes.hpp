...
class UBP_BuildableCampfireWidget_C : public UUserWidget
{
public:
	...
	class ABuildable_Campfire_C*                 StationOwner;                                      // 0x390(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	...
	static class UBP_BuildableCampfireWidget_C* GetDefaultObj();
