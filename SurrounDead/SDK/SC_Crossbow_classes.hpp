...
class USC_Crossbow_C : public UUserWidget
{
public:
	...
	class UJSI_Slot_C*                           ItemRef;                                           // 0x2D8(0x8)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class AActor*                                WeaponRef;                                         // 0x2E0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	TArray<class FName>                          InstalledAttachments;                              // 0x2E8(0x10)(Edit, BlueprintVisible, DisableEditOnInstance)
	class UJSI_Slot_C*                           ActionbarFollower;                                 // 0x2F8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class USC_Crossbow_C* GetDefaultObj();
