...
class UClass* USC_MosinNagant_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("SC_MosinNagant_C");

	return Clss;
}


// SC_MosinNagant_C SC_MosinNagant.Default__SC_MosinNagant_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class USC_MosinNagant_C* USC_MosinNagant_C::GetDefaultObj()
{
	static class USC_MosinNagant_C* Default = nullptr;

	if (!Default)
		Default = static_cast<USC_MosinNagant_C*>(USC_MosinNagant_C::StaticClass()->DefaultObject);

	return Default;
}


// Function SC_MosinNagant.SC_MosinNagant_C.SetActionbarFollower
...
void USC_MosinNagant_C::SetActionbarFollower(class UJSI_Slot_C* JigRef, bool* Return)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_MosinNagant_C", "SetActionbarFollower");

	Params::USC_MosinNagant_C_SetActionbarFollower_Params Parms{};
...
// Function SC_MosinNagant.SC_MosinNagant_C.GetAllAttachments
...
void USC_MosinNagant_C::GetAllAttachments(TArray<class FName>* Attachments, const TArray<class FName>& AllAtt, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, TArray<class UJSIContainer_C*>& K2Node_MakeArray_Array, int32 CallFunc_Array_Length_ReturnValue, class UJSIContainer_C* CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue, bool CallFunc_GetEquippedItemRef_Found_, class UJSI_Slot_C* CallFunc_GetEquippedItemRef_ItemRef, class FName CallFunc_GetItemID_ItemID, int32 CallFunc_Array_Add_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_MosinNagant_C", "GetAllAttachments");

	Params::USC_MosinNagant_C_GetAllAttachments_Params Parms{};
...
// Function SC_MosinNagant.SC_MosinNagant_C.GetListOfNonAddContainers
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// TArray<class UJSIContainer_C*>     Containers                                                       (Parm, OutParm, ContainsInstancedReference)

void USC_MosinNagant_C::GetListOfNonAddContainers(TArray<class UJSIContainer_C*>* Containers)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_MosinNagant_C", "GetListOfNonAddContainers");

	Params::USC_MosinNagant_C_GetListOfNonAddContainers_Params Parms{};
...
// Function SC_MosinNagant.SC_MosinNagant_C.GetJSIContainerByPlayerSlots
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void USC_MosinNagant_C::GetJSIContainerByPlayerSlots(enum class EPlayerSlots Slot, class UJSIContainer_C** Container, class UJSI_Slot_C** EquippedItem, bool* IsPending_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_MosinNagant_C", "GetJSIContainerByPlayerSlots");

	Params::USC_MosinNagant_C_GetJSIContainerByPlayerSlots_Params Parms{};
...
// Function SC_MosinNagant.SC_MosinNagant_C.GetDropWidget
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UDropItemBackGwidget_C*      DropWRef                                                         (Parm, OutParm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)

void USC_MosinNagant_C::GetDropWidget(class UDropItemBackGwidget_C** DropWRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_MosinNagant_C", "GetDropWidget");

	Params::USC_MosinNagant_C_GetDropWidget_Params Parms{};
...
// Function SC_MosinNagant.SC_MosinNagant_C.GetContainerByAttachmentType
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// Function SC_MosinNagant.SC_MosinNagant_C.GetListOfContainers
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// TArray<class UJSIContainer_C*>     Containers                                                       (Parm, OutParm, ContainsInstancedReference)
// TArray<class UJSIContainer_C*>     K2Node_MakeArray_Array                                           (ReferenceParm, ContainsInstancedReference)

void USC_MosinNagant_C::GetListOfContainers(TArray<class UJSIContainer_C*>* Containers, TArray<class UJSIContainer_C*>& K2Node_MakeArray_Array)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_MosinNagant_C", "GetListOfContainers");

	Params::USC_MosinNagant_C_GetListOfContainers_Params Parms{};
...
// Function SC_MosinNagant.SC_MosinNagant_C.GetIDIfEquipped
...
void USC_MosinNagant_C::GetIDIfEquipped(class UJSIContainer_C* Container, class FName* ItemId, bool CallFunc_GetEquippedItemRef_Found_, class UJSI_Slot_C* CallFunc_GetEquippedItemRef_ItemRef, class FName CallFunc_GetItemID_ItemID)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_MosinNagant_C", "GetIDIfEquipped");

	Params::USC_MosinNagant_C_GetIDIfEquipped_Params Parms{};
...
// Function SC_MosinNagant.SC_MosinNagant_C.SetActorOwner
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AActor*                      ActorRef                                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void USC_MosinNagant_C::SetActorOwner(class AActor* ActorRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_MosinNagant_C", "SetActorOwner");

	Params::USC_MosinNagant_C_SetActorOwner_Params Parms{};
...
// Function SC_MosinNagant.SC_MosinNagant_C.JSIOnWeightUpdated
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// double                             NewWeight                                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void USC_MosinNagant_C::JSIOnWeightUpdated(double NewWeight)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_MosinNagant_C", "JSIOnWeightUpdated");

	Params::USC_MosinNagant_C_JSIOnWeightUpdated_Params Parms{};
...
// Function SC_MosinNagant.SC_MosinNagant_C.SetItemReference
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void USC_MosinNagant_C::SetItemReference(class UJSI_Slot_C* ItemRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_MosinNagant_C", "SetItemReference");

	Params::USC_MosinNagant_C_SetItemReference_Params Parms{};
...
// Function SC_MosinNagant.SC_MosinNagant_C.DropInfo_OnItemEquippedChange_Event_0
...
void USC_MosinNagant_C::DropInfo_OnItemEquippedChange_Event_0(class UJSIContainer_C* FromContainer, class UJSIContainer_C* ToContainer, class UJSI_Slot_C* SlotRef, bool Equipped_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_MosinNagant_C", "DropInfo_OnItemEquippedChange_Event_0");

	Params::USC_MosinNagant_C_DropInfo_OnItemEquippedChange_Event_0_Params Parms{};
...
// Function SC_MosinNagant.SC_MosinNagant_C.JSICheckStatus
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:

void USC_MosinNagant_C::JSICheckStatus()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_MosinNagant_C", "JSICheckStatus");
...
// Function SC_MosinNagant.SC_MosinNagant_C.EventOnAttachmentEquipped
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class UJSIContainer_C*             FromContainer                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// class UJSIContainer_C*             ToContainer                                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void USC_MosinNagant_C::EventOnAttachmentEquipped(class UJSIContainer_C* FromContainer, class UJSIContainer_C* ToContainer, class UJSI_Slot_C* SlotRef, bool Equipped_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_MosinNagant_C", "EventOnAttachmentEquipped");

	Params::USC_MosinNagant_C_EventOnAttachmentEquipped_Params Parms{};
...
// Function SC_MosinNagant.SC_MosinNagant_C.DropInfo_OnItemEquippedChange_Event_1
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class UJSIContainer_C*             FromContainer                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// class UJSIContainer_C*             ToContainer                                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void USC_MosinNagant_C::DropInfo_OnItemEquippedChange_Event_1(class UJSIContainer_C* FromContainer, class UJSIContainer_C* ToContainer, class UJSI_Slot_C* SlotRef, bool Equipped_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_MosinNagant_C", "DropInfo_OnItemEquippedChange_Event_1");

	Params::USC_MosinNagant_C_DropInfo_OnItemEquippedChange_Event_1_Params Parms{};
...
// Function SC_MosinNagant.SC_MosinNagant_C.OnHandguardEquipped
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class UJSIContainer_C*             FromContainer                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// class UJSIContainer_C*             ToContainer                                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void USC_MosinNagant_C::OnHandguardEquipped(class UJSIContainer_C* FromContainer, class UJSIContainer_C* ToContainer, class UJSI_Slot_C* SlotRef, bool Equipped_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_MosinNagant_C", "OnHandguardEquipped");

	Params::USC_MosinNagant_C_OnHandguardEquipped_Params Parms{};
...
// Function SC_MosinNagant.SC_MosinNagant_C.UpdateSnap
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void USC_MosinNagant_C::UpdateSnap()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_MosinNagant_C", "UpdateSnap");
...
// Function SC_MosinNagant.SC_MosinNagant_C.OnHandguardAttachment
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class UJSIContainer_C*             FromContainer                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// class UJSIContainer_C*             ToContainer                                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void USC_MosinNagant_C::OnHandguardAttachment(class UJSIContainer_C* FromContainer, class UJSIContainer_C* ToContainer, class UJSI_Slot_C* SlotRef, bool Equipped_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_MosinNagant_C", "OnHandguardAttachment");

	Params::USC_MosinNagant_C_OnHandguardAttachment_Params Parms{};
...
void USC_MosinNagant_C::ExecuteUbergraph_SC_MosinNagant(int32 EntryPoint, class APawn* CallFunc_GetPlayerPawn_ReturnValue, TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface, bool K2Node_DynamicCast_bSuccess, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool Temp_bool_IsClosed_Variable, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, int32 Temp_int_Loop_Counter_Variable_1, int32 CallFunc_Add_IntInt_ReturnValue_1, int32 Temp_int_Array_Index_Variable_1, class AActor* K2Node_Event_ActorRef, double K2Node_Event_NewWeight, class UJSI_Slot_C* K2Node_Event_ItemRef, class UJSIContainer_C* K2Node_CustomEvent_FromContainer_4, class UJSIContainer_C* K2Node_CustomEvent_ToContainer_4, class UJSI_Slot_C* K2Node_CustomEvent_SlotRef_4, bool K2Node_CustomEvent_Equipped__4, class APawn* CallFunc_GetPlayerPawn_ReturnValue_1, TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface_1, bool K2Node_DynamicCast_bSuccess_1, int32 CallFunc_GetContainerCapacity_Cap, int32 CallFunc_GetContainerCapacity_MaxCapacity, bool CallFunc_JigCheckWeaponAmmoCount_Result, class APawn* CallFunc_GetPlayerPawn_ReturnValue_2, bool CallFunc_GetEquippedItemRef_Found_, class UJSI_Slot_C* CallFunc_GetEquippedItemRef_ItemRef, TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface_2, bool K2Node_DynamicCast_bSuccess_2, int32 CallFunc_GetContainerCapacity_Cap_1, int32 CallFunc_GetContainerCapacity_MaxCapacity_1, bool CallFunc_JigCheckWeaponAmmoCount_Result_1, class UJSIContainer_C* K2Node_CustomEvent_FromContainer_3, class UJSIContainer_C* K2Node_CustomEvent_ToContainer_3, class UJSI_Slot_C* K2Node_CustomEvent_SlotRef_3, bool K2Node_CustomEvent_Equipped__3, bool Temp_bool_Has_Been_Initd_Variable, bool CallFunc_IsValid_ReturnValue, bool CallFunc_OnSpecialContainerattachmentUpdated_Result, class UBP_InspectorWindowWidget_C* K2Node_DynamicCast_AsBP_Inspector_Window_Widget, bool K2Node_DynamicCast_bSuccess_3, bool CallFunc_IsVisible_ReturnValue, class AGameStateBase* CallFunc_GetGameState_ReturnValue, TScriptInterface<class IIT_ItemSnapCaptor_C> K2Node_DynamicCast_AsIT_Item_Snap_Captor, bool K2Node_DynamicCast_bSuccess_4, bool CallFunc_IsPendingSnap__PendingSnap, bool CallFunc_AddItemToQueue_Result, class UJSIContainer_C* K2Node_CustomEvent_FromContainer_2, class UJSIContainer_C* K2Node_CustomEvent_ToContainer_2, class UJSI_Slot_C* K2Node_CustomEvent_SlotRef_2, bool K2Node_CustomEvent_Equipped__2, bool CallFunc_IsEquipped__ReturnValue, int32 CallFunc_SelectInt_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_2, bool CallFunc_IsValid_ReturnValue_3, class UJSIContainer_C* K2Node_CustomEvent_FromContainer_1, class UJSIContainer_C* K2Node_CustomEvent_ToContainer_1, class UJSI_Slot_C* K2Node_CustomEvent_SlotRef_1, bool K2Node_CustomEvent_Equipped__1, class UUserWidget* CallFunc_GetContainerOneRef_ContainerRef, class UUserWidget* CallFunc_GetContainerOneRef_ContainerRef_1, TScriptInterface<class IJSISpecialWidgetInterface_C> K2Node_DynamicCast_AsJSISpecial_Widget_Interface, bool K2Node_DynamicCast_bSuccess_5, TScriptInterface<class IJSISpecialWidgetInterface_C> K2Node_DynamicCast_AsJSISpecial_Widget_Interface_1, bool K2Node_DynamicCast_bSuccess_6, TArray<class UJSIContainer_C*>& CallFunc_GetListOfContainers_Containers, TArray<class UJSIContainer_C*>& CallFunc_GetListOfContainers_Containers_1, class UJSIContainer_C* CallFunc_Array_Get_Item, class UJSIContainer_C* CallFunc_Array_Get_Item_1, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Array_Length_ReturnValue_1, bool CallFunc_Less_IntInt_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_4, bool CallFunc_IsValid_ReturnValue_5, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_3, class UJSIContainer_C* K2Node_CustomEvent_FromContainer, class UJSIContainer_C* K2Node_CustomEvent_ToContainer, class UJSI_Slot_C* K2Node_CustomEvent_SlotRef, bool K2Node_CustomEvent_Equipped_)
{
	...
	Params::USC_MosinNagant_C_ExecuteUbergraph_SC_MosinNagant_Params Parms{};
