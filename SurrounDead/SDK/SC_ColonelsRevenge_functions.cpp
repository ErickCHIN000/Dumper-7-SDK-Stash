...
class UClass* USC_ColonelsRevenge_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("SC_ColonelsRevenge_C");

	return Clss;
}


// SC_ColonelsRevenge_C SC_ColonelsRevenge.Default__SC_ColonelsRevenge_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class USC_ColonelsRevenge_C* USC_ColonelsRevenge_C::GetDefaultObj()
{
	static class USC_ColonelsRevenge_C* Default = nullptr;

	if (!Default)
		Default = static_cast<USC_ColonelsRevenge_C*>(USC_ColonelsRevenge_C::StaticClass()->DefaultObject);
...
void USC_ColonelsRevenge_C::SetActionbarFollower(class UJSI_Slot_C* JigRef, bool* Return)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_ColonelsRevenge_C", "SetActionbarFollower");

	Params::USC_ColonelsRevenge_C_SetActionbarFollower_Params Parms{};
...
void USC_ColonelsRevenge_C::GetAllAttachments(TArray<class FName>* Attachments, const TArray<class FName>& AllAtt, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue, TArray<class UJSIContainer_C*>& K2Node_MakeArray_Array, int32 CallFunc_Array_Length_ReturnValue, class UJSIContainer_C* CallFunc_Array_Get_Item, bool CallFunc_Less_IntInt_ReturnValue, bool CallFunc_GetEquippedItemRef_Found_, class UJSI_Slot_C* CallFunc_GetEquippedItemRef_ItemRef, class FName CallFunc_GetItemID_ItemID, int32 CallFunc_Array_Add_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_ColonelsRevenge_C", "GetAllAttachments");

	Params::USC_ColonelsRevenge_C_GetAllAttachments_Params Parms{};
...
void USC_ColonelsRevenge_C::GetListOfNonAddContainers(TArray<class UJSIContainer_C*>* Containers)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_ColonelsRevenge_C", "GetListOfNonAddContainers");

	Params::USC_ColonelsRevenge_C_GetListOfNonAddContainers_Params Parms{};
...
void USC_ColonelsRevenge_C::GetJSIContainerByPlayerSlots(enum class EPlayerSlots Slot, class UJSIContainer_C** Container, class UJSI_Slot_C** EquippedItem, bool* IsPending_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_ColonelsRevenge_C", "GetJSIContainerByPlayerSlots");

	Params::USC_ColonelsRevenge_C_GetJSIContainerByPlayerSlots_Params Parms{};
...
void USC_ColonelsRevenge_C::GetDropWidget(class UDropItemBackGwidget_C** DropWRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_ColonelsRevenge_C", "GetDropWidget");

	Params::USC_ColonelsRevenge_C_GetDropWidget_Params Parms{};
...
void USC_ColonelsRevenge_C::GetListOfContainers(TArray<class UJSIContainer_C*>* Containers, TArray<class UJSIContainer_C*>& K2Node_MakeArray_Array)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_ColonelsRevenge_C", "GetListOfContainers");

	Params::USC_ColonelsRevenge_C_GetListOfContainers_Params Parms{};
...
void USC_ColonelsRevenge_C::GetIDIfEquipped(class UJSIContainer_C* Container, class FName* ItemId, bool CallFunc_GetEquippedItemRef_Found_, class UJSI_Slot_C* CallFunc_GetEquippedItemRef_ItemRef, class FName CallFunc_GetItemID_ItemID)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_ColonelsRevenge_C", "GetIDIfEquipped");

	Params::USC_ColonelsRevenge_C_GetIDIfEquipped_Params Parms{};
...
void USC_ColonelsRevenge_C::SetActorOwner(class AActor* ActorRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_ColonelsRevenge_C", "SetActorOwner");

	Params::USC_ColonelsRevenge_C_SetActorOwner_Params Parms{};
...
void USC_ColonelsRevenge_C::JSIOnWeightUpdated(double NewWeight)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_ColonelsRevenge_C", "JSIOnWeightUpdated");

	Params::USC_ColonelsRevenge_C_JSIOnWeightUpdated_Params Parms{};
...
void USC_ColonelsRevenge_C::SetItemReference(class UJSI_Slot_C* ItemRef)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_ColonelsRevenge_C", "SetItemReference");

	Params::USC_ColonelsRevenge_C_SetItemReference_Params Parms{};
...
void USC_ColonelsRevenge_C::DropInfo_OnItemEquippedChange_Event_0(class UJSIContainer_C* FromContainer, class UJSIContainer_C* ToContainer, class UJSI_Slot_C* SlotRef, bool Equipped_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_ColonelsRevenge_C", "DropInfo_OnItemEquippedChange_Event_0");

	Params::USC_ColonelsRevenge_C_DropInfo_OnItemEquippedChange_Event_0_Params Parms{};
...
// Function SC_ColonelsRevenge.SC_ColonelsRevenge_C.JSICheckStatus
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:

void USC_ColonelsRevenge_C::JSICheckStatus()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_ColonelsRevenge_C", "JSICheckStatus");
...
void USC_ColonelsRevenge_C::EventOnAttachmentEquipped(class UJSIContainer_C* FromContainer, class UJSIContainer_C* ToContainer, class UJSI_Slot_C* SlotRef, bool Equipped_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_ColonelsRevenge_C", "EventOnAttachmentEquipped");

	Params::USC_ColonelsRevenge_C_EventOnAttachmentEquipped_Params Parms{};
...
void USC_ColonelsRevenge_C::DropInfo_OnItemEquippedChange_Event_1(class UJSIContainer_C* FromContainer, class UJSIContainer_C* ToContainer, class UJSI_Slot_C* SlotRef, bool Equipped_)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_ColonelsRevenge_C", "DropInfo_OnItemEquippedChange_Event_1");

	Params::USC_ColonelsRevenge_C_DropInfo_OnItemEquippedChange_Event_1_Params Parms{};
...
// Function SC_ColonelsRevenge.SC_ColonelsRevenge_C.UpdateSnap
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void USC_ColonelsRevenge_C::UpdateSnap()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SC_ColonelsRevenge_C", "UpdateSnap");
...
void USC_ColonelsRevenge_C::ExecuteUbergraph_SC_ColonelsRevenge(int32 EntryPoint, bool Temp_bool_IsClosed_Variable, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool Temp_bool_Has_Been_Initd_Variable, class AActor* K2Node_Event_ActorRef, double K2Node_Event_NewWeight, class UJSI_Slot_C* K2Node_Event_ItemRef, class UJSIContainer_C* K2Node_CustomEvent_FromContainer_2, class UJSIContainer_C* K2Node_CustomEvent_ToContainer_2, class UJSI_Slot_C* K2Node_CustomEvent_SlotRef_2, bool K2Node_CustomEvent_Equipped__2, class APawn* CallFunc_GetPlayerPawn_ReturnValue, TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface, bool K2Node_DynamicCast_bSuccess, int32 CallFunc_GetContainerCapacity_Cap, int32 CallFunc_GetContainerCapacity_MaxCapacity, bool CallFunc_JigCheckWeaponAmmoCount_Result, class APawn* CallFunc_GetPlayerPawn_ReturnValue_1, bool CallFunc_GetEquippedItemRef_Found_, class UJSI_Slot_C* CallFunc_GetEquippedItemRef_ItemRef, TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface_1, bool K2Node_DynamicCast_bSuccess_1, int32 CallFunc_GetContainerCapacity_Cap_1, int32 CallFunc_GetContainerCapacity_MaxCapacity_1, bool CallFunc_JigCheckWeaponAmmoCount_Result_1, class UJSIContainer_C* K2Node_CustomEvent_FromContainer_1, class UJSIContainer_C* K2Node_CustomEvent_ToContainer_1, class UJSI_Slot_C* K2Node_CustomEvent_SlotRef_1, bool K2Node_CustomEvent_Equipped__1, bool CallFunc_IsValid_ReturnValue, class UBP_InspectorWindowWidget_C* K2Node_DynamicCast_AsBP_Inspector_Window_Widget, bool K2Node_DynamicCast_bSuccess_2, bool CallFunc_IsVisible_ReturnValue, class AGameStateBase* CallFunc_GetGameState_ReturnValue, TScriptInterface<class IIT_ItemSnapCaptor_C> K2Node_DynamicCast_AsIT_Item_Snap_Captor, bool K2Node_DynamicCast_bSuccess_3, bool CallFunc_IsPendingSnap__PendingSnap, bool CallFunc_AddItemToQueue_Result, class UJSIContainer_C* K2Node_CustomEvent_FromContainer, class UJSIContainer_C* K2Node_CustomEvent_ToContainer, class UJSI_Slot_C* K2Node_CustomEvent_SlotRef, bool K2Node_CustomEvent_Equipped_, bool CallFunc_IsEquipped__ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, int32 CallFunc_SelectInt_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2, bool CallFunc_IsValid_ReturnValue_2, bool CallFunc_IsValid_ReturnValue_3, class APawn* CallFunc_GetPlayerPawn_ReturnValue_2, TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface_2, bool K2Node_DynamicCast_bSuccess_4, bool CallFunc_OnSpecialContainerattachmentUpdated_Result)
{
	...
	Params::USC_ColonelsRevenge_C_ExecuteUbergraph_SC_ColonelsRevenge_Params Parms{};
