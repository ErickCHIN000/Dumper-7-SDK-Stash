...
struct UDeadZombieUI_C_GetListOfContainers_Params
{
public:
...
struct UDeadZombieUI_C_GetContainerByAttachmentType_Params
{
public:
...
struct UDeadZombieUI_C_GetDropWidget_Params
{
public:
...
struct UDeadZombieUI_C_GetJSIContainerByPlayerSlots_Params
{
public:
...
struct UDeadZombieUI_C_GetListOfNonAddContainers_Params
{
public:
	TArray<class UJSIContainer_C*>               Containers;                                        // 0x0(0x10)(Parm, OutParm, ContainsInstancedReference)
};
...
struct UDeadZombieUI_C_GetAllAttachments_Params
{
public:
...
struct UDeadZombieUI_C_SetActionbarFollower_Params
{
public:
...
struct UDeadZombieUI_C_SetItemReference_Params
{
public:
...
struct UDeadZombieUI_C_SetActorOwner_Params
{
public:
...
struct UDeadZombieUI_C_JSIOnWeightUpdated_Params
{
public:
...
struct UDeadZombieUI_C_ExecuteUbergraph_DeadZombieUI_Params
{
public:
	...
	uint8                                        Pad_3E4[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_3F2[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
