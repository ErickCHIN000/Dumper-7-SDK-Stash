...
class ABP_MPVendorMilitary_C : public AActor
{
public:
	...
	class FText                                  ContainerName;                                     // 0x2C0(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	TSubclassOf<class UDialogue>                 Dialogue;                                          // 0x2D8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, UObjectWrapper, HasGetValueTypeHash)
	...
	bool                                         Outline_;                                          // 0x300(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class ABP_MPVendorMilitary_C* GetDefaultObj();
