...
class UClass* ABuildable_CeilingLight_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Buildable_CeilingLight_C");

	return Clss;
}


// Buildable_CeilingLight_C Buildable_CeilingLight.Default__Buildable_CeilingLight_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABuildable_CeilingLight_C* ABuildable_CeilingLight_C::GetDefaultObj()
{
	static class ABuildable_CeilingLight_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABuildable_CeilingLight_C*>(ABuildable_CeilingLight_C::StaticClass()->DefaultObject);
...
void ABuildable_CeilingLight_C::GetPickupName(class FText* Result)
{
	...
	Params::ABuildable_CeilingLight_C_GetPickupName_Params Parms{};
...
void ABuildable_CeilingLight_C::LightCallback(bool NewValue)
{
	...
	Params::ABuildable_CeilingLight_C_LightCallback_Params Parms{};
...
void ABuildable_CeilingLight_C::BndEvt__BP_CookingStation_AIOSubject_K2Node_ComponentBoundEvent_0_OnOptimizationUpdate__DelegateSignature(bool bIsBeyondLastLayer, int32 LayerIndex, bool bIsSeen)
{
	...
	Params::ABuildable_CeilingLight_C_BndEvt__BP_CookingStation_AIOSubject_K2Node_ComponentBoundEvent_0_OnOptimizationUpdate__DelegateSignature_Params Parms{};
...
void ABuildable_CeilingLight_C::ExecuteUbergraph_Buildable_CeilingLight(int32 EntryPoint, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2, bool K2Node_CustomEvent_NewValue, bool CallFunc_GetBoolCVar_ReturnValue, bool K2Node_ComponentBoundEvent_bIsBeyondLastLayer, int32 K2Node_ComponentBoundEvent_LayerIndex, bool K2Node_ComponentBoundEvent_bIsSeen, bool K2Node_SwitchInteger_CmpSuccess)
{
	...
	Params::ABuildable_CeilingLight_C_ExecuteUbergraph_Buildable_CeilingLight_Params Parms{};
