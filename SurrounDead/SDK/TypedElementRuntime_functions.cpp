...
class UClass* ITypedElementPrimitiveCustomDataInterface::StaticClass()
{
	static class UClass* Clss = nullptr;
...
class ITypedElementPrimitiveCustomDataInterface* ITypedElementPrimitiveCustomDataInterface::GetDefaultObj()
{
	static class ITypedElementPrimitiveCustomDataInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<ITypedElementPrimitiveCustomDataInterface*>(ITypedElementPrimitiveCustomDataInterface::StaticClass()->DefaultObject);
...
void ITypedElementPrimitiveCustomDataInterface::SetCustomDataValue(struct FScriptTypedElementHandle& InElementHandle, int32 CustomDataIndex, float CustomDataValue, bool bMarkRenderStateDirty)
{
	static class UFunction* Func = nullptr;
	...
	Params::ITypedElementPrimitiveCustomDataInterface_SetCustomDataValue_Params Parms{};
...
void ITypedElementPrimitiveCustomDataInterface::SetCustomData(struct FScriptTypedElementHandle& InElementHandle, TArray<float>& CustomDataFloats, bool bMarkRenderStateDirty)
{
	static class UFunction* Func = nullptr;
	...
	Params::ITypedElementPrimitiveCustomDataInterface_SetCustomData_Params Parms{};
