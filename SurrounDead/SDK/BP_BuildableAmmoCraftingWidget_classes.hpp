...
class UBP_BuildableAmmoCraftingWidget_C : public UUserWidget
{
public:
	...
	class ABuildable_AmmoBench_C*                StationOwner;                                      // 0x390(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	...
	static class UBP_BuildableAmmoCraftingWidget_C* GetDefaultObj();
