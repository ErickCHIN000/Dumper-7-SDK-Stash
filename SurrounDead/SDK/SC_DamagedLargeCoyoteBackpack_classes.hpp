...
class USC_DamagedLargeCoyoteBackpack_C : public UUserWidget
{
public:
	...
	class UJSI_Slot_C*                           Backpack_Ref;                                      // 0x2D0(0x8)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class USC_DamagedLargeCoyoteBackpack_C* GetDefaultObj();
	...
	void ExecuteUbergraph_SC_DamagedLargeCoyoteBackpack(int32 EntryPoint, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class AActor* K2Node_Event_ActorRef, double K2Node_Event_NewWeight, class UJSI_Slot_C* K2Node_Event_ItemRef, bool K2Node_CustomEvent_NewValue, bool CallFunc_Not_PreBool_ReturnValue);
};
