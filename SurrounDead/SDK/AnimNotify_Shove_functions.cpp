...
class UClass* UAnimNotify_Shove_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AnimNotify_Shove_C");

	return Clss;
}


// AnimNotify_Shove_C AnimNotify_Shove.Default__AnimNotify_Shove_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAnimNotify_Shove_C* UAnimNotify_Shove_C::GetDefaultObj()
{
	static class UAnimNotify_Shove_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAnimNotify_Shove_C*>(UAnimNotify_Shove_C::StaticClass()->DefaultObject);
...
bool UAnimNotify_Shove_C::Received_NotifyEnd(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, struct FAnimNotifyEventReference& EventReference, class AActor* CallFunc_GetOwner_ReturnValue, class ABP_PlayerCharacter_C* K2Node_DynamicCast_AsBP_Player_Character, bool K2Node_DynamicCast_bSuccess)
{
	...
	Params::UAnimNotify_Shove_C_Received_NotifyEnd_Params Parms{};
...
bool UAnimNotify_Shove_C::Received_NotifyBegin(class USkeletalMeshComponent* MeshComp, class UAnimSequenceBase* Animation, float TotalDuration, struct FAnimNotifyEventReference& EventReference, class AActor* CallFunc_GetOwner_ReturnValue, class ABP_PlayerCharacter_C* K2Node_DynamicCast_AsBP_Player_Character, bool K2Node_DynamicCast_bSuccess, const struct FTimerHandle& CallFunc_K2_SetTimer_ReturnValue)
{
	...
	Params::UAnimNotify_Shove_C_Received_NotifyBegin_Params Parms{};
