...
class UClass* ABP_CookingStation_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_CookingStation_C");

	return Clss;
}


// BP_CookingStation_C BP_CookingStation.Default__BP_CookingStation_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_CookingStation_C* ABP_CookingStation_C::GetDefaultObj()
{
	static class ABP_CookingStation_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_CookingStation_C*>(ABP_CookingStation_C::StaticClass()->DefaultObject);
...
void ABP_CookingStation_C::JigMP_GetLootWidget(class UWidget** Result, bool* Valid_)
{
	...
	Params::ABP_CookingStation_C_JigMP_GetLootWidget_Params Parms{};
...
void ABP_CookingStation_C::JigMP_OnContainersSwap(class UJSIContainer_C* Container1, class UJSIContainer_C* Container2, bool* Result)
{
	...
	Params::ABP_CookingStation_C_JigMP_OnContainersSwap_Params Parms{};
...
void ABP_CookingStation_C::JigMP_OnItemDropped(int32 ItemUID, int32 FromContainerUID, class AActor* ActorRef, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_JigMP_OnItemDropped_Params Parms{};
...
void ABP_CookingStation_C::JigMP_OnItemRemoved(int32 ItemUID, int32 FromContainerUID, int32 TocontainerUID, class UBP_JigMultiplayer_C* ToComponent, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_JigMP_OnItemRemoved_Params Parms{};
...
void ABP_CookingStation_C::JigMP_OnItemAdded(int32 ItemUID, int32 FromContainerUID, int32 TocontainerUID, class UBP_JigMultiplayer_C* FromComponent, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_JigMP_OnItemAdded_Params Parms{};
...
void ABP_CookingStation_C::JigMP_OnItemMoved(int32 ItemUID, int32 FromContainerUID, int32 TocontainerUID, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_JigMP_OnItemMoved_Params Parms{};
...
void ABP_CookingStation_C::JigMP_OnTwoContainersSwap(class FName FromContainer, class FName ToContainer, bool* Result)
{
	...
	Params::ABP_CookingStation_C_JigMP_OnTwoContainersSwap_Params Parms{};
...
void ABP_CookingStation_C::JigMP_OnUpdateChamberUID(int32 NewUID, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_JigMP_OnUpdateChamberUID_Params Parms{};
...
void ABP_CookingStation_C::JigMP_OnItemConsumed(const struct FRepItemInfo& ConsumedItem, int32 Amount, int32 Remaining, const struct FRepItemInfo& InsideOf, class FName FromContainer, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_JigMP_OnItemConsumed_Params Parms{};
...
void ABP_CookingStation_C::JigMP_OnMainContainerItemRemoved(int32 FromContainerUID, int32 ItemUID, class FName ContainerName, const struct FRepItemInfo& ItemRemovedInfo, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_JigMP_OnMainContainerItemRemoved_Params Parms{};
...
void ABP_CookingStation_C::JigMP_OnMainContainerItemAdded(int32 TocontainerUID, int32 ItemUID, class FName ToContainerName, const struct FRepItemInfo& ItemInfo, class FName FromMain, bool* Result, class AActor** ActorRef)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_JigMP_OnMainContainerItemAdded_Params Parms{};
...
void ABP_CookingStation_C::JigMP_OnPickupAdded(const struct FRepItemInfo& Info, int32 ItemUID, int32 TocontainerUID, class FName ToContainer, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_JigMP_OnPickupAdded_Params Parms{};
...
void ABP_CookingStation_C::JigMP_OnPickupEquipped(class AActor* ActorRef, class FName ToContainerName, int32 UID, int32 TocontainerUID, const struct FRepItemInfo& Info, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_JigMP_OnPickupEquipped_Params Parms{};
...
void ABP_CookingStation_C::JigMP_OnRequestDropItem(const struct FRepItemInfo& ItemInfo, class FName ContainerName, class AActor** ActorRef, class ACharacter* CallFunc_GetPlayerCharacter_ReturnValue, class UDataTable* CallFunc_GetDtRef_DTReference, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FFItemInfo& CallFunc_GetDataTableRowFromName_OutRow, bool CallFunc_GetDataTableRowFromName_ReturnValue, double CallFunc_RandomFloatInRange_ReturnValue, const struct FRotator& CallFunc_MakeRotator_ReturnValue, const struct FTransform& CallFunc_MakeTransform_ReturnValue, class AActor* CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue, class AActor* CallFunc_FinishSpawningActor_ReturnValue, float CallFunc_MakeRotator_Yaw_ImplicitCast)
{
	...
	Params::ABP_CookingStation_C_JigMP_OnRequestDropItem_Params Parms{};
...
void ABP_CookingStation_C::GetInteractOptions(bool* EnableContext_, TArray<class FText>* Options, TArray<class FText>* Stats)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_GetInteractOptions_Params Parms{};
...
void ABP_CookingStation_C::OnRequestServerInteract(class AActor* Actor, int32 OptionIndex, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_OnRequestServerInteract_Params Parms{};
...
void ABP_CookingStation_C::SetPickupCount(int32 NewCount, bool* Result)
{
	...
	Params::ABP_CookingStation_C_SetPickupCount_Params Parms{};
...
void ABP_CookingStation_C::JigSetCanInteract(bool CanInteract, bool EnablePhysics, bool* Result)
{
	...
	Params::ABP_CookingStation_C_JigSetCanInteract_Params Parms{};
...
void ABP_CookingStation_C::JigCanInteract(bool* Result)
{
	...
	Params::ABP_CookingStation_C_JigCanInteract_Params Parms{};
...
void ABP_CookingStation_C::GetItemInfo(struct FFItemInfo* Info, struct FS_RandomStatsConfig* RandomStatsConfig)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_GetItemInfo_Params Parms{};
...
void ABP_CookingStation_C::GetJigMultiplayerComponent(class UBP_JigMultiplayer_C** JigComp)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_GetJigMultiplayerComponent_Params Parms{};
...
void ABP_CookingStation_C::SetInteractDistance(class AActor* Target, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_SetInteractDistance_Params Parms{};
...
void ABP_CookingStation_C::CheckDistanceFromActor(TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface, bool K2Node_DynamicCast_bSuccess, bool CallFunc_OnInteractActorOverDistance_Result, bool CallFunc_IsValid_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FVector& CallFunc_Subtract_VectorVector_ReturnValue, double CallFunc_VSize_ReturnValue, bool CallFunc_Greater_DoubleDouble_ReturnValue)
{
	...
	Params::ABP_CookingStation_C_CheckDistanceFromActor_Params Parms{};
...
void ABP_CookingStation_C::OnStopExecuteInteract(class AActor* InteractingActor)
{
	...
	Params::ABP_CookingStation_C_OnStopExecuteInteract_Params Parms{};
...
// Function BP_CookingStation.BP_CookingStation_C.OnExecuteInteract_Dialogue
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AActor*                      InteractingActor                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void ABP_CookingStation_C::OnExecuteInteract_Dialogue(class AActor* InteractingActor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_CookingStation_C", "OnExecuteInteract_Dialogue");

	Params::ABP_CookingStation_C_OnExecuteInteract_Dialogue_Params Parms{};
...
void ABP_CookingStation_C::OnServerExecuteInteract(int32 OptionIndex, class AActor* ByActor)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_OnServerExecuteInteract_Params Parms{};
...
void ABP_CookingStation_C::SetInteractOption(int32 OptionIndex)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_SetInteractOption_Params Parms{};
...
// Function BP_CookingStation.BP_CookingStation_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ABP_CookingStation_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_CookingStation_C", "ReceiveBeginPlay");
...
// Function BP_CookingStation.BP_CookingStation_C.Outline
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                               NewValue                                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_CookingStation_C::Outline(bool NewValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_CookingStation_C", "Outline");

	Params::ABP_CookingStation_C_Outline_Params Parms{};
...
void ABP_CookingStation_C::OnExecuteInteract(class AActor* InteractingActor, int32 OptionIndex)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_OnExecuteInteract_Params Parms{};
...
void ABP_CookingStation_C::OnBeginInteract(class AActor* InteractingActor)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_CookingStation_C_OnBeginInteract_Params Parms{};
...
void ABP_CookingStation_C::BndEvt__BP_CookingStation_AIOSubject_K2Node_ComponentBoundEvent_0_OnOptimizationUpdate__DelegateSignature(bool bIsBeyondLastLayer, int32 LayerIndex, bool bIsSeen)
{
	...
	Params::ABP_CookingStation_C_BndEvt__BP_CookingStation_AIOSubject_K2Node_ComponentBoundEvent_0_OnOptimizationUpdate__DelegateSignature_Params Parms{};
...
// class UBP_CookingStationWidget_C*  K2Node_DynamicCast_AsBP_Cooking_Station_Widget                   (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
// bool                               K2Node_DynamicCast_bSuccess                                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ABP_CookingStation_C::ExecuteUbergraph_BP_CookingStation(int32 EntryPoint, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool K2Node_CustomEvent_NewValue, class AHUD_Game_C* CallFunc_GetHUD_HUD, class AHUD_Game_C* CallFunc_GetHUD_HUD_1, int32 K2Node_Event_OptionIndex_1, bool CallFunc_IsInventoryVisible__Result, bool CallFunc_Not_PreBool_ReturnValue, class UBP_CookingStationWidget_C* K2Node_DynamicCast_AsBP_Cooking_Station_Widget, bool K2Node_DynamicCast_bSuccess, const struct FTimerHandle& CallFunc_K2_SetTimer_ReturnValue, const struct FTimerHandle& CallFunc_K2_SetTimer_ReturnValue_1, int32 K2Node_Event_OptionIndex_2, class AActor* K2Node_Event_ByActor, class AActor* K2Node_Event_InteractingActor_2, class AActor* K2Node_Event_InteractingActor_3, class UUserWidget* CallFunc_SetupInventoryWidget_InventoryWidgetRef, class AActor* K2Node_Event_InteractingActor_1, int32 K2Node_Event_OptionIndex, class AActor* K2Node_Event_InteractingActor, TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface, bool K2Node_DynamicCast_bSuccess_1, TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface_1, bool K2Node_DynamicCast_bSuccess_2, bool CallFunc_RequestServerData_Result, bool CallFunc_AddJigWidgetToContent_Result, bool K2Node_ComponentBoundEvent_bIsBeyondLastLayer, int32 K2Node_ComponentBoundEvent_LayerIndex, bool K2Node_ComponentBoundEvent_bIsSeen, bool K2Node_SwitchInteger_CmpSuccess)
{
	...
	Params::ABP_CookingStation_C_ExecuteUbergraph_BP_CookingStation_Params Parms{};
	...
	Parms.K2Node_DynamicCast_AsBP_Cooking_Station_Widget = K2Node_DynamicCast_AsBP_Cooking_Station_Widget;
	Parms.K2Node_DynamicCast_bSuccess = K2Node_DynamicCast_bSuccess;
