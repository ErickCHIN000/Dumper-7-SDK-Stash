...
struct ABuildable_LogWire_C_BndEvt__Buildable_BearTrap_Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params
{
public:
...
struct ABuildable_LogWire_C_BndEvt__BP_CookingStation_AIOSubject_K2Node_ComponentBoundEvent_0_OnOptimizationUpdate__DelegateSignature_Params
{
public:
...
struct ABuildable_LogWire_C_ExecuteUbergraph_Buildable_LogWire_Params
{
public:
	...
	uint8                                        Pad_197[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class ACharacter*                            CallFunc_Array_Get_Item;                           // 0x140(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	double                                       CallFunc_SpawnFloatingDamageText_Damage_ImplicitCast; // 0x158(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
