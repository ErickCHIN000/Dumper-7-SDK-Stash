...
// 0x10 (0x2D0 - 0x2C0)
// WidgetBlueprintGeneratedClass Container_AllItems.Container_AllItems_C
class UContainer_AllItems_C : public UUserWidget
{
public:
	...
	static class UContainer_AllItems_C* GetDefaultObj();
	...
	void ExecuteUbergraph_Container_AllItems(int32 EntryPoint, double K2Node_Event_NewWeight, class UJSI_Slot_C* K2Node_Event_ItemRef, class AActor* K2Node_Event_ActorRef);
};
