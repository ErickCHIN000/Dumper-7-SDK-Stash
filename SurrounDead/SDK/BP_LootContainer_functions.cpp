...
class UClass* ABP_LootContainer_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_LootContainer_C");

	return Clss;
}


// BP_LootContainer_C BP_LootContainer.Default__BP_LootContainer_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_LootContainer_C* ABP_LootContainer_C::GetDefaultObj()
{
	static class ABP_LootContainer_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_LootContainer_C*>(ABP_LootContainer_C::StaticClass()->DefaultObject);
...
void ABP_LootContainer_C::IsHeld_(bool* Held_)
{
	...
	Params::ABP_LootContainer_C_IsHeld__Params Parms{};
...
void ABP_LootContainer_C::GetSettings(double* ChanceToProduceNoise, double* Default_ChanceToProduceNoise, double* DurationToHold)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_GetSettings_Params Parms{};
...
void ABP_LootContainer_C::ComponentsToSave(TArray<class UActorComponent*>* Components)
{
	...
	Params::ABP_LootContainer_C_ComponentsToSave_Params Parms{};
...
void ABP_LootContainer_C::JigMP_GetLootWidget(class UWidget** Result, bool* Valid_)
{
	...
	Params::ABP_LootContainer_C_JigMP_GetLootWidget_Params Parms{};
...
void ABP_LootContainer_C::JigMP_OnContainersSwap(class UJSIContainer_C* Container1, class UJSIContainer_C* Container2, bool* Result)
{
	...
	Params::ABP_LootContainer_C_JigMP_OnContainersSwap_Params Parms{};
...
void ABP_LootContainer_C::JigMP_OnItemDropped(int32 ItemUID, int32 FromContainerUID, class AActor* ActorRef, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_JigMP_OnItemDropped_Params Parms{};
...
void ABP_LootContainer_C::JigMP_OnItemRemoved(int32 ItemUID, int32 FromContainerUID, int32 TocontainerUID, class UBP_JigMultiplayer_C* ToComponent, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_JigMP_OnItemRemoved_Params Parms{};
...
void ABP_LootContainer_C::JigMP_OnItemAdded(int32 ItemUID, int32 FromContainerUID, int32 TocontainerUID, class UBP_JigMultiplayer_C* FromComponent, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_JigMP_OnItemAdded_Params Parms{};
...
void ABP_LootContainer_C::JigMP_OnItemMoved(int32 ItemUID, int32 FromContainerUID, int32 TocontainerUID, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_JigMP_OnItemMoved_Params Parms{};
...
void ABP_LootContainer_C::JigMP_OnTwoContainersSwap(class FName FromContainer, class FName ToContainer, bool* Result)
{
	...
	Params::ABP_LootContainer_C_JigMP_OnTwoContainersSwap_Params Parms{};
...
void ABP_LootContainer_C::JigMP_OnUpdateChamberUID(int32 NewUID, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_JigMP_OnUpdateChamberUID_Params Parms{};
...
void ABP_LootContainer_C::JigMP_OnItemConsumed(const struct FRepItemInfo& ConsumedItem, int32 Amount, int32 Remaining, const struct FRepItemInfo& InsideOf, class FName FromContainer, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_JigMP_OnItemConsumed_Params Parms{};
...
void ABP_LootContainer_C::JigMP_OnMainContainerItemRemoved(int32 FromContainerUID, int32 ItemUID, class FName ContainerName, const struct FRepItemInfo& ItemRemovedInfo, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_JigMP_OnMainContainerItemRemoved_Params Parms{};
...
void ABP_LootContainer_C::JigMP_OnMainContainerItemAdded(int32 TocontainerUID, int32 ItemUID, class FName ToContainerName, const struct FRepItemInfo& ItemInfo, class FName FromMain, bool* Result, class AActor** ActorRef)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_JigMP_OnMainContainerItemAdded_Params Parms{};
...
void ABP_LootContainer_C::JigMP_OnPickupAdded(const struct FRepItemInfo& Info, int32 ItemUID, int32 TocontainerUID, class FName ToContainer, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_JigMP_OnPickupAdded_Params Parms{};
...
void ABP_LootContainer_C::JigMP_OnPickupEquipped(class AActor* ActorRef, class FName ToContainerName, int32 UID, int32 TocontainerUID, const struct FRepItemInfo& Info, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_JigMP_OnPickupEquipped_Params Parms{};
...
void ABP_LootContainer_C::JigMP_OnRequestDropItem(const struct FRepItemInfo& ItemInfo, class FName ContainerName, class AActor** ActorRef, class ACharacter* CallFunc_GetPlayerCharacter_ReturnValue, class UDataTable* CallFunc_GetDtRef_DTReference, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FFItemInfo& CallFunc_GetDataTableRowFromName_OutRow, bool CallFunc_GetDataTableRowFromName_ReturnValue, double CallFunc_RandomFloatInRange_ReturnValue, const struct FRotator& CallFunc_MakeRotator_ReturnValue, const struct FTransform& CallFunc_MakeTransform_ReturnValue, class AActor* CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue, class AActor* CallFunc_FinishSpawningActor_ReturnValue, float CallFunc_MakeRotator_Yaw_ImplicitCast)
{
	...
	Params::ABP_LootContainer_C_JigMP_OnRequestDropItem_Params Parms{};
...
void ABP_LootContainer_C::GetInteractOptions(bool* EnableContext_, TArray<class FText>* Options, TArray<class FText>* Stats)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_GetInteractOptions_Params Parms{};
...
void ABP_LootContainer_C::OnRequestServerInteract(class AActor* Actor, int32 OptionIndex, bool* Result)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_OnRequestServerInteract_Params Parms{};
...
void ABP_LootContainer_C::SetPickupCount(int32 NewCount, bool* Result)
{
	...
	Params::ABP_LootContainer_C_SetPickupCount_Params Parms{};
...
void ABP_LootContainer_C::JigSetCanInteract(bool CanInteract, bool EnablePhysics, bool* Result)
{
	...
	Params::ABP_LootContainer_C_JigSetCanInteract_Params Parms{};
...
void ABP_LootContainer_C::JigCanInteract(bool* Result)
{
	...
	Params::ABP_LootContainer_C_JigCanInteract_Params Parms{};
...
void ABP_LootContainer_C::GetItemInfo(struct FFItemInfo* Info, struct FS_RandomStatsConfig* RandomStatsConfig)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_GetItemInfo_Params Parms{};
...
void ABP_LootContainer_C::GetJigMultiplayerComponent(class UBP_JigMultiplayer_C** JigComp)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_GetJigMultiplayerComponent_Params Parms{};
...
// Function BP_LootContainer.BP_LootContainer_C.TraceForNoLootArea
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void ABP_LootContainer_C::SearchSound(bool Spawn_, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, class UAudioComponent* CallFunc_SpawnSoundAtLocation_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_SearchSound_Params Parms{};
...
void ABP_LootContainer_C::NoiseEvent(class AHUD_Game_C* CallFunc_GetHUD_HUD, class APlayerController* CallFunc_GetPlayerController_ReturnValue, bool CallFunc_IsValid_ReturnValue, TScriptInterface<class IBP_PlayerControllerInterface_C> K2Node_DynamicCast_AsBP_Player_Controller_Interface, bool K2Node_DynamicCast_bSuccess, const class FString& CallFunc_Conv_DoubleToString_ReturnValue, const class FString& CallFunc_Concat_StrStr_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, class UPassiveSkillsComponent_C* CallFunc_GetPassiveSkillsComponent_SkillsComponent, double CallFunc_Divide_DoubleDouble_ReturnValue, double CallFunc_RandomFloatInRange_ReturnValue, class ACharacter* CallFunc_GetPlayerCharacter_ReturnValue, bool CallFunc_LessEqual_DoubleDouble_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue_1)
{
	...
	Params::ABP_LootContainer_C_NoiseEvent_Params Parms{};
...
void ABP_LootContainer_C::HoldToInteract(class AHUD_Game_C* CallFunc_GetHUD_HUD, class AHUD_Game_C* CallFunc_GetHUD_HUD_1, double CallFunc_Subtract_DoubleDouble_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue, bool CallFunc_GreaterEqual_DoubleDouble_ReturnValue, bool CallFunc_NotEqual_DoubleDouble_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, double CallFunc_Add_DoubleDouble_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UPassiveSkillsComponent_C* CallFunc_GetPassiveSkillsComponent_SkillsComponent, double CallFunc_RandomFloatInRange_ReturnValue, double CallFunc_Divide_DoubleDouble_ReturnValue, class UPassiveSkillsComponent_C* CallFunc_GetPassiveSkillsComponent_SkillsComponent_1, TScriptInterface<class IInt_PassiveSkills_C> K2Node_DynamicCast_AsInt_Passive_Skills, bool K2Node_DynamicCast_bSuccess)
{
	...
	Params::ABP_LootContainer_C_HoldToInteract_Params Parms{};
...
void ABP_LootContainer_C::DistanceOutline(class ACharacter* CallFunc_GetPlayerCharacter_ReturnValue, bool CallFunc_IsValid_ReturnValue, float CallFunc_GetDistanceTo_ReturnValue, bool CallFunc_LessEqual_DoubleDouble_ReturnValue, bool CallFunc_GetBoolCVar_ReturnValue, double CallFunc_LessEqual_DoubleDouble_A_ImplicitCast)
{
	...
	Params::ABP_LootContainer_C_DistanceOutline_Params Parms{};
...
void ABP_LootContainer_C::SetInspected(class FText InText, bool Inspected_, class AHUD_Game_C* CallFunc_GetHUD_HUD, bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_SetInspected_Params Parms{};
...
void ABP_LootContainer_C::SetInteractDistance(class AActor* Target, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_SetInteractDistance_Params Parms{};
...
void ABP_LootContainer_C::CheckDistanceFromActor(TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface, bool K2Node_DynamicCast_bSuccess, bool CallFunc_OnInteractActorOverDistance_Result, bool CallFunc_IsValid_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FVector& CallFunc_Subtract_VectorVector_ReturnValue, double CallFunc_VSize_ReturnValue, bool CallFunc_Greater_DoubleDouble_ReturnValue)
{
	...
	Params::ABP_LootContainer_C_CheckDistanceFromActor_Params Parms{};
...
// Function BP_LootContainer.BP_LootContainer_C.OnExecuteInteract_Dialogue
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AActor*                      InteractingActor                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void ABP_LootContainer_C::OnExecuteInteract_Dialogue(class AActor* InteractingActor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_LootContainer_C", "OnExecuteInteract_Dialogue");

	Params::ABP_LootContainer_C_OnExecuteInteract_Dialogue_Params Parms{};
...
void ABP_LootContainer_C::OnServerExecuteInteract(int32 OptionIndex, class AActor* ByActor)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_OnServerExecuteInteract_Params Parms{};
...
void ABP_LootContainer_C::SetInteractOption(int32 OptionIndex)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_SetInteractOption_Params Parms{};
...
void ABP_LootContainer_C::BndEvt__BP_MPLootContainer_AIOSubject_K2Node_ComponentBoundEvent_0_OnOptimizationUpdate__DelegateSignature(bool bIsBeyondLastLayer, int32 LayerIndex, bool bIsSeen)
{
	...
	Params::ABP_LootContainer_C_BndEvt__BP_MPLootContainer_AIOSubject_K2Node_ComponentBoundEvent_0_OnOptimizationUpdate__DelegateSignature_Params Parms{};
...
void ABP_LootContainer_C::OnStopExecuteInteract(class AActor* InteractingActor)
{
	...
	Params::ABP_LootContainer_C_OnStopExecuteInteract_Params Parms{};
...
void ABP_LootContainer_C::OnExecuteInteract(class AActor* InteractingActor, int32 OptionIndex)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_OnExecuteInteract_Params Parms{};
...
void ABP_LootContainer_C::OnBeginInteract(class AActor* InteractingActor)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_LootContainer_C_OnBeginInteract_Params Parms{};
...
// bool                               CallFunc_TraceForNoLootArea_Hit                                  (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AHUD_Game_C*                 CallFunc_GetHUD_HUD                                              (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class AHUD_Game_C*                 CallFunc_GetHUD_HUD_1                                            (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
void ABP_LootContainer_C::ExecuteUbergraph_BP_LootContainer(int32 EntryPoint, bool Temp_bool_Has_Been_Initd_Variable, class AActor* K2Node_Event_InteractingActor_3, int32 K2Node_Event_OptionIndex_2, class AActor* K2Node_Event_ByActor, int32 K2Node_Event_OptionIndex_1, float CallFunc_K2_GetTimerRemainingTimeHandle_ReturnValue, bool CallFunc_GetBoolCVar_ReturnValue, bool Temp_bool_IsClosed_Variable, bool CallFunc_K2_IsValidTimerHandle_ReturnValue, bool K2Node_ComponentBoundEvent_bIsBeyondLastLayer, int32 K2Node_ComponentBoundEvent_LayerIndex, bool K2Node_ComponentBoundEvent_bIsSeen, bool K2Node_SwitchInteger_CmpSuccess, bool CallFunc_GetBoolCVar_ReturnValue_1, bool CallFunc_TraceForNoLootArea_Hit, class AHUD_Game_C* CallFunc_GetHUD_HUD, class AHUD_Game_C* CallFunc_GetHUD_HUD_1, class AHUD_Game_C* CallFunc_GetHUD_HUD_2, const class FString& CallFunc_Conv_DoubleToString_ReturnValue, const class FString& CallFunc_Concat_StrStr_ReturnValue, double CallFunc_RandomFloatInRange_ReturnValue, bool CallFunc_GetBoolCVar_ReturnValue_2, bool Temp_bool_Whether_the_gate_is_currently_open_or_close_Variable, float CallFunc_GetFloatCVar_ReturnValue, TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface, bool K2Node_DynamicCast_bSuccess, TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface_1, bool K2Node_DynamicCast_bSuccess_1, const struct FTimerHandle& CallFunc_K2_SetTimer_ReturnValue, class UPassiveSkillsComponent_C* CallFunc_GetPassiveSkillsComponent_SkillsComponent, double CallFunc_Divide_DoubleDouble_ReturnValue, const struct FTimerHandle& CallFunc_K2_SetTimer_ReturnValue_1, double CallFunc_Divide_DoubleDouble_ReturnValue_1, double CallFunc_Multiply_DoubleDouble_ReturnValue, class AActor* K2Node_Event_InteractingActor_2, bool CallFunc_GetBoolCVar_ReturnValue_3, TScriptInterface<class IBPI_Player_C> K2Node_DynamicCast_AsBPI_Player, bool K2Node_DynamicCast_bSuccess_2, bool CallFunc_GetBoolCVar_ReturnValue_4, float CallFunc_K2_GetTimerRemainingTimeHandle_ReturnValue_1, bool CallFunc_NotEqual_DoubleDouble_ReturnValue, const class FString& CallFunc_Conv_DoubleToString_ReturnValue_1, const struct FTimerHandle& CallFunc_K2_SetTimer_ReturnValue_2, const struct FTimerHandle& CallFunc_K2_SetTimer_ReturnValue_3, bool CallFunc_RequestServerData_Result, class UUserWidget* CallFunc_SetupInventoryWidget_InventoryWidgetRef, bool CallFunc_AddJigWidgetToContent_Result, bool CallFunc_IsInventoryVisible__Result, bool CallFunc_Not_PreBool_ReturnValue, class AActor* K2Node_Event_InteractingActor_1, int32 K2Node_Event_OptionIndex, class AActor* K2Node_Event_InteractingActor, double K2Node_VariableSet_RefillTimer_ImplicitCast, float CallFunc_RetriggerableDelay_Duration_ImplicitCast, double CallFunc_Multiply_DoubleDouble_B_ImplicitCast, double CallFunc_Conv_DoubleToString_InDouble_ImplicitCast, double CallFunc_NotEqual_DoubleDouble_A_ImplicitCast)
{
	...
	Params::ABP_LootContainer_C_ExecuteUbergraph_BP_LootContainer_Params Parms{};
	...
	Parms.CallFunc_TraceForNoLootArea_Hit = CallFunc_TraceForNoLootArea_Hit;
	Parms.CallFunc_GetHUD_HUD = CallFunc_GetHUD_HUD;
	Parms.CallFunc_GetHUD_HUD_1 = CallFunc_GetHUD_HUD_1;
...
// Function BP_LootContainer.BP_LootContainer_C.SetCustomDepth_False__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)
// Parameters:

void ABP_LootContainer_C::SetCustomDepth_False__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_LootContainer_C", "SetCustomDepth_False__DelegateSignature");
...
// Function BP_LootContainer.BP_LootContainer_C.SetCustomDepth_True__DelegateSignature
// (Public, Delegate, BlueprintCallable, BlueprintEvent)
// Parameters:

void ABP_LootContainer_C::SetCustomDepth_True__DelegateSignature()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_LootContainer_C", "SetCustomDepth_True__DelegateSignature");
