...
void AChaosCacheManager::SetCacheCollection(class UChaosCacheCollection* InCacheCollection)
{
	...
	Params::AChaosCacheManager_SetCacheCollection_Params Parms{};
...
void AChaosCacheManager::EnablePlaybackByCache(class FName InCacheName, bool bEnable)
{
	...
	Params::AChaosCacheManager_EnablePlaybackByCache_Params Parms{};
...
void AChaosCacheManager::EnablePlayback(int32 Index, bool bEnable)
{
	...
	Params::AChaosCacheManager_EnablePlayback_Params Parms{};
