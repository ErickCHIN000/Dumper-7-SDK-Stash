...
{
public:
	uint8                                        Pad_BB5[0x160];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TMap<class FName, struct FGameplayTagSource> TagSources;                                        // 0x188(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_BB6[0xB0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_C00[0x2];                                      // Fixing Size After Last Property  [ Dumper-7 ]
