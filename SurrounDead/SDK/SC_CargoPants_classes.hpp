...
class USC_CargoPants_C : public UUserWidget
{
public:
	...
	class UJSIContainer_C*                       JSIContainer7_1;                                   // 0x2D0(0x8)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UJSI_Slot_C*                           CoyoteBackpack_Ref;                                // 0x2D8(0x8)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class USC_CargoPants_C* GetDefaultObj();
	...
	void ExecuteUbergraph_SC_CargoPants(int32 EntryPoint, class UJSI_Slot_C* K2Node_Event_ItemRef, class AActor* K2Node_Event_ActorRef, double K2Node_Event_NewWeight);
};
