...
public:
	...
	void ExecuteUbergraph_SC_FlatbedTruck(int32 EntryPoint, class UJSI_Slot_C* K2Node_Event_ItemRef, class AActor* K2Node_Event_ActorRef, double K2Node_Event_NewWeight);
};
