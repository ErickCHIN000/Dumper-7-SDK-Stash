...
class UBP_CookingStationWidget_C : public UUserWidget
{
public:
	...
	class ABP_CookingStation_C*                  StationOwner;                                      // 0x390(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	...
	static class UBP_CookingStationWidget_C* GetDefaultObj();
