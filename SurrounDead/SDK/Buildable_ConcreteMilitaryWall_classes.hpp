...
class ABuildable_ConcreteMilitaryWall_C : public ABuildable_MASTER_C
{
public:
	...
	static class ABuildable_ConcreteMilitaryWall_C* GetDefaultObj();
	...
	void ExecuteUbergraph_Buildable_ConcreteMilitaryWall(int32 EntryPoint, bool K2Node_ComponentBoundEvent_bIsBeyondLastLayer, int32 K2Node_ComponentBoundEvent_LayerIndex, bool K2Node_ComponentBoundEvent_bIsSeen);
};
