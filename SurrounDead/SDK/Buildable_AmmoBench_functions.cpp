...
class UClass* ABuildable_AmmoBench_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Buildable_AmmoBench_C");

	return Clss;
}


// Buildable_AmmoBench_C Buildable_AmmoBench.Default__Buildable_AmmoBench_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABuildable_AmmoBench_C* ABuildable_AmmoBench_C::GetDefaultObj()
{
	static class ABuildable_AmmoBench_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABuildable_AmmoBench_C*>(ABuildable_AmmoBench_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Buildable_AmmoBench.Buildable_AmmoBench_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ABuildable_AmmoBench_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Buildable_AmmoBench_C", "ReceiveBeginPlay");
...
void ABuildable_AmmoBench_C::OnInteractBuildable(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Buildable_AmmoBench_C", "OnInteractBuildable");

	Params::ABuildable_AmmoBench_C_OnInteractBuildable_Params Parms{};
...
void ABuildable_AmmoBench_C::BndEvt__BP_CookingStation_AIOSubject_K2Node_ComponentBoundEvent_0_OnOptimizationUpdate__DelegateSignature(bool bIsBeyondLastLayer, int32 LayerIndex, bool bIsSeen)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Buildable_AmmoBench_C", "BndEvt__BP_CookingStation_AIOSubject_K2Node_ComponentBoundEvent_0_OnOptimizationUpdate__DelegateSignature");

	Params::ABuildable_AmmoBench_C_BndEvt__BP_CookingStation_AIOSubject_K2Node_ComponentBoundEvent_0_OnOptimizationUpdate__DelegateSignature_Params Parms{};
...
// class UBP_BuildableAmmoCraftingWidget_C*K2Node_DynamicCast_AsBP_Buildable_Ammo_Crafting_Widget           (ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
void ABuildable_AmmoBench_C::ExecuteUbergraph_Buildable_AmmoBench(int32 EntryPoint, bool K2Node_ComponentBoundEvent_bIsBeyondLastLayer, int32 K2Node_ComponentBoundEvent_LayerIndex, bool K2Node_ComponentBoundEvent_bIsSeen, class UBP_BuildableAmmoCraftingWidget_C* K2Node_DynamicCast_AsBP_Buildable_Ammo_Crafting_Widget, bool K2Node_DynamicCast_bSuccess, const struct FTimerHandle& CallFunc_K2_SetTimer_ReturnValue, bool CallFunc_IsInventoryVisible__Result, class UUserWidget* CallFunc_SetupInventoryWidget_InventoryWidgetRef, bool CallFunc_Not_PreBool_ReturnValue, class AActor* K2Node_Event_Actor, TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface, bool K2Node_DynamicCast_bSuccess_1, TScriptInterface<class IBP_JigCharacterInterface_C> K2Node_DynamicCast_AsBP_Jig_Character_Interface_1, bool K2Node_DynamicCast_bSuccess_2, bool CallFunc_AddJigWidgetToContent_Result, bool CallFunc_RequestServerData_Result, TScriptInterface<class IBPI_Player_C> K2Node_DynamicCast_AsBPI_Player, bool K2Node_DynamicCast_bSuccess_3)
{
	...
	Parms.K2Node_DynamicCast_AsBP_Buildable_Ammo_Crafting_Widget = K2Node_DynamicCast_AsBP_Buildable_Ammo_Crafting_Widget;
