...
// 0x28 (0x28 - 0x0)
// Function BP_ProjectileRocket.BP_ProjectileRocket_C.SkillCheck
struct ABP_ProjectileRocket_C_SkillCheck_Params
{
public:
...
// 0x118 (0x118 - 0x0)
// Function BP_ProjectileRocket.BP_ProjectileRocket_C.BndEvt__BP_ProjectileGrenade_Capsule_K2Node_ComponentBoundEvent_4_ComponentHitSignature__DelegateSignature
struct ABP_ProjectileRocket_C_BndEvt__BP_ProjectileGrenade_Capsule_K2Node_ComponentBoundEvent_4_ComponentHitSignature__DelegateSignature_Params
{
public:
...
// 0x2E0 (0x2E0 - 0x0)
// Function BP_ProjectileRocket.BP_ProjectileRocket_C.ExecuteUbergraph_BP_ProjectileRocket
struct ABP_ProjectileRocket_C_ExecuteUbergraph_BP_ProjectileRocket_Params
{
public:
	...
	bool                                         CallFunc_NotEqual_ObjectObject_ReturnValue;        // 0x210(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2B56[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class ACharacter*                            CallFunc_GetPlayerCharacter_ReturnValue_3;         // 0x218(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TArray<enum class EObjectTypeQuery>          K2Node_MakeArray_Array;                            // 0x220(0x10)(ConstParm, ReferenceParm)
	TArray<class AActor*>                        CallFunc_SphereOverlapActors_OutActors;            // 0x230(0x10)(ReferenceParm)
	bool                                         CallFunc_SphereOverlapActors_ReturnValue;          // 0x240(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2B59[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class AActor*                                CallFunc_Array_Get_Item;                           // 0x248(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	double                                       CallFunc_RandomFloatInRange_ReturnValue_2;         // 0x250(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class IBPI_Damage_C>        K2Node_DynamicCast_AsBPI_Damage;                   // 0x258(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                       CallFunc_SkillCheck_Multiplier;                    // 0x270(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_ApplyDamage_ReturnValue;                  // 0x278(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2B67[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class ABP_AIOSpawner_Infestation_C*          K2Node_DynamicCast_AsBP_AIOSpawner_Infestation;    // 0x280(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class ABP_MasterAICharacter_C*               K2Node_DynamicCast_AsBP_Master_AICharacter;        // 0x290(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess_3;                     // 0x298(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_ActorHasTag_ReturnValue;                  // 0x299(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ABP_AI_C*                              K2Node_DynamicCast_AsBP_AI;                        // 0x2B8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_MakeRotator_Yaw_ImplicitCast;             // 0x2CC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_MakeRotator_Yaw_ImplicitCast_1;           // 0x2D0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_ApplyDamage_BaseDamage_ImplicitCast;      // 0x2D4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                       CallFunc_SpawnCombatText_Damage_ImplicitCast;      // 0x2D8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
