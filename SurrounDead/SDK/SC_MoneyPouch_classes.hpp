...
class USC_MoneyPouch_C : public UUserWidget
{
public:
	...
	static class USC_MoneyPouch_C* GetDefaultObj();
	...
	void ExecuteUbergraph_SC_MoneyPouch(int32 EntryPoint, class UJSI_Slot_C* K2Node_Event_ItemRef, class AActor* K2Node_Event_ActorRef, double K2Node_Event_NewWeight);
};
