...
class USC_DamagedCoyoteBackpack_C : public UUserWidget
{
public:
	...
	static class USC_DamagedCoyoteBackpack_C* GetDefaultObj();
	...
	void ExecuteUbergraph_SC_DamagedCoyoteBackpack(int32 EntryPoint, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class AActor* K2Node_Event_ActorRef, double K2Node_Event_NewWeight, class UJSI_Slot_C* K2Node_Event_ItemRef, bool K2Node_CustomEvent_NewValue, bool CallFunc_Not_PreBool_ReturnValue);
};
