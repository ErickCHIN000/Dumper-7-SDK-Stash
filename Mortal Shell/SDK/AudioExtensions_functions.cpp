...
class UClass* USoundModulationPluginSourceSettingsBase::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("SoundModulationPluginSourceSettingsBase");

	return Clss;
}


// SoundModulationPluginSourceSettingsBase AudioExtensions.Default__SoundModulationPluginSourceSettingsBase
// (Public, ClassDefaultObject, ArchetypeObject)

class USoundModulationPluginSourceSettingsBase* USoundModulationPluginSourceSettingsBase::GetDefaultObj()
{
	static class USoundModulationPluginSourceSettingsBase* Default = nullptr;

	if (!Default)
		Default = static_cast<USoundModulationPluginSourceSettingsBase*>(USoundModulationPluginSourceSettingsBase::StaticClass()->DefaultObject);
