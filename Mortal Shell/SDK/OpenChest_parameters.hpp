...
struct UOpenChest_C_Received_Notify_Params
{
public:
	...
	class ASK_Loot_Chest_C*                      K2Node_DynamicCast_AsSK_Loot_Chest;                // 0x30(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
