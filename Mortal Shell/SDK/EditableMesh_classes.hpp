...
public:
	...
	uint8                                        Pad_264[0x9C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_A34[0x390];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A38[0x148];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A3D[0x1E4];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_B52[0xA4];                                     // Fixing Size Of Struct [ Dumper-7 ]
