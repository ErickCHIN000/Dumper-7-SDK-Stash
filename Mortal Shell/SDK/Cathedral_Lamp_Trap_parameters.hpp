...
struct ACathedral_Lamp_Trap_C_OnActorUsed_Params
{
public:
	...
	bool                                         CallFunc_OnActorUsed_Success;                      // 0x14(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
struct ACathedral_Lamp_Trap_C_UserConstructionScript_Params
{
public:
...
struct ACathedral_Lamp_Trap_C_ExecuteUbergraph_Cathedral_Lamp_Trap_Params
{
public:
	...
	TScriptInterface<class IGamePlayPCInterface_C> CallFunc_Util_SaveGame_self_CastInput;             // 0x20(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AWraithSpawner_Cathedral_ButtonTrap_C* CallFunc_Array_Get_Item;                           // 0x40(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_GetArbNameInChangedSetPure_bIsInSet;      // 0x64(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_28F7[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FInventoryItem                        CallFunc_GetItemFromID_Item;                       // 0x68(0x132)(HasGetValueTypeHash)
	uint8                                        Pad_2902[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	bool                                         CallFunc_TryToAddItemToInventory_Success;          // 0x1A0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_2907[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FInventoryItem                        CallFunc_TryToAddItemToInventory_OutItem;          // 0x1A8(0x132)(HasGetValueTypeHash)
	uint8                                        Pad_290E[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        CallFunc_TryToAddItemToInventory_AddedToSlot;      // 0x2E0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
