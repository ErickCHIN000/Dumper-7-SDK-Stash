...
// Function Switcheroo.SwitcherooBlueprintLibrary.UnbindDetectedInputDeviceTypeChanged
// (Final, BlueprintCosmetic, Native, Static, Public, BlueprintCallable)
// Parameters:
// FDelegateProperty_                 Event                                                            (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)

void USwitcherooBlueprintLibrary::UnbindDetectedInputDeviceTypeChanged(FDelegateProperty_ Event)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SwitcherooBlueprintLibrary", "UnbindDetectedInputDeviceTypeChanged");

	Params::USwitcherooBlueprintLibrary_UnbindDetectedInputDeviceTypeChanged_Params Parms{};
...
// Function Switcheroo.SwitcherooBlueprintLibrary.GetDetectedInputDeviceType
// (Final, BlueprintCosmetic, Native, Static, Public, BlueprintCallable, BlueprintPure)
// Parameters:
// enum class ESwitcherooInputDeviceTypeReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

enum class ESwitcherooInputDeviceType USwitcherooBlueprintLibrary::GetDetectedInputDeviceType()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SwitcherooBlueprintLibrary", "GetDetectedInputDeviceType");

	Params::USwitcherooBlueprintLibrary_GetDetectedInputDeviceType_Params Parms{};
...
// Function Switcheroo.SwitcherooBlueprintLibrary.BindDetectedInputDeviceTypeChanged
// (Final, BlueprintCosmetic, Native, Static, Public, BlueprintCallable)
// Parameters:
// FDelegateProperty_                 Event                                                            (Parm, ZeroConstructor, NoDestructor, NativeAccessSpecifierPublic)

void USwitcherooBlueprintLibrary::BindDetectedInputDeviceTypeChanged(FDelegateProperty_ Event)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SwitcherooBlueprintLibrary", "BindDetectedInputDeviceTypeChanged");

	Params::USwitcherooBlueprintLibrary_BindDetectedInputDeviceTypeChanged_Params Parms{};
...
// Parameters:
// class USwitcherooSettings*         ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// Function Switcheroo.SwitcherooSettings.GetDefaultInputDeviceType
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// enum class ESwitcherooInputDeviceTypeReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

enum class ESwitcherooInputDeviceType USwitcherooSettings::GetDefaultInputDeviceType()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("SwitcherooSettings", "GetDefaultInputDeviceType");

	Params::USwitcherooSettings_GetDefaultInputDeviceType_Params Parms{};
