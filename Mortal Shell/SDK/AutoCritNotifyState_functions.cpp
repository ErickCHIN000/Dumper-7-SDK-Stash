...
class UClass* UAutoCritNotifyState_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AutoCritNotifyState_C");

	return Clss;
}


// AutoCritNotifyState_C AutoCritNotifyState.Default__AutoCritNotifyState_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAutoCritNotifyState_C* UAutoCritNotifyState_C::GetDefaultObj()
{
	static class UAutoCritNotifyState_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAutoCritNotifyState_C*>(UAutoCritNotifyState_C::StaticClass()->DefaultObject);
