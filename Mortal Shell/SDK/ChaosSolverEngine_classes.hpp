...
{
public:
	uint8                                        Pad_92A[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_942[0x110];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_948[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_A58[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
