...
struct ABP_Wind_Atk_01_C_BndEvt__Sphere_K2Node_ComponentBoundEvent_1_ComponentBeginOverlapSignature__DelegateSignature_Params
{
public:
...
struct ABP_Wind_Atk_01_C_MulticastSoundFX_Params
{
public:
...
struct ABP_Wind_Atk_01_C_ExecuteUbergraph_BP_Wind_Atk_01_Params
{
public:
	...
	struct FVector                               K2Node_CustomEvent_Location;                       // 0xB0(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_ApplyDamage_ReturnValue;                  // 0x144(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
