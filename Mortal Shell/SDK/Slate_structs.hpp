...
{
public:
	TArray<class FName>                          Names;                                             // 0x0(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	TArray<class FName>                          SectionOrder;                                      // 0xF8(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_778[0xE0];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
