...
class ABP_AxatanaSuper_TeleportVFX_katana_C : public AActor
{
public:
	...
	static class ABP_AxatanaSuper_TeleportVFX_katana_C* GetDefaultObj();
	...
	void ExecuteUbergraph_BP_AxatanaSuper_TeleportVFX_katana(int32 EntryPoint, class UActorComponent* K2Node_ComponentBoundEvent_Component, class UParticleSystemComponent* K2Node_ComponentBoundEvent_PSystem);
};
