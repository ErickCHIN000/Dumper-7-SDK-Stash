...
struct UTitleScreen_C_GetPlatform_Params
{
public:
	enum class EBoolean                          CallFunc_IfConsole_OutResult;                      // 0x0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UTitleScreen_C_ExecuteUbergraph_TitleScreen_Params
{
public:
