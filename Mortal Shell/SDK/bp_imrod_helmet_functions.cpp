...
class UClass* Abp_imrod_helmet_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("bp_imrod_helmet_C");

	return Clss;
}


// bp_imrod_helmet_C bp_imrod_helmet.Default__bp_imrod_helmet_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class Abp_imrod_helmet_C* Abp_imrod_helmet_C::GetDefaultObj()
{
	static class Abp_imrod_helmet_C* Default = nullptr;

	if (!Default)
		Default = static_cast<Abp_imrod_helmet_C*>(Abp_imrod_helmet_C::StaticClass()->DefaultObject);
...
void Abp_imrod_helmet_C::DualSense_HitAudioCue(uint8 CallFunc_MakeLiteralByte_ReturnValue, uint8 CallFunc_MakeLiteralByte_ReturnValue_1, const struct FVector& CallFunc_K2_GetComponentLocation_ReturnValue, const struct FTransform& CallFunc_MakeTransform_ReturnValue, class AActor* CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue, class ABP_ControllerAudio_C* CallFunc_FinishSpawningActor_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("bp_imrod_helmet_C", "DualSense_HitAudioCue");

	Params::Abp_imrod_helmet_C_DualSense_HitAudioCue_Params Parms{};
...
void Abp_imrod_helmet_C::SpawnHitAudioCue(bool CallFunc_IsValid_ReturnValue, class UAudioComponent* CallFunc_SpawnSoundAttached_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("bp_imrod_helmet_C", "SpawnHitAudioCue");

	Params::Abp_imrod_helmet_C_SpawnHitAudioCue_Params Parms{};
...
void Abp_imrod_helmet_C::UserConstructionScript(bool CallFunc_IsValid_ReturnValue, bool CallFunc_SetStaticMesh_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("bp_imrod_helmet_C", "UserConstructionScript");

	Params::Abp_imrod_helmet_C_UserConstructionScript_Params Parms{};
...
// Function bp_imrod_helmet.bp_imrod_helmet_C.Destroy
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void Abp_imrod_helmet_C::Destroy()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("bp_imrod_helmet_C", "Destroy");
...
void Abp_imrod_helmet_C::ReceiveActorBeginOverlap(class AActor* OtherActor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("bp_imrod_helmet_C", "ReceiveActorBeginOverlap");

	Params::Abp_imrod_helmet_C_ReceiveActorBeginOverlap_Params Parms{};
