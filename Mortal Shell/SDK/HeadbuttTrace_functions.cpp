...
// BlueprintGeneratedClass HeadbuttTrace.HeadbuttTrace_C
// (None)

class UClass* UHeadbuttTrace_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("HeadbuttTrace_C");

	return Clss;
}


// HeadbuttTrace_C HeadbuttTrace.Default__HeadbuttTrace_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UHeadbuttTrace_C* UHeadbuttTrace_C::GetDefaultObj()
{
	static class UHeadbuttTrace_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UHeadbuttTrace_C*>(UHeadbuttTrace_C::StaticClass()->DefaultObject);
