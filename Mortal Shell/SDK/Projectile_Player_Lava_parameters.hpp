...
struct AProjectile_Player_Lava_C_SpawnDecal_Params
{
public:
...
struct AProjectile_Player_Lava_C_ReceiveTick_Params
{
public:
...
struct AProjectile_Player_Lava_C_BndEvt__ProjectileMovement_K2Node_ComponentBoundEvent_0_OnProjectileStopDelegate__DelegateSignature_Params
{
public:
...
struct AProjectile_Player_Lava_C_ExecuteUbergraph_Projectile_Player_Lava_Params
{
public:
	...
	struct FHitResult                            K2Node_ComponentBoundEvent_ImpactResult;           // 0x24(0x88)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	uint8                                        Pad_1486[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FRotator                              CallFunc_FindLookAtRotation_ReturnValue;           // 0x138(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FHitResult                            CallFunc_K2_SetWorldRotation_SweepHitResult;       // 0x144(0x88)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
