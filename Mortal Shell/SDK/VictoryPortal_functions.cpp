...
class UClass* AVictoryPortal_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("VictoryPortal_C");

	return Clss;
}


// VictoryPortal_C VictoryPortal.Default__VictoryPortal_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AVictoryPortal_C* AVictoryPortal_C::GetDefaultObj()
{
	static class AVictoryPortal_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AVictoryPortal_C*>(AVictoryPortal_C::StaticClass()->DefaultObject);

	return Default;
}


// Function VictoryPortal.VictoryPortal_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void AVictoryPortal_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("VictoryPortal_C", "ReceiveBeginPlay");
...
// Function VictoryPortal.VictoryPortal_C.BndEvt__Sphere_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature
...
void AVictoryPortal_C::BndEvt__Sphere_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("VictoryPortal_C", "BndEvt__Sphere_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature");

	Params::AVictoryPortal_C_BndEvt__Sphere_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params Parms{};
...
// Function VictoryPortal.VictoryPortal_C.MulticastVictorySound
// (Net, NetReliable, NetMulticast, BlueprintCallable, BlueprintEvent)
// Parameters:

void AVictoryPortal_C::MulticastVictorySound()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("VictoryPortal_C", "MulticastVictorySound");
...
// Function VictoryPortal.VictoryPortal_C.ExecuteUbergraph_VictoryPortal
