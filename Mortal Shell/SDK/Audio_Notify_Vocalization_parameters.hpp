...
struct UAudio_Notify_Vocalization_C_Received_Notify_Params
{
public:
	...
	bool                                         CallFunc_PlayVocalizationAudio_Return;             // 0x48(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
