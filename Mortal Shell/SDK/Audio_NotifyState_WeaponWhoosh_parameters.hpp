...
struct UAudio_NotifyState_WeaponWhoosh_C_Received_NotifyEnd_Params
{
public:
	...
	int32                                        CallFunc_StopWeaponWhooshAudio_Return;             // 0x2C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x41 (0x41 - 0x0)
// Function Audio_NotifyState_WeaponWhoosh.Audio_NotifyState_WeaponWhoosh_C.Received_NotifyBegin
struct UAudio_NotifyState_WeaponWhoosh_C_Received_NotifyBegin_Params
{
public:
	class USkeletalMeshComponent*                MeshComp;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UAnimSequenceBase*                     Animation;                                         // 0x8(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_PlayWeaponWhooshAudio_Return;             // 0x40(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
