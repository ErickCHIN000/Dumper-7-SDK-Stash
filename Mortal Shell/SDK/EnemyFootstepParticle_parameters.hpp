...
struct UEnemyFootstepParticle_C_Received_Notify_Params
{
public:
	...
	class AGameModeBase*                         CallFunc_GetGameMode_ReturnValue;                  // 0x48(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
