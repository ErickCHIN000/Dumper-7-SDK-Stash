...
class UClass* UFootstep_Notify_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Footstep_Notify_C");

	return Clss;
}


// Footstep_Notify_C Footstep_Notify.Default__Footstep_Notify_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFootstep_Notify_C* UFootstep_Notify_C::GetDefaultObj()
{
	static class UFootstep_Notify_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFootstep_Notify_C*>(UFootstep_Notify_C::StaticClass()->DefaultObject);
