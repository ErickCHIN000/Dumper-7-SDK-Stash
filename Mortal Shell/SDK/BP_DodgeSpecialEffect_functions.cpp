...
// BlueprintGeneratedClass BP_DodgeSpecialEffect.BP_DodgeSpecialEffect_C
// (Actor)

class UClass* ABP_DodgeSpecialEffect_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_DodgeSpecialEffect_C");

	return Clss;
}


// BP_DodgeSpecialEffect_C BP_DodgeSpecialEffect.Default__BP_DodgeSpecialEffect_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_DodgeSpecialEffect_C* ABP_DodgeSpecialEffect_C::GetDefaultObj()
{
	static class ABP_DodgeSpecialEffect_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_DodgeSpecialEffect_C*>(ABP_DodgeSpecialEffect_C::StaticClass()->DefaultObject);
...
void ABP_DodgeSpecialEffect_C::MakeHitResults(class AActor* HitActor, TArray<struct FHitResult>* Array, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, const struct FHitResult& CallFunc_MakeHitResult_ReturnValue, TArray<struct FHitResult>& K2Node_MakeArray_Array)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_DodgeSpecialEffect_C", "MakeHitResults");

	Params::ABP_DodgeSpecialEffect_C_MakeHitResults_Params Parms{};
...
// Function BP_DodgeSpecialEffect.BP_DodgeSpecialEffect_C.UserConstructionScript
// (Event, Public, BlueprintCallable, BlueprintEvent)
// Parameters:

void ABP_DodgeSpecialEffect_C::UserConstructionScript()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_DodgeSpecialEffect_C", "UserConstructionScript");
...
// Function BP_DodgeSpecialEffect.BP_DodgeSpecialEffect_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ABP_DodgeSpecialEffect_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_DodgeSpecialEffect_C", "ReceiveBeginPlay");
...
void ABP_DodgeSpecialEffect_C::OnEnemyHit(class AEnemyCharacter_C* Enemy, const struct FVector& ImpactNormal)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_DodgeSpecialEffect_C", "OnEnemyHit");

	Params::ABP_DodgeSpecialEffect_C_OnEnemyHit_Params Parms{};
