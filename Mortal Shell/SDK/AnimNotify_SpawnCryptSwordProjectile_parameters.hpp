...
struct UAnimNotify_SpawnCryptSwordProjectile_C_Received_Notify_Params
{
public:
	...
	TScriptInterface<class IBPI_StormMode_Character_C> K2Node_DynamicCast_AsBPI_Storm_Mode_Character;     // 0x20(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
