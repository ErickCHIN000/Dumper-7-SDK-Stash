...
class UClass* AStartPortal_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("StartPortal_C");

	return Clss;
}


// StartPortal_C StartPortal.Default__StartPortal_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AStartPortal_C* AStartPortal_C::GetDefaultObj()
{
	static class AStartPortal_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AStartPortal_C*>(AStartPortal_C::StaticClass()->DefaultObject);

	return Default;
}


// Function StartPortal.StartPortal_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void AStartPortal_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("StartPortal_C", "ReceiveBeginPlay");
...
void AStartPortal_C::BndEvt__Sphere_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("StartPortal_C", "BndEvt__Sphere_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature");

	Params::AStartPortal_C_BndEvt__Sphere_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params Parms{};
...
// Function StartPortal.StartPortal_C.ActivatePortal
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void AStartPortal_C::ActivatePortal()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("StartPortal_C", "ActivatePortal");
...
// Function StartPortal.StartPortal_C.ActivatePortalWithDelay
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void AStartPortal_C::ActivatePortalWithDelay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("StartPortal_C", "ActivatePortalWithDelay");
...
// TArray<class AVictoryPortal_C*>    CallFunc_GetAllActorsOfClass_OutActors                           (ReferenceParm, HasGetValueTypeHash)
// class AVictoryPortal_C*            CallFunc_Array_Get_Item                                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
