...
class UClass* ABP_UnderdogThrownHead_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_UnderdogThrownHead_C");

	return Clss;
}


// BP_UnderdogThrownHead_C BP_UnderdogThrownHead.Default__BP_UnderdogThrownHead_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_UnderdogThrownHead_C* ABP_UnderdogThrownHead_C::GetDefaultObj()
{
	static class ABP_UnderdogThrownHead_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_UnderdogThrownHead_C*>(ABP_UnderdogThrownHead_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_UnderdogThrownHead.BP_UnderdogThrownHead_C.BndEvt__underdog_head_K2Node_ComponentBoundEvent_2_ComponentHitSignature__DelegateSignature
...
void ABP_UnderdogThrownHead_C::BndEvt__underdog_head_K2Node_ComponentBoundEvent_2_ComponentHitSignature__DelegateSignature(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, struct FHitResult& Hit)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_UnderdogThrownHead_C", "BndEvt__underdog_head_K2Node_ComponentBoundEvent_2_ComponentHitSignature__DelegateSignature");

	Params::ABP_UnderdogThrownHead_C_BndEvt__underdog_head_K2Node_ComponentBoundEvent_2_ComponentHitSignature__DelegateSignature_Params Parms{};
...
// Function BP_UnderdogThrownHead.BP_UnderdogThrownHead_C.ExecuteUbergraph_BP_UnderdogThrownHead
