...
public:
	...
	uint8                                        Pad_11EB[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_11F0[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1212[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint32                                       NavLinkUserId;                                     // 0x58(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_1245[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
