...
public:
	...
	uint8                                        Pad_B68[0x3C];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_B76[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	TArray<struct FMeshElementAttributeData>     Attributes;                                        // 0x0(0x10)(BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<struct FVertexIndexAndInstanceID>     VertexIndicesAndInstanceIDs;                       // 0x0(0x10)(BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<struct FMeshElementAttributeList>     VertexAttributeList;                               // 0x0(0x10)(BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_C0E[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	TArray<struct FSubdividedQuad>               SubdividedQuads;                                   // 0x0(0x10)(BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<struct FVector>                       VertexPositions;                                   // 0x0(0x10)(BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FSubdivisionLimitSection>      Sections;                                          // 0x10(0x10)(BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FSubdividedWireEdge>           SubdividedWireEdges;                               // 0x20(0x10)(BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	int32                                        MaterialIndex;                                     // 0x4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                        MaxTriangles;                                      // 0x8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_C26[0x3C];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
