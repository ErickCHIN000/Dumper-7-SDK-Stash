...
class UClass* UDirectionalDodgeRoll_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("DirectionalDodgeRoll_C");

	return Clss;
}


// DirectionalDodgeRoll_C DirectionalDodgeRoll.Default__DirectionalDodgeRoll_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UDirectionalDodgeRoll_C* UDirectionalDodgeRoll_C::GetDefaultObj()
{
	static class UDirectionalDodgeRoll_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UDirectionalDodgeRoll_C*>(UDirectionalDodgeRoll_C::StaticClass()->DefaultObject);

	return Default;
}


// Function DirectionalDodgeRoll.DirectionalDodgeRoll_C.Received_NotifyEnd
...
// Function DirectionalDodgeRoll.DirectionalDodgeRoll_C.Received_NotifyBegin
// (Event, Public, HasOutParams, BlueprintCallable, BlueprintEvent, Const)
// Parameters:
// class USkeletalMeshComponent*      MeshComp                                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UAnimSequenceBase*           Animation                                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// Function DirectionalDodgeRoll.DirectionalDodgeRoll_C.Received_NotifyTick
// (Event, Public, HasOutParams, BlueprintCallable, BlueprintEvent, Const)
// Parameters:
// class USkeletalMeshComponent*      MeshComp                                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UAnimSequenceBase*           Animation                                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
