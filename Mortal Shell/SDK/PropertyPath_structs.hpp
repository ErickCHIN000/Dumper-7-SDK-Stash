...
{
public:
	TArray<struct FPropertyPathSegment>          Segments;                                          // 0x0(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_975[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
