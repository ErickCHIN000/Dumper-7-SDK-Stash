...
public:
	...
	uint8                                        BitPad_35 : 2;                                     // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_856[0xE0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_858[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_8AC[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_91C[0x2F];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_92B[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_9B7[0x3F];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DE3[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DED[0xDC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DF1[0x357];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_DF2[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_E51[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_E71[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_ED3[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	TArray<struct FNavigationLink>               Links;                                             // 0x3F8(0x10)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_F32[0x24];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        BitPad_64 : 4;                                     // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	uint8                                        Pad_F68[0x3F];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_100C[0x4B];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1035[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1062[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	float                                        AgentMaxHeight;                                    // 0x424(0x4)(Edit, ZeroConstructor, Config, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1190[0x34];                                    // Fixing Size Of Struct [ Dumper-7 ]
