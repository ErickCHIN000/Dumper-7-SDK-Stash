...
struct UAudio_Notify_WeaponImpact_C_Received_Notify_Params
{
public:
	...
	bool                                         CallFunc_PlayWeaponImpactAudioFromAnimation_Return; // 0x41(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
