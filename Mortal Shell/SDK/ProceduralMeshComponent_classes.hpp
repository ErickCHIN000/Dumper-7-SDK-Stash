...
public:
	...
	uint8                                        Pad_4FE[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<struct FProcMeshSection>              ProcMeshSections;                                  // 0x430(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct FKConvexElem>                  CollisionConvexElems;                              // 0x440(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	TArray<class UBodySetup*>                    AsyncBodySetupQueue;                               // 0x470(0x10)(ZeroConstructor, Transient, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
