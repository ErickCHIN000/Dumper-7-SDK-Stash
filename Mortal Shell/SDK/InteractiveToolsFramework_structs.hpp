...
{
public:
	uint8                                        Pad_11A2[0xA8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_11AC[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_11B2[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_11B8[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
