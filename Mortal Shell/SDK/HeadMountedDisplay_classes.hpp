...
public:
	...
	TArray<class UMaterialInterface*>            DisplayMeshMaterialOverrides;                      // 0x418(0x10)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_634[0x68];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_636[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_982[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
