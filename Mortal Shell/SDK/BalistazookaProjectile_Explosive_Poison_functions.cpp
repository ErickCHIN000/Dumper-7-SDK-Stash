...
class UClass* ABalistazookaProjectile_Explosive_Poison_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BalistazookaProjectile_Explosive_Poison_C");

	return Clss;
}


// BalistazookaProjectile_Explosive_Poison_C BalistazookaProjectile_Explosive_Poison.Default__BalistazookaProjectile_Explosive_Poison_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABalistazookaProjectile_Explosive_Poison_C* ABalistazookaProjectile_Explosive_Poison_C::GetDefaultObj()
{
	static class ABalistazookaProjectile_Explosive_Poison_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABalistazookaProjectile_Explosive_Poison_C*>(ABalistazookaProjectile_Explosive_Poison_C::StaticClass()->DefaultObject);
...
void ABalistazookaProjectile_Explosive_Poison_C::OnEnemyHit(class AEnemyCharacter_C* Enemy, const struct FVector& ImpactNormal)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BalistazookaProjectile_Explosive_Poison_C", "OnEnemyHit");

	Params::ABalistazookaProjectile_Explosive_Poison_C_OnEnemyHit_Params Parms{};
...
void ABalistazookaProjectile_Explosive_Poison_C::ExecuteUbergraph_BalistazookaProjectile_Explosive_Poison(int32 EntryPoint, class AEnemyCharacter_C* K2Node_Event_Enemy, const struct FVector& K2Node_Event_ImpactNormal, const struct FVector2D& CallFunc_Conv_VectorToVector2D_ReturnValue, const struct FVector& CallFunc_Conv_Vector2DToVector_ReturnValue, bool CallFunc_ShouldEnableEffect_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BalistazookaProjectile_Explosive_Poison_C", "ExecuteUbergraph_BalistazookaProjectile_Explosive_Poison");

	Params::ABalistazookaProjectile_Explosive_Poison_C_ExecuteUbergraph_BalistazookaProjectile_Explosive_Poison_Params Parms{};
