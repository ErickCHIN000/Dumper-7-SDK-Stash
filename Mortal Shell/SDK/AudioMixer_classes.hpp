...
public:
	...
	uint8                                        Pad_1B4[0x20];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1BB[0x30];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1C5[0x80];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3EA[0x78];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_462[0x5C];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4B8[0x60];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4D7[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
