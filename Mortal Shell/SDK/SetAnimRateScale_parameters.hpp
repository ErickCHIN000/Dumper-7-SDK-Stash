...
// 0x3A (0x3A - 0x0)
// Function SetAnimRateScale.SetAnimRateScale_C.Received_NotifyTick
struct USetAnimRateScale_C_Received_NotifyTick_Params
{
public:
...
// 0x3A (0x3A - 0x0)
// Function SetAnimRateScale.SetAnimRateScale_C.Received_NotifyEnd
struct USetAnimRateScale_C_Received_NotifyEnd_Params
{
public:
	class USkeletalMeshComponent*                MeshComp;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UAnimSequenceBase*                     Animation;                                         // 0x8(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// 0x3A (0x3A - 0x0)
// Function SetAnimRateScale.SetAnimRateScale_C.Received_NotifyBegin
struct USetAnimRateScale_C_Received_NotifyBegin_Params
{
public:
	class USkeletalMeshComponent*                MeshComp;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UAnimSequenceBase*                     Animation;                                         // 0x8(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
