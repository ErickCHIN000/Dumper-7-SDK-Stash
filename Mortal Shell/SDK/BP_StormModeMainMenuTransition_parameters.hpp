...
struct ABP_StormModeMainMenuTransition_C_ExecuteUbergraph_BP_StormModeMainMenuTransition_Params
{
public:
	...
	class APlayerController*                     CallFunc_GetPlayerController_ReturnValue_4;        // 0x58(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class APlayerController*                     CallFunc_GetPlayerController_ReturnValue_5;        // 0x60(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class APlayerController*                     CallFunc_GetPlayerController_ReturnValue_6;        // 0x78(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TScriptInterface<class IBlendableInterface>  CallFunc_AddOrUpdateBlendable_InBlendableObject_CastInput_1; // 0x80(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
