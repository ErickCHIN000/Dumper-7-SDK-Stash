...
public:
	...
	TArray<struct FMagicLeapIdentityAttribute>   AttributeValue;                                    // 0x8(0x10)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<enum class EMagicLeapIdentityKey>     RequestedAttributeList;                            // 0x0(0x10)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1D[0x7];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	TArray<enum class EMagicLeapIdentityKey>     RequestedAttributeList;                            // 0x0(0x10)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct FMagicLeapIdentityAttribute>   RequestedAttributeValues;                          // 0x10(0x10)(Parm, OutParm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EMagicLeapIdentityError           ReturnValue;                                       // 0x20(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<enum class EMagicLeapIdentityKey>     AttributesUpdatedSuccessfully;                     // 0x8(0x10)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<enum class EMagicLeapIdentityKey>     AvailableAttributes;                               // 0x0(0x10)(Parm, OutParm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	TArray<enum class EMagicLeapIdentityKey>     AvailableAttributes;                               // 0x8(0x10)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
