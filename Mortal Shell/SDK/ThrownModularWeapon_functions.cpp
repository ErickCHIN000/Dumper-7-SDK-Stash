...
class UClass* AThrownModularWeapon_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("ThrownModularWeapon_C");

	return Clss;
}


// ThrownModularWeapon_C ThrownModularWeapon.Default__ThrownModularWeapon_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AThrownModularWeapon_C* AThrownModularWeapon_C::GetDefaultObj()
{
	static class AThrownModularWeapon_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AThrownModularWeapon_C*>(AThrownModularWeapon_C::StaticClass()->DefaultObject);
...
void AThrownModularWeapon_C::MulticastSoundFX(const struct FVector& Location, const struct FRotator& Rot)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("ThrownModularWeapon_C", "MulticastSoundFX");

	Params::AThrownModularWeapon_C_MulticastSoundFX_Params Parms{};
...
void AThrownModularWeapon_C::BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature(class UPrimitiveComponent* HitComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, const struct FVector& NormalImpulse, struct FHitResult& Hit)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("ThrownModularWeapon_C", "BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature");

	Params::AThrownModularWeapon_C_BndEvt__StaticMesh_K2Node_ComponentBoundEvent_0_ComponentHitSignature__DelegateSignature_Params Parms{};
