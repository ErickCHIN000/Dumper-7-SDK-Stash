...
// Function MobilePatchingUtils.MobilePatchingLibrary.IsConnectedToInternet
// (Final, Native, Static, Public, BlueprintCallable, BlueprintPure)
// Parameters:
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UMobilePatchingLibrary::IsConnectedToInternet()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("MobilePatchingLibrary", "IsConnectedToInternet");

	Params::UMobilePatchingLibrary_IsConnectedToInternet_Params Parms{};
