...
class ABP_Achievement_Ramps_C : public ABP_AchievementBase_C
{
public:
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0x240(0x8)(ZeroConstructor, Transient, DuplicateTransient)

	static class UClass* StaticClass();
	static class ABP_Achievement_Ramps_C* GetDefaultObj();
	...
	void ExecuteUbergraph_BP_Achievement_Ramps(int32 EntryPoint);
};
