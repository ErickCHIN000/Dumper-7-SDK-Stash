...
// BlueprintGeneratedClass BP_Achievement_Renovation.BP_Achievement_Renovation_C
// (Actor)

class UClass* ABP_Achievement_Renovation_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Achievement_Renovation_C");

	return Clss;
}


// BP_Achievement_Renovation_C BP_Achievement_Renovation.Default__BP_Achievement_Renovation_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Achievement_Renovation_C* ABP_Achievement_Renovation_C::GetDefaultObj()
{
	static class ABP_Achievement_Renovation_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Achievement_Renovation_C*>(ABP_Achievement_Renovation_C::StaticClass()->DefaultObject);
...
bool ABP_Achievement_Renovation_C::HasMetRequirements(bool bIsClient, bool bIsMainMenu, bool bIsIsland, bool CallFunc_Not_PreBool_ReturnValue, class UGGProgression* CallFunc_GetPlayerProgression_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, int32 CallFunc_GetUnlockedStretchGoalNum_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Achievement_Renovation_C", "HasMetRequirements");

	Params::ABP_Achievement_Renovation_C_HasMetRequirements_Params Parms{};
...
// Function BP_Achievement_Renovation.BP_Achievement_Renovation_C.OnAchievementInitialize
// (Event, Public, BlueprintEvent)
// Parameters:

void ABP_Achievement_Renovation_C::OnAchievementInitialize()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Achievement_Renovation_C", "OnAchievementInitialize");
...
void ABP_Achievement_Renovation_C::OnGoalUnlocked(class AGGCastleStretchGoal* UnlockedGoal)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Achievement_Renovation_C", "OnGoalUnlocked");

	Params::ABP_Achievement_Renovation_C_OnGoalUnlocked_Params Parms{};
