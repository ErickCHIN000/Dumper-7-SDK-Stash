...
public:
	...
	struct FMovieSceneSequencePlaybackSettings   Settings;                                          // 0x10(0x1C)(Parm, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_229[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class ATemplateSequenceActor*                OutActor;                                          // 0x30(0x8)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UTemplateSequencePlayer*               ReturnValue;                                       // 0x38(0x8)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
