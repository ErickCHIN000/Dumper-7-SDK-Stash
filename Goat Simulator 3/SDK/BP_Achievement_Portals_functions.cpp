...
// BlueprintGeneratedClass BP_Achievement_Portals.BP_Achievement_Portals_C
// (Actor)

class UClass* ABP_Achievement_Portals_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Achievement_Portals_C");

	return Clss;
}


// BP_Achievement_Portals_C BP_Achievement_Portals.Default__BP_Achievement_Portals_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Achievement_Portals_C* ABP_Achievement_Portals_C::GetDefaultObj()
{
	static class ABP_Achievement_Portals_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Achievement_Portals_C*>(ABP_Achievement_Portals_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_Achievement_Portals.BP_Achievement_Portals_C.HasMetRequirements
...
bool ABP_Achievement_Portals_C::HasMetRequirements(bool bIsClient, bool bIsMainMenu, bool bIsIsland, bool CallFunc_Not_PreBool_ReturnValue, class UGGProgression* CallFunc_GetPlayerProgression_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, int32 CallFunc_GetUnlockedStretchGoalNum_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Achievement_Portals_C", "HasMetRequirements");

	Params::ABP_Achievement_Portals_C_HasMetRequirements_Params Parms{};
...
// Function BP_Achievement_Portals.BP_Achievement_Portals_C.OnAchievementInitialize
// (Event, Public, BlueprintEvent)
// Parameters:

void ABP_Achievement_Portals_C::OnAchievementInitialize()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Achievement_Portals_C", "OnAchievementInitialize");
...
// Function BP_Achievement_Portals.BP_Achievement_Portals_C.OnGoalUnlocked
...
void ABP_Achievement_Portals_C::OnGoalUnlocked(class AGGCastleStretchGoal* UnlockedGoal)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Achievement_Portals_C", "OnGoalUnlocked");

	Params::ABP_Achievement_Portals_C_OnGoalUnlocked_Params Parms{};
...
// Function BP_Achievement_Portals.BP_Achievement_Portals_C.ExecuteUbergraph_BP_Achievement_Portals
