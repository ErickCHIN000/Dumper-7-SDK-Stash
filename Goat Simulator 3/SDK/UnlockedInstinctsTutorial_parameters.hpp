...
struct AUnlockedInstinctsTutorial_C_OnTutorialActivated_Params
{
public:
...
struct AUnlockedInstinctsTutorial_C_OnMenuNavigation_Params
{
public:
...
struct AUnlockedInstinctsTutorial_C_ExecuteUbergraph_UnlockedInstinctsTutorial_Params
{
public:
	...
	class AGGPlayerController*                   K2Node_Event_PC;                                   // 0x28(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AGGGoat*                               K2Node_Event_Goat;                                 // 0x30(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayTag                          K2Node_CustomEvent_InMenuTag;                      // 0x38(0x8)(NoDestructor, HasGetValueTypeHash)
	struct FMenuNavigationContext                K2Node_CustomEvent_Context;                        // 0x40(0x28)(None)
	...
	TArray<class AGGPlayerController*>           CallFunc_GetAllOwningPlayers_ReturnValue;          // 0x70(0x10)(ReferenceParm)
	struct FMenuNavigationContext                CallFunc_MakeMenuNavigationContextStruct_ReturnValue; // 0x80(0x28)(None)
	class AGGPlayerController*                   CallFunc_Array_Get_Item;                           // 0xA8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
