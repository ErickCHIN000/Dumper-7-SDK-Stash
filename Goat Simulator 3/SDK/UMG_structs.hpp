...
{
public:
	uint8                                        Pad_1730[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1731[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1737[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	struct FTextBlockStyle                       TextStyle;                                         // 0x8(0x270)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_1740[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1741[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1743[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1744[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
