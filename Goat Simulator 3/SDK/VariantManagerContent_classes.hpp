...
public:
	...
	uint8                                        Pad_3C1[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	struct FSoftObjectPath                       LevelVariantSets;                                  // 0x230(0x18)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class UClass*, class ULevelVariantSetsFunctionDirector*> DirectorInstances;                                 // 0x248(0x50)(Transient, NativeAccessSpecifierPrivate)
...
{
public:
	uint8                                        Pad_460[0x60];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_473[0x6F];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4D1[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class USceneComponent*                       SceneComponent;                                    // 0x248(0x8)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	int32                                        LastSelectedOption;                                // 0x250(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_4D3[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_57B[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_5E0[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
