...
{
public:
	uint8                                        Pad_1174[0xA8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1177[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1178[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
