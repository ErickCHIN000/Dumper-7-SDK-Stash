...
struct ABP_SE_Burning_Default_C_BPInitializeStatus_Params
{
public:
...
struct ABP_SE_Burning_Default_C_ReceiveEndPlay_Params
{
public:
...
struct ABP_SE_Burning_Default_C_BPClientInitializeStatus_Params
{
public:
	class UGGStatusEffectManager*                Manager;                                           // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct ABP_SE_Burning_Default_C_ExecuteUbergraph_BP_SE_Burning_Default_Params
{
public:
	...
	bool                                         CallFunc_IsPlaying_ReturnValue;                    // 0x3A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class EEndPlayReason                    K2Node_Event_EndPlayReason;                        // 0x3B(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_D77[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class UGGStatusEffectManager*                K2Node_Event_Manager;                              // 0x40(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
