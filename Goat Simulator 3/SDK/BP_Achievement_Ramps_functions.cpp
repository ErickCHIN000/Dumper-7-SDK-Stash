...
// BlueprintGeneratedClass BP_Achievement_Ramps.BP_Achievement_Ramps_C
// (Actor)

class UClass* ABP_Achievement_Ramps_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Achievement_Ramps_C");

	return Clss;
}


// BP_Achievement_Ramps_C BP_Achievement_Ramps.Default__BP_Achievement_Ramps_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Achievement_Ramps_C* ABP_Achievement_Ramps_C::GetDefaultObj()
{
	static class ABP_Achievement_Ramps_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Achievement_Ramps_C*>(ABP_Achievement_Ramps_C::StaticClass()->DefaultObject);
...
// Function BP_Achievement_Ramps.BP_Achievement_Ramps_C.OnAchievementInitialize
// (Event, Public, BlueprintEvent)
// Parameters:

void ABP_Achievement_Ramps_C::OnAchievementInitialize()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Achievement_Ramps_C", "OnAchievementInitialize");
...
void ABP_Achievement_Ramps_C::ExecuteUbergraph_BP_Achievement_Ramps(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Achievement_Ramps_C", "ExecuteUbergraph_BP_Achievement_Ramps");

	Params::ABP_Achievement_Ramps_C_ExecuteUbergraph_BP_Achievement_Ramps_Params Parms{};
