...
public:
	...
	uint8                                        Pad_E5[0x18];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F0[0x4];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_262[0x238];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FMovieSceneSequencePlaybackSettings   PlaybackSettings;                                  // 0x2D0(0x1C)(Net, NoDestructor, Protected, NativeAccessSpecifierProtected)
	...
	uint8                                        Pad_270[0x68];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_275[0x88];                                     // Fixing Size Of Struct [ Dumper-7 ]
	...
	void SetTargetControllerId(int32 ControllerId);
	...
	void SetDisableMovementInput(bool bDisableMovementInput);
	void SetDisableLookAtInput(bool bDisableLookAtInput);
	...
	bool GetForceDisableCameraCuts();
	struct FQualifiedFrameTime GetEndTime();
	struct FQualifiedFrameTime GetDuration();
	bool GetDisableSplitscreen();
	bool GetDisableMovementInput();
	bool GetDisableLookAtInput();
...
public:
	...
	uint8                                        Pad_2D4[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2DB[0x1D];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2F5[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_33A[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_407[0x6];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_41C[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_432[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_43D[0x7];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_499[0xB0];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4A2[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4C0[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4F1[0x270];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	struct FMovieSceneEntitySystemGraph          SystemGraph;                                       // 0x298(0x138)(NativeAccessSpecifierPublic)
	uint8                                        Pad_4F4[0x120];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4FE[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_534[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_53F[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_55D[0x90];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_56D[0x8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_599[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_5A2[0xB0];                                     // Fixing Size Of Struct [ Dumper-7 ]
