...
struct ABP_FireballProjectile_C_ReceiveTick_Params
{
public:
...
struct ABP_FireballProjectile_C_ExecuteUbergraph_BP_FireballProjectile_Params
{
public:
	...
	struct FHitResult                            CallFunc_K2_SetWorldRotation_SweepHitResult;       // 0x2C(0x88)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
