...
// BlueprintGeneratedClass UnlockedGearStoreTutorial.UnlockedGearStoreTutorial_C
// (Actor)

class UClass* AUnlockedGearStoreTutorial_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UnlockedGearStoreTutorial_C");

	return Clss;
}


// UnlockedGearStoreTutorial_C UnlockedGearStoreTutorial.Default__UnlockedGearStoreTutorial_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AUnlockedGearStoreTutorial_C* AUnlockedGearStoreTutorial_C::GetDefaultObj()
{
	static class AUnlockedGearStoreTutorial_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AUnlockedGearStoreTutorial_C*>(AUnlockedGearStoreTutorial_C::StaticClass()->DefaultObject);

	return Default;
}


// Function UnlockedGearStoreTutorial.UnlockedGearStoreTutorial_C.OnTutorialActivated
...
void AUnlockedGearStoreTutorial_C::OnTutorialActivated(class AGGPlayerController* PC, class AGGGoat* Goat)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("UnlockedGearStoreTutorial_C", "OnTutorialActivated");

	Params::AUnlockedGearStoreTutorial_C_OnTutorialActivated_Params Parms{};
...
// Function UnlockedGearStoreTutorial.UnlockedGearStoreTutorial_C.OnMenuNavigation
...
void AUnlockedGearStoreTutorial_C::OnMenuNavigation(const struct FGameplayTag& InMenuTag, const struct FMenuNavigationContext& Context)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("UnlockedGearStoreTutorial_C", "OnMenuNavigation");

	Params::AUnlockedGearStoreTutorial_C_OnMenuNavigation_Params Parms{};
...
// Function UnlockedGearStoreTutorial.UnlockedGearStoreTutorial_C.ExecuteUbergraph_UnlockedGearStoreTutorial
