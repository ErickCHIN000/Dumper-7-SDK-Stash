...
public:
	...
	uint8                                        BitPad_8 : 2;                                      // Fixing Bit-Field Size  [ Dumper-7 ]
	...
	float                                        Mass;                                              // 0x14C(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_122[0x18];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_135[0x2C];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class AController*                           OverrideController;                                // 0x290(0x8)(Net, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	void ServerUpdateState(float InSteeringInput, float InThrottleInput, float InBrakeInput, float InHandbrakeInput, int32 CurrentGear, float EngineRotationSpeed, float W0S, float W0A, float W1S, float W1A, float W2S, float W2A, float W3S, float W3A, const struct FRepMovement& ReplicatedMovement);
	void ServerClearInput();
	bool GetUseAutoGears();
	int32 GetTargetGear();
	float GetForwardSpeed();
	float GetEngineRotationSpeed(bool bForceUseWheelSpeedAverageFallback);
...
{
public:
	uint8                                        Pad_179[0x798];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	class USkeletalMeshComponent*                Mesh;                                              // 0x290(0x8)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UWheeledVehicleMovementComponent*      VehicleMovement;                                   // 0x298(0x8)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
{
public:
	struct FVehicleEngineData                    EngineSetup;                                       // 0x298(0xA0)(Edit, NativeAccessSpecifierPublic)
	struct FVehicleDifferential4WData            DifferentialSetup;                                 // 0x338(0x1C)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	float                                        AckermannAccuracy;                                 // 0x354(0x4)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVehicleTransmissionData              TransmissionSetup;                                 // 0x358(0x30)(Edit, NativeAccessSpecifierPublic)
	struct FRuntimeFloatCurve                    SteeringCurve;                                     // 0x388(0x88)(Edit, NativeAccessSpecifierPublic)
