...
{
public:
	class ABP_Tornado_C*                         BP_Tornado;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x8 (0x8 - 0x0)
// Function Event_TheButterflyEffect_Seq.SequenceDirector_C.TornadoStartSound
struct USequenceDirector_C_TornadoStartSound_Params
{
public:
	class ABP_Tornado_C*                         BP_Tornado;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	class ABP_Tornado_C*                         K2Node_CustomEvent_BP_Tornado;                     // 0x8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
