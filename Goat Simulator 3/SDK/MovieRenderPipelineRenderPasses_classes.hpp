...
{
public:
	uint8                                        Pad_2F4[0x80];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_30A[0x5];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_34B[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_352[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_36A[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
