...
public:
	...
	uint8                                        Pad_292[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2C1[0x138];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TMap<class FName, struct FGameplayTagSource> TagSources;                                        // 0x160(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_2C2[0x80];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UDataTable*>                    GameplayTagTables;                                 // 0x230(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<class FString>                        PluginTagSearchPaths;                              // 0x240(0x10)(ZeroConstructor, Config, NativeAccessSpecifierPrivate)
