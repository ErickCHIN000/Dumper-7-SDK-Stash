...
// float                              EngineRotationSpeed                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                              W0S                                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                              W0A                                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                              W1S                                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                              W1A                                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                              W2S                                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                              W2A                                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                              W3S                                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                              W3A                                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FRepMovement                ReplicatedMovement                                               (Parm, NoDestructor, NativeAccessSpecifierPublic)

void UWheeledVehicleMovementComponent::ServerUpdateState(float InSteeringInput, float InThrottleInput, float InBrakeInput, float InHandbrakeInput, int32 CurrentGear, float EngineRotationSpeed, float W0S, float W0A, float W1S, float W1A, float W2S, float W2A, float W3S, float W3A, const struct FRepMovement& ReplicatedMovement)
{
	static class UFunction* Func = nullptr;
	...
	Parms.EngineRotationSpeed = EngineRotationSpeed;
	Parms.W0S = W0S;
	Parms.W0A = W0A;
	Parms.W1S = W1S;
	Parms.W1A = W1A;
	...
	Parms.W3S = W3S;
	Parms.W3A = W3A;
	Parms.ReplicatedMovement = ReplicatedMovement;
...
// Function PhysXVehicles.WheeledVehicleMovementComponent.ServerClearInput
// (Net, NetReliable, Native, Event, Protected, NetServer)
// Parameters:

void UWheeledVehicleMovementComponent::ServerClearInput()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("WheeledVehicleMovementComponent", "ServerClearInput");
...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// bool                               bForceUseWheelSpeedAverageFallback                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                              ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

float UWheeledVehicleMovementComponent::GetEngineRotationSpeed(bool bForceUseWheelSpeedAverageFallback)
{
	static class UFunction* Func = nullptr;
	...
	Parms.bForceUseWheelSpeedAverageFallback = bForceUseWheelSpeedAverageFallback;
