...
struct UBP_Interactable_Sink_C_Wash_Params
{
public:
...
struct UBP_Interactable_Sink_C_CanInteract_Params
{
public:
	...
	class UWaterComponent*                       CallFunc_GetTrait_ReturnValue;                     // 0xA8(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UBP_Interactable_Sink_C_Interact_Params
{
public:
	class AActor*                                Instigator;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UBP_Interactable_Sink_C_ExecuteUbergraph_BP_Interactable_Sink_Params
{
public:
