...
struct UCF_UpdateForecast_C_OnConstruction_Params
{
public:
	int32                                        Temp_int_Variable;                                 // 0x0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        Temp_int_Variable_1;                               // 0x4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FProspectForecastEnum                 CallFunc_IntToStruct_ReturnValue;                  // 0x8(0x10)(HasGetValueTypeHash)
	int32                                        CallFunc_Add_IntInt_ReturnValue;                   // 0x18(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FProspectForecastRowHandle            CallFunc_StructToRowHandle_ReturnValue;            // 0x1C(0x18)(NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_6[0x4];                                        // Fixing Size After Last Property  [ Dumper-7 ]
	struct FProspectForecastEnum                 CallFunc_RowHandleToStruct_ReturnValue;            // 0x38(0x10)(HasGetValueTypeHash)
	struct FProspectForecast                     CallFunc_GetProspectForecastStruct_ProspectForecast; // 0x48(0x40)(None)
	enum class EValid                            CallFunc_GetProspectForecastStruct_Paths;          // 0x88(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                        CallFunc_NumRows_ReturnValue;                      // 0xA0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9[0x4];                                        // Fixing Size After Last Property  [ Dumper-7 ]
	class UProspectForecastRow_C*                CallFunc_Create_ReturnValue;                       // 0xA8(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UCF_UpdateForecast_C_HandleExecute_Params
{
public:
...
struct UCF_UpdateForecast_C_ExecuteUbergraph_CF_UpdateForecast_Params
{
public:
	...
	uint8                                        Pad_1C[0x5];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class UProspectForecastRow_C*                K2Node_DynamicCast_AsProspect_Forecast_Row;        // 0x40(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess_1;                     // 0x48(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_1E[0x3];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	struct FProspectForecastRowHandle            CallFunc_StructToRowHandle_ReturnValue;            // 0x4C(0x18)(NoDestructor, HasGetValueTypeHash)
};
