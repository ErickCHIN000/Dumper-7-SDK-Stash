...
class UBP_ActionableBehaviour_CurvedSplinePlace_Power_C : public UBP_ActionableBehaviour_CurvedSplinePlace_C
{
public:
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0x540(0x8)(ZeroConstructor, Transient, DuplicateTransient)

	static class UClass* StaticClass();
	static class UBP_ActionableBehaviour_CurvedSplinePlace_Power_C* GetDefaultObj();
