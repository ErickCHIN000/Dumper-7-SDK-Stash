...
public:
	...
	uint8                                        Pad_5C6[0x17];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_5EB[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_5FA[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5FF[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_C2A[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_CFC[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_D28[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_EFC[0xA0];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F1E[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F34[0x64];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F4E[0x48];                                     // Fixing Size Of Struct [ Dumper-7 ]
