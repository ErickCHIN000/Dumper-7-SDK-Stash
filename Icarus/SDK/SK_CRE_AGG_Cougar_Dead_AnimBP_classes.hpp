...
class USK_CRE_AGG_Cougar_Dead_AnimBP_C : public UIcarusCorpseAnimInstance
{
public:
	...
	static class USK_CRE_AGG_Cougar_Dead_AnimBP_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_SK_CRE_AGG_Cougar_Dead_AnimBP(int32 EntryPoint);
};
