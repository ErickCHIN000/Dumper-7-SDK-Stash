...
struct UBP_Interactable_Interact_RocketPart_C_CanInteract_Params
{
public:
	...
	class ABP_PartBase_C*                        K2Node_DynamicCast_AsBP_Part_Base;                 // 0xB8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AIcarusPlayerControllerSurvival*       CallFunc_GetAssignedPlayer_ReturnValue;            // 0xC8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UBP_Interactable_Interact_RocketPart_C_Interact_Params
{
public:
	class AActor*                                Instigator;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UBP_Interactable_Interact_RocketPart_C_ExecuteUbergraph_BP_Interactable_Interact_RocketPart_Params
{
public:
	...
	class ABP_PartBase_C*                        K2Node_DynamicCast_AsBP_Part_Base;                 // 0xA0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                            CallFunc_WorldInteract_HitResult;                  // 0xAC(0x88)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};
