...
// BlueprintGeneratedClass BP_Building_Wall_Half_Angle_L.BP_Building_Wall_Half_Angle_L_C
// (Actor)

class UClass* ABP_Building_Wall_Half_Angle_L_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Building_Wall_Half_Angle_L_C");

	return Clss;
}


// BP_Building_Wall_Half_Angle_L_C BP_Building_Wall_Half_Angle_L.Default__BP_Building_Wall_Half_Angle_L_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Building_Wall_Half_Angle_L_C* ABP_Building_Wall_Half_Angle_L_C::GetDefaultObj()
{
	static class ABP_Building_Wall_Half_Angle_L_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Building_Wall_Half_Angle_L_C*>(ABP_Building_Wall_Half_Angle_L_C::StaticClass()->DefaultObject);
...
void ABP_Building_Wall_Half_Angle_L_C::GetBlockingBypass(class UClass* BuildingClass, TArray<struct FVectorPair>& BlockingPreRotate, const struct FTransform& GridSpaceTransform, TArray<struct FVectorPair>* BypassBlocking, TArray<struct FVectorPair>& K2Node_MakeArray_Array, const struct FVectorPair& K2Node_MakeStruct_VectorPair, const struct FVectorPair& K2Node_MakeStruct_VectorPair_1, TArray<struct FVectorPair>& K2Node_MakeArray_Array_1, TArray<struct FVectorPair>& K2Node_MakeArray_Array_2, TArray<struct FVectorPair>& CallFunc_GetBlockingBypass_BypassBlocking, const struct FVectorPair& K2Node_MakeStruct_VectorPair_2, TArray<struct FVectorPair>& K2Node_MakeArray_Array_3, const struct FRotator& CallFunc_K2_GetActorRotation_ReturnValue, TArray<struct FVectorPair>& CallFunc_GetBlockingBypass_BypassBlocking_1, float CallFunc_BreakRotator_Roll, float CallFunc_BreakRotator_Pitch, float CallFunc_BreakRotator_Yaw, float CallFunc_Add_FloatFloat_ReturnValue, const struct FRotator& CallFunc_MakeRotator_ReturnValue, const struct FVector& CallFunc_BreakTransform_Location, const struct FRotator& CallFunc_BreakTransform_Rotation, const struct FVector& CallFunc_BreakTransform_Scale, const struct FRotator& CallFunc_K2_GetActorRotation_ReturnValue_1, bool CallFunc_NotEqual_RotatorRotator_ReturnValue, const struct FVector& CallFunc_BreakTransform_Location_1, const struct FRotator& CallFunc_BreakTransform_Rotation_1, const struct FVector& CallFunc_BreakTransform_Scale_1, bool CallFunc_NotEqual_RotatorRotator_ReturnValue_1, bool CallFunc_ClassIsChildOf_ReturnValue, bool CallFunc_ClassIsChildOf_ReturnValue_1, bool CallFunc_ClassIsChildOf_ReturnValue_2)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Building_Wall_Half_Angle_L_C", "GetBlockingBypass");

	Params::ABP_Building_Wall_Half_Angle_L_C_GetBlockingBypass_Params Parms{};
