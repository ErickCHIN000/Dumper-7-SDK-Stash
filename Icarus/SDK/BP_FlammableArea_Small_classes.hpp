...
class ABP_FlammableArea_Small_C : public ABP_FlammableArea_C
{
public:
	...
	class UNiagaraComponent*                     NS_Potbelly_Fire;                                  // 0x298(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class ABP_FlammableArea_Small_C* GetDefaultObj();

	void CleanupVFX();
	void ExecuteUbergraph_BP_FlammableArea_Small(int32 EntryPoint);
};
