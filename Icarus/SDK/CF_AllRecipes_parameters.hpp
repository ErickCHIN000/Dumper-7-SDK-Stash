...
struct UCF_AllRecipes_C_GetCheckboxState_Params
{
public:
	bool                                         ReturnValue;                                       // 0x0(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor)
	uint8                                        Pad_243C[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class APlayerController*                     CallFunc_GetOwningPlayer_ReturnValue;              // 0x8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsUnlockAllRecipesEnabled_ReturnValue;    // 0x10(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

// 0x1 (0x1 - 0x0)
// Function CF_AllRecipes.CF_AllRecipes_C.OnCheckboxStateChanged
struct UCF_AllRecipes_C_OnCheckboxStateChanged_Params
{
public:
...
struct UCF_AllRecipes_C_ExecuteUbergraph_CF_AllRecipes_Params
{
public:
