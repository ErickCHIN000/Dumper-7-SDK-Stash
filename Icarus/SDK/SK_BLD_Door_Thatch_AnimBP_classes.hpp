...
class USK_BLD_Door_Thatch_AnimBP_C : public UAnimInstance
{
public:
	uint8                                        Pad_4D4D[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class USK_BLD_Door_Thatch_AnimBP_C* GetDefaultObj();
