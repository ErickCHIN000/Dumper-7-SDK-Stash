...
class UBP_Interactable_Water_Purifier_Container_C : public UInteractableBehaviour
{
public:
	...
	static class UBP_Interactable_Water_Purifier_Container_C* GetDefaultObj();
