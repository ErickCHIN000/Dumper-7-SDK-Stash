...
class USK_CRE_RedGoat_Dead_AnimBP_C : public UIcarusCorpseAnimInstance
{
public:
	...
	uint8                                        Pad_60FA[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class USK_CRE_RedGoat_Dead_AnimBP_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_SK_CRE_RedGoat_Dead_AnimBP(int32 EntryPoint);
};
