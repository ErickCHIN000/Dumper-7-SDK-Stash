...
class ABP_Railing_Concrete_C : public ABP_Railing_Base_C
{
public:
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0x780(0x8)(ZeroConstructor, Transient, DuplicateTransient)

	static class UClass* StaticClass();
	static class ABP_Railing_Concrete_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_Railing_Concrete(int32 EntryPoint);
};
