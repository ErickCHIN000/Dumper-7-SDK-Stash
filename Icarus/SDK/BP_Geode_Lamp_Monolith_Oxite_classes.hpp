...
class ABP_Geode_Lamp_Monolith_Oxite_C : public ABP_Light_Free_Base_C
{
public:
	...
	static class ABP_Geode_Lamp_Monolith_Oxite_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_Geode_Lamp_Monolith_Oxite(int32 EntryPoint);
};
