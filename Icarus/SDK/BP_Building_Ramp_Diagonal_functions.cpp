...
// BlueprintGeneratedClass BP_Building_Ramp_Diagonal.BP_Building_Ramp_Diagonal_C
// (Actor)

class UClass* ABP_Building_Ramp_Diagonal_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Building_Ramp_Diagonal_C");

	return Clss;
}


// BP_Building_Ramp_Diagonal_C BP_Building_Ramp_Diagonal.Default__BP_Building_Ramp_Diagonal_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Building_Ramp_Diagonal_C* ABP_Building_Ramp_Diagonal_C::GetDefaultObj()
{
	static class ABP_Building_Ramp_Diagonal_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Building_Ramp_Diagonal_C*>(ABP_Building_Ramp_Diagonal_C::StaticClass()->DefaultObject);
...
void ABP_Building_Ramp_Diagonal_C::ShouldRotate(enum class ERotationalDirections Direction, const struct FTransform& GridSpaceTrans, class UClass* NewBuilding, float HitDistanceFromCenter, const struct FVector& Dots, const struct FRotator& WorldRotToTest, const struct FRotator& GridspaceRotTestAgainst, const struct FVector& RawHitNormal, class ACharacter* Player, struct FTransform* Shifted, bool* WantsBlockLikePlacement, struct FTransform* BlockLikePlacementExtra, const struct FTransform& ExtraGridSpaceTrans, const struct FTransform& WorkingTransform, enum class ERotationalDirections WorkingDirection, const struct FTransform& CallFunc_MakeTransform_ReturnValue, const struct FTransform& CallFunc_MakeTransform_ReturnValue_1, const struct FTransform& CallFunc_MakeTransform_ReturnValue_2, const struct FTransform& CallFunc_MakeTransform_ReturnValue_3, const struct FTransform& CallFunc_BackwardsShift_ShiftedLoc, const struct FVector& CallFunc_BreakTransform_Location, const struct FRotator& CallFunc_BreakTransform_Rotation, const struct FVector& CallFunc_BreakTransform_Scale, const struct FRotator& CallFunc_ComposeRotators_ReturnValue, const struct FTransform& CallFunc_MakeTransform_ReturnValue_4, const struct FVector& CallFunc_BreakTransform_Location_1, const struct FRotator& CallFunc_BreakTransform_Rotation_1, const struct FVector& CallFunc_BreakTransform_Scale_1, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_1, const struct FTransform& CallFunc_MakeTransform_ReturnValue_5, const struct FTransform& CallFunc_RightShift_ShiftedLoc, const struct FVector& CallFunc_BreakTransform_Location_2, const struct FRotator& CallFunc_BreakTransform_Rotation_2, const struct FVector& CallFunc_BreakTransform_Scale_2, const struct FVector& CallFunc_Add_VectorVector_ReturnValue, const struct FTransform& CallFunc_BackwardsShift_ShiftedLoc_1, const struct FTransform& CallFunc_MakeTransform_ReturnValue_6, bool K2Node_SwitchEnum_CmpSuccess, const struct FVector& CallFunc_BreakTransform_Location_3, const struct FRotator& CallFunc_BreakTransform_Rotation_3, const struct FVector& CallFunc_BreakTransform_Scale_3, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_2, const struct FTransform& CallFunc_MakeTransform_ReturnValue_7, const struct FVector& CallFunc_BreakTransform_Location_4, const struct FRotator& CallFunc_BreakTransform_Rotation_4, const struct FVector& CallFunc_BreakTransform_Scale_4, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_3, const struct FTransform& CallFunc_MakeTransform_ReturnValue_8, const struct FTransform& CallFunc_RightShift_ShiftedLoc_1, const struct FVector& CallFunc_GetForwardVector_ReturnValue, float CallFunc_BreakVector_X, float CallFunc_BreakVector_Y, float CallFunc_BreakVector_Z, float CallFunc_BreakVector_X_1, float CallFunc_BreakVector_Y_1, float CallFunc_BreakVector_Z_1, bool CallFunc_NearlyEqual_FloatFloat_ReturnValue, const struct FVector& CallFunc_GetForwardVector_ReturnValue_1, float CallFunc_BreakVector_X_2, float CallFunc_BreakVector_Y_2, float CallFunc_BreakVector_Z_2, float CallFunc_BreakVector_X_3, float CallFunc_BreakVector_Y_3, float CallFunc_BreakVector_Z_3, const struct FVector& CallFunc_BreakTransform_Location_5, const struct FRotator& CallFunc_BreakTransform_Rotation_5, const struct FVector& CallFunc_BreakTransform_Scale_5, bool CallFunc_NearlyEqual_FloatFloat_ReturnValue_1, float CallFunc_BreakRotator_Roll, float CallFunc_BreakRotator_Pitch, float CallFunc_BreakRotator_Yaw, const struct FRotator& CallFunc_MakeRotator_ReturnValue, float CallFunc_Add_FloatFloat_ReturnValue, const struct FTransform& CallFunc_MakeTransform_ReturnValue_9, const struct FRotator& CallFunc_MakeRotator_ReturnValue_1, const struct FTransform& CallFunc_MakeTransform_ReturnValue_10, float CallFunc_Add_FloatFloat_ReturnValue_1, const struct FRotator& CallFunc_MakeRotator_ReturnValue_2, float CallFunc_Add_FloatFloat_ReturnValue_2, const struct FTransform& CallFunc_MakeTransform_ReturnValue_11, const struct FRotator& CallFunc_MakeRotator_ReturnValue_3, const struct FTransform& CallFunc_MakeTransform_ReturnValue_12, bool K2Node_SwitchEnum_CmpSuccess_1, const struct FVector& CallFunc_BreakTransform_Location_6, const struct FRotator& CallFunc_BreakTransform_Rotation_6, const struct FVector& CallFunc_BreakTransform_Scale_6, const struct FVector& CallFunc_BreakTransform_Location_7, const struct FRotator& CallFunc_BreakTransform_Rotation_7, const struct FVector& CallFunc_BreakTransform_Scale_7, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_4, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_5, const struct FVector& CallFunc_Add_VectorVector_ReturnValue_1, const struct FVector& CallFunc_Add_VectorVector_ReturnValue_2, const struct FTransform& CallFunc_MakeTransform_ReturnValue_13, const struct FTransform& CallFunc_MakeTransform_ReturnValue_14, bool K2Node_SwitchEnum_CmpSuccess_2, const struct FVector& CallFunc_BreakTransform_Location_8, const struct FRotator& CallFunc_BreakTransform_Rotation_8, const struct FVector& CallFunc_BreakTransform_Scale_8, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_6, bool K2Node_SwitchEnum_CmpSuccess_3, const struct FVector& CallFunc_Add_VectorVector_ReturnValue_3, const struct FTransform& CallFunc_MakeTransform_ReturnValue_15, const struct FVector& CallFunc_BreakTransform_Location_9, const struct FRotator& CallFunc_BreakTransform_Rotation_9, const struct FVector& CallFunc_BreakTransform_Scale_9, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_7, const struct FVector& CallFunc_Add_VectorVector_ReturnValue_4, const struct FTransform& CallFunc_MakeTransform_ReturnValue_16, bool K2Node_SwitchEnum_CmpSuccess_4, const struct FVector& CallFunc_BreakTransform_Location_10, const struct FRotator& CallFunc_BreakTransform_Rotation_10, const struct FVector& CallFunc_BreakTransform_Scale_10, float CallFunc_BreakRotator_Roll_1, float CallFunc_BreakRotator_Pitch_1, float CallFunc_BreakRotator_Yaw_1, TArray<class UPrimitiveComponent*>& K2Node_MakeArray_Array, float CallFunc_Add_FloatFloat_ReturnValue_3, bool CallFunc_NearlyEqual_FloatFloat_ReturnValue_2, float CallFunc_Abs_ReturnValue, bool CallFunc_NearlyEqual_FloatFloat_ReturnValue_3, bool CallFunc_NearlyEqual_FloatFloat_ReturnValue_4, bool CallFunc_NearlyEqual_FloatFloat_ReturnValue_5, bool K2Node_SwitchEnum_CmpSuccess_5, const struct FVector& CallFunc_BreakTransform_Location_11, const struct FRotator& CallFunc_BreakTransform_Rotation_11, const struct FVector& CallFunc_BreakTransform_Scale_11, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_8, const struct FVector& CallFunc_BreakTransform_Location_12, const struct FRotator& CallFunc_BreakTransform_Rotation_12, const struct FVector& CallFunc_BreakTransform_Scale_12, const struct FVector& CallFunc_Add_VectorVector_ReturnValue_5, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_9, const struct FTransform& CallFunc_MakeTransform_ReturnValue_17, const struct FVector& CallFunc_Add_VectorVector_ReturnValue_6, const struct FTransform& CallFunc_MakeTransform_ReturnValue_18, bool K2Node_SwitchEnum_CmpSuccess_6, const struct FVector& CallFunc_BreakTransform_Location_13, const struct FRotator& CallFunc_BreakTransform_Rotation_13, const struct FVector& CallFunc_BreakTransform_Scale_13, bool K2Node_SwitchEnum_CmpSuccess_7, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_10, const struct FVector& CallFunc_Add_VectorVector_ReturnValue_7, const struct FTransform& CallFunc_MakeTransform_ReturnValue_19, const struct FVector& CallFunc_BreakTransform_Location_14, const struct FRotator& CallFunc_BreakTransform_Rotation_14, const struct FVector& CallFunc_BreakTransform_Scale_14, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_11, const struct FVector& CallFunc_Add_VectorVector_ReturnValue_8, const struct FTransform& CallFunc_MakeTransform_ReturnValue_20, bool K2Node_SwitchEnum_CmpSuccess_8, const struct FVector& CallFunc_BreakTransform_Location_15, const struct FRotator& CallFunc_BreakTransform_Rotation_15, const struct FVector& CallFunc_BreakTransform_Scale_15, float CallFunc_BreakRotator_Roll_2, float CallFunc_BreakRotator_Pitch_2, float CallFunc_BreakRotator_Yaw_2, float CallFunc_Add_FloatFloat_ReturnValue_4, const struct FTransform& CallFunc_DownShift_ShiftedLoc, bool CallFunc_NearlyEqual_FloatFloat_ReturnValue_6, float CallFunc_Abs_ReturnValue_1, bool CallFunc_NearlyEqual_FloatFloat_ReturnValue_7, bool CallFunc_NearlyEqual_FloatFloat_ReturnValue_8, bool CallFunc_NearlyEqual_FloatFloat_ReturnValue_9, bool K2Node_SwitchEnum_CmpSuccess_9, const struct FVector& CallFunc_GetForwardVector_ReturnValue_2, float CallFunc_BreakVector_X_4, float CallFunc_BreakVector_Y_4, float CallFunc_BreakVector_Z_4, const struct FTransform& CallFunc_DownShift_ShiftedLoc_1, const struct FTransform& CallFunc_LeftShift_ShiftedTrans, const struct FTransform& CallFunc_BackwardsShift_ShiftedLoc_2, const struct FVector& CallFunc_BreakTransform_Location_16, const struct FRotator& CallFunc_BreakTransform_Rotation_16, const struct FVector& CallFunc_BreakTransform_Scale_16, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_12, const struct FVector& CallFunc_BreakTransform_Location_17, const struct FRotator& CallFunc_BreakTransform_Rotation_17, const struct FVector& CallFunc_BreakTransform_Scale_17, const struct FTransform& CallFunc_MakeTransform_ReturnValue_21, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_13, const struct FTransform& CallFunc_MakeTransform_ReturnValue_22, const struct FVector& CallFunc_BreakTransform_Location_18, const struct FRotator& CallFunc_BreakTransform_Rotation_18, const struct FVector& CallFunc_BreakTransform_Scale_18, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_14, const struct FTransform& CallFunc_MakeTransform_ReturnValue_23, const struct FTransform& CallFunc_RightShift_ShiftedLoc_2, const struct FTransform& CallFunc_MakeTransform_ReturnValue_24, bool K2Node_SwitchEnum_CmpSuccess_10, const struct FVector& CallFunc_BreakTransform_Location_19, const struct FRotator& CallFunc_BreakTransform_Rotation_19, const struct FVector& CallFunc_BreakTransform_Scale_19, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_15, const struct FTransform& CallFunc_MakeTransform_ReturnValue_25, const struct FTransform& CallFunc_BackwardsShift_ShiftedLoc_3, const struct FTransform& CallFunc_RightShift_ShiftedLoc_3, bool K2Node_SwitchEnum_CmpSuccess_11, TArray<class UPrimitiveComponent*>& K2Node_MakeArray_Array_1, bool CallFunc_ClassIsChildOf_ReturnValue, const struct FTransform& CallFunc_RightShift_ShiftedLoc_4, const struct FVector& CallFunc_BreakTransform_Location_20, const struct FRotator& CallFunc_BreakTransform_Rotation_20, const struct FVector& CallFunc_BreakTransform_Scale_20, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_16, const struct FTransform& CallFunc_MakeTransform_ReturnValue_26, const struct FVector& CallFunc_BreakTransform_Location_21, const struct FRotator& CallFunc_BreakTransform_Rotation_21, const struct FVector& CallFunc_BreakTransform_Scale_21, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_17, const struct FTransform& CallFunc_MakeTransform_ReturnValue_27, const struct FTransform& CallFunc_UpShift_ShiftedLoc, const struct FTransform& CallFunc_LeftShift_ShiftedTrans_1, bool K2Node_SwitchEnum_CmpSuccess_12, float CallFunc_BreakVector_X_5, float CallFunc_BreakVector_Y_5, float CallFunc_BreakVector_Z_5, bool CallFunc_NearlyEqual_FloatFloat_ReturnValue_10, bool K2Node_SwitchEnum_CmpSuccess_13, const struct FVector& CallFunc_BreakTransform_Location_22, const struct FRotator& CallFunc_BreakTransform_Rotation_22, const struct FVector& CallFunc_BreakTransform_Scale_22, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_18, bool CallFunc_Less_FloatFloat_ReturnValue, const struct FTransform& CallFunc_MakeTransform_ReturnValue_28, bool K2Node_SwitchEnum_CmpSuccess_14, TArray<class UPrimitiveComponent*>& K2Node_MakeArray_Array_2, TArray<class UPrimitiveComponent*>& K2Node_MakeArray_Array_3, TArray<class UPrimitiveComponent*>& K2Node_MakeArray_Array_4, TArray<class UPrimitiveComponent*>& K2Node_MakeArray_Array_5, TArray<class UPrimitiveComponent*>& K2Node_MakeArray_Array_6, TArray<class UPrimitiveComponent*>& K2Node_MakeArray_Array_7, bool CallFunc_ClassIsChildOf_ReturnValue_1, const struct FRotator& CallFunc_NegateRotator_ReturnValue, const struct FTransform& CallFunc_GetTransform_ReturnValue, const struct FRotator& CallFunc_MakeRotFromX_ReturnValue, const struct FRotator& CallFunc_InverseTransformRotation_ReturnValue, const struct FTransform& CallFunc_ForwardShift_ShiftedLoc, const struct FRotator& CallFunc_Round_Grid_Space_Rot_to_Valid_Grid_Space_Rot_RoundedGridSpaceRot, const struct FTransform& CallFunc_BackwardsShift_ShiftedLoc_4, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_19, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_20, const struct FTransform& CallFunc_MakeTransform_ReturnValue_29, float CallFunc_BreakRotator_Roll_3, float CallFunc_BreakRotator_Pitch_3, float CallFunc_BreakRotator_Yaw_3, bool CallFunc_NearlyEqual_FloatFloat_ReturnValue_11, float CallFunc_Abs_ReturnValue_2, bool CallFunc_NearlyEqual_FloatFloat_ReturnValue_12, bool CallFunc_NearlyEqual_FloatFloat_ReturnValue_13, bool CallFunc_NearlyEqual_FloatFloat_ReturnValue_14, const struct FTransform& CallFunc_RightShift_ShiftedLoc_5, const struct FTransform& CallFunc_LeftShift_ShiftedTrans_2, const struct FTransform& CallFunc_ForwardShift_ShiftedLoc_1, const struct FTransform& CallFunc_BackwardsShift_ShiftedLoc_5, const struct FTransform& CallFunc_DownShift_ShiftedLoc_2, const struct FTransform& CallFunc_ForwardShift_ShiftedLoc_2, const struct FTransform& CallFunc_BackwardsShift_ShiftedLoc_6, const struct FVector& CallFunc_BreakTransform_Location_23, const struct FRotator& CallFunc_BreakTransform_Rotation_23, const struct FVector& CallFunc_BreakTransform_Scale_23, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_21, const struct FTransform& CallFunc_MakeTransform_ReturnValue_30, const struct FVector& CallFunc_BreakTransform_Location_24, const struct FRotator& CallFunc_BreakTransform_Rotation_24, const struct FVector& CallFunc_BreakTransform_Scale_24, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_22, bool CallFunc_Less_FloatFloat_ReturnValue_1, const struct FTransform& CallFunc_MakeTransform_ReturnValue_31, bool K2Node_SwitchEnum_CmpSuccess_15, const struct FRotator& CallFunc_NegateRotator_ReturnValue_1, const struct FTransform& CallFunc_GetTransform_ReturnValue_1, const struct FRotator& CallFunc_MakeRotFromX_ReturnValue_1, const struct FRotator& CallFunc_InverseTransformRotation_ReturnValue_1, bool CallFunc_ClassIsChildOf_ReturnValue_2, const struct FRotator& CallFunc_Round_Grid_Space_Rot_to_Valid_Grid_Space_Rot_RoundedGridSpaceRot_1, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_23, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_24, bool K2Node_SwitchEnum_CmpSuccess_16, const struct FTransform& CallFunc_MakeTransform_ReturnValue_32, const struct FTransform& CallFunc_BackwardsShift_ShiftedLoc_7, const struct FTransform& CallFunc_BackwardsShift_ShiftedLoc_8, const struct FTransform& CallFunc_RightShift_ShiftedLoc_6, const struct FTransform& CallFunc_LeftShift_ShiftedTrans_3, const struct FTransform& CallFunc_BackwardsShift_ShiftedLoc_9, const struct FTransform& CallFunc_BackwardsShift_ShiftedLoc_10, bool CallFunc_ClassIsChildOf_ReturnValue_3, bool K2Node_SwitchEnum_CmpSuccess_17, const struct FVector& CallFunc_BreakTransform_Location_25, const struct FRotator& CallFunc_BreakTransform_Rotation_25, const struct FVector& CallFunc_BreakTransform_Scale_25, const struct FTransform& CallFunc_MakeTransform_ReturnValue_33, const struct FVector& CallFunc_BreakTransform_Location_26, const struct FRotator& CallFunc_BreakTransform_Rotation_26, const struct FVector& CallFunc_BreakTransform_Scale_26, const struct FVector& CallFunc_Add_VectorVector_ReturnValue_9, const struct FTransform& CallFunc_MakeTransform_ReturnValue_34, const struct FTransform& CallFunc_RightShift_ShiftedLoc_7, const struct FTransform& CallFunc_LeftShift_ShiftedTrans_4, const struct FTransform& CallFunc_ForwardShift_ShiftedLoc_3, const struct FTransform& CallFunc_BackwardsShift_ShiftedLoc_11, const struct FVector& CallFunc_BreakTransform_Location_27, const struct FRotator& CallFunc_BreakTransform_Rotation_27, const struct FVector& CallFunc_BreakTransform_Scale_27, const struct FRotator& CallFunc_ComposeRotators_ReturnValue_25, const struct FTransform& CallFunc_ForwardShift_ShiftedLoc_4, const struct FTransform& CallFunc_MakeTransform_ReturnValue_35, const struct FTransform& CallFunc_BackwardsShift_ShiftedLoc_12, bool CallFunc_ClassIsChildOf_ReturnValue_4, const struct FVector& CallFunc_BreakTransform_Location_28, const struct FRotator& CallFunc_BreakTransform_Rotation_28, const struct FVector& CallFunc_BreakTransform_Scale_28, const struct FVector& CallFunc_Add_VectorVector_ReturnValue_10, bool CallFunc_ClassIsChildOf_ReturnValue_5, const struct FTransform& CallFunc_MakeTransform_ReturnValue_36, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_ClassIsChildOf_ReturnValue_6, bool CallFunc_ClassIsChildOf_ReturnValue_7, bool CallFunc_ClassIsChildOf_ReturnValue_8)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Building_Ramp_Diagonal_C", "ShouldRotate");

	Params::ABP_Building_Ramp_Diagonal_C_ShouldRotate_Params Parms{};
