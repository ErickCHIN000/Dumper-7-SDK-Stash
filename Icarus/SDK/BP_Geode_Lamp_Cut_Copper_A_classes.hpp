...
class ABP_Geode_Lamp_Cut_Copper_A_C : public ABP_Light_Free_Base_C
{
public:
	...
	static class ABP_Geode_Lamp_Cut_Copper_A_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_Geode_Lamp_Cut_Copper_A(int32 EntryPoint);
};
