...
class UClass* ABP_WoodenBarrel_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_WoodenBarrel_C");

	return Clss;
}


// BP_WoodenBarrel_C BP_WoodenBarrel.Default__BP_WoodenBarrel_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_WoodenBarrel_C* ABP_WoodenBarrel_C::GetDefaultObj()
{
	static class ABP_WoodenBarrel_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_WoodenBarrel_C*>(ABP_WoodenBarrel_C::StaticClass()->DefaultObject);
...
// Function BP_WoodenBarrel.BP_WoodenBarrel_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ABP_WoodenBarrel_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_WoodenBarrel_C", "ReceiveBeginPlay");
...
void ABP_WoodenBarrel_C::ReceiveTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_WoodenBarrel_C", "ReceiveTick");

	Params::ABP_WoodenBarrel_C_ReceiveTick_Params Parms{};
...
// Function BP_WoodenBarrel.BP_WoodenBarrel_C.OnWaterDepleted
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void ABP_WoodenBarrel_C::OnWaterDepleted()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_WoodenBarrel_C", "OnWaterDepleted");
