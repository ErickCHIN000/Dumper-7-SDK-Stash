...
struct UBTD_CheckLastMountMovementResult_C_PerformConditionCheck_Params
{
public:
	...
	uint8                                        CallFunc_GetBlackboardValueAsEnum_ReturnValue;     // 0x9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
