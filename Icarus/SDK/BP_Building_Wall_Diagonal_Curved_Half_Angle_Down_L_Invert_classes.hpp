...
class ABP_Building_Wall_Diagonal_Curved_Half_Angle_Down_L_Invert_C : public ABP_Building_Wall_Diagonal_Curved_C
{
public:

	static class UClass* StaticClass();
	static class ABP_Building_Wall_Diagonal_Curved_Half_Angle_Down_L_Invert_C* GetDefaultObj();
