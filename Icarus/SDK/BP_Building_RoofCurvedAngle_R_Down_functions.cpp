...
class UClass* ABP_Building_RoofCurvedAngle_R_Down_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Building_RoofCurvedAngle_R_Down_C");

	return Clss;
}


// BP_Building_RoofCurvedAngle_R_Down_C BP_Building_RoofCurvedAngle_R_Down.Default__BP_Building_RoofCurvedAngle_R_Down_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Building_RoofCurvedAngle_R_Down_C* ABP_Building_RoofCurvedAngle_R_Down_C::GetDefaultObj()
{
	static class ABP_Building_RoofCurvedAngle_R_Down_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Building_RoofCurvedAngle_R_Down_C*>(ABP_Building_RoofCurvedAngle_R_Down_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_Building_RoofCurvedAngle_R_Down.BP_Building_RoofCurvedAngle_R_Down_C.GetBlockingBypass
