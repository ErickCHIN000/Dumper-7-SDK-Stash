...
class UClass* UBP_Actionable_Tonic_Consumable_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Actionable_Tonic_Consumable_C");

	return Clss;
}


// BP_Actionable_Tonic_Consumable_C BP_Actionable_Tonic_Consumable.Default__BP_Actionable_Tonic_Consumable_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_Actionable_Tonic_Consumable_C* UBP_Actionable_Tonic_Consumable_C::GetDefaultObj()
{
	static class UBP_Actionable_Tonic_Consumable_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_Actionable_Tonic_Consumable_C*>(UBP_Actionable_Tonic_Consumable_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_Actionable_Tonic_Consumable.BP_Actionable_Tonic_Consumable_C.CanHold
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor)

bool UBP_Actionable_Tonic_Consumable_C::CanHold()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Actionable_Tonic_Consumable_C", "CanHold");

	Params::UBP_Actionable_Tonic_Consumable_C_CanHold_Params Parms{};
...
// Function BP_Actionable_Tonic_Consumable.BP_Actionable_Tonic_Consumable_C.CompleteHold
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                               Success                                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UBP_Actionable_Tonic_Consumable_C::CompleteHold(bool Success)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Actionable_Tonic_Consumable_C", "CompleteHold");

	Params::UBP_Actionable_Tonic_Consumable_C_CompleteHold_Params Parms{};
...
// Function BP_Actionable_Tonic_Consumable.BP_Actionable_Tonic_Consumable_C.ExecuteUbergraph_BP_Actionable_Tonic_Consumable
...
void UBP_Actionable_Tonic_Consumable_C::ExecuteUbergraph_BP_Actionable_Tonic_Consumable(int32 EntryPoint, class AIcarusPlayerCharacter* CallFunc_GetPlayer_OwningPlayer, bool K2Node_Event_Success, class AIcarusPlayerCharacterSurvival* K2Node_DynamicCast_AsIcarus_Player_Character_Survival, bool K2Node_DynamicCast_bSuccess, class AIcarusPlayerController* CallFunc_GetIcarusPlayerController_ReturnValue, class UInventory* CallFunc_GetFocusedItemInventoryAndSlot_FocusedItemInventory, int32 CallFunc_GetFocusedItemInventoryAndSlot_FocusedItemSlot, enum class EDataValidity CallFunc_GetFocusedItemInventoryAndSlot_Validity, bool CallFunc_LocalOrServer_Local, bool CallFunc_LocalOrServer_Server, bool K2Node_SwitchEnum_CmpSuccess)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Actionable_Tonic_Consumable_C", "ExecuteUbergraph_BP_Actionable_Tonic_Consumable");

	Params::UBP_Actionable_Tonic_Consumable_C_ExecuteUbergraph_BP_Actionable_Tonic_Consumable_Params Parms{};
