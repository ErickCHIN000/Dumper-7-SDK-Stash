...
public:
	...
	uint8                                        Pad_525[0x34];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_529[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_549[0x2C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_557[0x24];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_573[0x68];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_575[0xC];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_5A9[0xB0];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_5D1[0xB0];                                     // Fixing Size Of Struct [ Dumper-7 ]
