...
struct ABP_Building_Wall_Diagonal_Curved_Half_Angle_Up_R_Invert_C_GetBlockingBypass_Params
{
public:
	...
	uint8                                        Pad_4A44[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FVectorPair                           K2Node_MakeStruct_VectorPair;                      // 0xE4(0x18)(NoDestructor)
	bool                                         CallFunc_NotEqual_RotatorRotator_ReturnValue;      // 0xFC(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_4AA9[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FVectorPair                           K2Node_MakeStruct_VectorPair_1;                    // 0x100(0x18)(NoDestructor)
	struct FVectorPair                           K2Node_MakeStruct_VectorPair_2;                    // 0x118(0x18)(NoDestructor)
	struct FVectorPair                           K2Node_MakeStruct_VectorPair_3;                    // 0x130(0x18)(NoDestructor)
