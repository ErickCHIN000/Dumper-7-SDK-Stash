...
class UClass* UUMG_ToolDamage_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UMG_ToolDamage_C");

	return Clss;
}


// UMG_ToolDamage_C UMG_ToolDamage.Default__UMG_ToolDamage_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUMG_ToolDamage_C* UUMG_ToolDamage_C::GetDefaultObj()
{
	static class UUMG_ToolDamage_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUMG_ToolDamage_C*>(UUMG_ToolDamage_C::StaticClass()->DefaultObject);

	return Default;
}


// Function UMG_ToolDamage.UMG_ToolDamage_C.UpdateDamage
...
// class UUMG_DamageVariation_C*      Target                                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UUMG_ToolDamage_C::UpdateDamage(class FText Type, const struct FStatsEnum& Damage, const struct FStatsEnum& Variation, class UUMG_DamageVariation_C* Target, bool* Valid, int32 CallFunc_Get_Damage_Variation_Specific_Minimum, int32 CallFunc_Get_Damage_Variation_Specific_Maximum, bool CallFunc_NotEqual_IntInt_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("UMG_ToolDamage_C", "UpdateDamage");

	Params::UUMG_ToolDamage_C_UpdateDamage_Params Parms{};
...
// Function UMG_ToolDamage.UMG_ToolDamage_C.Update
...
// Function UMG_ToolDamage.UMG_ToolDamage_C.BP_OnEntryReleased
// (Event, Protected, BlueprintEvent)
// Parameters:

void UUMG_ToolDamage_C::BP_OnEntryReleased()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("UMG_ToolDamage_C", "BP_OnEntryReleased");
...
// Function UMG_ToolDamage.UMG_ToolDamage_C.BP_OnItemExpansionChanged
// (Event, Protected, BlueprintEvent)
// Parameters:
// bool                               bIsExpanded                                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UUMG_ToolDamage_C::BP_OnItemExpansionChanged(bool bIsExpanded)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("UMG_ToolDamage_C", "BP_OnItemExpansionChanged");

	Params::UUMG_ToolDamage_C_BP_OnItemExpansionChanged_Params Parms{};
...
// Function UMG_ToolDamage.UMG_ToolDamage_C.BP_OnItemSelectionChanged
// (Event, Protected, BlueprintEvent)
// Parameters:
// bool                               bIsSelected                                                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UUMG_ToolDamage_C::BP_OnItemSelectionChanged(bool bIsSelected)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("UMG_ToolDamage_C", "BP_OnItemSelectionChanged");

	Params::UUMG_ToolDamage_C_BP_OnItemSelectionChanged_Params Parms{};
...
// Function UMG_ToolDamage.UMG_ToolDamage_C.ExecuteUbergraph_UMG_ToolDamage
...
void UUMG_ToolDamage_C::ExecuteUbergraph_UMG_ToolDamage(int32 EntryPoint, bool K2Node_Event_bIsSelected, bool K2Node_Event_bIsExpanded)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("UMG_ToolDamage_C", "ExecuteUbergraph_UMG_ToolDamage");

	Params::UUMG_ToolDamage_C_ExecuteUbergraph_UMG_ToolDamage_Params Parms{};
