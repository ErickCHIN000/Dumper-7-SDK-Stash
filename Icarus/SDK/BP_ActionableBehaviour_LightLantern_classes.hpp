...
{
public:
	uint8                                        Pad_5D7D[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class UBP_ActionableBehaviour_LightLantern_C* GetDefaultObj();
