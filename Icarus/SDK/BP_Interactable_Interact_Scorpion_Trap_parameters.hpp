...
struct UBP_Interactable_Interact_Scorpion_Trap_C_CanInteract_Params
{
public:
	...
	class ABP_Scorpion_Trap_Medium_C*            K2Node_DynamicCast_AsBP_Scorpion_Trap_Medium;      // 0x98(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0xA0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

// 0x90 (0x90 - 0x0)
// Function BP_Interactable_Interact_Scorpion_Trap.BP_Interactable_Interact_Scorpion_Trap_C.Interact
struct UBP_Interactable_Interact_Scorpion_Trap_C_Interact_Params
{
public:
	class AActor*                                Instigator;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UBP_Interactable_Interact_Scorpion_Trap_C_ExecuteUbergraph_BP_Interactable_Interact_Scorpion_Trap_Params
{
public:
