...
class UUMG_FieldGuideResourceItemsFewGrid_C : public UFieldGuidePageWidgetBase
{
public:
	...
	static class UUMG_FieldGuideResourceItemsFewGrid_C* GetDefaultObj();
	...
	void ExecuteUbergraph_UMG_FieldGuideResourceItemsFewGrid(int32 EntryPoint, const struct FItemsStaticRowHandle& K2Node_Event_ItemIn, const struct FFieldGuideCategoriesRowHandle& K2Node_Event_CategoryIn);
};
