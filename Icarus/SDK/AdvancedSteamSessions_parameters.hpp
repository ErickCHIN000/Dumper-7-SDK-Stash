...
public:
	...
	uint8                                        Pad_260[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	bool                                         ReturnValue;                                       // 0x21(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_277[0x6];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
// 0x138 (0x138 - 0x0)
// Function AdvancedSteamSessions.JoinSessionCallbackProxyAdvanced.JoinAdvancedSession
struct UJoinSessionCallbackProxyAdvanced_JoinAdvancedSession_Params
{
public:
	...
	class FName                                  SessionName;                                       // 0x118(0x8)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                Options;                                           // 0x120(0x10)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UJoinSessionCallbackProxyAdvanced*     ReturnValue;                                       // 0x130(0x8)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
