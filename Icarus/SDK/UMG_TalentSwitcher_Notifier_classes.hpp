...
public:
	...
	static class UUMG_TalentSwitcher_Notifier_C* GetDefaultObj();

	void Is_Point_Available(bool HasPoints, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, enum class ESlateVisibility K2Node_Select_Default);
	void Construct();
	void ExecuteUbergraph_UMG_TalentSwitcher_Notifier(int32 EntryPoint, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue);
};
