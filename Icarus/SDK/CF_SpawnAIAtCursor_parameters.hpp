...
struct UCF_SpawnAIAtCursor_C_OnConstruction_Params
{
public:
...
struct UCF_SpawnAIAtCursor_C_ExecuteUbergraph_CF_SpawnAIAtCursor_Params
{
public:
	...
	class UUserWidget*                           CallFunc_GetSelectedWidget_ReturnValue;            // 0x10(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UAIRow_C*                              K2Node_DynamicCast_AsAIRow;                        // 0x20(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
