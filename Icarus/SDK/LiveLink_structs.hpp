...
public:
	...
	uint8                                        Pad_F9D[0x18];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_FA9[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_FB1[0x1];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
