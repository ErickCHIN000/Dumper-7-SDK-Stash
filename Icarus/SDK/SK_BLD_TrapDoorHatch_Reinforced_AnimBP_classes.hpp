...
{
public:
	uint8                                        Pad_66FF[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class USK_BLD_TrapDoorHatch_Reinforced_AnimBP_C* GetDefaultObj();
