...
class UBP_Interactable_Water_Purifier_Drink_C : public UInteractableBehaviour
{
public:
	...
	static class UBP_Interactable_Water_Purifier_Drink_C* GetDefaultObj();
