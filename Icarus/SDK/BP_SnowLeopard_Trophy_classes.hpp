...
class ABP_SnowLeopard_Trophy_C : public ABP_DeployableBase_C
{
public:
	...
	static class ABP_SnowLeopard_Trophy_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_SnowLeopard_Trophy(int32 EntryPoint);
};
