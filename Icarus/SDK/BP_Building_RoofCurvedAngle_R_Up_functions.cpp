...
// BlueprintGeneratedClass BP_Building_RoofCurvedAngle_R_Up.BP_Building_RoofCurvedAngle_R_Up_C
// (Actor)

class UClass* ABP_Building_RoofCurvedAngle_R_Up_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Building_RoofCurvedAngle_R_Up_C");

	return Clss;
}


// BP_Building_RoofCurvedAngle_R_Up_C BP_Building_RoofCurvedAngle_R_Up.Default__BP_Building_RoofCurvedAngle_R_Up_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Building_RoofCurvedAngle_R_Up_C* ABP_Building_RoofCurvedAngle_R_Up_C::GetDefaultObj()
{
	static class ABP_Building_RoofCurvedAngle_R_Up_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Building_RoofCurvedAngle_R_Up_C*>(ABP_Building_RoofCurvedAngle_R_Up_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_Building_RoofCurvedAngle_R_Up.BP_Building_RoofCurvedAngle_R_Up_C.GetBlockingBypass
