...
class USK_CRE_Spider_Corpse_AnimBP_C : public UIcarusCorpseAnimInstance
{
public:
	...
	static class USK_CRE_Spider_Corpse_AnimBP_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_SK_CRE_Spider_Corpse_AnimBP(int32 EntryPoint);
};
