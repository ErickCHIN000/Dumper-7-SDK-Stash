...
struct UUMG_Waterwheel_C_BndEvt__CloseButton_K2Node_ComponentBoundEvent_7_Clicked__DelegateSignature_Params
{
public:
...
struct UUMG_Waterwheel_C_Tick_Params
{
public:
...
struct UUMG_Waterwheel_C_CloseUI_Params
{
public:
...
struct UUMG_Waterwheel_C_ExecuteUbergraph_UMG_Waterwheel_Params
{
public:
	...
	uint8                                        Pad_5FEC[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5FFF[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	enum class EValid                            CallFunc_GetTrait_Paths;                           // 0x88(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_6008[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UGeneratorComponent*                   CallFunc_GetTrait_ReturnValue;                     // 0x90(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGeneratorData                        CallFunc_GetGeneratorData_OutData;                 // 0x98(0x50)(None)
	bool                                         CallFunc_GetGeneratorData_ReturnValue;             // 0xE8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	uint8                                        Pad_6018[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class AActor*                                K2Node_CustomEvent_Actor;                          // 0x100(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class EEndPlayReason                    K2Node_CustomEvent_EndPlayReason;                  // 0x108(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
