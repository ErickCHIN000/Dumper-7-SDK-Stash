...
class ABP_PolarBear_Trophy_C : public ABP_DeployableBase_C
{
public:
	...
	static class ABP_PolarBear_Trophy_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_PolarBear_Trophy(int32 EntryPoint);
};
