...
class ABP_Geode_Lamp_Cut_Gold_A_C : public ABP_Light_Free_Base_C
{
public:
	...
	static class ABP_Geode_Lamp_Cut_Gold_A_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_Geode_Lamp_Cut_Gold_A(int32 EntryPoint);
};
