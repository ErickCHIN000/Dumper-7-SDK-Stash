...
public:
	...
	static class UBP_Interactable_UnlinkBeacon_C* GetDefaultObj();
	...
	void ExecuteUbergraph_BP_Interactable_UnlinkBeacon(int32 EntryPoint, class AActor* K2Node_Event_Instigator, const struct FHitResult& K2Node_Event_HitResult, class ABP_SkeletalItem_Beacon_Tool_C* CallFunc_GetInstigatorBeaconTool_BeaconTool, bool CallFunc_IsValid_ReturnValue);
};
