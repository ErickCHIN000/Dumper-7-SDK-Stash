...
class UClass* ABP_PotBellyStove_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_PotBellyStove_C");

	return Clss;
}


// BP_PotBellyStove_C BP_PotBellyStove.Default__BP_PotBellyStove_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_PotBellyStove_C* ABP_PotBellyStove_C::GetDefaultObj()
{
	static class ABP_PotBellyStove_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_PotBellyStove_C*>(ABP_PotBellyStove_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_PotBellyStove.BP_PotBellyStove_C.ProcessorStateUpdate
...
void ABP_PotBellyStove_C::ProcessorStateUpdate(bool Active, bool CallFunc_IsServer_ReturnValue, enum class EValid CallFunc_GetTrait_Paths, class UGeneratorComponent* CallFunc_GetTrait_ReturnValue, bool CallFunc_ActivateGenerator_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_PotBellyStove_C", "ProcessorStateUpdate");

	Params::ABP_PotBellyStove_C_ProcessorStateUpdate_Params Parms{};
...
// Function BP_PotBellyStove.BP_PotBellyStove_C.GeneratorStateUpdate
