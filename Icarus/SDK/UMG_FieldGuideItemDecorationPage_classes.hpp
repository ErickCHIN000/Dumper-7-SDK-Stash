...
class UUMG_FieldGuideItemDecorationPage_C : public UFieldGuidePageWidgetBase
{
public:
	...
	static class UUMG_FieldGuideItemDecorationPage_C* GetDefaultObj();
	...
	void ExecuteUbergraph_UMG_FieldGuideItemDecorationPage(int32 EntryPoint, const struct FItemsStaticRowHandle& K2Node_Event_ItemIn, const struct FFieldGuideCategoriesRowHandle& K2Node_Event_CategoryIn);
};
