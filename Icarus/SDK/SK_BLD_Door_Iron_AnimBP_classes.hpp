...
class USK_BLD_Door_Iron_AnimBP_C : public UAnimInstance
{
public:
	uint8                                        Pad_6736[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class USK_BLD_Door_Iron_AnimBP_C* GetDefaultObj();
