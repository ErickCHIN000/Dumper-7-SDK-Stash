...
// JoinSessionCallbackProxyAdvanced AdvancedSteamSessions.Default__JoinSessionCallbackProxyAdvanced
...
class UJoinSessionCallbackProxyAdvanced* UJoinSessionCallbackProxyAdvanced::JoinAdvancedSession(class UObject* WorldContextObject, class APlayerController* PlayerController, struct FBlueprintSessionResult& SearchResult, class FName SessionName, const class FString& Options)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("JoinSessionCallbackProxyAdvanced", "JoinAdvancedSession");

	Params::UJoinSessionCallbackProxyAdvanced_JoinAdvancedSession_Params Parms{};
