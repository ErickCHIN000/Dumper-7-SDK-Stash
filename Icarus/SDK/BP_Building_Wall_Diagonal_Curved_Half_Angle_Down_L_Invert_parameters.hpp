...
struct ABP_Building_Wall_Diagonal_Curved_Half_Angle_Down_L_Invert_C_GetBlockingBypass_Params
{
public:
	...
	uint8                                        Pad_42C2[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
