...
class ABP_LavaHunter_Spit_C : public ASkeletalItem
{
public:
	uint8                                        Pad_606B[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class ABP_LavaHunter_Spit_C* GetDefaultObj();
