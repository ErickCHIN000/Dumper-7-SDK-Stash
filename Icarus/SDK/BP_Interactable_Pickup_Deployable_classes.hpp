...
public:
	...
	static class UBP_Interactable_Pickup_Deployable_C* GetDefaultObj();
	...
	void ExecuteUbergraph_BP_Interactable_Pickup_Deployable(int32 EntryPoint, class AActor* CallFunc_GetOwner_ReturnValue, class ABP_DeployableBase_C* K2Node_DynamicCast_AsBP_Deployable_Base, bool K2Node_DynamicCast_bSuccess);
};
