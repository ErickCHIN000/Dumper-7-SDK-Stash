...
// bool                               bKeepParameterValues                                             (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFMODAudioComponent::SetEvent(class UFMODEvent* NewEvent, bool bKeepParameterValues)
{
	static class UFunction* Func = nullptr;
	...
	Parms.bKeepParameterValues = bKeepParameterValues;
...
// enum class EFMODValid              IsValid                                                          (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                               bUseListenerRotation                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UFMODAudioComponent* UFMODBlueprintStatics::PlayEventAttached(class UFMODEvent* Event, class USceneComponent* AttachToComponent, class FName AttachPointName, const struct FVector& Location, enum class EAttachLocation LocationType, bool bStopWhenAttachedToDestroyed, bool bAutoPlay, bool bAutoDestroy, enum class EFMODValid* IsValid, bool bUseListenerRotation)
{
	...
	Parms.bUseListenerRotation = bUseListenerRotation;
...
struct FFMODEventInstance UFMODBlueprintStatics::PlayEventAtLocation(class UObject* WorldContextObject, class UFMODEvent* Event, struct FTransform& Location, bool bAutoPlay, bool bUseListenerRotation)
{
	static class UFunction* Func = nullptr;
