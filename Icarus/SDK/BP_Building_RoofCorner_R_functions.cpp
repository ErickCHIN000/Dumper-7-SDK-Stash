...
// BlueprintGeneratedClass BP_Building_RoofCorner_R.BP_Building_RoofCorner_R_C
// (Actor)

class UClass* ABP_Building_RoofCorner_R_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Building_RoofCorner_R_C");

	return Clss;
}


// BP_Building_RoofCorner_R_C BP_Building_RoofCorner_R.Default__BP_Building_RoofCorner_R_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Building_RoofCorner_R_C* ABP_Building_RoofCorner_R_C::GetDefaultObj()
{
	static class ABP_Building_RoofCorner_R_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Building_RoofCorner_R_C*>(ABP_Building_RoofCorner_R_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_Building_RoofCorner_R.BP_Building_RoofCorner_R_C.GetBlockingBypass
