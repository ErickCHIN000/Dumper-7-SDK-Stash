...
class UBP_Interactable_Fill_Water_Trough_C : public UInteractableBehaviour
{
public:
	...
	static class UBP_Interactable_Fill_Water_Trough_C* GetDefaultObj();
	...
	void ExecuteUbergraph_BP_Interactable_Fill_Water_Trough(int32 EntryPoint, class AActor* K2Node_CustomEvent_Instigator, class AActor* K2Node_Event_Instigator, const struct FHitResult& K2Node_Event_HitResult, class ABP_IcarusPlayerCharacterSurvival_C* K2Node_DynamicCast_AsBP_Icarus_Player_Character_Survival, bool K2Node_DynamicCast_bSuccess, class AActor* CallFunc_GetOwner_ReturnValue, enum class EValid CallFunc_GetTrait_Paths, class UBP_FillableComponent_C* CallFunc_GetTrait_ReturnValue, class AIcarusActor* K2Node_DynamicCast_AsIcarus_Actor, bool K2Node_DynamicCast_bSuccess_1, int32 CallFunc_GetStoredUnits_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess, int32 CallFunc_AddContainerActorCapacity_ReturnValue);
};
