...
class UClass* UUMG_NotificationAttachments_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UMG_NotificationAttachments_C");

	return Clss;
}


// UMG_NotificationAttachments_C UMG_NotificationAttachments.Default__UMG_NotificationAttachments_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUMG_NotificationAttachments_C* UUMG_NotificationAttachments_C::GetDefaultObj()
{
	static class UUMG_NotificationAttachments_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUMG_NotificationAttachments_C*>(UUMG_NotificationAttachments_C::StaticClass()->DefaultObject);

	return Default;
}


// Function UMG_NotificationAttachments.UMG_NotificationAttachments_C.UpdateAttachments
