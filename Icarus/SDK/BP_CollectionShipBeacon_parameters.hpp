...
struct ABP_CollectionShipBeacon_C_DoLaunchCollectionShip_Params
{
public:
	int32                                        ExoticCount;                                       // 0x0(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_49DD[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	int32                                        CallFunc_FindStaticStackTotal_ReturnValue;         // 0x1C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct ABP_CollectionShipBeacon_C_Deployable_Interact_Params
{
public:
...
struct ABP_CollectionShipBeacon_C_ExecuteUbergraph_BP_CollectionShipBeacon_Params
{
public:
