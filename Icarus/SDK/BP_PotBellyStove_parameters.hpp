...
struct ABP_PotBellyStove_C_ProcessorStateUpdate_Params
{
public:
	...
	uint8                                        Pad_6773[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct ABP_PotBellyStove_C_GeneratorStateUpdate_Params
{
public:
	bool                                         Active;                                            // 0x0(0x1)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_IsServer_ReturnValue;                     // 0x1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	enum class EValid                            CallFunc_GetTrait_Paths;                           // 0x2(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_67B1[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
