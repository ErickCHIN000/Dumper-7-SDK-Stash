...
public:
	...
	static class ABP_Seat_Bed_C* GetDefaultObj();

	void GetAudioSeatType(enum class EAudioSeatType* Type);
	...
	void ExecuteUbergraph_BP_Seat_Bed(int32 EntryPoint, bool CallFunc_IsServer_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class AActor* CallFunc_GetOwner_ReturnValue, class AActor* K2Node_CustomEvent_DestroyedActor);
};
