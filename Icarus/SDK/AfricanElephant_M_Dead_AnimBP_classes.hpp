...
class UAfricanElephant_M_Dead_AnimBP_C : public UIcarusCorpseAnimInstance
{
public:
	...
	static class UAfricanElephant_M_Dead_AnimBP_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_AfricanElephant_M_Dead_AnimBP(int32 EntryPoint);
};
