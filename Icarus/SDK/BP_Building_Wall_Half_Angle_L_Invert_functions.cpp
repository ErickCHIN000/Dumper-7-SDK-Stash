...
// BlueprintGeneratedClass BP_Building_Wall_Half_Angle_L_Invert.BP_Building_Wall_Half_Angle_L_Invert_C
// (Actor)

class UClass* ABP_Building_Wall_Half_Angle_L_Invert_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Building_Wall_Half_Angle_L_Invert_C");

	return Clss;
}


// BP_Building_Wall_Half_Angle_L_Invert_C BP_Building_Wall_Half_Angle_L_Invert.Default__BP_Building_Wall_Half_Angle_L_Invert_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Building_Wall_Half_Angle_L_Invert_C* ABP_Building_Wall_Half_Angle_L_Invert_C::GetDefaultObj()
{
	static class ABP_Building_Wall_Half_Angle_L_Invert_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Building_Wall_Half_Angle_L_Invert_C*>(ABP_Building_Wall_Half_Angle_L_Invert_C::StaticClass()->DefaultObject);
