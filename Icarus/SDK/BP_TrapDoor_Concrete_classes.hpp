...
class ABP_TrapDoor_Concrete_C : public ABP_Door_Base_C
{
public:
	...
	static class ABP_TrapDoor_Concrete_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_TrapDoor_Concrete(int32 EntryPoint);
};
