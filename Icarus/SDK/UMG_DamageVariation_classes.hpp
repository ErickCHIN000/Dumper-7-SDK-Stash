...
class UUMG_DamageVariation_C : public UUserWidget
{
public:
	...
	static class UUMG_DamageVariation_C* GetDefaultObj();
	...
	void Construct();
	void ExecuteUbergraph_UMG_DamageVariation(int32 EntryPoint, bool K2Node_Event_bIsExpanded, bool K2Node_Event_bIsSelected);
};
