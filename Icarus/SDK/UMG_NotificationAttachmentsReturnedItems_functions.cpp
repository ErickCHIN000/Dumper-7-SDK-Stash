...
// WidgetBlueprintGeneratedClass UMG_NotificationAttachmentsReturnedItems.UMG_NotificationAttachmentsReturnedItems_C
// (None)

class UClass* UUMG_NotificationAttachmentsReturnedItems_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("UMG_NotificationAttachmentsReturnedItems_C");

	return Clss;
}


// UMG_NotificationAttachmentsReturnedItems_C UMG_NotificationAttachmentsReturnedItems.Default__UMG_NotificationAttachmentsReturnedItems_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UUMG_NotificationAttachmentsReturnedItems_C* UUMG_NotificationAttachmentsReturnedItems_C::GetDefaultObj()
{
	static class UUMG_NotificationAttachmentsReturnedItems_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UUMG_NotificationAttachmentsReturnedItems_C*>(UUMG_NotificationAttachmentsReturnedItems_C::StaticClass()->DefaultObject);
