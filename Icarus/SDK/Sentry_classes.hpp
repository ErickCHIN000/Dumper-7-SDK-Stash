...
{
public:
	uint8                                        Pad_7D1[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_965[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	bool                                         InitAutomatically;                                 // 0x48(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FAutomaticBreadcrumbs                 AutomaticBreadcrumbs;                              // 0x49(0x5)(Edit, BlueprintVisible, Config, NoDestructor, NativeAccessSpecifierPublic)
	bool                                         UploadSymbolsAutomatically;                        // 0x4E(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_CE7[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class FString                                PropertiesFilePath;                                // 0x50(0x10)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_DED[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_EC9[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
