...
class ABP_Masonry_Bench_T3_C : public ABP_ProcessorBase_C
{
public:
	...
	static class ABP_Masonry_Bench_T3_C* GetDefaultObj();
	...
	void ExecuteUbergraph_BP_Masonry_Bench_T3(int32 EntryPoint);
};
