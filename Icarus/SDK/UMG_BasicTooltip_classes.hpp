...
class UUMG_BasicTooltip_C : public UUserWidget
{
public:
	...
	static class UUMG_BasicTooltip_C* GetDefaultObj();

	void Construct();
	void SetText(class FText ToolTipText);
	void ExecuteUbergraph_UMG_BasicTooltip(int32 EntryPoint, class FText K2Node_CustomEvent_ToolTipText);
};
