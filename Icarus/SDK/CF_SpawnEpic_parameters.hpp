...
struct UCF_SpawnEpic_C_OnConstruction_Params
{
public:
	int32                                        Temp_int_Variable;                                 // 0x0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        Temp_int_Variable_1;                               // 0x4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FEpicCreaturesEnum                    CallFunc_IntToStruct_ReturnValue;                  // 0x8(0x10)(HasGetValueTypeHash)
	...
	class UEpicRow_C*                            CallFunc_Create_ReturnValue;                       // 0x50(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UCF_SpawnEpic_C_Handle_Execute_Params
{
public:
...
struct UCF_SpawnEpic_C_ExecuteUbergraph_CF_SpawnEpic_Params
{
public:
	...
	class UEpicRow_C*                            K2Node_DynamicCast_AsEpic_Row;                     // 0x48(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess_1;                     // 0x50(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_24FC[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FEpicCreatures                        CallFunc_GetEpicCreaturesStruct_EpicCreatures;     // 0x58(0x90)(None)
	enum class EValid                            CallFunc_GetEpicCreaturesStruct_Paths;             // 0xE8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
