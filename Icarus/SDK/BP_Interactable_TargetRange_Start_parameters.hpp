...
struct UBP_Interactable_TargetRange_Start_C_CanInteract_Params
{
public:
...
struct UBP_Interactable_TargetRange_Start_C_Interact_Params
{
public:
	class AActor*                                Instigator;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UBP_Interactable_TargetRange_Start_C_ExecuteUbergraph_BP_Interactable_TargetRange_Start_Params
{
public:
	...
	uint8                                        Pad_474[0x7];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class AActor*                                CallFunc_GetOwner_ReturnValue;                     // 0xA8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ATargetRangeTrigger*                   K2Node_DynamicCast_AsTarget_Range_Trigger;         // 0xB0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
