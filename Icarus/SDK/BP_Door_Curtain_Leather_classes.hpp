...
class ABP_Door_Curtain_Leather_C : public ABP_DeployableBase_C
{
public:
	...
	static class ABP_Door_Curtain_Leather_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_Door_Curtain_Leather(int32 EntryPoint);
};
