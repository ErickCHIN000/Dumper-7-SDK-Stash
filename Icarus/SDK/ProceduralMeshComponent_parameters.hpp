...
public:
	...
	uint8                                        Pad_1A6[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1C1[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	int32                                        LODIndex;                                          // 0x8(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1C9[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
