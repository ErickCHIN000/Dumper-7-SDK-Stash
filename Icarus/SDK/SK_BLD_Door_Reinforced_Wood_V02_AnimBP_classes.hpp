...
class USK_BLD_Door_Reinforced_Wood_V02_AnimBP_C : public UAnimInstance
{
public:
	uint8                                        Pad_66FA[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class USK_BLD_Door_Reinforced_Wood_V02_AnimBP_C* GetDefaultObj();
