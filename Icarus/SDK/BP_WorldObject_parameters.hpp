...
struct ABP_WorldObject_C_Play_Interact_Sound_Params
{
public:
	...
	uint8                                        Pad_31D0[0xD];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct ABP_WorldObject_C_WorldObject_Held_Interact_Params
{
public:
...
struct ABP_WorldObject_C_WorldObject_Interact_Params
{
public:
	class AActor*                                Instigator;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
