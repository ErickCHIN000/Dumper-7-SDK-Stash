...
struct UBTTask_PreEmerge_C_ReceiveExecuteAI_Params
{
public:
...
struct UBTTask_PreEmerge_C_ExecuteUbergraph_BTTask_PreEmerge_Params
{
public:
	...
	class AIcarusNPCGOAPCharacter*               K2Node_DynamicCast_AsIcarus_NPCGOAPCharacter;      // 0x18(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ABP_Faction_Mission_Boss_Den_C*        K2Node_DynamicCast_AsBP_Faction_Mission_Boss_Den;  // 0x30(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
