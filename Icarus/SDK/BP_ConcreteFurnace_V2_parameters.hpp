...
struct ABP_ConcreteFurnace_V2_C_GeneratorStateUpdate_Params
{
public:
	...
	class UThermalComponent*                     CallFunc_GetTrait_ReturnValue;                     // 0x20(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_4028[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         CallFunc_IsPlaying_ReturnValue;                    // 0x88(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
