...
{
public:
	uint8                                        Pad_78F[0x2A8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_79A[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_83A[0x10];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_8E6[0x70];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_8F4[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_910[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
