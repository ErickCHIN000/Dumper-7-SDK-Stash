...
struct UUMG_OxiteTooltip_C_ExecuteUbergraph_UMG_OxiteTooltip_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FItemsStaticRowHandle                 CallFunc_MakeLiteralItemsStatic_ReturnValue;       // 0x4(0x18)(NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_9C9[0x4];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class UBP_UIProjectionComponent_Generic_C*   K2Node_DynamicCast_AsBP_UIProjection_Component_Generic; // 0x20(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	int32                                        CallFunc_FindStaticStackTotal_ReturnValue;         // 0x48(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
