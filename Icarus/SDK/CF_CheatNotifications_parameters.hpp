...
struct UCF_CheatNotifications_C_GetCheckboxState_Params
{
public:
	bool                                         ReturnValue;                                       // 0x0(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor)
	uint8                                        Pad_2391[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class AGameStateBase*                        CallFunc_GetGameState_ReturnValue;                 // 0x8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class AIcarusGameStateBase*                  K2Node_DynamicCast_AsIcarus_Game_State_Base;       // 0x10(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x18(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

// 0x1 (0x1 - 0x0)
// Function CF_CheatNotifications.CF_CheatNotifications_C.OnCheckboxStateChanged
struct UCF_CheatNotifications_C_OnCheckboxStateChanged_Params
{
public:
...
struct UCF_CheatNotifications_C_ExecuteUbergraph_CF_CheatNotifications_Params
{
public:
