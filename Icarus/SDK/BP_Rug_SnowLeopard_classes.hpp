...
class ABP_Rug_SnowLeopard_C : public ABP_DeployableBase_C
{
public:
	...
	static class ABP_Rug_SnowLeopard_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_Rug_SnowLeopard(int32 EntryPoint);
};
