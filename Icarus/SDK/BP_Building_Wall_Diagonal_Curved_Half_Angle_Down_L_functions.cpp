...
// BlueprintGeneratedClass BP_Building_Wall_Diagonal_Curved_Half_Angle_Down_L.BP_Building_Wall_Diagonal_Curved_Half_Angle_Down_L_C
// (Actor)

class UClass* ABP_Building_Wall_Diagonal_Curved_Half_Angle_Down_L_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Building_Wall_Diagonal_Curved_Half_Angle_Down_L_C");

	return Clss;
}


// BP_Building_Wall_Diagonal_Curved_Half_Angle_Down_L_C BP_Building_Wall_Diagonal_Curved_Half_Angle_Down_L.Default__BP_Building_Wall_Diagonal_Curved_Half_Angle_Down_L_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Building_Wall_Diagonal_Curved_Half_Angle_Down_L_C* ABP_Building_Wall_Diagonal_Curved_Half_Angle_Down_L_C::GetDefaultObj()
{
	static class ABP_Building_Wall_Diagonal_Curved_Half_Angle_Down_L_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Building_Wall_Diagonal_Curved_Half_Angle_Down_L_C*>(ABP_Building_Wall_Diagonal_Curved_Half_Angle_Down_L_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_Building_Wall_Diagonal_Curved_Half_Angle_Down_L.BP_Building_Wall_Diagonal_Curved_Half_Angle_Down_L_C.GetBlockingBypass
