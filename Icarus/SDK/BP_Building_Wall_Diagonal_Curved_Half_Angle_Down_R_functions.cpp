...
// BlueprintGeneratedClass BP_Building_Wall_Diagonal_Curved_Half_Angle_Down_R.BP_Building_Wall_Diagonal_Curved_Half_Angle_Down_R_C
// (Actor)

class UClass* ABP_Building_Wall_Diagonal_Curved_Half_Angle_Down_R_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Building_Wall_Diagonal_Curved_Half_Angle_Down_R_C");

	return Clss;
}


// BP_Building_Wall_Diagonal_Curved_Half_Angle_Down_R_C BP_Building_Wall_Diagonal_Curved_Half_Angle_Down_R.Default__BP_Building_Wall_Diagonal_Curved_Half_Angle_Down_R_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Building_Wall_Diagonal_Curved_Half_Angle_Down_R_C* ABP_Building_Wall_Diagonal_Curved_Half_Angle_Down_R_C::GetDefaultObj()
{
	static class ABP_Building_Wall_Diagonal_Curved_Half_Angle_Down_R_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Building_Wall_Diagonal_Curved_Half_Angle_Down_R_C*>(ABP_Building_Wall_Diagonal_Curved_Half_Angle_Down_R_C::StaticClass()->DefaultObject);
