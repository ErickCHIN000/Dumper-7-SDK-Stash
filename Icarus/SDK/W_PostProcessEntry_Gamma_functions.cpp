...
class UClass* UW_PostProcessEntry_Gamma_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("W_PostProcessEntry_Gamma_C");

	return Clss;
}


// W_PostProcessEntry_Gamma_C W_PostProcessEntry_Gamma.Default__W_PostProcessEntry_Gamma_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UW_PostProcessEntry_Gamma_C* UW_PostProcessEntry_Gamma_C::GetDefaultObj()
{
	static class UW_PostProcessEntry_Gamma_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UW_PostProcessEntry_Gamma_C*>(UW_PostProcessEntry_Gamma_C::StaticClass()->DefaultObject);

	return Default;
}


// Function W_PostProcessEntry_Gamma.W_PostProcessEntry_Gamma_C.UpdatePostProcess
