...
public:
	...
	uint8                                        Pad_5DE[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	enum class EDLSSPreset                       DLAAPreset;                                        // 0x5A(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_5EF[0x1];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	enum class EDLSSPreset                       DLSSQualityPreset;                                 // 0x5C(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EDLSSPreset                       DLSSBalancedPreset;                                // 0x5D(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EDLSSPreset                       DLSSPerformancePreset;                             // 0x5E(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EDLSSPreset                       DLSSUltraPerformancePreset;                        // 0x5F(0x1)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
