...
struct UCF_NetworkStatus_C_OnCheckboxStateChanged_Params
{
public:
...
struct UCF_NetworkStatus_C_ExecuteUbergraph_CF_NetworkStatus_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_2678[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<class UUMG_NetworkDebugInfo_C*>       CallFunc_GetAllWidgetsOfClass_FoundWidgets;        // 0x8(0x10)(ReferenceParm, ContainsInstancedReference)
	...
	class UUMG_NetworkDebugInfo_C*               CallFunc_Array_Get_Item;                           // 0x28(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UUMG_NetworkDebugInfo_C*               CallFunc_Array_Get_Item_1;                         // 0x40(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Less_IntInt_ReturnValue_1;                // 0x48(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         K2Node_Event_NewState;                             // 0x49(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
