...
class USK_DEP_Leather_Curtain_Window_variationA_AnimBP_C : public UAnimInstance
{
public:
	uint8                                        Pad_67AC[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class USK_DEP_Leather_Curtain_Window_variationA_AnimBP_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void BlueprintUpdateAnimation(float DeltaTimeX);
	void ExecuteUbergraph_SK_DEP_Leather_Curtain_Window_variationA_AnimBP(int32 EntryPoint, class AActor* CallFunc_GetOwningActor_ReturnValue, class ABP_Window_Base_C* K2Node_DynamicCast_AsBP_Window_Base, bool K2Node_DynamicCast_bSuccess, float K2Node_Event_DeltaTimeX);
};
