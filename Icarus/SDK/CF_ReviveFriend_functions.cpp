...
class UClass* UCF_ReviveFriend_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CF_ReviveFriend_C");

	return Clss;
}


// CF_ReviveFriend_C CF_ReviveFriend.Default__CF_ReviveFriend_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCF_ReviveFriend_C* UCF_ReviveFriend_C::GetDefaultObj()
{
	static class UCF_ReviveFriend_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCF_ReviveFriend_C*>(UCF_ReviveFriend_C::StaticClass()->DefaultObject);

	return Default;
}


// Function CF_ReviveFriend.CF_ReviveFriend_C.HandleExecute
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class UUserWidget*                 Widget                                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                              Amount                                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UCF_ReviveFriend_C::HandleExecute(class UUserWidget* Widget, int32 Amount)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("CF_ReviveFriend_C", "HandleExecute");

	Params::UCF_ReviveFriend_C_HandleExecute_Params Parms{};
...
// Function CF_ReviveFriend.CF_ReviveFriend_C.OnMouseEnter
// (BlueprintCosmetic, Event, Public, HasOutParams, BlueprintEvent)
// Parameters:
// struct FGeometry                   MyGeometry                                                       (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor)
// struct FPointerEvent               MouseEvent                                                       (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void UCF_ReviveFriend_C::OnMouseEnter(const struct FGeometry& MyGeometry, struct FPointerEvent& MouseEvent)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("CF_ReviveFriend_C", "OnMouseEnter");

	Params::UCF_ReviveFriend_C_OnMouseEnter_Params Parms{};
...
// Function CF_ReviveFriend.CF_ReviveFriend_C.ExecuteUbergraph_CF_ReviveFriend
