...
{
public:
	uint8                                        Pad_2534[0xA8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_253F[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_2554[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
