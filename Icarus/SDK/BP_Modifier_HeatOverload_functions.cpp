...
class UClass* UBP_Modifier_HeatOverload_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Modifier_HeatOverload_C");

	return Clss;
}


// BP_Modifier_HeatOverload_C BP_Modifier_HeatOverload.Default__BP_Modifier_HeatOverload_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_Modifier_HeatOverload_C* UBP_Modifier_HeatOverload_C::GetDefaultObj()
{
	static class UBP_Modifier_HeatOverload_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_Modifier_HeatOverload_C*>(UBP_Modifier_HeatOverload_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_Modifier_HeatOverload.BP_Modifier_HeatOverload_C.CanHeal
