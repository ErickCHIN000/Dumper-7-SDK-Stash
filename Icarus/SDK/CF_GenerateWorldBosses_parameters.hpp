...
struct UCF_GenerateWorldBosses_C_HandleExecute_Params
{
public:
...
struct UCF_GenerateWorldBosses_C_ExecuteUbergraph_CF_GenerateWorldBosses_Params
{
public:
	...
	struct FProspectListEnum                     CallFunc_IntToStruct_ReturnValue;                  // 0x38(0x10)(HasGetValueTypeHash)
	struct FProspectListRowHandle                CallFunc_MakeProspectList_ReturnValue;             // 0x48(0x18)(NoDestructor, HasGetValueTypeHash)
	class FName                                  CallFunc_BreakProspectListEnum_Name;               // 0x60(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_BreakProspectListEnum_Index;              // 0x68(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1668[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FProspectListEnum                     CallFunc_RowHandleToStruct_ReturnValue;            // 0x70(0x10)(HasGetValueTypeHash)
