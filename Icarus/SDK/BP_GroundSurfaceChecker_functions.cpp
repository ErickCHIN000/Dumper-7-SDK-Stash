...
class UClass* UBP_GroundSurfaceChecker_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_GroundSurfaceChecker_C");

	return Clss;
}


// BP_GroundSurfaceChecker_C BP_GroundSurfaceChecker.Default__BP_GroundSurfaceChecker_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_GroundSurfaceChecker_C* UBP_GroundSurfaceChecker_C::GetDefaultObj()
{
	static class UBP_GroundSurfaceChecker_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_GroundSurfaceChecker_C*>(UBP_GroundSurfaceChecker_C::StaticClass()->DefaultObject);
