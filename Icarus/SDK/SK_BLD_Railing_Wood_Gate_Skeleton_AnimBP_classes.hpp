...
{
public:
	uint8                                        Pad_670D[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class USK_BLD_Railing_Wood_Gate_Skeleton_AnimBP_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void EvaluateGraphExposedInputs_ExecuteUbergraph_SK_BLD_Railing_Wood_Gate_Skeleton_AnimBP_AnimGraphNode_TransitionResult_BDC5625947EA739F1EB4E09B06D5B072();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_SK_BLD_Railing_Wood_Gate_Skeleton_AnimBP_AnimGraphNode_TransitionResult_6EDE800941A5D274B6462D8D273D3FC0();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_SK_BLD_Railing_Wood_Gate_Skeleton_AnimBP_AnimGraphNode_TransitionResult_4D9906E9495E26F88B2803BE36C19DF6();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_SK_BLD_Railing_Wood_Gate_Skeleton_AnimBP_AnimGraphNode_TransitionResult_59FB5C4E4D07A716000521B2B06C6DBB();
	void BlueprintUpdateAnimation(float DeltaTimeX);
	void ExecuteUbergraph_SK_BLD_Railing_Wood_Gate_Skeleton_AnimBP(int32 EntryPoint, class AActor* CallFunc_GetOwningActor_ReturnValue, class ABP_Door_Base_C* K2Node_DynamicCast_AsBP_Door_Base, bool K2Node_DynamicCast_bSuccess, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue_1, bool CallFunc_NotEqual_ByteByte_ReturnValue, bool CallFunc_NotEqual_ByteByte_ReturnValue_1, float K2Node_Event_DeltaTimeX);
};
