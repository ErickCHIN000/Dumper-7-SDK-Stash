...
struct UUMG_ToolDamage_C_UpdateDamage_Params
{
public:
	...
	class UUMG_DamageVariation_C*                Target;                                            // 0x38(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UUMG_ToolDamage_C_Update_Params
{
public:
...
struct UUMG_ToolDamage_C_BP_OnItemExpansionChanged_Params
{
public:
...
struct UUMG_ToolDamage_C_BP_OnItemSelectionChanged_Params
{
public:
...
struct UUMG_ToolDamage_C_ExecuteUbergraph_UMG_ToolDamage_Params
{
public:
