...
class ABP_Moa_Juvenile_Corpse_C : public ABP_GOAP_Corpse_C
{
public:
	...
	static class ABP_Moa_Juvenile_Corpse_C* GetDefaultObj();

	void UpdateSkeletalMeshCarryPhysics(class USkeletalMeshComponent* SkeletalMeshComponent);
