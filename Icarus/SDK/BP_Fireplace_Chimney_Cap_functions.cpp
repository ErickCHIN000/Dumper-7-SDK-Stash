...
class UClass* ABP_Fireplace_Chimney_Cap_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Fireplace_Chimney_Cap_C");

	return Clss;
}


// BP_Fireplace_Chimney_Cap_C BP_Fireplace_Chimney_Cap.Default__BP_Fireplace_Chimney_Cap_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Fireplace_Chimney_Cap_C* ABP_Fireplace_Chimney_Cap_C::GetDefaultObj()
{
	static class ABP_Fireplace_Chimney_Cap_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Fireplace_Chimney_Cap_C*>(ABP_Fireplace_Chimney_Cap_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_Fireplace_Chimney_Cap.BP_Fireplace_Chimney_Cap_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ABP_Fireplace_Chimney_Cap_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Fireplace_Chimney_Cap_C", "ReceiveBeginPlay");
...
// Function BP_Fireplace_Chimney_Cap.BP_Fireplace_Chimney_Cap_C.InitialiseAttachment
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void ABP_Fireplace_Chimney_Cap_C::InitialiseAttachment()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Fireplace_Chimney_Cap_C", "InitialiseAttachment");
...
// Function BP_Fireplace_Chimney_Cap.BP_Fireplace_Chimney_Cap_C.ExecuteUbergraph_BP_Fireplace_Chimney_Cap
