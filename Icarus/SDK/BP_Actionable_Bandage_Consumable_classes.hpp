...
public:
	...
	static class UBP_Actionable_Bandage_Consumable_C* GetDefaultObj();

	bool CanHold();
	void CompleteHold(bool Success);
	void ExecuteUbergraph_BP_Actionable_Bandage_Consumable(int32 EntryPoint, class AIcarusPlayerCharacter* CallFunc_GetPlayer_OwningPlayer, bool K2Node_Event_Success, class AIcarusPlayerCharacterSurvival* K2Node_DynamicCast_AsIcarus_Player_Character_Survival, bool K2Node_DynamicCast_bSuccess, class AIcarusPlayerController* CallFunc_GetIcarusPlayerController_ReturnValue, class UInventory* CallFunc_GetFocusedItemInventoryAndSlot_FocusedItemInventory, int32 CallFunc_GetFocusedItemInventoryAndSlot_FocusedItemSlot, enum class EDataValidity CallFunc_GetFocusedItemInventoryAndSlot_Validity, bool CallFunc_LocalOrServer_Local, bool CallFunc_LocalOrServer_Server, bool K2Node_SwitchEnum_CmpSuccess);
};
