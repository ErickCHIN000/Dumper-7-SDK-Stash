...
class UClass* UBP_BallisticFunctionLibrary_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_BallisticFunctionLibrary_C");

	return Clss;
}


// BP_BallisticFunctionLibrary_C BP_BallisticFunctionLibrary.Default__BP_BallisticFunctionLibrary_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_BallisticFunctionLibrary_C* UBP_BallisticFunctionLibrary_C::GetDefaultObj()
{
	static class UBP_BallisticFunctionLibrary_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_BallisticFunctionLibrary_C*>(UBP_BallisticFunctionLibrary_C::StaticClass()->DefaultObject);
...
// Parameters:
// struct FPredictProjectilePathResultInPredictionData                                                 (BlueprintVisible, BlueprintReadOnly, Parm, ContainsInstancedReference)
...
// bool                               IsBlacklistBone                                                  (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
// class UPrimitiveComponent*         TargetComponent                                                  (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// struct FPredictProjectilePathPointDataCallFunc_Array_Get_Item                                          (NoDestructor)
...
// struct FCriticalHitLocation        CallFunc_Array_Get_Item_1                                        (NoDestructor)
...
// class USkinnedMeshComponent*       CallFunc_GetComponentByClass_ReturnValue                         (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UBP_AimAssistTargetComponent_C*CallFunc_GetComponentByClass_ReturnValue_1                       (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class USkinnedMeshComponent*       CallFunc_GetComponentByClass_ReturnValue_2                       (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// struct FVector                     CallFunc_FindClosestPointOnLine_ReturnValue_1                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UBP_BallisticFunctionLibrary_C::GetClosestBoneAlongProjectilePrediction(const struct FPredictProjectilePathResult& InPredictionData, class AActor* InActor, class UObject* __WorldContext, class FName* HitBone, class UPrimitiveComponent** HitComponent, bool IsBlacklistBone, class UPrimitiveComponent* TargetComponent, class FName TargetBone, const struct FHitResult& HitResult, const struct FAISetupRowHandle& Temp_struct_Variable, class UIcarusLogSubsystem* CallFunc_GetGameInstanceSubsystem_ReturnValue, const struct FAISetup& CallFunc_GetAISetupStruct_AISetup, enum class EValid CallFunc_GetAISetupStruct_Paths, bool CallFunc_IsValid_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_BreakHitResult_bBlockingHit, bool CallFunc_BreakHitResult_bInitialOverlap, float CallFunc_BreakHitResult_Time, float CallFunc_BreakHitResult_Distance, const struct FVector& CallFunc_BreakHitResult_Location, const struct FVector& CallFunc_BreakHitResult_ImpactPoint, const struct FVector& CallFunc_BreakHitResult_Normal, const struct FVector& CallFunc_BreakHitResult_ImpactNormal, class UPhysicalMaterial* CallFunc_BreakHitResult_PhysMat, class AActor* CallFunc_BreakHitResult_HitActor, class UPrimitiveComponent* CallFunc_BreakHitResult_HitComponent, class FName CallFunc_BreakHitResult_HitBoneName, int32 CallFunc_BreakHitResult_HitItem, int32 CallFunc_BreakHitResult_ElementIndex, int32 CallFunc_BreakHitResult_FaceIndex, const struct FVector& CallFunc_BreakHitResult_TraceStart, const struct FVector& CallFunc_BreakHitResult_TraceEnd, TScriptInterface<class ISpawnableAI> K2Node_DynamicCast_AsSpawnable_AI, bool K2Node_DynamicCast_bSuccess, int32 CallFunc_Array_LastIndex_ReturnValue, const struct FAISetupRowHandle& CallFunc_GetAISetupRowHandle_ReturnValue, const struct FPredictProjectilePathPointData& CallFunc_Array_Get_Item, bool CallFunc_Array_IsValidIndex_ReturnValue, const struct FVector& CallFunc_Normal_ReturnValue, int32 Temp_int_Variable, int32 CallFunc_Add_IntInt_ReturnValue, class FName Temp_wildcard_Variable, bool CallFunc_NotEqual_NameName_ReturnValue, int32 Temp_int_Array_Index_Variable, const struct FCriticalHitLocation& CallFunc_Array_Get_Item_1, bool CallFunc_BreakHitResult_bBlockingHit_1, bool CallFunc_BreakHitResult_bInitialOverlap_1, float CallFunc_BreakHitResult_Time_1, float CallFunc_BreakHitResult_Distance_1, const struct FVector& CallFunc_BreakHitResult_Location_1, const struct FVector& CallFunc_BreakHitResult_ImpactPoint_1, const struct FVector& CallFunc_BreakHitResult_Normal_1, const struct FVector& CallFunc_BreakHitResult_ImpactNormal_1, class UPhysicalMaterial* CallFunc_BreakHitResult_PhysMat_1, class AActor* CallFunc_BreakHitResult_HitActor_1, class UPrimitiveComponent* CallFunc_BreakHitResult_HitComponent_1, class FName CallFunc_BreakHitResult_HitBoneName_1, int32 CallFunc_BreakHitResult_HitItem_1, int32 CallFunc_BreakHitResult_ElementIndex_1, int32 CallFunc_BreakHitResult_FaceIndex_1, const struct FVector& CallFunc_BreakHitResult_TraceStart_1, const struct FVector& CallFunc_BreakHitResult_TraceEnd_1, bool CallFunc_IsValid_ReturnValue_1, const class FString& CallFunc_Conv_NameToString_ReturnValue, int32 Temp_int_Loop_Counter_Variable, class USkinnedMeshComponent* CallFunc_GetComponentByClass_ReturnValue, class UBP_AimAssistTargetComponent_C* CallFunc_GetComponentByClass_ReturnValue_1, bool CallFunc_Less_IntInt_ReturnValue, bool CallFunc_IsValid_ReturnValue_2, int32 CallFunc_Add_IntInt_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_3, const struct FVector& CallFunc_K2_GetComponentLocation_ReturnValue, const struct FVector& CallFunc_FindClosestBone_K2_BoneLocation, class FName CallFunc_FindClosestBone_K2_ReturnValue, class USkinnedMeshComponent* K2Node_DynamicCast_AsSkinned_Mesh_Component, bool K2Node_DynamicCast_bSuccess_1, class FName CallFunc_GetBoneName_ReturnValue, bool CallFunc_EqualEqual_NameName_ReturnValue, const struct FVector& CallFunc_GetSocketLocation_ReturnValue, int32 CallFunc_GetNumBones_ReturnValue, const struct FVector& CallFunc_FindClosestPointOnLine_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, float CallFunc_Vector_DistanceSquared_ReturnValue, bool CallFunc_LessEqual_IntInt_ReturnValue, bool CallFunc_BreakHitResult_bBlockingHit_2, bool CallFunc_BreakHitResult_bInitialOverlap_2, float CallFunc_BreakHitResult_Time_2, float CallFunc_BreakHitResult_Distance_2, const struct FVector& CallFunc_BreakHitResult_Location_2, const struct FVector& CallFunc_BreakHitResult_ImpactPoint_2, const struct FVector& CallFunc_BreakHitResult_Normal_2, const struct FVector& CallFunc_BreakHitResult_ImpactNormal_2, class UPhysicalMaterial* CallFunc_BreakHitResult_PhysMat_2, class AActor* CallFunc_BreakHitResult_HitActor_2, class UPrimitiveComponent* CallFunc_BreakHitResult_HitComponent_2, class FName CallFunc_BreakHitResult_HitBoneName_2, int32 CallFunc_BreakHitResult_HitItem_2, int32 CallFunc_BreakHitResult_ElementIndex_2, int32 CallFunc_BreakHitResult_FaceIndex_2, const struct FVector& CallFunc_BreakHitResult_TraceStart_2, const struct FVector& CallFunc_BreakHitResult_TraceEnd_2, bool CallFunc_IsValid_ReturnValue_4, class USkinnedMeshComponent* CallFunc_GetComponentByClass_ReturnValue_2, bool CallFunc_IsValid_ReturnValue_5, const struct FVector& CallFunc_FindClosestBone_K2_BoneLocation_1, class FName CallFunc_FindClosestBone_K2_ReturnValue_1, const struct FVector& CallFunc_GetSocketLocation_ReturnValue_1, const struct FVector& CallFunc_FindClosestPointOnLine_ReturnValue_1, float CallFunc_Vector_DistanceSquared_ReturnValue_1, bool CallFunc_Less_FloatFloat_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BallisticFunctionLibrary_C", "GetClosestBoneAlongProjectilePrediction");

	Params::UBP_BallisticFunctionLibrary_C_GetClosestBoneAlongProjectilePrediction_Params Parms{};

	Parms.InPredictionData = InPredictionData;
	Parms.InActor = InActor;
	Parms.__WorldContext = __WorldContext;
	Parms.IsBlacklistBone = IsBlacklistBone;
	...
	Parms.CallFunc_FindClosestPointOnLine_ReturnValue_1 = CallFunc_FindClosestPointOnLine_ReturnValue_1;
...
// struct FHitResult                  ProjectileHit                                                    (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
...
// int32                              CallFunc_GetCriticalDamagePlusPercent_ReturnValue                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float                              CallFunc_Conv_IntToFloat_ReturnValue_1                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float                              CallFunc_Divide_FloatFloat_ReturnValue                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_BallisticFunctionLibrary_C::PredictProjectileDamage(class AActor* Weapon, class AActor* Defender, const struct FHitResult& ProjectileHit, bool Killcam, class UObject* __WorldContext, float* OutDamage, float Temp_wildcard_Variable, int32 CallFunc_PredictResistedDamage_ReturnValue, float CallFunc_Conv_IntToFloat_ReturnValue, const struct FCriticalHitAreasEnum& CallFunc_IsCriticalHit_CriticalHitType, bool CallFunc_IsCriticalHit_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue, int32 CallFunc_GetCriticalDamagePlusPercent_ReturnValue, float CallFunc_Conv_IntToFloat_ReturnValue_1, float CallFunc_Divide_FloatFloat_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BallisticFunctionLibrary_C", "PredictProjectileDamage");

	Params::UBP_BallisticFunctionLibrary_C_PredictProjectileDamage_Params Parms{};

	Parms.Weapon = Weapon;
	Parms.Defender = Defender;
	Parms.ProjectileHit = ProjectileHit;
	...
	Parms.CallFunc_GetCriticalDamagePlusPercent_ReturnValue = CallFunc_GetCriticalDamagePlusPercent_ReturnValue;
...
// Parameters:
// struct FHitResult                  InPredictedHit                                                   (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
...
// class UObject*                     __WorldContext                                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FHitResult                  OutCriticalHit                                                   (Parm, OutParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
// class USkeletalMeshComponent*      MeshComp                                                         (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_NotEqual_NameName_ReturnValue                           (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_IsValid_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_BreakHitResult_bBlockingHit                             (ZeroConstructor, IsPlainOldData, NoDestructor)
// bool                               CallFunc_BreakHitResult_bInitialOverlap                          (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UBP_BallisticFunctionLibrary_C::CreateCriticalHitResult(const struct FHitResult& InPredictedHit, class FName CriticalHitBone, class UObject* __WorldContext, struct FHitResult* OutCriticalHit, class USkeletalMeshComponent* MeshComp, bool CallFunc_NotEqual_NameName_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_BreakHitResult_bBlockingHit, bool CallFunc_BreakHitResult_bInitialOverlap, float CallFunc_BreakHitResult_Time, float CallFunc_BreakHitResult_Distance, const struct FVector& CallFunc_BreakHitResult_Location, const struct FVector& CallFunc_BreakHitResult_ImpactPoint, const struct FVector& CallFunc_BreakHitResult_Normal, const struct FVector& CallFunc_BreakHitResult_ImpactNormal, class UPhysicalMaterial* CallFunc_BreakHitResult_PhysMat, class AActor* CallFunc_BreakHitResult_HitActor, class UPrimitiveComponent* CallFunc_BreakHitResult_HitComponent, class FName CallFunc_BreakHitResult_HitBoneName, int32 CallFunc_BreakHitResult_HitItem, int32 CallFunc_BreakHitResult_ElementIndex, int32 CallFunc_BreakHitResult_FaceIndex, const struct FVector& CallFunc_BreakHitResult_TraceStart, const struct FVector& CallFunc_BreakHitResult_TraceEnd, bool CallFunc_IsValid_ReturnValue_1, bool CallFunc_BreakHitResult_bBlockingHit_1, bool CallFunc_BreakHitResult_bInitialOverlap_1, float CallFunc_BreakHitResult_Time_1, float CallFunc_BreakHitResult_Distance_1, const struct FVector& CallFunc_BreakHitResult_Location_1, const struct FVector& CallFunc_BreakHitResult_ImpactPoint_1, const struct FVector& CallFunc_BreakHitResult_Normal_1, const struct FVector& CallFunc_BreakHitResult_ImpactNormal_1, class UPhysicalMaterial* CallFunc_BreakHitResult_PhysMat_1, class AActor* CallFunc_BreakHitResult_HitActor_1, class UPrimitiveComponent* CallFunc_BreakHitResult_HitComponent_1, class FName CallFunc_BreakHitResult_HitBoneName_1, int32 CallFunc_BreakHitResult_HitItem_1, int32 CallFunc_BreakHitResult_ElementIndex_1, int32 CallFunc_BreakHitResult_FaceIndex_1, const struct FVector& CallFunc_BreakHitResult_TraceStart_1, const struct FVector& CallFunc_BreakHitResult_TraceEnd_1, class USkeletalMeshComponent* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_DoesSocketExist_ReturnValue, const struct FVector& CallFunc_GetSocketLocation_ReturnValue, const struct FHitResult& CallFunc_MakeHitResult_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BallisticFunctionLibrary_C", "CreateCriticalHitResult");

	Params::UBP_BallisticFunctionLibrary_C_CreateCriticalHitResult_Params Parms{};
	...
	if (OutCriticalHit != nullptr)
		*OutCriticalHit = std::move(Parms.OutCriticalHit);
...
// Parameters:
// class UObject*                     __WorldContext                                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UBallisticPoolManager*       ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AGameModeBase*               CallFunc_GetGameMode_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UBallisticPoolManager*       CallFunc_GetComponentByClass_ReturnValue                         (ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_IsValid_ReturnValue                                     (ZeroConstructor, IsPlainOldData, NoDestructor)

class UBallisticPoolManager* UBP_BallisticFunctionLibrary_C::GetBallisticPoolManager(class UObject* __WorldContext, class AGameModeBase* CallFunc_GetGameMode_ReturnValue, class UBallisticPoolManager* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_BallisticFunctionLibrary_C", "GetBallisticPoolManager");

	Params::UBP_BallisticFunctionLibrary_C_GetBallisticPoolManager_Params Parms{};
