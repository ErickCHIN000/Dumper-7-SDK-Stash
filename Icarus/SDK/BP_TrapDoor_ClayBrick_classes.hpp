...
class ABP_TrapDoor_ClayBrick_C : public ABP_Door_Base_C
{
public:
	...
	static class ABP_TrapDoor_ClayBrick_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_TrapDoor_ClayBrick(int32 EntryPoint);
};
