...
class UCF_DebugLogging_C : public UCF_BaseBool_C
{
public:
	...
	static class UCF_DebugLogging_C* GetDefaultObj();
	...
	void ExecuteUbergraph_CF_DebugLogging(int32 EntryPoint, bool K2Node_Event_NewState, class AGameStateBase* CallFunc_GetGameState_ReturnValue, class AIcarusGameStateSurvival* K2Node_DynamicCast_AsIcarus_Game_State_Survival, bool K2Node_DynamicCast_bSuccess);
};
