...
class UClass* ABP_SW_Bramble_A_Var2_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_SW_Bramble_A_Var2_C");

	return Clss;
}


// BP_SW_Bramble_A_Var2_C BP_SW_Bramble_A_Var2.Default__BP_SW_Bramble_A_Var2_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_SW_Bramble_A_Var2_C* ABP_SW_Bramble_A_Var2_C::GetDefaultObj()
{
	static class ABP_SW_Bramble_A_Var2_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_SW_Bramble_A_Var2_C*>(ABP_SW_Bramble_A_Var2_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_SW_Bramble_A_Var2.BP_SW_Bramble_A_Var2_C.PlayHarvestFX
...
// class ABP_HAV_SW_Bramble_A_Var2_C* CallFunc_FinishSpawningActor_ReturnValue                         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_SW_Bramble_A_Var2_C::PlayHarvestFX(const struct FVector& Location, class AIcarusPlayerCharacter* Instigator, const struct FTransform& CallFunc_GetTransform_ReturnValue, class AActor* CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue, class ABP_HAV_SW_Bramble_A_Var2_C* CallFunc_FinishSpawningActor_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_SW_Bramble_A_Var2_C", "PlayHarvestFX");

	Params::ABP_SW_Bramble_A_Var2_C_PlayHarvestFX_Params Parms{};
...
// Function BP_SW_Bramble_A_Var2.BP_SW_Bramble_A_Var2_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ABP_SW_Bramble_A_Var2_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_SW_Bramble_A_Var2_C", "ReceiveBeginPlay");
...
// Function BP_SW_Bramble_A_Var2.BP_SW_Bramble_A_Var2_C.BndEvt__BP_SW_Bramble_A_Var1_StaticMesh_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature
...
void ABP_SW_Bramble_A_Var2_C::BndEvt__BP_SW_Bramble_A_Var1_StaticMesh_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)
{
	...
	if (!Func)
		Func = Class->GetFunction("BP_SW_Bramble_A_Var2_C", "BndEvt__BP_SW_Bramble_A_Var1_StaticMesh_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature");

	Params::ABP_SW_Bramble_A_Var2_C_BndEvt__BP_SW_Bramble_A_Var1_StaticMesh_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params Parms{};
...
// Function BP_SW_Bramble_A_Var2.BP_SW_Bramble_A_Var2_C.ExecuteUbergraph_BP_SW_Bramble_A_Var2
...
void ABP_SW_Bramble_A_Var2_C::ExecuteUbergraph_BP_SW_Bramble_A_Var2(int32 EntryPoint, bool CallFunc_IsServer_ReturnValue, class UPrimitiveComponent* K2Node_ComponentBoundEvent_OverlappedComponent, class AActor* K2Node_ComponentBoundEvent_OtherActor, class UPrimitiveComponent* K2Node_ComponentBoundEvent_OtherComp, int32 K2Node_ComponentBoundEvent_OtherBodyIndex, bool K2Node_ComponentBoundEvent_bFromSweep, const struct FHitResult& K2Node_ComponentBoundEvent_SweepResult, const struct FModifier& K2Node_MakeStruct_Modifier, class ABP_IcarusNPCGOAPCharacter_C* K2Node_DynamicCast_AsBP_Icarus_NPCGOAPCharacter, bool K2Node_DynamicCast_bSuccess, class ABP_Mount_Base_C* K2Node_DynamicCast_AsBP_Mount_Base, bool K2Node_DynamicCast_bSuccess_1, bool CallFunc_HasModifierState_ReturnValue, bool CallFunc_HasModifierState_ReturnValue_1, class AIcarusPlayerCharacter* K2Node_DynamicCast_AsIcarus_Player_Character, bool K2Node_DynamicCast_bSuccess_2, bool CallFunc_HasModifierState_ReturnValue_2, int32 CallFunc_AddModifierState_ReturnValue, const struct FModifier& K2Node_MakeStruct_Modifier_1, const struct FModifier& K2Node_MakeStruct_Modifier_2, int32 CallFunc_AddModifierState_ReturnValue_1, int32 CallFunc_AddModifierState_ReturnValue_2)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_SW_Bramble_A_Var2_C", "ExecuteUbergraph_BP_SW_Bramble_A_Var2");

	Params::ABP_SW_Bramble_A_Var2_C_ExecuteUbergraph_BP_SW_Bramble_A_Var2_Params Parms{};
