...
struct UCF_TriggerAfflictionChance_C_OnConstruction_Params
{
public:
	int32                                        Temp_int_Variable;                                 // 0x0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        Temp_int_Variable_1;                               // 0x4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FAfflictionChanceEnum                 CallFunc_IntToStruct_ReturnValue;                  // 0x8(0x10)(HasGetValueTypeHash)
	int32                                        CallFunc_Add_IntInt_ReturnValue;                   // 0x18(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FAfflictionChanceRowHandle            CallFunc_StructToRowHandle_ReturnValue;            // 0x1C(0x18)(NoDestructor, HasGetValueTypeHash)
	...
	class UAfflictionRow_C*                      CallFunc_Create_ReturnValue;                       // 0x48(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UCF_TriggerAfflictionChance_C_HandleExecute_Params
{
public:
...
struct UCF_TriggerAfflictionChance_C_ExecuteUbergraph_CF_TriggerAfflictionChance_Params
{
public:
	...
	class UAfflictionRow_C*                      K2Node_DynamicCast_AsAffliction_Row;               // 0x40(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess_1;                     // 0x48(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_23EF[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FAfflictionChanceRowHandle            CallFunc_MakeAfflictionChance_ReturnValue;         // 0x4C(0x18)(NoDestructor, HasGetValueTypeHash)
};
