...
class ABP_Building_Wall_Diagonal_Half_Angle_L_Invert_C : public ABP_Building_Wall_Diagonal_C
{
public:

	static class UClass* StaticClass();
	static class ABP_Building_Wall_Diagonal_Half_Angle_L_Invert_C* GetDefaultObj();
