...
struct UBP_AnimNofity_Needler_HideSpikes_C_Received_Notify_Params
{
public:
	...
	class ABP_NPC_Needler_Character_C*           K2Node_DynamicCast_AsBP_NPC_Needler_Character;     // 0x20(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x28(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

// 0x10 (0x10 - 0x0)
// Function BP_AnimNofity_Needler_HideSpikes.BP_AnimNofity_Needler_HideSpikes_C.GetNotifyName
struct UBP_AnimNofity_Needler_HideSpikes_C_GetNotifyName_Params
{
public:
