...
public:
	...
	struct FAnimNode_BlendListByBool             AnimGraphNode_BlendListByBool;                     // 0x688(0xA0)(None)
	struct FAnimNode_SequenceEvaluator           AnimGraphNode_SequenceEvaluator;                   // 0x728(0x50)(None)
	struct FVector                               FakeVelocity;                                      // 0x778(0xC)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class USK_CRE_Batdog_Corpse_AnimBP_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_SK_CRE_Batdog_Corpse_AnimBP(int32 EntryPoint);
};
