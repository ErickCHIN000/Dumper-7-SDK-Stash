...
class ABP_Building_RoofCurvedAngle_L_Down_Invert_C : public ABP_Building_InvRoofCorner_C
{
public:

	static class UClass* StaticClass();
	static class ABP_Building_RoofCurvedAngle_L_Down_Invert_C* GetDefaultObj();
