...
public:
	...
	TScriptInterface<class IBP_PlayerAudio_AnimNotify_Interface_C> K2Node_DynamicCast_AsBP_Player_Audio_Anim_Notify_Interface; // 0x20(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
