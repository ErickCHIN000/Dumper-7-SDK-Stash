...
class UBrownBear_Y_Dead_AnimBP_C : public UIcarusCorpseAnimInstance
{
public:
	...
	static class UBrownBear_Y_Dead_AnimBP_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_BrownBear_Y_Dead_AnimBP(int32 EntryPoint);
};
