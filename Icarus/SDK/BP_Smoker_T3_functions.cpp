...
class UClass* ABP_Smoker_T3_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Smoker_T3_C");

	return Clss;
}


// BP_Smoker_T3_C BP_Smoker_T3.Default__BP_Smoker_T3_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Smoker_T3_C* ABP_Smoker_T3_C::GetDefaultObj()
{
	static class ABP_Smoker_T3_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Smoker_T3_C*>(ABP_Smoker_T3_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_Smoker_T3.BP_Smoker_T3_C.ProcessorStateUpdate
...
void ABP_Smoker_T3_C::ProcessorStateUpdate(bool Active, bool CallFunc_IsServer_ReturnValue, enum class EValid CallFunc_GetTrait_Paths, class UGeneratorComponent* CallFunc_GetTrait_ReturnValue, bool CallFunc_ActivateGenerator_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Smoker_T3_C", "ProcessorStateUpdate");

	Params::ABP_Smoker_T3_C_ProcessorStateUpdate_Params Parms{};
...
// Function BP_Smoker_T3.BP_Smoker_T3_C.GeneratorStateUpdate
