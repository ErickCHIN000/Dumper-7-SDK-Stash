...
class ABP_SnowLeopard_Alpha_Corpse_C : public ABP_GOAP_Corpse_C
{
public:
	...
	static class ABP_SnowLeopard_Alpha_Corpse_C* GetDefaultObj();

	void OnCorpseFocused(bool IsThirdPerson);
