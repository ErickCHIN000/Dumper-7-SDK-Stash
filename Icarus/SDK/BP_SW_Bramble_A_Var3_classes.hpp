...
class ABP_SW_Bramble_A_Var3_C : public ABP_ResourceNodeBase_C
{
public:
	...
	static class ABP_SW_Bramble_A_Var3_C* GetDefaultObj();

	void PlayHarvestFX(const struct FVector& Location, class AIcarusPlayerCharacter* Instigator, const struct FTransform& CallFunc_GetTransform_ReturnValue, class AActor* CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue, class ABP_HAV_SW_Bramble_A_Var3_C* CallFunc_FinishSpawningActor_ReturnValue);
