...
public:
	...
	uint8                                        Pad_1[0x40];                                       // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2[0x3F0];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_D[0x30];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_10[0x80];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_15[0x40];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_19[0x1E0];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_20[0x10];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_23[0x10];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_29[0x140];                                     // Fixing Size After Last Property  [ Dumper-7 ]
