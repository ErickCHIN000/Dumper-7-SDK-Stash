...
struct UBP_Interactable_DropShip_C_CanInteract_Params
{
public:
...
struct UBP_Interactable_DropShip_C_Interact_Params
{
public:
	class AActor*                                Instigator;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UBP_Interactable_DropShip_C_ExecuteUbergraph_BP_Interactable_DropShip_Params
{
public:
	...
	class ABP_DropShip_C*                        K2Node_DynamicCast_AsBP_Drop_Ship;                 // 0xA0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
