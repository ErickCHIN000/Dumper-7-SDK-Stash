...
class UUMG_StatDescription_C : public UUserWidget
{
public:
	...
	uint8                                        Pad_1AA6[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FStatsEnum                            Stat;                                              // 0x278(0x10)(Edit, BlueprintVisible, ExposeOnSpawn, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class UUMG_StatDescription_C* GetDefaultObj();
	...
	void ExecuteUbergraph_UMG_StatDescription(int32 EntryPoint, bool K2Node_Event_IsDesignTime, bool K2Node_Event_bIsExpanded, bool K2Node_Event_bIsSelected, const struct FSlateColor& K2Node_MakeStruct_SlateColor, const struct FSlateColor& K2Node_MakeStruct_SlateColor_1, bool K2Node_CustomEvent_Active, const struct FSlateColor& K2Node_MakeStruct_SlateColor_2);
};
