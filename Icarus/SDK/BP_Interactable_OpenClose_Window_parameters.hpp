...
struct UBP_Interactable_OpenClose_Window_C_CanInteract_Params
{
public:
	...
	class ABP_Window_Base_C*                     K2Node_DynamicCast_AsBP_Window_Base;               // 0xA0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0xA8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};

// 0x90 (0x90 - 0x0)
// Function BP_Interactable_OpenClose_Window.BP_Interactable_OpenClose_Window_C.Interact
struct UBP_Interactable_OpenClose_Window_C_Interact_Params
{
public:
	class AActor*                                Instigator;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UBP_Interactable_OpenClose_Window_C_ExecuteUbergraph_BP_Interactable_OpenClose_Window_Params
{
public:
	...
	class ABP_Window_Base_C*                     K2Node_DynamicCast_AsBP_Window_Base;               // 0xA0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0xA8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_Open_Close_Window_Success;                // 0xA9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
