...
class USK_BLD_Window_Reinforced_Wood_V02_AnimBP_C : public UAnimInstance
{
public:
	uint8                                        Pad_66CB[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class USK_BLD_Window_Reinforced_Wood_V02_AnimBP_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void BlueprintUpdateAnimation(float DeltaTimeX);
	void ExecuteUbergraph_SK_BLD_Window_Reinforced_Wood_V02_AnimBP(int32 EntryPoint, class AActor* CallFunc_GetOwningActor_ReturnValue, class ABP_Window_Base_C* K2Node_DynamicCast_AsBP_Window_Base, bool K2Node_DynamicCast_bSuccess, float K2Node_Event_DeltaTimeX);
};
