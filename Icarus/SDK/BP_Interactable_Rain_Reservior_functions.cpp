...
class UClass* UBP_Interactable_Rain_Reservior_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Interactable_Rain_Reservior_C");

	return Clss;
}


// BP_Interactable_Rain_Reservior_C BP_Interactable_Rain_Reservior.Default__BP_Interactable_Rain_Reservior_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_Interactable_Rain_Reservior_C* UBP_Interactable_Rain_Reservior_C::GetDefaultObj()
{
	static class UBP_Interactable_Rain_Reservior_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_Interactable_Rain_Reservior_C*>(UBP_Interactable_Rain_Reservior_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_Interactable_Rain_Reservior.BP_Interactable_Rain_Reservior_C.PlayInteractSound
...
void UBP_Interactable_Rain_Reservior_C::PlayInteractSound(class AActor* Instigator, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, const struct FTransform& CallFunc_GetTransform_ReturnValue, const struct FFMODEventInstance& CallFunc_PlayEventAtLocation_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Interactable_Rain_Reservior_C", "PlayInteractSound");

	Params::UBP_Interactable_Rain_Reservior_C_PlayInteractSound_Params Parms{};
...
// Function BP_Interactable_Rain_Reservior.BP_Interactable_Rain_Reservior_C.CanInteract
...
// Function BP_Interactable_Rain_Reservior.BP_Interactable_Rain_Reservior_C.Interact
// (Event, Public, HasOutParams, BlueprintEvent)
// Parameters:
// class AActor*                      Instigator                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FHitResult                  HitResult                                                        (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)

void UBP_Interactable_Rain_Reservior_C::Interact(class AActor* Instigator, struct FHitResult& HitResult)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Interactable_Rain_Reservior_C", "Interact");

	Params::UBP_Interactable_Rain_Reservior_C_Interact_Params Parms{};
...
// Function BP_Interactable_Rain_Reservior.BP_Interactable_Rain_Reservior_C.MULTI_PlayInteractFX
// (Net, NetMulticast, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AActor*                      Instigator                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_Interactable_Rain_Reservior_C::MULTI_PlayInteractFX(class AActor* Instigator)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Interactable_Rain_Reservior_C", "MULTI_PlayInteractFX");

	Params::UBP_Interactable_Rain_Reservior_C_MULTI_PlayInteractFX_Params Parms{};
...
// Function BP_Interactable_Rain_Reservior.BP_Interactable_Rain_Reservior_C.ExecuteUbergraph_BP_Interactable_Rain_Reservior
