...
class UClass* UW_PostProcessEntry_MouseSmoothing_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("W_PostProcessEntry_MouseSmoothing_C");

	return Clss;
}


// W_PostProcessEntry_MouseSmoothing_C W_PostProcessEntry_MouseSmoothing.Default__W_PostProcessEntry_MouseSmoothing_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UW_PostProcessEntry_MouseSmoothing_C* UW_PostProcessEntry_MouseSmoothing_C::GetDefaultObj()
{
	static class UW_PostProcessEntry_MouseSmoothing_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UW_PostProcessEntry_MouseSmoothing_C*>(UW_PostProcessEntry_MouseSmoothing_C::StaticClass()->DefaultObject);
