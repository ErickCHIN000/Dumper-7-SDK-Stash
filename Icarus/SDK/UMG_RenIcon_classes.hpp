...
public:
	...
	static class UUMG_RenIcon_C* GetDefaultObj();

	void Construct();
	void ExecuteUbergraph_UMG_RenIcon(int32 EntryPoint, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, class FText CallFunc_Format_ReturnValue);
};
