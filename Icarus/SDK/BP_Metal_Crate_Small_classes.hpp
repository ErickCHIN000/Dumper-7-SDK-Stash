...
class ABP_Metal_Crate_Small_C : public ABP_DeployableContainerBase_C
{
public:
	...
	static class ABP_Metal_Crate_Small_C* GetDefaultObj();

	void OnBecomeInteractedWith();
	void OnNoLongerInteractedWith();
	void ExecuteUbergraph_BP_Metal_Crate_Small(int32 EntryPoint);
};
