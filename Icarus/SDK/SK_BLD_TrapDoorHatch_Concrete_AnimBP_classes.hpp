...
class USK_BLD_TrapDoorHatch_Concrete_AnimBP_C : public UAnimInstance
{
public:
	uint8                                        Pad_6707[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class USK_BLD_TrapDoorHatch_Concrete_AnimBP_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void EvaluateGraphExposedInputs_ExecuteUbergraph_SK_BLD_TrapDoorHatch_Concrete_AnimBP_AnimGraphNode_TransitionResult_6D97017C4BA4954588CE56A47C4B5D2B();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_SK_BLD_TrapDoorHatch_Concrete_AnimBP_AnimGraphNode_TransitionResult_0E79621146D94A070666E9A2FCC114F0();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_SK_BLD_TrapDoorHatch_Concrete_AnimBP_AnimGraphNode_TransitionResult_42EC7314424818BF939070BF8ECDDC87();
	void EvaluateGraphExposedInputs_ExecuteUbergraph_SK_BLD_TrapDoorHatch_Concrete_AnimBP_AnimGraphNode_TransitionResult_05F91A784EC632CFCB7A40A3A13FB7A9();
	void BlueprintUpdateAnimation(float DeltaTimeX);
	void ExecuteUbergraph_SK_BLD_TrapDoorHatch_Concrete_AnimBP(int32 EntryPoint, class AActor* CallFunc_GetOwningActor_ReturnValue, class ABP_Door_Base_C* K2Node_DynamicCast_AsBP_Door_Base, bool K2Node_DynamicCast_bSuccess, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue_1, bool CallFunc_NotEqual_ByteByte_ReturnValue, bool CallFunc_NotEqual_ByteByte_ReturnValue_1, float K2Node_Event_DeltaTimeX);
};
