...
class UClass* UBP_ActionableBehaviour_CurvedSplinePlace_Water_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_ActionableBehaviour_CurvedSplinePlace_Water_C");

	return Clss;
}


// BP_ActionableBehaviour_CurvedSplinePlace_Water_C BP_ActionableBehaviour_CurvedSplinePlace_Water.Default__BP_ActionableBehaviour_CurvedSplinePlace_Water_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_ActionableBehaviour_CurvedSplinePlace_Water_C* UBP_ActionableBehaviour_CurvedSplinePlace_Water_C::GetDefaultObj()
{
	static class UBP_ActionableBehaviour_CurvedSplinePlace_Water_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_ActionableBehaviour_CurvedSplinePlace_Water_C*>(UBP_ActionableBehaviour_CurvedSplinePlace_Water_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_ActionableBehaviour_CurvedSplinePlace_Water.BP_ActionableBehaviour_CurvedSplinePlace_Water_C.SetHighlight
...
// Function BP_ActionableBehaviour_CurvedSplinePlace_Water.BP_ActionableBehaviour_CurvedSplinePlace_Water_C.HighlightPrimitive
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
...
void UBP_ActionableBehaviour_CurvedSplinePlace_Water_C::HighlightPrimitive(class UObject* Object, bool Highlight, int32 StencilValue, bool Temp_bool_Variable, class UPrimitiveComponent* K2Node_DynamicCast_AsPrimitive_Component, bool K2Node_DynamicCast_bSuccess, bool Temp_bool_Variable_1, const struct FVector& CallFunc_K2_GetComponentLocation_ReturnValue, class AActor* CallFunc_GetOwner_ReturnValue, const struct FTransform& CallFunc_GetTransform_ReturnValue, const struct FVector& CallFunc_BreakTransform_Location, const struct FRotator& CallFunc_BreakTransform_Rotation, const struct FVector& CallFunc_BreakTransform_Scale, float CallFunc_Vector_Distance_ReturnValue, bool CallFunc_Less_FloatFloat_ReturnValue, int32 CallFunc_SelectInt_ReturnValue, bool K2Node_Select_Default)
{
	...
	if (!Func)
		Func = Class->GetFunction("BP_ActionableBehaviour_CurvedSplinePlace_Water_C", "HighlightPrimitive");

	Params::UBP_ActionableBehaviour_CurvedSplinePlace_Water_C_HighlightPrimitive_Params Parms{};
...
// Function BP_ActionableBehaviour_CurvedSplinePlace_Water.BP_ActionableBehaviour_CurvedSplinePlace_Water_C.Event_Highlight
// (Net, NetReliable, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                               Highlight                                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UBP_ActionableBehaviour_CurvedSplinePlace_Water_C::Event_Highlight(bool Highlight)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_ActionableBehaviour_CurvedSplinePlace_Water_C", "Event_Highlight");

	Params::UBP_ActionableBehaviour_CurvedSplinePlace_Water_C_Event_Highlight_Params Parms{};
...
// Function BP_ActionableBehaviour_CurvedSplinePlace_Water.BP_ActionableBehaviour_CurvedSplinePlace_Water_C.ReceiveBeginPlay
// (Event, Public, BlueprintEvent)
// Parameters:

void UBP_ActionableBehaviour_CurvedSplinePlace_Water_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_ActionableBehaviour_CurvedSplinePlace_Water_C", "ReceiveBeginPlay");
...
// Function BP_ActionableBehaviour_CurvedSplinePlace_Water.BP_ActionableBehaviour_CurvedSplinePlace_Water_C.ReceiveEndPlay
// (Event, Public, BlueprintEvent)
// Parameters:
// enum class EEndPlayReason          EndPlayReason                                                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_ActionableBehaviour_CurvedSplinePlace_Water_C::ReceiveEndPlay(enum class EEndPlayReason EndPlayReason)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_ActionableBehaviour_CurvedSplinePlace_Water_C", "ReceiveEndPlay");

	Params::UBP_ActionableBehaviour_CurvedSplinePlace_Water_C_ReceiveEndPlay_Params Parms{};
...
// Function BP_ActionableBehaviour_CurvedSplinePlace_Water.BP_ActionableBehaviour_CurvedSplinePlace_Water_C.ReceiveTick
// (Event, Public, BlueprintEvent)
// Parameters:
// float                              DeltaSeconds                                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_ActionableBehaviour_CurvedSplinePlace_Water_C::ReceiveTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_ActionableBehaviour_CurvedSplinePlace_Water_C", "ReceiveTick");

	Params::UBP_ActionableBehaviour_CurvedSplinePlace_Water_C_ReceiveTick_Params Parms{};
...
// Function BP_ActionableBehaviour_CurvedSplinePlace_Water.BP_ActionableBehaviour_CurvedSplinePlace_Water_C.ExecuteUbergraph_BP_ActionableBehaviour_CurvedSplinePlace_Water
