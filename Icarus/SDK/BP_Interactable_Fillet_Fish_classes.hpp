...
class UBP_Interactable_Fillet_Fish_C : public UInteractableBehaviour
{
public:
	...
	static class UBP_Interactable_Fillet_Fish_C* GetDefaultObj();
	...
	void ExecuteUbergraph_BP_Interactable_Fillet_Fish(int32 EntryPoint, class AActor* K2Node_Event_Instigator, const struct FHitResult& K2Node_Event_HitResult, class AActor* CallFunc_GetOwner_ReturnValue, class ABP_DeployableBase_C* K2Node_DynamicCast_AsBP_Deployable_Base, bool K2Node_DynamicCast_bSuccess, class AIcarusPlayerCharacter* K2Node_DynamicCast_AsIcarus_Player_Character, bool K2Node_DynamicCast_bSuccess_1);
};
