...
// enum class EOnlineAdvertisementTypeType                                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct FSessionPropertyKeyPair     ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct FSessionPropertyKeyPair UAdvancedSessionsLibrary::MakeLiteralSessionPropertyString(class FName Key, const class FString& Value, enum class EOnlineAdvertisementType Type)
{
	static class UFunction* Func = nullptr;
...
struct FSessionPropertyKeyPair UAdvancedSessionsLibrary::MakeLiteralSessionPropertyInt(class FName Key, int32 Value, enum class EOnlineAdvertisementType Type)
{
	static class UFunction* Func = nullptr;
...
struct FSessionPropertyKeyPair UAdvancedSessionsLibrary::MakeLiteralSessionPropertyFloat(class FName Key, float Value, enum class EOnlineAdvertisementType Type)
{
	static class UFunction* Func = nullptr;
...
struct FSessionPropertyKeyPair UAdvancedSessionsLibrary::MakeLiteralSessionPropertyByte(class FName Key, uint8 Value, enum class EOnlineAdvertisementType Type)
{
	static class UFunction* Func = nullptr;
...
struct FSessionPropertyKeyPair UAdvancedSessionsLibrary::MakeLiteralSessionPropertyBool(class FName Key, bool Value, enum class EOnlineAdvertisementType Type)
{
	static class UFunction* Func = nullptr;
...
class UDestroySessionCallbackProxyAdvanced* UDestroySessionCallbackProxyAdvanced::DestroyAdvacedSession(class UObject* WorldContextObject, class APlayerController* PlayerController, class FName SessionName)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("DestroySessionCallbackProxyAdvanced", "DestroyAdvacedSession");

	Params::UDestroySessionCallbackProxyAdvanced_DestroyAdvacedSession_Params Parms{};
...
bool UFindSessionsCallbackProxyAdvanced::SessionTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("FindSessionsCallbackProxyAdvanced", "SessionTick");

	Params::UFindSessionsCallbackProxyAdvanced_SessionTick_Params Parms{};
...
// class FString                      Type                                                             (Parm, ZeroConstructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class ULoginUserCallbackProxy* ULoginUserCallbackProxy::LoginUser(class UObject* WorldContextObject, class APlayerController* PlayerController, const class FString& UserID, const class FString& UserToken, const class FString& Type)
{
	static class UFunction* Func = nullptr;
