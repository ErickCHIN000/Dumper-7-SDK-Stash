...
struct UBP_Interactable_Harvest_CropPlot_C_CanInteract_Params
{
public:
...
struct UBP_Interactable_Harvest_CropPlot_C_Interact_Params
{
public:
	class AActor*                                Instigator;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct UBP_Interactable_Harvest_CropPlot_C_ExecuteUbergraph_BP_Interactable_Harvest_CropPlot_Params
{
public:
