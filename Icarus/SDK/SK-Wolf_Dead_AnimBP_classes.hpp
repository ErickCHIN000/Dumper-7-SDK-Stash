...
class USKMinusWolf_Dead_AnimBP_C : public UIcarusCorpseAnimInstance
{
public:
	...
	static class USKMinusWolf_Dead_AnimBP_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_SKMinusWolf_Dead_AnimBP(int32 EntryPoint);
};
