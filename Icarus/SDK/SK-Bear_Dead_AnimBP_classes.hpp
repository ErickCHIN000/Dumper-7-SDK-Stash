...
class USKMinusBear_Dead_AnimBP_C : public UIcarusCorpseAnimInstance
{
public:
	...
	static class USKMinusBear_Dead_AnimBP_C* GetDefaultObj();

	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_SKMinusBear_Dead_AnimBP(int32 EntryPoint);
};
