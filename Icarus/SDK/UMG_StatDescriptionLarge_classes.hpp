...
class UUMG_StatDescriptionLarge_C : public UUserWidget
{
public:
	...
	static class UUMG_StatDescriptionLarge_C* GetDefaultObj();
	...
	void ExecuteUbergraph_UMG_StatDescriptionLarge(int32 EntryPoint, bool K2Node_Event_IsDesignTime, bool K2Node_Event_bIsExpanded, bool K2Node_Event_bIsSelected, const struct FSlateColor& K2Node_MakeStruct_SlateColor, const struct FSlateColor& K2Node_MakeStruct_SlateColor_1, bool K2Node_CustomEvent_Active, const struct FSlateColor& K2Node_MakeStruct_SlateColor_2);
};
