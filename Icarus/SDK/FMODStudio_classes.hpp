...
public:
	...
	uint8                                        Pad_1D3[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         bUseListenerRotation;                              // 0x26C(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1D5[0x17];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	uint8                                        bAutoDestroy : 1;                                  // Mask: 0x1, PropSize: 0x10x284(0x1)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        bStopWhenOwnerDestroyed : 1;                       // Mask: 0x2, PropSize: 0x10x284(0x1)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1DF[0xB9];                                     // Fixing Size Of Struct [ Dumper-7 ]
	...
	void SetEvent(class UFMODEvent* NewEvent, bool bKeepParameterValues);
	void Release();
	void Play();
	void KeyOff();
	bool IsPlaying();
...
public:
	...
	class UFMODAudioComponent* PlayEventAttached(class UFMODEvent* Event, class USceneComponent* AttachToComponent, class FName AttachPointName, const struct FVector& Location, enum class EAttachLocation LocationType, bool bStopWhenAttachedToDestroyed, bool bAutoPlay, bool bAutoDestroy, enum class EFMODValid* IsValid, bool bUseListenerRotation);
	struct FFMODEventInstance PlayEventAtLocation(class UObject* WorldContextObject, class UFMODEvent* Event, struct FTransform& Location, bool bAutoPlay, bool bUseListenerRotation);
...
public:
	...
	uint8                                        Pad_543[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
