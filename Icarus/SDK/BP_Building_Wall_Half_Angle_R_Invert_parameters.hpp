...
struct ABP_Building_Wall_Half_Angle_R_Invert_C_GetBlockingBypass_Params
{
public:
	...
	uint8                                        Pad_3B7C[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         CallFunc_NotEqual_RotatorRotator_ReturnValue;      // 0x10C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FRotator                              CallFunc_K2_GetActorRotation_ReturnValue_1;        // 0x134(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_ClassIsChildOf_ReturnValue;               // 0x140(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_NotEqual_RotatorRotator_ReturnValue_1;    // 0x141(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	TArray<struct FVectorPair>                   K2Node_MakeArray_Array_2;                          // 0x148(0x10)(ReferenceParm)
	struct FVectorPair                           K2Node_MakeStruct_VectorPair_2;                    // 0x158(0x18)(NoDestructor)
