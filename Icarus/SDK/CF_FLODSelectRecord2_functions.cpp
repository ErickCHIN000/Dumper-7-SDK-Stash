...
class UClass* UCF_FLODSelectRecord2_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CF_FLODSelectRecord2_C");

	return Clss;
}


// CF_FLODSelectRecord2_C CF_FLODSelectRecord2.Default__CF_FLODSelectRecord2_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCF_FLODSelectRecord2_C* UCF_FLODSelectRecord2_C::GetDefaultObj()
{
	static class UCF_FLODSelectRecord2_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCF_FLODSelectRecord2_C*>(UCF_FLODSelectRecord2_C::StaticClass()->DefaultObject);

	return Default;
}


// Function CF_FLODSelectRecord2.CF_FLODSelectRecord2_C.GetSelectedRecord
...
// Function CF_FLODSelectRecord2.CF_FLODSelectRecord2_C.OnHandleExecute
