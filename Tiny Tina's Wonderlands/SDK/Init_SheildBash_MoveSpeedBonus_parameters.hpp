...
struct UInit_SheildBash_MoveSpeedBonus_C_CalculateAttributeInitialValue_Params
{
public:
	...
	float                                        CallFunc_GetValueOfAttribute_ReturnValue1;         // 0x10(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
