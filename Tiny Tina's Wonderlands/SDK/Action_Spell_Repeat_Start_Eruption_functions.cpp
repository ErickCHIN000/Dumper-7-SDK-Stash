...
class UClass* UAction_Spell_Repeat_Start_Eruption_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Action_Spell_Repeat_Start_Eruption_C");

	return Clss;
}


// Action_Spell_Repeat_Start_Eruption_C Action_Spell_Repeat_Start_Eruption.Default__Action_Spell_Repeat_Start_Eruption_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAction_Spell_Repeat_Start_Eruption_C* UAction_Spell_Repeat_Start_Eruption_C::GetDefaultObj()
{
	static class UAction_Spell_Repeat_Start_Eruption_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAction_Spell_Repeat_Start_Eruption_C*>(UAction_Spell_Repeat_Start_Eruption_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Action_Spell_Repeat_Start_Eruption.Action_Spell_Repeat_Start_Eruption_C.Notify_SpellWarmup
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAction_Spell_Repeat_Start_Eruption_C::Notify_SpellWarmup()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Repeat_Start_Eruption_C", "Notify_SpellWarmup");
...
// Function Action_Spell_Repeat_Start_Eruption.Action_Spell_Repeat_Start_Eruption_C.OnBegin
// (Event, Public, BlueprintEvent)
// Parameters:
// class AActor*                      Actor                                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAction_Spell_Repeat_Start_Eruption_C::OnBegin(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Repeat_Start_Eruption_C", "OnBegin");

	Params::UAction_Spell_Repeat_Start_Eruption_C_OnBegin_Params Parms{};
...
// Function Action_Spell_Repeat_Start_Eruption.Action_Spell_Repeat_Start_Eruption_C.ExecuteUbergraph_Action_Spell_Repeat_Start_Eruption
// (None)
// Parameters:
