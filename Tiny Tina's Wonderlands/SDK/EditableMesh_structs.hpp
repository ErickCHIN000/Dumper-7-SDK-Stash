...
{
public:
	uint8                                        Pad_BF7[0x50];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FColor                                GbxVertexColor;                                    // 0x18(0x4)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                               VertexNormal;                                      // 0x1C(0xC)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVector                               VertexTangent;                                     // 0x28(0xC)(BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        VertexBinormalSign;                                // 0x34(0x4)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FSubdividedQuadVertex                 QuadVertex0;                                       // 0x0(0x38)(BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FSubdividedQuadVertex                 QuadVertex1;                                       // 0x38(0x38)(BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FSubdividedQuadVertex                 QuadVertex2;                                       // 0x70(0x38)(BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct FSubdividedQuadVertex                 QuadVertex3;                                       // 0xA8(0x38)(BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_CA2[0x3C];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
