...
// BlueprintGeneratedClass Action_Spell_Channel_Fire_Barrelmaker.Action_Spell_Channel_Fire_Barrelmaker_C
// (None)

class UClass* UAction_Spell_Channel_Fire_Barrelmaker_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Action_Spell_Channel_Fire_Barrelmaker_C");

	return Clss;
}


// Action_Spell_Channel_Fire_Barrelmaker_C Action_Spell_Channel_Fire_Barrelmaker.Default__Action_Spell_Channel_Fire_Barrelmaker_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAction_Spell_Channel_Fire_Barrelmaker_C* UAction_Spell_Channel_Fire_Barrelmaker_C::GetDefaultObj()
{
	static class UAction_Spell_Channel_Fire_Barrelmaker_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAction_Spell_Channel_Fire_Barrelmaker_C*>(UAction_Spell_Channel_Fire_Barrelmaker_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Action_Spell_Channel_Fire_Barrelmaker.Action_Spell_Channel_Fire_Barrelmaker_C.OnBegin
// (Event, Public, BlueprintEvent)
// Parameters:
// class AActor*                      Actor                                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAction_Spell_Channel_Fire_Barrelmaker_C::OnBegin(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Channel_Fire_Barrelmaker_C", "OnBegin");

	Params::UAction_Spell_Channel_Fire_Barrelmaker_C_OnBegin_Params Parms{};
...
// Function Action_Spell_Channel_Fire_Barrelmaker.Action_Spell_Channel_Fire_Barrelmaker_C.SpellCharge
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAction_Spell_Channel_Fire_Barrelmaker_C::SpellCharge()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Channel_Fire_Barrelmaker_C", "SpellCharge");
...
// Function Action_Spell_Channel_Fire_Barrelmaker.Action_Spell_Channel_Fire_Barrelmaker_C.SpellThrow
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAction_Spell_Channel_Fire_Barrelmaker_C::SpellThrow()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Channel_Fire_Barrelmaker_C", "SpellThrow");
...
// Function Action_Spell_Channel_Fire_Barrelmaker.Action_Spell_Channel_Fire_Barrelmaker_C.ExecuteUbergraph_Action_Spell_Channel_Fire_Barrelmaker
// (None)
// Parameters:
