...
class ULightProj_Host_ShieldHeal_C : public UOakLightProjectileData
{
public:
	uint8                                        Pad_1BD7[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]

	static class UClass* StaticClass();
	static class ULightProj_Host_ShieldHeal_C* GetDefaultObj();
