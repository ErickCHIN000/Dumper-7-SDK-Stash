...
public:
	...
	uint8                                        Pad_F8A[0x50];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         bExcludeLocalizedAssets;                           // 0xE3(0x1)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_FD5[0x28];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FDateTime                             AssetDateModified;                                 // 0x50(0x8)(BlueprintVisible, BlueprintReadOnly, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
