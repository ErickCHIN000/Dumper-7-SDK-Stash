...
class ULightProjectile_Minstrel_C : public UOakLightProjectileData
{
public:
	uint8                                        Pad_3FEF[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]

	static class UClass* StaticClass();
	static class ULightProjectile_Minstrel_C* GetDefaultObj();
