...
public:
	...
	uint8                                        Pad_606[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FMovieSceneSequencePlaybackSettings   Settings;                                          // 0x10(0x48)(Parm, NativeAccessSpecifierPublic)
	class ALevelSequenceActor*                   OutActor;                                          // 0x58(0x8)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class ULevelSequencePlayer*                  ReturnValue;                                       // 0x60(0x8)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	struct FSoftClassPath                        InBurnInClass;                                     // 0x0(0x18)(Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
