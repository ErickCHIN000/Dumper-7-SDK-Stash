...
// BlueprintGeneratedClass PayloadBehavior_Multi_TimeSkip.PayloadBehavior_Multi_TimeSkip_C
// (None)

class UClass* UPayloadBehavior_Multi_TimeSkip_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PayloadBehavior_Multi_TimeSkip_C");

	return Clss;
}


// PayloadBehavior_Multi_TimeSkip_C PayloadBehavior_Multi_TimeSkip.Default__PayloadBehavior_Multi_TimeSkip_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPayloadBehavior_Multi_TimeSkip_C* UPayloadBehavior_Multi_TimeSkip_C::GetDefaultObj()
{
	static class UPayloadBehavior_Multi_TimeSkip_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPayloadBehavior_Multi_TimeSkip_C*>(UPayloadBehavior_Multi_TimeSkip_C::StaticClass()->DefaultObject);
