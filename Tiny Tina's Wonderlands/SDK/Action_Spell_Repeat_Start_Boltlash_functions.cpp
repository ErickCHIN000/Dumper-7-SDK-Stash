...
class UClass* UAction_Spell_Repeat_Start_Boltlash_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Action_Spell_Repeat_Start_Boltlash_C");

	return Clss;
}


// Action_Spell_Repeat_Start_Boltlash_C Action_Spell_Repeat_Start_Boltlash.Default__Action_Spell_Repeat_Start_Boltlash_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAction_Spell_Repeat_Start_Boltlash_C* UAction_Spell_Repeat_Start_Boltlash_C::GetDefaultObj()
{
	static class UAction_Spell_Repeat_Start_Boltlash_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAction_Spell_Repeat_Start_Boltlash_C*>(UAction_Spell_Repeat_Start_Boltlash_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Action_Spell_Repeat_Start_Boltlash.Action_Spell_Repeat_Start_Boltlash_C.OnBegin
// (Event, Public, BlueprintEvent)
// Parameters:
// class AActor*                      Actor                                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAction_Spell_Repeat_Start_Boltlash_C::OnBegin(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Repeat_Start_Boltlash_C", "OnBegin");

	Params::UAction_Spell_Repeat_Start_Boltlash_C_OnBegin_Params Parms{};
...
// Function Action_Spell_Repeat_Start_Boltlash.Action_Spell_Repeat_Start_Boltlash_C.Notify_SpellcastStart
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAction_Spell_Repeat_Start_Boltlash_C::Notify_SpellcastStart()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Repeat_Start_Boltlash_C", "Notify_SpellcastStart");
...
// Function Action_Spell_Repeat_Start_Boltlash.Action_Spell_Repeat_Start_Boltlash_C.ExecuteUbergraph_Action_Spell_Repeat_Start_Boltlash
// (None)
// Parameters:
