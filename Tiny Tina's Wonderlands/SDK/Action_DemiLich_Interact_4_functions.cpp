...
// BlueprintGeneratedClass Action_DemiLich_Interact_4.Action_DemiLich_Interact_4_C
// (None)

class UClass* UAction_DemiLich_Interact_4_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Action_DemiLich_Interact_4_C");

	return Clss;
}


// Action_DemiLich_Interact_4_C Action_DemiLich_Interact_4.Default__Action_DemiLich_Interact_4_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAction_DemiLich_Interact_4_C* UAction_DemiLich_Interact_4_C::GetDefaultObj()
{
	static class UAction_DemiLich_Interact_4_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAction_DemiLich_Interact_4_C*>(UAction_DemiLich_Interact_4_C::StaticClass()->DefaultObject);
...
void UAction_DemiLich_Interact_4_C::OnBegin(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_DemiLich_Interact_4_C", "OnBegin");

	Params::UAction_DemiLich_Interact_4_C_OnBegin_Params Parms{};
