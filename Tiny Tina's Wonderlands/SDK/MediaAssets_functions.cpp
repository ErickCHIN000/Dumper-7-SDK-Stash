...
class UClass* IMediaAudioSinkProviderInterface::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MediaAudioSinkProviderInterface");

	return Clss;
}


// MediaAudioSinkProviderInterface MediaAssets.Default__MediaAudioSinkProviderInterface
// (Public, ClassDefaultObject, ArchetypeObject)

class IMediaAudioSinkProviderInterface* IMediaAudioSinkProviderInterface::GetDefaultObj()
{
	static class IMediaAudioSinkProviderInterface* Default = nullptr;

	if (!Default)
		Default = static_cast<IMediaAudioSinkProviderInterface*>(IMediaAudioSinkProviderInterface::StaticClass()->DefaultObject);
...
void UMediaPlayer::SetAudioSinkProvider(TScriptInterface<class IMediaAudioSinkProviderInterface> NewSinkProvider)
{
	...
	Params::UMediaPlayer_SetAudioSinkProvider_Params Parms{};
