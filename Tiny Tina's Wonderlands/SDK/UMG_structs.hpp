...
{
public:
	uint8                                        Pad_281A[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_281F[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2887[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	TArray<class FName>                          BrushPropertyNamePath;                             // 0x60(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
};
...
public:
	...
	uint8                                        Pad_28BC[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
