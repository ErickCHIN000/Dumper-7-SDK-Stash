...
class ULightProj_Spell_MagicMissile_Mod03_C : public ULightProj_Spell_MagicMissile_Base_C
{
public:

	static class UClass* StaticClass();
	static class ULightProj_Spell_MagicMissile_Mod03_C* GetDefaultObj();
