...
void UMovieSceneSequencePlayer::SetEnableUpdateRateOptimizations(bool Enable)
{
	...
	Params::UMovieSceneSequencePlayer_SetEnableUpdateRateOptimizations_Params Parms{};
...
bool UMovieSceneSequencePlayer::GetEnableUpdateRateOptimizations()
{
	...
	Params::UMovieSceneSequencePlayer_GetEnableUpdateRateOptimizations_Params Parms{};
...
class UClass* UMovieSceneSegmentCompilerTestTrack::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MovieSceneSegmentCompilerTestTrack");

	return Clss;
}


// MovieSceneSegmentCompilerTestTrack MovieScene.Default__MovieSceneSegmentCompilerTestTrack
// (Public, ClassDefaultObject, ArchetypeObject)

class UMovieSceneSegmentCompilerTestTrack* UMovieSceneSegmentCompilerTestTrack::GetDefaultObj()
{
	static class UMovieSceneSegmentCompilerTestTrack* Default = nullptr;

	if (!Default)
		Default = static_cast<UMovieSceneSegmentCompilerTestTrack*>(UMovieSceneSegmentCompilerTestTrack::StaticClass()->DefaultObject);
...
class UClass* UMovieSceneSegmentCompilerTestSection::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MovieSceneSegmentCompilerTestSection");

	return Clss;
}


// MovieSceneSegmentCompilerTestSection MovieScene.Default__MovieSceneSegmentCompilerTestSection
// (Public, ClassDefaultObject, ArchetypeObject)

class UMovieSceneSegmentCompilerTestSection* UMovieSceneSegmentCompilerTestSection::GetDefaultObj()
{
	static class UMovieSceneSegmentCompilerTestSection* Default = nullptr;

	if (!Default)
		Default = static_cast<UMovieSceneSegmentCompilerTestSection*>(UMovieSceneSegmentCompilerTestSection::StaticClass()->DefaultObject);
