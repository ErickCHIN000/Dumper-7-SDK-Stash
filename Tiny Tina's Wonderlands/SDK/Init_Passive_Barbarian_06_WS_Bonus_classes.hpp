...
class UInit_Passive_Barbarian_06_WS_Bonus_C : public UAttributeInitializer
{
public:
	struct FDataTableValueHandle                 WeaponSwapHandle;                                  // 0x30(0x18)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)

	static class UClass* StaticClass();
	static class UInit_Passive_Barbarian_06_WS_Bonus_C* GetDefaultObj();
