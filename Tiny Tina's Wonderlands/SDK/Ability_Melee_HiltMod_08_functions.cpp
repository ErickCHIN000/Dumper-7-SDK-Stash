...
class UClass* UAbility_Melee_HiltMod_08_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Ability_Melee_HiltMod_08_C");

	return Clss;
}


// Ability_Melee_HiltMod_08_C Ability_Melee_HiltMod_08.Default__Ability_Melee_HiltMod_08_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAbility_Melee_HiltMod_08_C* UAbility_Melee_HiltMod_08_C::GetDefaultObj()
{
	static class UAbility_Melee_HiltMod_08_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAbility_Melee_HiltMod_08_C*>(UAbility_Melee_HiltMod_08_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Ability_Melee_HiltMod_08.Ability_Melee_HiltMod_08_C.OnActivated
// (Event, Protected, BlueprintEvent)
// Parameters:

void UAbility_Melee_HiltMod_08_C::OnActivated()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Ability_Melee_HiltMod_08_C", "OnActivated");
...
void UAbility_Melee_HiltMod_08_C::DoHiltMod_Hit(class UGbxDamageType* DamageType, class AActor* DamagedActor, const struct FCausedDamageDetails& Details)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Ability_Melee_HiltMod_08_C", "DoHiltMod_Hit");

	Params::UAbility_Melee_HiltMod_08_C_DoHiltMod_Hit_Params Parms{};
