...
class UClass* UInit_Shaman_06_DamageDealt_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Init_Shaman_06_DamageDealt_C");

	return Clss;
}


// Init_Shaman_06_DamageDealt_C Init_Shaman_06_DamageDealt.Default__Init_Shaman_06_DamageDealt_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UInit_Shaman_06_DamageDealt_C* UInit_Shaman_06_DamageDealt_C::GetDefaultObj()
{
	static class UInit_Shaman_06_DamageDealt_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UInit_Shaman_06_DamageDealt_C*>(UInit_Shaman_06_DamageDealt_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Init_Shaman_06_DamageDealt.Init_Shaman_06_DamageDealt_C.CalculateAttributeInitialValue
