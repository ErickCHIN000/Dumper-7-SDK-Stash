...
public:
	...
	uint8                                        Pad_DA8[0xF];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_DB3[0xB];                                      // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_DD9[0x5];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_E7D[0x8];                                      // Fixing Size After Last Property  [ Dumper-7 ]
