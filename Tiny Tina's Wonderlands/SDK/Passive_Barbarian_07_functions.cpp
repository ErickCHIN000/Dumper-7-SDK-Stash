...
// BlueprintGeneratedClass Passive_Barbarian_07.Passive_Barbarian_07_C
// (None)

class UClass* UPassive_Barbarian_07_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Passive_Barbarian_07_C");

	return Clss;
}


// Passive_Barbarian_07_C Passive_Barbarian_07.Default__Passive_Barbarian_07_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPassive_Barbarian_07_C* UPassive_Barbarian_07_C::GetDefaultObj()
{
	static class UPassive_Barbarian_07_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPassive_Barbarian_07_C*>(UPassive_Barbarian_07_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Passive_Barbarian_07.Passive_Barbarian_07_C.GetManualHUDIconValues
...
// Function Passive_Barbarian_07.Passive_Barbarian_07_C.OnActivated
// (Event, Protected, BlueprintEvent)
// Parameters:

void UPassive_Barbarian_07_C::OnActivated()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Passive_Barbarian_07_C", "OnActivated");
...
// Function Passive_Barbarian_07.Passive_Barbarian_07_C.ExecuteUbergraph_Passive_Barbarian_07
// (HasDefaults)
// Parameters:
...
void UPassive_Barbarian_07_C::ExecuteUbergraph_Passive_Barbarian_07(int32 EntryPoint, const struct FGameResourcePoolReference& CallFunc_GetResourcePoolByResource_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Passive_Barbarian_07_C", "ExecuteUbergraph_Passive_Barbarian_07");

	Params::UPassive_Barbarian_07_C_ExecuteUbergraph_Passive_Barbarian_07_Params Parms{};
