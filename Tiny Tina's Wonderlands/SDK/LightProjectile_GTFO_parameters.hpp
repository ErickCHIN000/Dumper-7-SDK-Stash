...
// 0x8 (0x8 - 0x0)
// Function LightProjectile_GTFO.LightProjectile_GTFO_C.EnableHoming
struct ULightProjectile_GTFO_C_EnableHoming_Params
{
public:
...
// 0x140 (0x140 - 0x0)
// Function LightProjectile_GTFO.LightProjectile_GTFO_C.OnRicochet
struct ULightProjectile_GTFO_C_OnRicochet_Params
{
public:
	class ULightProjectile*                      Projectile;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// 0x98 (0x98 - 0x0)
// Function LightProjectile_GTFO.LightProjectile_GTFO_C.OnImpact
struct ULightProjectile_GTFO_C_OnImpact_Params
{
public:
	class ULightProjectile*                      Projectile;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                            Hit;                                               // 0x8(0x90)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
...
// 0x8 (0x8 - 0x0)
// Function LightProjectile_GTFO.LightProjectile_GTFO_C.OnLifetimeExpired
struct ULightProjectile_GTFO_C_OnLifetimeExpired_Params
{
public:
	class ULightProjectile*                      Projectile;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
