...
{
public:
	uint8                                        Pad_B26[0xD50];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_B2A[0xF8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_B2D[0x1E4];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_BE6[0xA4];                                     // Fixing Size Of Struct [ Dumper-7 ]
