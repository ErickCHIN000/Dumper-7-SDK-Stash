...
public:
	...
	class UInventoryListComponent*               CallFunc_GetBankInventoryComponent_ReturnValue;    // 0x40(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
