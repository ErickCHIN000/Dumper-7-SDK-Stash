...
// BlueprintGeneratedClass Action_DemiLich_Interact_2.Action_DemiLich_Interact_2_C
// (None)

class UClass* UAction_DemiLich_Interact_2_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Action_DemiLich_Interact_2_C");

	return Clss;
}


// Action_DemiLich_Interact_2_C Action_DemiLich_Interact_2.Default__Action_DemiLich_Interact_2_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAction_DemiLich_Interact_2_C* UAction_DemiLich_Interact_2_C::GetDefaultObj()
{
	static class UAction_DemiLich_Interact_2_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAction_DemiLich_Interact_2_C*>(UAction_DemiLich_Interact_2_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Action_DemiLich_Interact_2.Action_DemiLich_Interact_2_C.OnBegin
// (Event, Public, BlueprintEvent)
// Parameters:
// class AActor*                      Actor                                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAction_DemiLich_Interact_2_C::OnBegin(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_DemiLich_Interact_2_C", "OnBegin");

	Params::UAction_DemiLich_Interact_2_C_OnBegin_Params Parms{};
...
// Function Action_DemiLich_Interact_2.Action_DemiLich_Interact_2_C.ExecuteUbergraph_Action_DemiLich_Interact_2
// (HasDefaults)
// Parameters:
