...
struct ULightProjectile_SMG_Magic_Fire_02_C_OnRicochet_Params
{
public:
	...
	class APawn*                                 CallFunc_GetInstigator_ReturnValue;                // 0x120(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                              CallFunc_MakeRotFromZ_ReturnValue;                 // 0x128(0xC)(IsPlainOldData, NoDestructor)
	uint8                                        Pad_3F6F[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct ULightProjectile_SMG_Magic_Fire_02_C_OnImpact_Params
{
public:
	class ULightProjectile*                      Projectile;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FHitResult                            Hit;                                               // 0x8(0x90)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FRotator                              CallFunc_MakeRotFromZ_ReturnValue;                 // 0x120(0xC)(IsPlainOldData, NoDestructor)
	...
	class ASplat*                                CallFunc_FinishSpawningActor_ReturnValue;          // 0x168(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
