...
class UClass* UBP_CE_BAMF_Player_StandIn_CC_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_CE_BAMF_Player_StandIn_CC_C");

	return Clss;
}


// BP_CE_BAMF_Player_StandIn_CC_C BP_CE_BAMF_Player_StandIn_CC.Default__BP_CE_BAMF_Player_StandIn_CC_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_CE_BAMF_Player_StandIn_CC_C* UBP_CE_BAMF_Player_StandIn_CC_C::GetDefaultObj()
{
	static class UBP_CE_BAMF_Player_StandIn_CC_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_CE_BAMF_Player_StandIn_CC_C*>(UBP_CE_BAMF_Player_StandIn_CC_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_CE_BAMF_Player_StandIn_CC.BP_CE_BAMF_Player_StandIn_CC_C.PlayMaterialAudio
...
// Function BP_CE_BAMF_Player_StandIn_CC.BP_CE_BAMF_Player_StandIn_CC_C.PlayPoofAudio
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FVector                     CallFunc_GetActorBounds_Origin                                   (IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FVector                     CallFunc_GetActorBounds_BoxExtent                                (IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UBP_CE_BAMF_Player_StandIn_CC_C::PlayPoofAudio(const struct FVector& CallFunc_GetActorBounds_Origin, const struct FVector& CallFunc_GetActorBounds_BoxExtent, float CallFunc_GetMaxElement_ReturnValue, const struct FWwisePlaybackInstance& CallFunc_PostEventAtLocation_ReturnValue, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue, bool CallFunc_GreaterEqual_FloatFloat_ReturnValue1)
{
	...
	if (!Func)
		Func = Class->GetFunction("BP_CE_BAMF_Player_StandIn_CC_C", "PlayPoofAudio");

	Params::UBP_CE_BAMF_Player_StandIn_CC_C_PlayPoofAudio_Params Parms{};
...
// Function BP_CE_BAMF_Player_StandIn_CC.BP_CE_BAMF_Player_StandIn_CC_C.OnBegin
// (Event, Public, BlueprintEvent)
// Parameters:
// class AActor*                      Actor                                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_CE_BAMF_Player_StandIn_CC_C::OnBegin(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_CE_BAMF_Player_StandIn_CC_C", "OnBegin");

	Params::UBP_CE_BAMF_Player_StandIn_CC_C_OnBegin_Params Parms{};
...
// Function BP_CE_BAMF_Player_StandIn_CC.BP_CE_BAMF_Player_StandIn_CC_C.ExecuteUbergraph_BP_CE_BAMF_Player_StandIn_CC
// (HasDefaults)
// Parameters:
...
void UBP_CE_BAMF_Player_StandIn_CC_C::ExecuteUbergraph_BP_CE_BAMF_Player_StandIn_CC(int32 EntryPoint, const struct FVector& CallFunc_GetActorBounds_Origin, const struct FVector& CallFunc_GetActorBounds_BoxExtent, class AActor* K2Node_Event_Actor, float CallFunc_VSize_ReturnValue, const struct FWwisePlaybackInstance& CallFunc_PostEventAtLocation_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_CE_BAMF_Player_StandIn_CC_C", "ExecuteUbergraph_BP_CE_BAMF_Player_StandIn_CC");

	Params::UBP_CE_BAMF_Player_StandIn_CC_C_ExecuteUbergraph_BP_CE_BAMF_Player_StandIn_CC_Params Parms{};
