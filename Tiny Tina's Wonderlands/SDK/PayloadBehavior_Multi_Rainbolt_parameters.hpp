...
struct UPayloadBehavior_Multi_Rainbolt_C_GetSpellCastingSocket_Params
{
public:
	...
	uint8                                        Pad_18C0[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
struct UPayloadBehavior_Multi_Rainbolt_C_GetCustomSpellSpawnInfo_Params
{
public:
	...
	uint8                                        Pad_19A6[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FVector                               CallFunc_GetActorAimViewPoint_OutLocation;         // 0x100(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                              CallFunc_GetActorAimViewPoint_OutRotation;         // 0x10C(0xC)(IsPlainOldData, NoDestructor)
	...
	struct FVector                               CallFunc_RandomUnitVectorInConeInDegreesFromStream_ReturnValue; // 0x148(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
