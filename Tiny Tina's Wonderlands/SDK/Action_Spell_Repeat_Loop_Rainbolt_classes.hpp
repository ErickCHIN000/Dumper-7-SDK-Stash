...
class UAction_Spell_Repeat_Loop_Rainbolt_C : public UAction_SpellThrow_Wand_C
{
public:
	...
	static class UAction_Spell_Repeat_Loop_Rainbolt_C* GetDefaultObj();
