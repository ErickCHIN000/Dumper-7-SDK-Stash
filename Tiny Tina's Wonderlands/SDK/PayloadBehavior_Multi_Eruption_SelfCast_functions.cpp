...
// BlueprintGeneratedClass PayloadBehavior_Multi_Eruption_SelfCast.PayloadBehavior_Multi_Eruption_SelfCast_C
// (None)

class UClass* UPayloadBehavior_Multi_Eruption_SelfCast_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PayloadBehavior_Multi_Eruption_SelfCast_C");

	return Clss;
}


// PayloadBehavior_Multi_Eruption_SelfCast_C PayloadBehavior_Multi_Eruption_SelfCast.Default__PayloadBehavior_Multi_Eruption_SelfCast_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPayloadBehavior_Multi_Eruption_SelfCast_C* UPayloadBehavior_Multi_Eruption_SelfCast_C::GetDefaultObj()
{
	static class UPayloadBehavior_Multi_Eruption_SelfCast_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPayloadBehavior_Multi_Eruption_SelfCast_C*>(UPayloadBehavior_Multi_Eruption_SelfCast_C::StaticClass()->DefaultObject);

	return Default;
}


// Function PayloadBehavior_Multi_Eruption_SelfCast.PayloadBehavior_Multi_Eruption_SelfCast_C.GetCustomSpellSpawnInfo
