...
struct UPayloadBehavior_Multi_Eruption_C_GetCustomSpellSpawnInfo_Params
{
public:
	...
	uint8                                        Pad_35ED[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	int32                                        CallFunc_RandomIntegerInRangeFromStream_ReturnValue; // 0xCC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_Subtract_IntInt_ReturnValue1;             // 0xD0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3615[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	int32                                        CallFunc_Add_IntInt_ReturnValue2;                  // 0x114(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UOakFirstPersonComponent*              CallFunc_GetComponentByClass_ReturnValue;          // 0x168(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector                               CallFunc_GetActorAimViewPoint_OutLocation;         // 0x170(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FRotator                              CallFunc_GetActorAimViewPoint_OutRotation;         // 0x17C(0xC)(IsPlainOldData, NoDestructor)
	struct FVector                               CallFunc_GetForwardVector_ReturnValue;             // 0x188(0xC)(IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3626[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<struct FTransform>                    CallFunc_GeneratePointsOnCone_ReturnValue;         // 0x1F8(0x10)(ZeroConstructor, ReferenceParm)
};
