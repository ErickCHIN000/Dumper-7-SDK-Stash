...
// BlueprintGeneratedClass Init_Barbarian_13_FireRate.Init_Barbarian_13_FireRate_C
// (None)

class UClass* UInit_Barbarian_13_FireRate_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Init_Barbarian_13_FireRate_C");

	return Clss;
}


// Init_Barbarian_13_FireRate_C Init_Barbarian_13_FireRate.Default__Init_Barbarian_13_FireRate_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UInit_Barbarian_13_FireRate_C* UInit_Barbarian_13_FireRate_C::GetDefaultObj()
{
	static class UInit_Barbarian_13_FireRate_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UInit_Barbarian_13_FireRate_C*>(UInit_Barbarian_13_FireRate_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Init_Barbarian_13_FireRate.Init_Barbarian_13_FireRate_C.CalculateAttributeInitialValue
