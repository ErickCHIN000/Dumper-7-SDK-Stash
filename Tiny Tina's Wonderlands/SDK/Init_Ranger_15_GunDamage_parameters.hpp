...
struct UInit_Ranger_15_GunDamage_C_CalculateAttributeInitialValue_Params
{
public:
	...
	float                                        BulletDamage;                                      // 0xC(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CurrentStackAmount;                                // 0x10(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
