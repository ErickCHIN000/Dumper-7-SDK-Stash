...
class UClass* UAbility_Rune_Mind_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Ability_Rune_Mind_C");

	return Clss;
}


// Ability_Rune_Mind_C Ability_Rune_Mind.Default__Ability_Rune_Mind_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAbility_Rune_Mind_C* UAbility_Rune_Mind_C::GetDefaultObj()
{
	static class UAbility_Rune_Mind_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAbility_Rune_Mind_C*>(UAbility_Rune_Mind_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Ability_Rune_Mind.Ability_Rune_Mind_C.OnActivated
// (Event, Protected, BlueprintEvent)
// Parameters:

void UAbility_Rune_Mind_C::OnActivated()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Ability_Rune_Mind_C", "OnActivated");
...
// Function Ability_Rune_Mind.Ability_Rune_Mind_C.OnDeactivated
// (Event, Protected, BlueprintEvent)
// Parameters:

void UAbility_Rune_Mind_C::OnDeactivated()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Ability_Rune_Mind_C", "OnDeactivated");
...
// Function Ability_Rune_Mind.Ability_Rune_Mind_C.SpellCastTrigger
...
void UAbility_Rune_Mind_C::SpellCastTrigger(class AGrenadeMod* GrenadeMod, class AOakCharacter_Player* EquippedPlayer)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Ability_Rune_Mind_C", "SpellCastTrigger");

	Params::UAbility_Rune_Mind_C_SpellCastTrigger_Params Parms{};
...
// Function Ability_Rune_Mind.Ability_Rune_Mind_C.DamageGateReset
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAbility_Rune_Mind_C::DamageGateReset()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Ability_Rune_Mind_C", "DamageGateReset");
...
// Function Ability_Rune_Mind.Ability_Rune_Mind_C.ExecuteUbergraph_Ability_Rune_Mind
// (HasDefaults)
// Parameters:
