...
struct UPayloadBehavior_Multi_ElementalHawk_Fan_C_GetCustomSpellSpawnInfo_Params
{
public:
	...
	uint8                                        Pad_134D[0xF];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_135B[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class UOakFirstPersonComponent*              CallFunc_GetComponentByClass_ReturnValue;          // 0x190(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
