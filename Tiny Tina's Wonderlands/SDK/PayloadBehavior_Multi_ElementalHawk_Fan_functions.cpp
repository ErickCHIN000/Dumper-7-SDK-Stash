...
class UClass* UPayloadBehavior_Multi_ElementalHawk_Fan_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PayloadBehavior_Multi_ElementalHawk_Fan_C");

	return Clss;
}


// PayloadBehavior_Multi_ElementalHawk_Fan_C PayloadBehavior_Multi_ElementalHawk_Fan.Default__PayloadBehavior_Multi_ElementalHawk_Fan_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPayloadBehavior_Multi_ElementalHawk_Fan_C* UPayloadBehavior_Multi_ElementalHawk_Fan_C::GetDefaultObj()
{
	static class UPayloadBehavior_Multi_ElementalHawk_Fan_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPayloadBehavior_Multi_ElementalHawk_Fan_C*>(UPayloadBehavior_Multi_ElementalHawk_Fan_C::StaticClass()->DefaultObject);

	return Default;
}


// Function PayloadBehavior_Multi_ElementalHawk_Fan.PayloadBehavior_Multi_ElementalHawk_Fan_C.GetCustomSpellSpawnInfo
