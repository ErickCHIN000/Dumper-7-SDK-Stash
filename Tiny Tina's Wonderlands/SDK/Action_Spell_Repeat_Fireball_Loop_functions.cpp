...
class UClass* UAction_Spell_Repeat_Fireball_Loop_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Action_Spell_Repeat_Fireball_Loop_C");

	return Clss;
}


// Action_Spell_Repeat_Fireball_Loop_C Action_Spell_Repeat_Fireball_Loop.Default__Action_Spell_Repeat_Fireball_Loop_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAction_Spell_Repeat_Fireball_Loop_C* UAction_Spell_Repeat_Fireball_Loop_C::GetDefaultObj()
{
	static class UAction_Spell_Repeat_Fireball_Loop_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAction_Spell_Repeat_Fireball_Loop_C*>(UAction_Spell_Repeat_Fireball_Loop_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Action_Spell_Repeat_Fireball_Loop.Action_Spell_Repeat_Fireball_Loop_C.OnDialogSequenceFinished_2
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAction_Spell_Repeat_Fireball_Loop_C::OnDialogSequenceFinished_2()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Repeat_Fireball_Loop_C", "OnDialogSequenceFinished_2");
...
// Function Action_Spell_Repeat_Fireball_Loop.Action_Spell_Repeat_Fireball_Loop_C.OnBegin
// (Event, Public, BlueprintEvent)
// Parameters:
// class AActor*                      Actor                                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAction_Spell_Repeat_Fireball_Loop_C::OnBegin(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Repeat_Fireball_Loop_C", "OnBegin");

	Params::UAction_Spell_Repeat_Fireball_Loop_C_OnBegin_Params Parms{};
...
// Function Action_Spell_Repeat_Fireball_Loop.Action_Spell_Repeat_Fireball_Loop_C.SpellCharge
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAction_Spell_Repeat_Fireball_Loop_C::SpellCharge()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Repeat_Fireball_Loop_C", "SpellCharge");
...
// Function Action_Spell_Repeat_Fireball_Loop.Action_Spell_Repeat_Fireball_Loop_C.SpellThrow
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAction_Spell_Repeat_Fireball_Loop_C::SpellThrow()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Repeat_Fireball_Loop_C", "SpellThrow");
...
// Function Action_Spell_Repeat_Fireball_Loop.Action_Spell_Repeat_Fireball_Loop_C.Audio_PushCast
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAction_Spell_Repeat_Fireball_Loop_C::Audio_PushCast()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Repeat_Fireball_Loop_C", "Audio_PushCast");
...
// Function Action_Spell_Repeat_Fireball_Loop.Action_Spell_Repeat_Fireball_Loop_C.ExecuteUbergraph_Action_Spell_Repeat_Fireball_Loop
// (HasDefaults)
// Parameters:
