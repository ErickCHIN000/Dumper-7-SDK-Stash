...
// BlueprintGeneratedClass Action_Spell_Channel_Fire_LightningBlast.Action_Spell_Channel_Fire_LightningBlast_C
// (None)

class UClass* UAction_Spell_Channel_Fire_LightningBlast_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Action_Spell_Channel_Fire_LightningBlast_C");

	return Clss;
}


// Action_Spell_Channel_Fire_LightningBlast_C Action_Spell_Channel_Fire_LightningBlast.Default__Action_Spell_Channel_Fire_LightningBlast_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAction_Spell_Channel_Fire_LightningBlast_C* UAction_Spell_Channel_Fire_LightningBlast_C::GetDefaultObj()
{
	static class UAction_Spell_Channel_Fire_LightningBlast_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAction_Spell_Channel_Fire_LightningBlast_C*>(UAction_Spell_Channel_Fire_LightningBlast_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Action_Spell_Channel_Fire_LightningBlast.Action_Spell_Channel_Fire_LightningBlast_C.OnDialogSequenceFinished_2
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAction_Spell_Channel_Fire_LightningBlast_C::OnDialogSequenceFinished_2()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Channel_Fire_LightningBlast_C", "OnDialogSequenceFinished_2");
...
// Function Action_Spell_Channel_Fire_LightningBlast.Action_Spell_Channel_Fire_LightningBlast_C.OnBegin
// (Event, Public, BlueprintEvent)
// Parameters:
// class AActor*                      Actor                                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAction_Spell_Channel_Fire_LightningBlast_C::OnBegin(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Channel_Fire_LightningBlast_C", "OnBegin");

	Params::UAction_Spell_Channel_Fire_LightningBlast_C_OnBegin_Params Parms{};
...
// Function Action_Spell_Channel_Fire_LightningBlast.Action_Spell_Channel_Fire_LightningBlast_C.SpellCharge
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAction_Spell_Channel_Fire_LightningBlast_C::SpellCharge()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Channel_Fire_LightningBlast_C", "SpellCharge");
...
// Function Action_Spell_Channel_Fire_LightningBlast.Action_Spell_Channel_Fire_LightningBlast_C.SpellThrow
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAction_Spell_Channel_Fire_LightningBlast_C::SpellThrow()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Channel_Fire_LightningBlast_C", "SpellThrow");
...
// Function Action_Spell_Channel_Fire_LightningBlast.Action_Spell_Channel_Fire_LightningBlast_C.ExecuteUbergraph_Action_Spell_Channel_Fire_LightningBlast
// (HasDefaults)
// Parameters:
