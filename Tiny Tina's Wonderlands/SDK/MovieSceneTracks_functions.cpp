...
class UClass* UMovieSceneFeedbackSection::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MovieSceneFeedbackSection");

	return Clss;
}


// MovieSceneFeedbackSection MovieSceneTracks.Default__MovieSceneFeedbackSection
// (Public, ClassDefaultObject, ArchetypeObject)

class UMovieSceneFeedbackSection* UMovieSceneFeedbackSection::GetDefaultObj()
{
	static class UMovieSceneFeedbackSection* Default = nullptr;

	if (!Default)
		Default = static_cast<UMovieSceneFeedbackSection*>(UMovieSceneFeedbackSection::StaticClass()->DefaultObject);
...
class UClass* UMovieSceneFeedbackTrack::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MovieSceneFeedbackTrack");

	return Clss;
}


// MovieSceneFeedbackTrack MovieSceneTracks.Default__MovieSceneFeedbackTrack
// (Public, ClassDefaultObject, ArchetypeObject)

class UMovieSceneFeedbackTrack* UMovieSceneFeedbackTrack::GetDefaultObj()
{
	static class UMovieSceneFeedbackTrack* Default = nullptr;

	if (!Default)
		Default = static_cast<UMovieSceneFeedbackTrack*>(UMovieSceneFeedbackTrack::StaticClass()->DefaultObject);
...
class UClass* UMovieSceneGbxPlayRateSection::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MovieSceneGbxPlayRateSection");

	return Clss;
}


// MovieSceneGbxPlayRateSection MovieSceneTracks.Default__MovieSceneGbxPlayRateSection
// (Public, ClassDefaultObject, ArchetypeObject)

class UMovieSceneGbxPlayRateSection* UMovieSceneGbxPlayRateSection::GetDefaultObj()
{
	static class UMovieSceneGbxPlayRateSection* Default = nullptr;

	if (!Default)
		Default = static_cast<UMovieSceneGbxPlayRateSection*>(UMovieSceneGbxPlayRateSection::StaticClass()->DefaultObject);
...
class UClass* UMovieSceneGbxPlayRateTrack::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MovieSceneGbxPlayRateTrack");

	return Clss;
}


// MovieSceneGbxPlayRateTrack MovieSceneTracks.Default__MovieSceneGbxPlayRateTrack
// (Public, ClassDefaultObject, ArchetypeObject)

class UMovieSceneGbxPlayRateTrack* UMovieSceneGbxPlayRateTrack::GetDefaultObj()
{
	static class UMovieSceneGbxPlayRateTrack* Default = nullptr;

	if (!Default)
		Default = static_cast<UMovieSceneGbxPlayRateTrack*>(UMovieSceneGbxPlayRateTrack::StaticClass()->DefaultObject);
...
class UClass* UMovieSceneNearClippingPlaneTrack::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MovieSceneNearClippingPlaneTrack");

	return Clss;
}


// MovieSceneNearClippingPlaneTrack MovieSceneTracks.Default__MovieSceneNearClippingPlaneTrack
// (Public, ClassDefaultObject, ArchetypeObject)

class UMovieSceneNearClippingPlaneTrack* UMovieSceneNearClippingPlaneTrack::GetDefaultObj()
{
	static class UMovieSceneNearClippingPlaneTrack* Default = nullptr;

	if (!Default)
		Default = static_cast<UMovieSceneNearClippingPlaneTrack*>(UMovieSceneNearClippingPlaneTrack::StaticClass()->DefaultObject);
...
class UClass* UMovieSceneNearClippingPlaneSection::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MovieSceneNearClippingPlaneSection");

	return Clss;
}


// MovieSceneNearClippingPlaneSection MovieSceneTracks.Default__MovieSceneNearClippingPlaneSection
// (Public, ClassDefaultObject, ArchetypeObject)

class UMovieSceneNearClippingPlaneSection* UMovieSceneNearClippingPlaneSection::GetDefaultObj()
{
	static class UMovieSceneNearClippingPlaneSection* Default = nullptr;

	if (!Default)
		Default = static_cast<UMovieSceneNearClippingPlaneSection*>(UMovieSceneNearClippingPlaneSection::StaticClass()->DefaultObject);
...
void UMovieSceneSkeletalAnimationSection::GetAvailableSlotNames(TArray<class FName>* OutSlotNames)
{
	...
	Params::UMovieSceneSkeletalAnimationSection_GetAvailableSlotNames_Params Parms{};
