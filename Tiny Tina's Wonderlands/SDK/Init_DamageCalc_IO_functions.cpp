...
class UClass* UInit_DamageCalc_IO_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Init_DamageCalc_IO_C");

	return Clss;
}


// Init_DamageCalc_IO_C Init_DamageCalc_IO.Default__Init_DamageCalc_IO_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UInit_DamageCalc_IO_C* UInit_DamageCalc_IO_C::GetDefaultObj()
{
	static class UInit_DamageCalc_IO_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UInit_DamageCalc_IO_C*>(UInit_DamageCalc_IO_C::StaticClass()->DefaultObject);
...
// struct FDataTableValueHandle       IO_DamageBase                                                    (Edit, BlueprintVisible, NoDestructor)
...
float UInit_DamageCalc_IO_C::CalculateAttributeInitialValue(class UObject* Context, const struct FDataTableValueHandle& IO_DamageBase, float CallFunc_GetValueOfAttribute_ReturnValue, float CallFunc_GetDataTableValueFromHandle_ReturnValue, float CallFunc_GetDataTableValueFromHandle_ReturnValue1, float CallFunc_GetValueOfAttribute_ReturnValue1, float CallFunc_Multiply_FloatFloat_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue1, float CallFunc_GetValueOfAttribute_ReturnValue2, float CallFunc_Add_FloatFloat_ReturnValue, float CallFunc_EvaluateBalanceFormula_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue2)
{
	...
	Params::UInit_DamageCalc_IO_C_CalculateAttributeInitialValue_Params Parms{};

	Parms.Context = Context;
	Parms.IO_DamageBase = IO_DamageBase;
