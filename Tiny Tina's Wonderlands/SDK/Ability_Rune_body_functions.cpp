...
// BlueprintGeneratedClass Ability_Rune_body.Ability_Rune_Body_C
// (None)

class UClass* UAbility_Rune_Body_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Ability_Rune_Body_C");

	return Clss;
}


// Ability_Rune_Body_C Ability_Rune_body.Default__Ability_Rune_Body_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAbility_Rune_Body_C* UAbility_Rune_Body_C::GetDefaultObj()
{
	static class UAbility_Rune_Body_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAbility_Rune_Body_C*>(UAbility_Rune_Body_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Ability_Rune_body.Ability_Rune_Body_C.OnActivated
// (Event, Protected, BlueprintEvent)
// Parameters:

void UAbility_Rune_Body_C::OnActivated()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Ability_Rune_Body_C", "OnActivated");
...
void UAbility_Rune_Body_C::OnCausedDeath_Event(class UDamageComponent* Damaged, struct FCausedDeathDetails& Details)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Ability_Rune_Body_C", "OnCausedDeath_Event");

	Params::UAbility_Rune_Body_C_OnCausedDeath_Event_Params Parms{};
...
// Function Ability_Rune_body.Ability_Rune_Body_C.RemoveStatus
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAbility_Rune_Body_C::RemoveStatus()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Ability_Rune_Body_C", "RemoveStatus");
...
// Function Ability_Rune_body.Ability_Rune_Body_C.OnDeactivated
// (Event, Protected, BlueprintEvent)
// Parameters:

void UAbility_Rune_Body_C::OnDeactivated()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Ability_Rune_Body_C", "OnDeactivated");
...
// Function Ability_Rune_body.Ability_Rune_Body_C.RemoveCDM
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAbility_Rune_Body_C::RemoveCDM()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Ability_Rune_Body_C", "RemoveCDM");
...
void UAbility_Rune_Body_C::ExecuteUbergraph_Ability_Rune_Body(int32 EntryPoint, bool CallFunc_K2_EvaluateConditionType_ReturnValue, float CallFunc_GetDataTableValue_OutValue, bool CallFunc_GetDataTableValue_ReturnValue, class AActor* CallFunc_GetAbilityOwner_ReturnValue, class UDamageComponent* K2Node_CustomEvent_Damaged, const struct FCausedDeathDetails& K2Node_CustomEvent_Details, class AActor* CallFunc_GetOwner_ReturnValue, class AActor* CallFunc_GetOwner_ReturnValue1, class AOakCharacter* K2Node_DynamicCast_AsOak_Character, bool K2Node_DynamicCast_bSuccess, UDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, const struct FGbxAbilityResourceSpec_ConditionalDamageModifier& K2Node_MakeStruct_GbxAbilityResourceSpec_ConditionalDamageModifier, const struct FGbxAbilityResourceSpec_ConditionalDamageModifier& K2Node_MakeStruct_GbxAbilityResourceSpec_ConditionalDamageModifier1, class AActor* CallFunc_GetAbilityOwner_ReturnValue1, class AActor* CallFunc_GetAbilityOwner_ReturnValue2, const struct FStatusEffectSpec& K2Node_MakeStruct_StatusEffectSpec, const struct FStatusEffectRemoveSpec& K2Node_MakeStruct_StatusEffectRemoveSpec, const struct FStatusEffectInstanceReference& CallFunc_AddStatusEffect_ReturnValue, bool CallFunc_RemoveStatusEffect_ReturnValue, const struct FGbxAbilityResourceSpec_ScriptDelegate& K2Node_MakeStruct_GbxAbilityResourceSpec_ScriptDelegate)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Ability_Rune_Body_C", "ExecuteUbergraph_Ability_Rune_Body");

	Params::UAbility_Rune_Body_C_ExecuteUbergraph_Ability_Rune_Body_Params Parms{};
