...
class UClass* ULightProj_LightningBlast_Target_Mod02_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LightProj_LightningBlast_Target_Mod02_C");

	return Clss;
}


// LightProj_LightningBlast_Target_Mod02_C LightProj_LightningBlast_Target_Mod02.Default__LightProj_LightningBlast_Target_Mod02_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ULightProj_LightningBlast_Target_Mod02_C* ULightProj_LightningBlast_Target_Mod02_C::GetDefaultObj()
{
	static class ULightProj_LightningBlast_Target_Mod02_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ULightProj_LightningBlast_Target_Mod02_C*>(ULightProj_LightningBlast_Target_Mod02_C::StaticClass()->DefaultObject);
