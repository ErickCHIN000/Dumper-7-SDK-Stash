...
class UBP_CE_BAMF_Player_StandIn_CC_Details_C : public UOakAction_CoordinatedEffect
{
public:
	...
	static class UBP_CE_BAMF_Player_StandIn_CC_Details_C* GetDefaultObj();
