...
class UPassive_Barbarian_07_C : public U_Passive_Parent_C
{
public:
	uint8                                        Pad_2213[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class UPassive_Barbarian_07_C* GetDefaultObj();
	...
	void OnActivated();
	void ExecuteUbergraph_Passive_Barbarian_07(int32 EntryPoint, const struct FGameResourcePoolReference& CallFunc_GetResourcePoolByResource_ReturnValue);
};
