...
class UClass* ULightProjectile_JAK_CrossbowBolt_Base_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LightProjectile_JAK_CrossbowBolt_Base_C");

	return Clss;
}


// LightProjectile_JAK_CrossbowBolt_Base_C LightProjectile_JAK_CrossbowBolt_Base.Default__LightProjectile_JAK_CrossbowBolt_Base_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ULightProjectile_JAK_CrossbowBolt_Base_C* ULightProjectile_JAK_CrossbowBolt_Base_C::GetDefaultObj()
{
	static class ULightProjectile_JAK_CrossbowBolt_Base_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ULightProjectile_JAK_CrossbowBolt_Base_C*>(ULightProjectile_JAK_CrossbowBolt_Base_C::StaticClass()->DefaultObject);

	return Default;
}


// Function LightProjectile_JAK_CrossbowBolt_Base.LightProjectile_JAK_CrossbowBolt_Base_C.OnLifetimeExpired
...
void ULightProjectile_JAK_CrossbowBolt_Base_C::OnLifetimeExpired(class ULightProjectile* Projectile, class AActor* CallFunc_GetAttachedActor_ReturnValue, class UGameplayTagContainerComponent* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_RemoveGameplayTag_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("LightProjectile_JAK_CrossbowBolt_Base_C", "OnLifetimeExpired");

	Params::ULightProjectile_JAK_CrossbowBolt_Base_C_OnLifetimeExpired_Params Parms{};
...
// Function LightProjectile_JAK_CrossbowBolt_Base.LightProjectile_JAK_CrossbowBolt_Base_C.OnAttached
