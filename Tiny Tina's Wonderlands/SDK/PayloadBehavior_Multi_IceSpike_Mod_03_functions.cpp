...
// BlueprintGeneratedClass PayloadBehavior_Multi_IceSpike_Mod_03.PayloadBehavior_Multi_IceSpike_Mod_03_C
// (None)

class UClass* UPayloadBehavior_Multi_IceSpike_Mod_03_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PayloadBehavior_Multi_IceSpike_Mod_03_C");

	return Clss;
}


// PayloadBehavior_Multi_IceSpike_Mod_03_C PayloadBehavior_Multi_IceSpike_Mod_03.Default__PayloadBehavior_Multi_IceSpike_Mod_03_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPayloadBehavior_Multi_IceSpike_Mod_03_C* UPayloadBehavior_Multi_IceSpike_Mod_03_C::GetDefaultObj()
{
	static class UPayloadBehavior_Multi_IceSpike_Mod_03_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPayloadBehavior_Multi_IceSpike_Mod_03_C*>(UPayloadBehavior_Multi_IceSpike_Mod_03_C::StaticClass()->DefaultObject);
