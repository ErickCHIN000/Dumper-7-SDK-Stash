...
// BlueprintGeneratedClass Init_PlayerStat_CritChance_Spell_Mod1.Init_PlayerStat_CritChance_Spell_Mod1_C
// (None)

class UClass* UInit_PlayerStat_CritChance_Spell_Mod1_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Init_PlayerStat_CritChance_Spell_Mod1_C");

	return Clss;
}


// Init_PlayerStat_CritChance_Spell_Mod1_C Init_PlayerStat_CritChance_Spell_Mod1.Default__Init_PlayerStat_CritChance_Spell_Mod1_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UInit_PlayerStat_CritChance_Spell_Mod1_C* UInit_PlayerStat_CritChance_Spell_Mod1_C::GetDefaultObj()
{
	static class UInit_PlayerStat_CritChance_Spell_Mod1_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UInit_PlayerStat_CritChance_Spell_Mod1_C*>(UInit_PlayerStat_CritChance_Spell_Mod1_C::StaticClass()->DefaultObject);
