...
class UInit_Barbarian_13_MeleeSpeed_C : public UAttributeInitializer
{
public:
	struct FDataTableValueHandle                 MeleeSpeedHandle;                                  // 0x30(0x18)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)

	static class UClass* StaticClass();
	static class UInit_Barbarian_13_MeleeSpeed_C* GetDefaultObj();
