...
// BlueprintGeneratedClass Action_Spell_Channel_Inflammation_Loop.Action_Spell_Channel_Inflammation_Loop_C
// (None)

class UClass* UAction_Spell_Channel_Inflammation_Loop_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Action_Spell_Channel_Inflammation_Loop_C");

	return Clss;
}


// Action_Spell_Channel_Inflammation_Loop_C Action_Spell_Channel_Inflammation_Loop.Default__Action_Spell_Channel_Inflammation_Loop_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAction_Spell_Channel_Inflammation_Loop_C* UAction_Spell_Channel_Inflammation_Loop_C::GetDefaultObj()
{
	static class UAction_Spell_Channel_Inflammation_Loop_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAction_Spell_Channel_Inflammation_Loop_C*>(UAction_Spell_Channel_Inflammation_Loop_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Action_Spell_Channel_Inflammation_Loop.Action_Spell_Channel_Inflammation_Loop_C.OnBegin
// (Event, Public, BlueprintEvent)
// Parameters:
// class AActor*                      Actor                                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAction_Spell_Channel_Inflammation_Loop_C::OnBegin(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Channel_Inflammation_Loop_C", "OnBegin");

	Params::UAction_Spell_Channel_Inflammation_Loop_C_OnBegin_Params Parms{};
...
// Function Action_Spell_Channel_Inflammation_Loop.Action_Spell_Channel_Inflammation_Loop_C.OnEnd
// (Event, Public, BlueprintEvent)
// Parameters:
// enum class EGbxActionEndState      ActionEndState                                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AActor*                      Actor                                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAction_Spell_Channel_Inflammation_Loop_C::OnEnd(enum class EGbxActionEndState ActionEndState, class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Channel_Inflammation_Loop_C", "OnEnd");

	Params::UAction_Spell_Channel_Inflammation_Loop_C_OnEnd_Params Parms{};
...
// Function Action_Spell_Channel_Inflammation_Loop.Action_Spell_Channel_Inflammation_Loop_C.ExecuteUbergraph_Action_Spell_Channel_Inflammation_Loop
// (None)
// Parameters:
...
void UAction_Spell_Channel_Inflammation_Loop_C::ExecuteUbergraph_Action_Spell_Channel_Inflammation_Loop(int32 EntryPoint, class AActor* K2Node_Event_Actor1, enum class EGbxActionEndState K2Node_Event_ActionEndState, class AActor* K2Node_Event_Actor, class UParticleSystemComponent* CallFunc_PlayFX_1stFXComponent, class UParticleSystemComponent* CallFunc_PlayFX_3rdFXComponent, class FName CallFunc_PlayFX_Socket, enum class EOakElementalType CallFunc_GetSpellElement_ReturnedElement, enum class EOakElementalType CallFunc_GetSpellElement_ReturnedElement1, class UWwiseEvent* CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, class UWwiseEvent* CallFunc_Map_Find_Value1, bool CallFunc_Map_Find_ReturnValue1)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Channel_Inflammation_Loop_C", "ExecuteUbergraph_Action_Spell_Channel_Inflammation_Loop");

	Params::UAction_Spell_Channel_Inflammation_Loop_C_ExecuteUbergraph_Action_Spell_Channel_Inflammation_Loop_Params Parms{};
