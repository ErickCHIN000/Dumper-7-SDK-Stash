...
// BlueprintGeneratedClass PayloadBehavior_Multi_SWicked.PayloadBehavior_Multi_SWicked_C
// (None)

class UClass* UPayloadBehavior_Multi_SWicked_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PayloadBehavior_Multi_SWicked_C");

	return Clss;
}


// PayloadBehavior_Multi_SWicked_C PayloadBehavior_Multi_SWicked.Default__PayloadBehavior_Multi_SWicked_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPayloadBehavior_Multi_SWicked_C* UPayloadBehavior_Multi_SWicked_C::GetDefaultObj()
{
	static class UPayloadBehavior_Multi_SWicked_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPayloadBehavior_Multi_SWicked_C*>(UPayloadBehavior_Multi_SWicked_C::StaticClass()->DefaultObject);

	return Default;
}


// Function PayloadBehavior_Multi_SWicked.PayloadBehavior_Multi_SWicked_C.GetCustomSpellSpawnInfo
