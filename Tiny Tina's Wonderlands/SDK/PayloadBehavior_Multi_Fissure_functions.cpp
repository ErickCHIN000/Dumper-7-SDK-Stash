...
class UClass* UPayloadBehavior_Multi_Fissure_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PayloadBehavior_Multi_Fissure_C");

	return Clss;
}


// PayloadBehavior_Multi_Fissure_C PayloadBehavior_Multi_Fissure.Default__PayloadBehavior_Multi_Fissure_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPayloadBehavior_Multi_Fissure_C* UPayloadBehavior_Multi_Fissure_C::GetDefaultObj()
{
	static class UPayloadBehavior_Multi_Fissure_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPayloadBehavior_Multi_Fissure_C*>(UPayloadBehavior_Multi_Fissure_C::StaticClass()->DefaultObject);
