...
// Function AIModule.EnvQueryInstanceBlueprintWrapper.GuaranteeQueryCompletion
// (Final, Native, Public, BlueprintCallable)
// Parameters:

void UEnvQueryInstanceBlueprintWrapper::GuaranteeQueryCompletion()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("EnvQueryInstanceBlueprintWrapper", "GuaranteeQueryCompletion");
...
bool UBlackboardComponent::HasValue(class FName& KeyName)
{
	static class UFunction* Func = nullptr;
	...
	Params::UBlackboardComponent_HasValue_Params Parms{};
...
uint8 UBlackboardComponent::AddRuntimeKey(class FName KeyName, class UBlackboardKeyType* KeyType)
{
	...
	Params::UBlackboardComponent_AddRuntimeKey_Params Parms{};
...
class UClass* UEnvQueryItemType_Component::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("EnvQueryItemType_Component");

	return Clss;
}


// EnvQueryItemType_Component AIModule.Default__EnvQueryItemType_Component
// (Public, ClassDefaultObject, ArchetypeObject)

class UEnvQueryItemType_Component* UEnvQueryItemType_Component::GetDefaultObj()
{
	static class UEnvQueryItemType_Component* Default = nullptr;

	if (!Default)
		Default = static_cast<UEnvQueryItemType_Component*>(UEnvQueryItemType_Component::StaticClass()->DefaultObject);
