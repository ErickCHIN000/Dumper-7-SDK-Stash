...
struct UAction_Spell_Repeat_Loop_MagicMissile_C_OnBegin_Params
{
public:
...
struct UAction_Spell_Repeat_Loop_MagicMissile_C_ExecuteUbergraph_Action_Spell_Repeat_Loop_MagicMissile_Params
{
public:
	...
	enum class EOakElementalType                 CallFunc_GetSpellElement_ReturnedElement;          // 0x268(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1822[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UWwiseEvent*                           CallFunc_Map_Find_Value;                           // 0x270(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FDialogContext                        CallFunc_NewDialogContext_ReturnValue1;            // 0x280(0x218)(None)
	struct FDialogConversation                   CallFunc_FinishTriggerDialog_Conversation1;        // 0x498(0xC)(NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_FinishTriggerDialog_SequenceID1;          // 0x4A4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_FinishTriggerDialog_ReturnValue1;         // 0x4A8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
