...
// BlueprintGeneratedClass Action_Spell_Fire_LightningBlast.Action_Spell_Fire_LightningBlast_C
// (None)

class UClass* UAction_Spell_Fire_LightningBlast_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Action_Spell_Fire_LightningBlast_C");

	return Clss;
}


// Action_Spell_Fire_LightningBlast_C Action_Spell_Fire_LightningBlast.Default__Action_Spell_Fire_LightningBlast_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAction_Spell_Fire_LightningBlast_C* UAction_Spell_Fire_LightningBlast_C::GetDefaultObj()
{
	static class UAction_Spell_Fire_LightningBlast_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAction_Spell_Fire_LightningBlast_C*>(UAction_Spell_Fire_LightningBlast_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Action_Spell_Fire_LightningBlast.Action_Spell_Fire_LightningBlast_C.OnDialogSequenceFinished_2
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAction_Spell_Fire_LightningBlast_C::OnDialogSequenceFinished_2()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Fire_LightningBlast_C", "OnDialogSequenceFinished_2");
...
void UAction_Spell_Fire_LightningBlast_C::OnBegin(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Fire_LightningBlast_C", "OnBegin");

	Params::UAction_Spell_Fire_LightningBlast_C_OnBegin_Params Parms{};
...
// Function Action_Spell_Fire_LightningBlast.Action_Spell_Fire_LightningBlast_C.Notify_SpellWarmup
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAction_Spell_Fire_LightningBlast_C::Notify_SpellWarmup()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Fire_LightningBlast_C", "Notify_SpellWarmup");
...
// Function Action_Spell_Fire_LightningBlast.Action_Spell_Fire_LightningBlast_C.Notify_SpellCast
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAction_Spell_Fire_LightningBlast_C::Notify_SpellCast()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Fire_LightningBlast_C", "Notify_SpellCast");
...
// Function Action_Spell_Fire_LightningBlast.Action_Spell_Fire_LightningBlast_C.Notify_SpellWarmup3rd
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAction_Spell_Fire_LightningBlast_C::Notify_SpellWarmup3rd()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Fire_LightningBlast_C", "Notify_SpellWarmup3rd");
...
// Function Action_Spell_Fire_LightningBlast.Action_Spell_Fire_LightningBlast_C.Notify_SpellCast3rd
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAction_Spell_Fire_LightningBlast_C::Notify_SpellCast3rd()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Fire_LightningBlast_C", "Notify_SpellCast3rd");
...
void UAction_Spell_Fire_LightningBlast_C::ExecuteUbergraph_Action_Spell_Fire_LightningBlast(int32 EntryPoint, class AActor* CallFunc_K2_GetActor_ReturnValue, const struct FDialogContext& CallFunc_NewDialogContext_ReturnValue, const struct FDialogConversation& CallFunc_FinishTriggerDialog_Conversation, int32 CallFunc_FinishTriggerDialog_SequenceID, bool CallFunc_FinishTriggerDialog_ReturnValue, class AActor* K2Node_Event_Actor, class AActor* CallFunc_K2_GetActor_ReturnValue1, class AActor* CallFunc_K2_GetActor_ReturnValue2, class UParticleSystem* CallFunc_GetCollectionFX_ReturnValue, class AActor* CallFunc_K2_GetActor_ReturnValue3, class UParticleSystemComponent* CallFunc_PlayFX_1stFXComponent, class UParticleSystemComponent* CallFunc_PlayFX_3rdFXComponent, class FName CallFunc_PlayFX_Socket, class UParticleSystem* CallFunc_GetCollectionFX_ReturnValue1, class AActor* CallFunc_K2_GetActor_ReturnValue4, class AActor* CallFunc_K2_GetActor_ReturnValue5, class UParticleSystemComponent* CallFunc_PlayFX_1stFXComponent1, class UParticleSystemComponent* CallFunc_PlayFX_3rdFXComponent1, class FName CallFunc_PlayFX_Socket1, class UParticleSystem* CallFunc_GetCollectionFX_ReturnValue2, class AActor* CallFunc_K2_GetActor_ReturnValue6, class AActor* CallFunc_K2_GetActor_ReturnValue7, class UParticleSystemComponent* CallFunc_PlayFX_1stFXComponent2, class UParticleSystemComponent* CallFunc_PlayFX_3rdFXComponent2, class FName CallFunc_PlayFX_Socket2, class UParticleSystem* CallFunc_GetCollectionFX_ReturnValue3, class AActor* CallFunc_K2_GetActor_ReturnValue8, class UParticleSystemComponent* CallFunc_PlayFX_1stFXComponent3, class UParticleSystemComponent* CallFunc_PlayFX_3rdFXComponent3, class FName CallFunc_PlayFX_Socket3, class AActor* CallFunc_K2_GetActor_ReturnValue9, enum class EOakElementalType CallFunc_GetSpellElement_ReturnedElement, class UWwiseEvent* CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, class AActor* CallFunc_K2_GetActor_ReturnValue10, enum class EOakElementalType CallFunc_GetSpellElement_ReturnedElement1, const struct FDialogContext& CallFunc_NewDialogContext_ReturnValue1, class UWwiseEvent* CallFunc_Map_Find_Value1, bool CallFunc_Map_Find_ReturnValue1, const struct FDialogConversation& CallFunc_FinishTriggerDialog_Conversation1, int32 CallFunc_FinishTriggerDialog_SequenceID1, bool CallFunc_FinishTriggerDialog_ReturnValue1, class AActor* CallFunc_K2_GetActor_ReturnValue11)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Fire_LightningBlast_C", "ExecuteUbergraph_Action_Spell_Fire_LightningBlast");

	Params::UAction_Spell_Fire_LightningBlast_C_ExecuteUbergraph_Action_Spell_Fire_LightningBlast_Params Parms{};
