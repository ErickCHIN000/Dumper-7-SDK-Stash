...
class UClass* ULightProj_Hydra_Targeting_Base_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LightProj_Hydra_Targeting_Base_C");

	return Clss;
}


// LightProj_Hydra_Targeting_Base_C LightProj_Hydra_Targeting_Base.Default__LightProj_Hydra_Targeting_Base_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ULightProj_Hydra_Targeting_Base_C* ULightProj_Hydra_Targeting_Base_C::GetDefaultObj()
{
	static class ULightProj_Hydra_Targeting_Base_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ULightProj_Hydra_Targeting_Base_C*>(ULightProj_Hydra_Targeting_Base_C::StaticClass()->DefaultObject);
...
void ULightProj_Hydra_Targeting_Base_C::MakeHydraSpawnTransform(class ULightProjectile* Projectile, const struct FHitResult& HitInfo, struct FTransform* Transform, class APawn* CallFunc_GetInstigator_ReturnValue, bool CallFunc_BreakHitResult_bBlockingHit, bool CallFunc_BreakHitResult_bInitialOverlap, float CallFunc_BreakHitResult_Time, float CallFunc_BreakHitResult_Distance, const struct FVector& CallFunc_BreakHitResult_Location, const struct FVector& CallFunc_BreakHitResult_ImpactPoint, const struct FVector& CallFunc_BreakHitResult_Normal, const struct FVector& CallFunc_BreakHitResult_ImpactNormal, class UPhysicalMaterial* CallFunc_BreakHitResult_PhysMat, class AActor* CallFunc_BreakHitResult_HitActor, class UPrimitiveComponent* CallFunc_BreakHitResult_HitComponent, class FName CallFunc_BreakHitResult_HitBoneName, int32 CallFunc_BreakHitResult_HitItem, int32 CallFunc_BreakHitResult_FaceIndex, const struct FVector& CallFunc_BreakHitResult_TraceStart, const struct FVector& CallFunc_BreakHitResult_TraceEnd, const struct FVector& CallFunc_GetActorRightVector_ReturnValue, const struct FVector& CallFunc_Add_VectorVector_ReturnValue, const struct FVector& CallFunc_GetActorForwardVector_ReturnValue, const struct FRotator& CallFunc_MakeRotationFromAxes_ReturnValue, const struct FTransform& CallFunc_MakeTransform_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("LightProj_Hydra_Targeting_Base_C", "MakeHydraSpawnTransform");

	Params::ULightProj_Hydra_Targeting_Base_C_MakeHydraSpawnTransform_Params Parms{};
