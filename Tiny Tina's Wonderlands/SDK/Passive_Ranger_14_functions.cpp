...
class UClass* UPassive_Ranger_14_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Passive_Ranger_14_C");

	return Clss;
}


// Passive_Ranger_14_C Passive_Ranger_14.Default__Passive_Ranger_14_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPassive_Ranger_14_C* UPassive_Ranger_14_C::GetDefaultObj()
{
	static class UPassive_Ranger_14_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPassive_Ranger_14_C*>(UPassive_Ranger_14_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Passive_Ranger_14.Passive_Ranger_14_C.OnActivated
// (Event, Protected, BlueprintEvent)
// Parameters:

void UPassive_Ranger_14_C::OnActivated()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Passive_Ranger_14_C", "OnActivated");
...
void UPassive_Ranger_14_C::OakPassiveOnCausedAnyDamage(class AActor* DamageInstigator, float Damage, class UGbxDamageType* DamageType, class UDamageSource* DamageSource, class AActor* DamagedActor, const struct FCausedDamageDetails& Details)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Passive_Ranger_14_C", "OakPassiveOnCausedAnyDamage");

	Params::UPassive_Ranger_14_C_OakPassiveOnCausedAnyDamage_Params Parms{};
...
void UPassive_Ranger_14_C::ExecuteUbergraph_Passive_Ranger_14(int32 EntryPoint, class AActor* CallFunc_GetAbilityOwner_ReturnValue, TScriptInterface<class IIBPChar_Player_C> K2Node_DynamicCast_AsIBPChar_Player, bool K2Node_DynamicCast_bSuccess, class AActor* K2Node_Event_DamageInstigator, float K2Node_Event_Damage, class UGbxDamageType* K2Node_Event_DamageType, class UDamageSource* K2Node_Event_DamageSource, class AActor* K2Node_Event_DamagedActor, const struct FCausedDamageDetails& K2Node_Event_Details, class UGbxAbility* CallFunc_GetClassFeat_Res, bool CallFunc_Compare_Damage_Source_Equal, bool CallFunc_Compare_Damage_Source_Not_Equal, class AActor* CallFunc_GetAbilityOwner_ReturnValue1, const struct FStatusEffectSpec& K2Node_MakeStruct_StatusEffectSpec, float CallFunc_GetDataTableValueFromHandle_ReturnValue, const struct FStatusEffectInstanceReference& CallFunc_AddStatusEffect_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Passive_Ranger_14_C", "ExecuteUbergraph_Passive_Ranger_14");

	Params::UPassive_Ranger_14_C_ExecuteUbergraph_Passive_Ranger_14_Params Parms{};
