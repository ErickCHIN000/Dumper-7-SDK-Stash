...
class UClass* UPayloadBehavior_Multi_ElementalHawk_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PayloadBehavior_Multi_ElementalHawk_C");

	return Clss;
}


// PayloadBehavior_Multi_ElementalHawk_C PayloadBehavior_Multi_ElementalHawk.Default__PayloadBehavior_Multi_ElementalHawk_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPayloadBehavior_Multi_ElementalHawk_C* UPayloadBehavior_Multi_ElementalHawk_C::GetDefaultObj()
{
	static class UPayloadBehavior_Multi_ElementalHawk_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPayloadBehavior_Multi_ElementalHawk_C*>(UPayloadBehavior_Multi_ElementalHawk_C::StaticClass()->DefaultObject);
