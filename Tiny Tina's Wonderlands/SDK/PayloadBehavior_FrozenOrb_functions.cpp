...
// BlueprintGeneratedClass PayloadBehavior_FrozenOrb.PayloadBehavior_FrozenOrb_C
// (None)

class UClass* UPayloadBehavior_FrozenOrb_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PayloadBehavior_FrozenOrb_C");

	return Clss;
}


// PayloadBehavior_FrozenOrb_C PayloadBehavior_FrozenOrb.Default__PayloadBehavior_FrozenOrb_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPayloadBehavior_FrozenOrb_C* UPayloadBehavior_FrozenOrb_C::GetDefaultObj()
{
	static class UPayloadBehavior_FrozenOrb_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPayloadBehavior_FrozenOrb_C*>(UPayloadBehavior_FrozenOrb_C::StaticClass()->DefaultObject);
