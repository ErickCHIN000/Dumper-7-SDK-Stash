...
// BlueprintGeneratedClass Init_SE_Barbarian_03.Init_SE_Barbarian_03_C
// (None)

class UClass* UInit_SE_Barbarian_03_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Init_SE_Barbarian_03_C");

	return Clss;
}


// Init_SE_Barbarian_03_C Init_SE_Barbarian_03.Default__Init_SE_Barbarian_03_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UInit_SE_Barbarian_03_C* UInit_SE_Barbarian_03_C::GetDefaultObj()
{
	static class UInit_SE_Barbarian_03_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UInit_SE_Barbarian_03_C*>(UInit_SE_Barbarian_03_C::StaticClass()->DefaultObject);
