...
struct UBP_ZoneMap_LegendaryPOI_C_ExecuteUbergraph_BP_ZoneMap_LegendaryPOI_Params
{
public:
	...
	class AZoneMapViewer*                        K2Node_DynamicCast_AsZone_Map_Viewer;              // 0x18(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
