...
class UClass* ULightProjectile_HW_COV_SawBlade_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LightProjectile_HW_COV_SawBlade_C");

	return Clss;
}


// LightProjectile_HW_COV_SawBlade_C LightProjectile_HW_COV_SawBlade.Default__LightProjectile_HW_COV_SawBlade_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ULightProjectile_HW_COV_SawBlade_C* ULightProjectile_HW_COV_SawBlade_C::GetDefaultObj()
{
	static class ULightProjectile_HW_COV_SawBlade_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ULightProjectile_HW_COV_SawBlade_C*>(ULightProjectile_HW_COV_SawBlade_C::StaticClass()->DefaultObject);
...
void ULightProjectile_HW_COV_SawBlade_C::OnRicochet(class ULightProjectile* Projectile, struct FHitResult& Hit, const struct FVector& ImpactVelocity, bool CallFunc_BreakHitResult_bBlockingHit, bool CallFunc_BreakHitResult_bInitialOverlap, float CallFunc_BreakHitResult_Time, float CallFunc_BreakHitResult_Distance, const struct FVector& CallFunc_BreakHitResult_Location, const struct FVector& CallFunc_BreakHitResult_ImpactPoint, const struct FVector& CallFunc_BreakHitResult_Normal, const struct FVector& CallFunc_BreakHitResult_ImpactNormal, class UPhysicalMaterial* CallFunc_BreakHitResult_PhysMat, class AActor* CallFunc_BreakHitResult_HitActor, class UPrimitiveComponent* CallFunc_BreakHitResult_HitComponent, class FName CallFunc_BreakHitResult_HitBoneName, int32 CallFunc_BreakHitResult_HitItem, int32 CallFunc_BreakHitResult_FaceIndex, const struct FVector& CallFunc_BreakHitResult_TraceStart, const struct FVector& CallFunc_BreakHitResult_TraceEnd, const struct FWwisePlaybackInstance& CallFunc_PostEventAtLocation_ReturnValue, class UParticleSystemComponent* CallFunc_SpawnEmitterAtLocation_ReturnValue)
{
	...
	Params::ULightProjectile_HW_COV_SawBlade_C_OnRicochet_Params Parms{};
...
void ULightProjectile_HW_COV_SawBlade_C::OnImpact(class ULightProjectile* Projectile, struct FHitResult& Hit)
{
	...
	Params::ULightProjectile_HW_COV_SawBlade_C_OnImpact_Params Parms{};
...
void ULightProjectile_HW_COV_SawBlade_C::OnLifetimeExpired(class ULightProjectile* Projectile)
{
	...
	Params::ULightProjectile_HW_COV_SawBlade_C_OnLifetimeExpired_Params Parms{};
