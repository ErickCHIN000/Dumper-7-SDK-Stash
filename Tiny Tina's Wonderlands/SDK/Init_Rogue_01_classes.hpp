...
class UInit_Rogue_01_C : public UAttributeInitializer
{
public:
	struct FDataTableValueHandle                 MeleeAttackDamageHandle;                           // 0x30(0x18)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)

	static class UClass* StaticClass();
	static class UInit_Rogue_01_C* GetDefaultObj();
