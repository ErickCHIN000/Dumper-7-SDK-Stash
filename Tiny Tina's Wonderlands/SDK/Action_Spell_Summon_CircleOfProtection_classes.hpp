...
class UAction_Spell_Summon_CircleOfProtection_C : public UAction_SpellThrow_Base_C
{
public:
	...
	static class UAction_Spell_Summon_CircleOfProtection_C* GetDefaultObj();
