...
// BlueprintGeneratedClass Init_Passive_Barbarian_06_WS_Bonus.Init_Passive_Barbarian_06_WS_Bonus_C
// (None)

class UClass* UInit_Passive_Barbarian_06_WS_Bonus_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Init_Passive_Barbarian_06_WS_Bonus_C");

	return Clss;
}


// Init_Passive_Barbarian_06_WS_Bonus_C Init_Passive_Barbarian_06_WS_Bonus.Default__Init_Passive_Barbarian_06_WS_Bonus_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UInit_Passive_Barbarian_06_WS_Bonus_C* UInit_Passive_Barbarian_06_WS_Bonus_C::GetDefaultObj()
{
	static class UInit_Passive_Barbarian_06_WS_Bonus_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UInit_Passive_Barbarian_06_WS_Bonus_C*>(UInit_Passive_Barbarian_06_WS_Bonus_C::StaticClass()->DefaultObject);
