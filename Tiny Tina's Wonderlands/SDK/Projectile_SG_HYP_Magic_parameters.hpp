...
struct AProjectile_SG_HYP_Magic_C_ScaleByShotsFired_Params
{
public:
	float                                        ScaleToIncrease;                                   // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        FinalScale;                                        // 0x4(0x4)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FString                                CallFunc_Concat_StrStr_ReturnValue3;               // 0x68(0x10)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                CallFunc_Concat_StrStr_ReturnValue4;               // 0x78(0x10)(ZeroConstructor, HasGetValueTypeHash)
};

// 0x3C (0x3C - 0x0)
// Function Projectile_SG_HYP_Magic.Projectile_SG_HYP_Magic_C.UserConstructionScript
struct AProjectile_SG_HYP_Magic_C_UserConstructionScript_Params
{
public:
	...
	class UBPWeaponFireProjectile_Magic_HYP_C*   CallFunc_GetComponentByClass_ReturnValue;          // 0x18(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_ScaleByShotsFired_FinalScale;             // 0x2C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
