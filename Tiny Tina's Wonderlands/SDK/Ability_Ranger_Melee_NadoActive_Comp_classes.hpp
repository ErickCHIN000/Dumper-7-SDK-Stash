...
class UAbility_Ranger_Melee_NadoActive_Comp_C : public UAbility_All_Enchantment_Base_C
{
public:
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0x198(0x8)(Transient, DuplicateTransient)

	static class UClass* StaticClass();
	static class UAbility_Ranger_Melee_NadoActive_Comp_C* GetDefaultObj();
