...
// BlueprintGeneratedClass LightProj_Spell_Eruption_Mod_03.LightProj_Spell_Eruption_Mod_03_C
// (None)

class UClass* ULightProj_Spell_Eruption_Mod_03_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LightProj_Spell_Eruption_Mod_03_C");

	return Clss;
}


// LightProj_Spell_Eruption_Mod_03_C LightProj_Spell_Eruption_Mod_03.Default__LightProj_Spell_Eruption_Mod_03_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ULightProj_Spell_Eruption_Mod_03_C* ULightProj_Spell_Eruption_Mod_03_C::GetDefaultObj()
{
	static class ULightProj_Spell_Eruption_Mod_03_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ULightProj_Spell_Eruption_Mod_03_C*>(ULightProj_Spell_Eruption_Mod_03_C::StaticClass()->DefaultObject);

	return Default;
}


// Function LightProj_Spell_Eruption_Mod_03.LightProj_Spell_Eruption_Mod_03_C.OnImpact
