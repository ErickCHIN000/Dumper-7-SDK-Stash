...
struct ULightProj_Host_ShieldHeal_C_OnBegin_Params
{
public:
...
struct ULightProj_Host_ShieldHeal_C_OnImpact_Params
{
public:
	class ULightProjectile*                      Projectile;                                        // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AActor*                                CallFunc_GetTarget_ReturnValue;                    // 0x118(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
