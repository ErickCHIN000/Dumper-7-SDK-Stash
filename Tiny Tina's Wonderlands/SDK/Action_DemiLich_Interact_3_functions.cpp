...
// BlueprintGeneratedClass Action_DemiLich_Interact_3.Action_DemiLich_Interact_3_C
// (None)

class UClass* UAction_DemiLich_Interact_3_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Action_DemiLich_Interact_3_C");

	return Clss;
}


// Action_DemiLich_Interact_3_C Action_DemiLich_Interact_3.Default__Action_DemiLich_Interact_3_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAction_DemiLich_Interact_3_C* UAction_DemiLich_Interact_3_C::GetDefaultObj()
{
	static class UAction_DemiLich_Interact_3_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAction_DemiLich_Interact_3_C*>(UAction_DemiLich_Interact_3_C::StaticClass()->DefaultObject);
...
void UAction_DemiLich_Interact_3_C::OnBegin(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_DemiLich_Interact_3_C", "OnBegin");

	Params::UAction_DemiLich_Interact_3_C_OnBegin_Params Parms{};
