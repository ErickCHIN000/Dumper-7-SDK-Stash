...
// BlueprintGeneratedClass Init_Necromancer_10_DamageTaken.Init_Necromancer_10_DamageTaken_C
// (None)

class UClass* UInit_Necromancer_10_DamageTaken_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Init_Necromancer_10_DamageTaken_C");

	return Clss;
}


// Init_Necromancer_10_DamageTaken_C Init_Necromancer_10_DamageTaken.Default__Init_Necromancer_10_DamageTaken_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UInit_Necromancer_10_DamageTaken_C* UInit_Necromancer_10_DamageTaken_C::GetDefaultObj()
{
	static class UInit_Necromancer_10_DamageTaken_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UInit_Necromancer_10_DamageTaken_C*>(UInit_Necromancer_10_DamageTaken_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Init_Necromancer_10_DamageTaken.Init_Necromancer_10_DamageTaken_C.CalculateAttributeInitialValue
