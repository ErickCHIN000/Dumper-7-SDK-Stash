...
class AAuxActor_IceAxe_Whirlwind_C : public AStandInAuxiliaryActor
{
public:
	...
	static class AAuxActor_IceAxe_Whirlwind_C* GetDefaultObj();
	...
	void DigiOut();
	void InterruptDigi();
	void ExecuteUbergraph_AuxActor_IceAxe_Whirlwind(int32 EntryPoint, TArray<struct FGbxActionRegister>& Temp_struct_Variable, enum class EEndPlayReason K2Node_Event_EndPlayReason, class UGbxAction* CallFunc_K2Play_ReturnValue);
};
