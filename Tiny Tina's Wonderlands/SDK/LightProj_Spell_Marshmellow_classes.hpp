...
class ULightProj_Spell_Marshmellow_C : public UOakLightProjectileData
{
public:
	uint8                                        Pad_4534[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]

	static class UClass* StaticClass();
	static class ULightProj_Spell_Marshmellow_C* GetDefaultObj();

	void OnExplode(class ULightProjectile* Projectile, const struct FHitResult& Temp_struct_Variable, class AActor* CallFunc_GetSource_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue);
