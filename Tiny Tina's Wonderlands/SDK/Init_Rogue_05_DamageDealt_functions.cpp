...
// BlueprintGeneratedClass Init_Rogue_05_DamageDealt.Init_Rogue_05_DamageDealt_C
// (None)

class UClass* UInit_Rogue_05_DamageDealt_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Init_Rogue_05_DamageDealt_C");

	return Clss;
}


// Init_Rogue_05_DamageDealt_C Init_Rogue_05_DamageDealt.Default__Init_Rogue_05_DamageDealt_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UInit_Rogue_05_DamageDealt_C* UInit_Rogue_05_DamageDealt_C::GetDefaultObj()
{
	static class UInit_Rogue_05_DamageDealt_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UInit_Rogue_05_DamageDealt_C*>(UInit_Rogue_05_DamageDealt_C::StaticClass()->DefaultObject);
