...
// BlueprintGeneratedClass LightProj_HawkinsWrath_StickyChild.LightProj_HawkinsWrath_StickyChild_C
// (None)

class UClass* ULightProj_HawkinsWrath_StickyChild_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LightProj_HawkinsWrath_StickyChild_C");

	return Clss;
}


// LightProj_HawkinsWrath_StickyChild_C LightProj_HawkinsWrath_StickyChild.Default__LightProj_HawkinsWrath_StickyChild_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ULightProj_HawkinsWrath_StickyChild_C* ULightProj_HawkinsWrath_StickyChild_C::GetDefaultObj()
{
	static class ULightProj_HawkinsWrath_StickyChild_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ULightProj_HawkinsWrath_StickyChild_C*>(ULightProj_HawkinsWrath_StickyChild_C::StaticClass()->DefaultObject);

	return Default;
}


// Function LightProj_HawkinsWrath_StickyChild.LightProj_HawkinsWrath_StickyChild_C.OnLifetimeExpired
// (Event, Public, BlueprintCallable, BlueprintEvent, Const)
// Parameters:
// class ULightProjectile*            Projectile                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ULightProj_HawkinsWrath_StickyChild_C::OnLifetimeExpired(class ULightProjectile* Projectile)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("LightProj_HawkinsWrath_StickyChild_C", "OnLifetimeExpired");

	Params::ULightProj_HawkinsWrath_StickyChild_C_OnLifetimeExpired_Params Parms{};
...
// Function LightProj_HawkinsWrath_StickyChild.LightProj_HawkinsWrath_StickyChild_C.HomeTo
...
void ULightProj_HawkinsWrath_StickyChild_C::HomeTo(class UOakLightProjectile* Projectile)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("LightProj_HawkinsWrath_StickyChild_C", "HomeTo");

	Params::ULightProj_HawkinsWrath_StickyChild_C_HomeTo_Params Parms{};
...
// Function LightProj_HawkinsWrath_StickyChild.LightProj_HawkinsWrath_StickyChild_C.OnDamage
...
void ULightProj_HawkinsWrath_StickyChild_C::OnDamage(class ULightProjectile* Projectile, struct FHitResult& Hit, bool bCritical, class AActor* Target, const struct FVector& EndLocation, const struct FVector& StartLocation, class ULightProjectile* MyProjectile, bool CallFunc_BreakHitResult_bBlockingHit, bool CallFunc_BreakHitResult_bInitialOverlap, float CallFunc_BreakHitResult_Time, float CallFunc_BreakHitResult_Distance, const struct FVector& CallFunc_BreakHitResult_Location, const struct FVector& CallFunc_BreakHitResult_ImpactPoint, const struct FVector& CallFunc_BreakHitResult_Normal, const struct FVector& CallFunc_BreakHitResult_ImpactNormal, class UPhysicalMaterial* CallFunc_BreakHitResult_PhysMat, class AActor* CallFunc_BreakHitResult_HitActor, class UPrimitiveComponent* CallFunc_BreakHitResult_HitComponent, class FName CallFunc_BreakHitResult_HitBoneName, int32 CallFunc_BreakHitResult_HitItem, int32 CallFunc_BreakHitResult_FaceIndex, const struct FVector& CallFunc_BreakHitResult_TraceStart, const struct FVector& CallFunc_BreakHitResult_TraceEnd, uint8 CallFunc_GetFiringPatternID_ReturnValue, bool CallFunc_Less_ByteByte_ReturnValue, TArray<struct FTransform>& CallFunc_GeneratePointsOnCone_ReturnValue, uint8 CallFunc_GetFiringPatternID_ReturnValue1, enum class EWeaponShotModifierType CallFunc_GetModifierType_ReturnValue, uint8 CallFunc_Add_ByteByte_ReturnValue, class APawn* CallFunc_GetInstigator_ReturnValue, class AActor* CallFunc_GetSource_ReturnValue, class AActor* CallFunc_RunEnvQueryForBestActor_ResultActor, bool CallFunc_RunEnvQueryForBestActor_ReturnValue, const struct FLightProjectileInitializationData& K2Node_MakeStruct_LightProjectileInitializationData, int32 CallFunc_RandomIntegerInRange_ReturnValue, const struct FVector& CallFunc_BreakTransform_Location, const struct FRotator& CallFunc_BreakTransform_Rotation, const struct FVector& CallFunc_BreakTransform_Scale, const struct FVector& CallFunc_GetForwardVector_ReturnValue, const struct FVector& CallFunc_Multiply_VectorFloat_ReturnValue, const struct FVector& CallFunc_Add_VectorVector_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("LightProj_HawkinsWrath_StickyChild_C", "OnDamage");

	Params::ULightProj_HawkinsWrath_StickyChild_C_OnDamage_Params Parms{};
