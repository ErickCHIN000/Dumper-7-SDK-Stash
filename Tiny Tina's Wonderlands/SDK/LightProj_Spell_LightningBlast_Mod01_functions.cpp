...
class UClass* ULightProj_Spell_LightningBlast_Mod01_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LightProj_Spell_LightningBlast_Mod01_C");

	return Clss;
}


// LightProj_Spell_LightningBlast_Mod01_C LightProj_Spell_LightningBlast_Mod01.Default__LightProj_Spell_LightningBlast_Mod01_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ULightProj_Spell_LightningBlast_Mod01_C* ULightProj_Spell_LightningBlast_Mod01_C::GetDefaultObj()
{
	static class ULightProj_Spell_LightningBlast_Mod01_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ULightProj_Spell_LightningBlast_Mod01_C*>(ULightProj_Spell_LightningBlast_Mod01_C::StaticClass()->DefaultObject);
...
// struct FRandomStream               RandStream                                                       (Edit, BlueprintVisible, NoDestructor)
// int32                              CallFunc_Array_Length_ReturnValue                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// int32                              CallFunc_Subtract_IntInt_ReturnValue                             (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void ULightProj_Spell_LightningBlast_Mod01_C::GetRandomNearbyEnemy(TArray<class AActor*>& TargetArray, class AActor** Output, const struct FRandomStream& RandStream, int32 CallFunc_Array_Length_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, int32 CallFunc_Clamp_ReturnValue, int32 CallFunc_RandomIntegerInRangeFromStream_ReturnValue, class AActor* CallFunc_Array_Get_Item)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("LightProj_Spell_LightningBlast_Mod01_C", "GetRandomNearbyEnemy");

	Params::ULightProj_Spell_LightningBlast_Mod01_C_GetRandomNearbyEnemy_Params Parms{};
...
// bool                               HitEnemy_                                                        (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
