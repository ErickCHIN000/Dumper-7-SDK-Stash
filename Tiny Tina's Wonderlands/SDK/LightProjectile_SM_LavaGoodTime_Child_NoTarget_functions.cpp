...
class UClass* ULightProjectile_SM_LavaGoodTime_Child_NoTarget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LightProjectile_SM_LavaGoodTime_Child_NoTarget_C");

	return Clss;
}


// LightProjectile_SM_LavaGoodTime_Child_NoTarget_C LightProjectile_SM_LavaGoodTime_Child_NoTarget.Default__LightProjectile_SM_LavaGoodTime_Child_NoTarget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ULightProjectile_SM_LavaGoodTime_Child_NoTarget_C* ULightProjectile_SM_LavaGoodTime_Child_NoTarget_C::GetDefaultObj()
{
	static class ULightProjectile_SM_LavaGoodTime_Child_NoTarget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ULightProjectile_SM_LavaGoodTime_Child_NoTarget_C*>(ULightProjectile_SM_LavaGoodTime_Child_NoTarget_C::StaticClass()->DefaultObject);
...
void ULightProjectile_SM_LavaGoodTime_Child_NoTarget_C::OnAttached(class ULightProjectile* Projectile, class AActor* AttachedActor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("LightProjectile_SM_LavaGoodTime_Child_NoTarget_C", "OnAttached");

	Params::ULightProjectile_SM_LavaGoodTime_Child_NoTarget_C_OnAttached_Params Parms{};
...
void ULightProjectile_SM_LavaGoodTime_Child_NoTarget_C::OnLifetimeExpired(class ULightProjectile* Projectile)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("LightProjectile_SM_LavaGoodTime_Child_NoTarget_C", "OnLifetimeExpired");

	Params::ULightProjectile_SM_LavaGoodTime_Child_NoTarget_C_OnLifetimeExpired_Params Parms{};
