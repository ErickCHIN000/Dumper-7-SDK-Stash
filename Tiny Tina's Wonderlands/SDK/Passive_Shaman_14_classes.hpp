...
class UPassive_Shaman_14_C : public U_Passive_Parent_C
{
public:
	...
	uint8                                        Pad_2EA1[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	static class UPassive_Shaman_14_C* GetDefaultObj();

	void OakPassiveOnCausedElementalEffect(class AActor* Target, const struct FStatusEffectSpec& Spec);
	void ExecuteUbergraph_Passive_Shaman_14(int32 EntryPoint, class AActor* CallFunc_GetAbilityOwner_ReturnValue, class AActor* K2Node_Event_Target, const struct FStatusEffectSpec& K2Node_Event_Spec, const struct FStatusEffectSpec& K2Node_MakeStruct_StatusEffectSpec, bool CallFunc_EqualEqual_ObjectObject_ReturnValue, const struct FStatusEffectInstanceReference& CallFunc_AddStatusEffect_ReturnValue);
};
