...
class UInit_Necromancer_10_DamageTaken_C : public UAttributeInitializer
{
public:
	struct FDataTableValueHandle                 DamageTakenPerHealthPercent;                       // 0x30(0x18)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)

	static class UClass* StaticClass();
	static class UInit_Necromancer_10_DamageTaken_C* GetDefaultObj();
