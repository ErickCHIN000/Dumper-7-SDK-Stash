...
struct UCond_IsInEndlessDungeon_C_EvaluateCondition_Params
{
public:
	...
	class AEndlessdungeon*                       CallFunc_GetEndlessDungeon_ReturnValue;            // 0x18(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ERunnerType                       CallFunc_GetCurrentRunnerType_ReturnValue;         // 0x20(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
