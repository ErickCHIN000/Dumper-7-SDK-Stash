...
class UClass* UInit_Barbarian_05_DamageTaken_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Init_Barbarian_05_DamageTaken_C");

	return Clss;
}


// Init_Barbarian_05_DamageTaken_C Init_Barbarian_05_DamageTaken.Default__Init_Barbarian_05_DamageTaken_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UInit_Barbarian_05_DamageTaken_C* UInit_Barbarian_05_DamageTaken_C::GetDefaultObj()
{
	static class UInit_Barbarian_05_DamageTaken_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UInit_Barbarian_05_DamageTaken_C*>(UInit_Barbarian_05_DamageTaken_C::StaticClass()->DefaultObject);
