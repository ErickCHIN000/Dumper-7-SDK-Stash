...
class UClass* UPassive_Barbarian_06_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Passive_Barbarian_06_C");

	return Clss;
}


// Passive_Barbarian_06_C Passive_Barbarian_06.Default__Passive_Barbarian_06_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPassive_Barbarian_06_C* UPassive_Barbarian_06_C::GetDefaultObj()
{
	static class UPassive_Barbarian_06_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPassive_Barbarian_06_C*>(UPassive_Barbarian_06_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Passive_Barbarian_06.Passive_Barbarian_06_C.GetManualHUDIconValues
...
// Function Passive_Barbarian_06.Passive_Barbarian_06_C.OnActivated
// (Event, Protected, BlueprintEvent)
// Parameters:

void UPassive_Barbarian_06_C::OnActivated()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Passive_Barbarian_06_C", "OnActivated");
...
// Function Passive_Barbarian_06.Passive_Barbarian_06_C.ExecuteUbergraph_Passive_Barbarian_06
// (HasDefaults)
// Parameters:
...
void UPassive_Barbarian_06_C::ExecuteUbergraph_Passive_Barbarian_06(int32 EntryPoint, const struct FGameResourcePoolReference& CallFunc_GetResourcePoolByResource_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Passive_Barbarian_06_C", "ExecuteUbergraph_Passive_Barbarian_06");

	Params::UPassive_Barbarian_06_C_ExecuteUbergraph_Passive_Barbarian_06_Params Parms{};
