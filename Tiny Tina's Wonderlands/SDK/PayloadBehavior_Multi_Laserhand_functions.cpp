...
class UClass* UPayloadBehavior_Multi_Laserhand_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PayloadBehavior_Multi_Laserhand_C");

	return Clss;
}


// PayloadBehavior_Multi_Laserhand_C PayloadBehavior_Multi_Laserhand.Default__PayloadBehavior_Multi_Laserhand_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPayloadBehavior_Multi_Laserhand_C* UPayloadBehavior_Multi_Laserhand_C::GetDefaultObj()
{
	static class UPayloadBehavior_Multi_Laserhand_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPayloadBehavior_Multi_Laserhand_C*>(UPayloadBehavior_Multi_Laserhand_C::StaticClass()->DefaultObject);
