...
// BlueprintGeneratedClass LightProj_SG_LastRites_Bounce.LightProj_SG_LastRites_Bounce_C
// (None)

class UClass* ULightProj_SG_LastRites_Bounce_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LightProj_SG_LastRites_Bounce_C");

	return Clss;
}


// LightProj_SG_LastRites_Bounce_C LightProj_SG_LastRites_Bounce.Default__LightProj_SG_LastRites_Bounce_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ULightProj_SG_LastRites_Bounce_C* ULightProj_SG_LastRites_Bounce_C::GetDefaultObj()
{
	static class ULightProj_SG_LastRites_Bounce_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ULightProj_SG_LastRites_Bounce_C*>(ULightProj_SG_LastRites_Bounce_C::StaticClass()->DefaultObject);
...
void ULightProj_SG_LastRites_Bounce_C::OnBegin(class ULightProjectile* Projectile, class AActor* CallFunc_GetTarget_ReturnValue, bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("LightProj_SG_LastRites_Bounce_C", "OnBegin");

	Params::ULightProj_SG_LastRites_Bounce_C_OnBegin_Params Parms{};
...
void ULightProj_SG_LastRites_Bounce_C::OnDamage(class ULightProjectile* Projectile, struct FHitResult& Hit, bool bCritical, const struct FVector& HitLoc, class AActor* HitTarget, class AActor* NewTarget, bool Temp_bool_Has_Been_Initd_Variable, bool CallFunc_BreakHitResult_bBlockingHit, bool CallFunc_BreakHitResult_bInitialOverlap, float CallFunc_BreakHitResult_Time, float CallFunc_BreakHitResult_Distance, const struct FVector& CallFunc_BreakHitResult_Location, const struct FVector& CallFunc_BreakHitResult_ImpactPoint, const struct FVector& CallFunc_BreakHitResult_Normal, const struct FVector& CallFunc_BreakHitResult_ImpactNormal, class UPhysicalMaterial* CallFunc_BreakHitResult_PhysMat, class AActor* CallFunc_BreakHitResult_HitActor, class UPrimitiveComponent* CallFunc_BreakHitResult_HitComponent, class FName CallFunc_BreakHitResult_HitBoneName, int32 CallFunc_BreakHitResult_HitItem, int32 CallFunc_BreakHitResult_FaceIndex, const struct FVector& CallFunc_BreakHitResult_TraceStart, const struct FVector& CallFunc_BreakHitResult_TraceEnd, class AActor* CallFunc_GetDamageCauser_ReturnValue, float CallFunc_GetModifierValue_ReturnValue, float CallFunc_Multiply_FloatFloat_ReturnValue, enum class EWeaponShotModifierType CallFunc_GetModifierType_ReturnValue, class APawn* CallFunc_GetInstigator_ReturnValue, bool Temp_bool_IsClosed_Variable, bool CallFunc_RandomBoolWithWeight_ReturnValue, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, const struct FOakLightProjectileInitializationData& K2Node_MakeStruct_OakLightProjectileInitializationData, TArray<class AActor*>& CallFunc_RunEnvQueryForAllActors_ResultActors, bool CallFunc_RunEnvQueryForAllActors_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, int32 CallFunc_RandomIntegerInRangeFromStream_ReturnValue, class AActor* CallFunc_Array_Get_Item)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("LightProj_SG_LastRites_Bounce_C", "OnDamage");

	Params::ULightProj_SG_LastRites_Bounce_C_OnDamage_Params Parms{};
