...
// BlueprintGeneratedClass PayloadBehavior_Multi_Sawblades.PayloadBehavior_Multi_Sawblades_C
// (None)

class UClass* UPayloadBehavior_Multi_Sawblades_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PayloadBehavior_Multi_Sawblades_C");

	return Clss;
}


// PayloadBehavior_Multi_Sawblades_C PayloadBehavior_Multi_Sawblades.Default__PayloadBehavior_Multi_Sawblades_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPayloadBehavior_Multi_Sawblades_C* UPayloadBehavior_Multi_Sawblades_C::GetDefaultObj()
{
	static class UPayloadBehavior_Multi_Sawblades_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPayloadBehavior_Multi_Sawblades_C*>(UPayloadBehavior_Multi_Sawblades_C::StaticClass()->DefaultObject);
