...
struct UInit_GunMage_Feat_SpellDamageCalc_C_CalculateAttributeInitialValue_Params
{
public:
	...
	int32                                        CallFunc_GetSpellweavingStacks_Res;                // 0xC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_GetSpellWeavingStacks_ClassStat;          // 0x10(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
