...
public:
	...
	uint8                                        Pad_AE8[0x4];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	struct FSoftClassPath                        GameInstanceClass;                                 // 0x70(0x18)(Edit, Config, NoClear, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct FSoftClassPath                        GlobalDefaultGameMode;                             // 0xB8(0x18)(Edit, Config, NoClear, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct FSoftClassPath                        GlobalDefaultServerGameMode;                       // 0xD0(0x18)(Edit, Config, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                        Pad_B62[0x7];                                      // Fixing Size Of Struct [ Dumper-7 ]
