...
class UInit_Passive_Barbarian_07_MoveSpeed_Bonus_C : public UAttributeInitializer
{
public:
	struct FDataTableValueHandle                 MoveSpeedHandle;                                   // 0x30(0x18)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)

	static class UClass* StaticClass();
	static class UInit_Passive_Barbarian_07_MoveSpeed_Bonus_C* GetDefaultObj();
