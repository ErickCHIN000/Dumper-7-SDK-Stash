...
struct UAction_DemiLich_Spellcast_C_OnBegin_Params
{
public:
...
struct UAction_DemiLich_Spellcast_C_ExecuteUbergraph_Action_DemiLich_Spellcast_Params
{
public:
	...
	class AActor*                                CallFunc_K2_GetActor_ReturnValue;                  // 0x240(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
