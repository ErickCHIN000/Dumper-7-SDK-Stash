...
// BlueprintGeneratedClass Condition_Shield_Rune_Master.Condition_Shield_Rune_Master_C
// (None)

class UClass* UCondition_Shield_Rune_Master_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Condition_Shield_Rune_Master_C");

	return Clss;
}


// Condition_Shield_Rune_Master_C Condition_Shield_Rune_Master.Default__Condition_Shield_Rune_Master_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCondition_Shield_Rune_Master_C* UCondition_Shield_Rune_Master_C::GetDefaultObj()
{
	static class UCondition_Shield_Rune_Master_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCondition_Shield_Rune_Master_C*>(UCondition_Shield_Rune_Master_C::StaticClass()->DefaultObject);
...
// bool                               FoundMasterRune                                                  (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
