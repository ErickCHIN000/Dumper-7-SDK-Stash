...
class AAuxActor_KnightHammer_HammerOfGods_C : public AStandInAuxiliaryActor
{
public:
	...
	static class AAuxActor_KnightHammer_HammerOfGods_C* GetDefaultObj();

	void UserConstructionScript();
	void ReceiveBeginPlay();
	void DigiOut();
	void InterruptDigi();
	void ExecuteUbergraph_AuxActor_KnightHammer_HammerOfGods(int32 EntryPoint, TArray<struct FGbxActionRegister>& Temp_struct_Variable, class UGbxAction* CallFunc_K2Play_ReturnValue);
};
