...
class UPassive_Barbarian_03_C : public UOakPassiveAbility
{
public:
	...
	static class UPassive_Barbarian_03_C* GetDefaultObj();
	...
	void OnActivated();
	void ExecuteUbergraph_Passive_Barbarian_03(int32 EntryPoint, const struct FGameResourcePoolReference& CallFunc_GetResourcePoolByResource_ReturnValue);
};
