...
struct ULightProjectile_Envy_Ricochet_C_OnDamage_Params
{
public:
	...
	bool                                         CallFunc_K2_EvaluateConditionType_ReturnValue;     // 0x128(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
