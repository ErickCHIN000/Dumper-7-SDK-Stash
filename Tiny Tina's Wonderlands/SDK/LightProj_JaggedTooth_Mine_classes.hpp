...
// 0x8 (0x380 - 0x378)
// BlueprintGeneratedClass LightProj_JaggedTooth_Mine.LightProj_JaggedTooth_Mine_C
class ULightProj_JaggedTooth_Mine_C : public UOakLightProjectileData
{
public:
	uint8                                        Pad_3CDA[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]

	static class UClass* StaticClass();
	static class ULightProj_JaggedTooth_Mine_C* GetDefaultObj();
