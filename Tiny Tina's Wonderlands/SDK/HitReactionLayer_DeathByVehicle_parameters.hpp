...
public:
	...
	class UDamageSource_Vehicle_C*               K2Node_DynamicCast_AsDamage_Source_Vehicle;        // 0x50(0x8)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
