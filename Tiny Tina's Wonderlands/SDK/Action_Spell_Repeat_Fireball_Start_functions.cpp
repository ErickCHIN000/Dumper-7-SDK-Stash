...
class UClass* UAction_Spell_Repeat_Fireball_Start_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Action_Spell_Repeat_Fireball_Start_C");

	return Clss;
}


// Action_Spell_Repeat_Fireball_Start_C Action_Spell_Repeat_Fireball_Start.Default__Action_Spell_Repeat_Fireball_Start_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAction_Spell_Repeat_Fireball_Start_C* UAction_Spell_Repeat_Fireball_Start_C::GetDefaultObj()
{
	static class UAction_Spell_Repeat_Fireball_Start_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAction_Spell_Repeat_Fireball_Start_C*>(UAction_Spell_Repeat_Fireball_Start_C::StaticClass()->DefaultObject);
...
void UAction_Spell_Repeat_Fireball_Start_C::OnBegin(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Repeat_Fireball_Start_C", "OnBegin");

	Params::UAction_Spell_Repeat_Fireball_Start_C_OnBegin_Params Parms{};
