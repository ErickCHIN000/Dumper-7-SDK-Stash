...
class UAbility_Rune_Master_C : public UOakAbility
{
public:
	...
	static class UAbility_Rune_Master_C* GetDefaultObj();

	void OnActivated();
	void ExecuteUbergraph_Ability_Rune_Master(int32 EntryPoint);
};
