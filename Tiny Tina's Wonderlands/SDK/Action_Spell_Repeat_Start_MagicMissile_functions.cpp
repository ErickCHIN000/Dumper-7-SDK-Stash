...
class UClass* UAction_Spell_Repeat_Start_MagicMissile_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Action_Spell_Repeat_Start_MagicMissile_C");

	return Clss;
}


// Action_Spell_Repeat_Start_MagicMissile_C Action_Spell_Repeat_Start_MagicMissile.Default__Action_Spell_Repeat_Start_MagicMissile_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAction_Spell_Repeat_Start_MagicMissile_C* UAction_Spell_Repeat_Start_MagicMissile_C::GetDefaultObj()
{
	static class UAction_Spell_Repeat_Start_MagicMissile_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAction_Spell_Repeat_Start_MagicMissile_C*>(UAction_Spell_Repeat_Start_MagicMissile_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Action_Spell_Repeat_Start_MagicMissile.Action_Spell_Repeat_Start_MagicMissile_C.OnDialogSequenceFinished_2
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAction_Spell_Repeat_Start_MagicMissile_C::OnDialogSequenceFinished_2()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Repeat_Start_MagicMissile_C", "OnDialogSequenceFinished_2");
...
void UAction_Spell_Repeat_Start_MagicMissile_C::OnBegin(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Repeat_Start_MagicMissile_C", "OnBegin");

	Params::UAction_Spell_Repeat_Start_MagicMissile_C_OnBegin_Params Parms{};
...
// Function Action_Spell_Repeat_Start_MagicMissile.Action_Spell_Repeat_Start_MagicMissile_C.Notify_SpellcastStart
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UAction_Spell_Repeat_Start_MagicMissile_C::Notify_SpellcastStart()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Repeat_Start_MagicMissile_C", "Notify_SpellcastStart");
