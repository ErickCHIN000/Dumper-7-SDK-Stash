...
struct UInit_Necromancer_10_DamageDealt_C_CalculateAttributeInitialValue_Params
{
public:
	...
	class UOakPassiveAbility*                    K2Node_DynamicCast_AsOak_Passive_Ability;          // 0x38(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
