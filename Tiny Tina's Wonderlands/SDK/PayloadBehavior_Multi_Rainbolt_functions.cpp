...
// BlueprintGeneratedClass PayloadBehavior_Multi_Rainbolt.PayloadBehavior_Multi_Rainbolt_C
// (None)

class UClass* UPayloadBehavior_Multi_Rainbolt_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PayloadBehavior_Multi_Rainbolt_C");

	return Clss;
}


// PayloadBehavior_Multi_Rainbolt_C PayloadBehavior_Multi_Rainbolt.Default__PayloadBehavior_Multi_Rainbolt_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPayloadBehavior_Multi_Rainbolt_C* UPayloadBehavior_Multi_Rainbolt_C::GetDefaultObj()
{
	static class UPayloadBehavior_Multi_Rainbolt_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPayloadBehavior_Multi_Rainbolt_C*>(UPayloadBehavior_Multi_Rainbolt_C::StaticClass()->DefaultObject);

	return Default;
}


// Function PayloadBehavior_Multi_Rainbolt.PayloadBehavior_Multi_Rainbolt_C.GetSpellCastingSocket
...
void UPayloadBehavior_Multi_Rainbolt_C::GetSpellCastingSocket(class AOakCharacter* PlayerChar, class UObject* SpellMod, class FName* Socket, bool Temp_bool_Variable, class FName Temp_name_Variable, class FName Temp_name_Variable1, bool Temp_bool_Variable1, class FName Temp_name_Variable2, class FName Temp_name_Variable3, class AActor* CallFunc_GetEquippedInventoryForSlot_ReturnValue, class AActor* CallFunc_GetEquippedInventoryForSlot_ReturnValue1, bool CallFunc_EqualEqual_ObjectObject_ReturnValue, bool CallFunc_EqualEqual_ObjectObject_ReturnValue1, class FName K2Node_Select_Default, class FName K2Node_Select1_Default)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("PayloadBehavior_Multi_Rainbolt_C", "GetSpellCastingSocket");

	Params::UPayloadBehavior_Multi_Rainbolt_C_GetSpellCastingSocket_Params Parms{};
...
// Function PayloadBehavior_Multi_Rainbolt.PayloadBehavior_Multi_Rainbolt_C.GetCustomSpellSpawnInfo
