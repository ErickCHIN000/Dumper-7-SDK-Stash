...
class UMission_PLC2_CompletionV1_C : public UMission_SideTemplate_C
{
public:
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0x570(0x8)(Transient, DuplicateTransient)
	class UMissionObjectiveSet*                  CompletedPLC2Week1_ObjSetVar;                      // 0x578(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	static class UMission_PLC2_CompletionV1_C* GetDefaultObj();

	void MissionKickoff();
	void CompletedPLC2Week1(enum class EMissionObjectiveSetEvent ObjectiveSetEvent);
