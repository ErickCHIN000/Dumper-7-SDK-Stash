...
class UBP_CE_BAMF_PortalIn_C : public UOakAction_CoordinatedEffect
{
public:
	...
	static class UBP_CE_BAMF_PortalIn_C* GetDefaultObj();
	...
	void ExecuteUbergraph_BP_CE_BAMF_PortalIn(int32 EntryPoint, class AActor* K2Node_Event_Actor);
};
