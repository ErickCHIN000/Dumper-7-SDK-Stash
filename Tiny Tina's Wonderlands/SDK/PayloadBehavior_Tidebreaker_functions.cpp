...
// BlueprintGeneratedClass PayloadBehavior_Tidebreaker.PayloadBehavior_Tidebreaker_C
// (None)

class UClass* UPayloadBehavior_Tidebreaker_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PayloadBehavior_Tidebreaker_C");

	return Clss;
}


// PayloadBehavior_Tidebreaker_C PayloadBehavior_Tidebreaker.Default__PayloadBehavior_Tidebreaker_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPayloadBehavior_Tidebreaker_C* UPayloadBehavior_Tidebreaker_C::GetDefaultObj()
{
	static class UPayloadBehavior_Tidebreaker_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPayloadBehavior_Tidebreaker_C*>(UPayloadBehavior_Tidebreaker_C::StaticClass()->DefaultObject);
