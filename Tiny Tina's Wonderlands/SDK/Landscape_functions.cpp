...
class UClass* UMaterialExpressionLandscapeAutoPaintLayers::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MaterialExpressionLandscapeAutoPaintLayers");

	return Clss;
}


// MaterialExpressionLandscapeAutoPaintLayers Landscape.Default__MaterialExpressionLandscapeAutoPaintLayers
// (Public, ClassDefaultObject, ArchetypeObject)

class UMaterialExpressionLandscapeAutoPaintLayers* UMaterialExpressionLandscapeAutoPaintLayers::GetDefaultObj()
{
	static class UMaterialExpressionLandscapeAutoPaintLayers* Default = nullptr;

	if (!Default)
		Default = static_cast<UMaterialExpressionLandscapeAutoPaintLayers*>(UMaterialExpressionLandscapeAutoPaintLayers::StaticClass()->DefaultObject);
