...
struct UInit_Passive_Barbarian_07_MoveSpeed_Bonus_C_CalculateAttributeInitialValue_Params
{
public:
	...
	TScriptInterface<class IIFeat_Barbarian_C>   K2Node_DynamicCast_AsIFeat_Barbarian;              // 0x38(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         K2Node_DynamicCast_bSuccess1;                      // 0x48(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                         CallFunc_IsEnraged_Res;                            // 0x49(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
