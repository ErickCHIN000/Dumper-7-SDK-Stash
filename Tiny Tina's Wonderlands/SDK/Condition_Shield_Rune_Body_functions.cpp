...
class UClass* UCondition_Shield_Rune_Body_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Condition_Shield_Rune_Body_C");

	return Clss;
}


// Condition_Shield_Rune_Body_C Condition_Shield_Rune_Body.Default__Condition_Shield_Rune_Body_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCondition_Shield_Rune_Body_C* UCondition_Shield_Rune_Body_C::GetDefaultObj()
{
	static class UCondition_Shield_Rune_Body_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCondition_Shield_Rune_Body_C*>(UCondition_Shield_Rune_Body_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Condition_Shield_Rune_Body.Condition_Shield_Rune_Body_C.EvaluateCondition
// (Event, Protected, HasOutParams, BlueprintCallable, BlueprintEvent, Const)
// Parameters:
// class UObject*                     Context                                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UObject*                     OptionalContext                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor)
// bool                               FoundBodyRune                                                    (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
