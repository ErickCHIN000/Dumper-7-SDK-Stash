...
class UClass* ULightProjectile_ThunderAnima3_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LightProjectile_ThunderAnima3_C");

	return Clss;
}


// LightProjectile_ThunderAnima3_C LightProjectile_ThunderAnima3.Default__LightProjectile_ThunderAnima3_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ULightProjectile_ThunderAnima3_C* ULightProjectile_ThunderAnima3_C::GetDefaultObj()
{
	static class ULightProjectile_ThunderAnima3_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ULightProjectile_ThunderAnima3_C*>(ULightProjectile_ThunderAnima3_C::StaticClass()->DefaultObject);
