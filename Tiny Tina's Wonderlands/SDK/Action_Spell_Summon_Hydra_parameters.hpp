...
struct UAction_Spell_Summon_Hydra_C_OnBegin_Params
{
public:
...
struct UAction_Spell_Summon_Hydra_C_ExecuteUbergraph_Action_Spell_Summon_Hydra_Params
{
public:
	...
	class UParticleSystem*                       CallFunc_GetCollectionFX_ReturnValue1;             // 0x268(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FDialogContext                        CallFunc_NewDialogContext_ReturnValue1;            // 0x2C0(0x218)(None)
	class UWwiseEvent*                           CallFunc_Map_Find_Value1;                          // 0x4D8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_Map_Find_ReturnValue1;                    // 0x4E0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_1B1B[0x3];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FDialogConversation                   CallFunc_FinishTriggerDialog_Conversation1;        // 0x4E4(0xC)(NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_FinishTriggerDialog_SequenceID1;          // 0x4F0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_FinishTriggerDialog_ReturnValue1;         // 0x4F4(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
