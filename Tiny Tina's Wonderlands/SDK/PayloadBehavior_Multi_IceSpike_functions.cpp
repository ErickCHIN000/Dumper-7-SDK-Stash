...
class UClass* UPayloadBehavior_Multi_IceSpike_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PayloadBehavior_Multi_IceSpike_C");

	return Clss;
}


// PayloadBehavior_Multi_IceSpike_C PayloadBehavior_Multi_IceSpike.Default__PayloadBehavior_Multi_IceSpike_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPayloadBehavior_Multi_IceSpike_C* UPayloadBehavior_Multi_IceSpike_C::GetDefaultObj()
{
	static class UPayloadBehavior_Multi_IceSpike_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPayloadBehavior_Multi_IceSpike_C*>(UPayloadBehavior_Multi_IceSpike_C::StaticClass()->DefaultObject);
