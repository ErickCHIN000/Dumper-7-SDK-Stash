...
// BlueprintGeneratedClass Action_Spell_Channel_Loop_LightningBlast.Action_Spell_Channel_Loop_LightningBlast_C
// (None)

class UClass* UAction_Spell_Channel_Loop_LightningBlast_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Action_Spell_Channel_Loop_LightningBlast_C");

	return Clss;
}


// Action_Spell_Channel_Loop_LightningBlast_C Action_Spell_Channel_Loop_LightningBlast.Default__Action_Spell_Channel_Loop_LightningBlast_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAction_Spell_Channel_Loop_LightningBlast_C* UAction_Spell_Channel_Loop_LightningBlast_C::GetDefaultObj()
{
	static class UAction_Spell_Channel_Loop_LightningBlast_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAction_Spell_Channel_Loop_LightningBlast_C*>(UAction_Spell_Channel_Loop_LightningBlast_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Action_Spell_Channel_Loop_LightningBlast.Action_Spell_Channel_Loop_LightningBlast_C.OnBegin
// (Event, Public, BlueprintEvent)
// Parameters:
// class AActor*                      Actor                                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAction_Spell_Channel_Loop_LightningBlast_C::OnBegin(class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Channel_Loop_LightningBlast_C", "OnBegin");

	Params::UAction_Spell_Channel_Loop_LightningBlast_C_OnBegin_Params Parms{};
...
// Function Action_Spell_Channel_Loop_LightningBlast.Action_Spell_Channel_Loop_LightningBlast_C.OnEnd
// (Event, Public, BlueprintEvent)
// Parameters:
// enum class EGbxActionEndState      ActionEndState                                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class AActor*                      Actor                                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAction_Spell_Channel_Loop_LightningBlast_C::OnEnd(enum class EGbxActionEndState ActionEndState, class AActor* Actor)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Action_Spell_Channel_Loop_LightningBlast_C", "OnEnd");

	Params::UAction_Spell_Channel_Loop_LightningBlast_C_OnEnd_Params Parms{};
...
// Function Action_Spell_Channel_Loop_LightningBlast.Action_Spell_Channel_Loop_LightningBlast_C.ExecuteUbergraph_Action_Spell_Channel_Loop_LightningBlast
// (None)
// Parameters:
...
// bool                               CallFunc_DoesSpellHavePartSoft_ReturnValue                       (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void UAction_Spell_Channel_Loop_LightningBlast_C::ExecuteUbergraph_Action_Spell_Channel_Loop_LightningBlast(int32 EntryPoint, class AActor* K2Node_Event_Actor1, enum class EGbxActionEndState K2Node_Event_ActionEndState, class AActor* K2Node_Event_Actor, class UParticleSystem* CallFunc_GetCollectionFX_ReturnValue, class UParticleSystemComponent* CallFunc_PlayFX_1stFXComponent, class UParticleSystemComponent* CallFunc_PlayFX_3rdFXComponent, class FName CallFunc_PlayFX_Socket, class UParticleSystem* CallFunc_GetCollectionFX_ReturnValue1, class UParticleSystemComponent* CallFunc_PlayFX_1stFXComponent1, class UParticleSystemComponent* CallFunc_PlayFX_3rdFXComponent1, class FName CallFunc_PlayFX_Socket1, class AActor* CallFunc_K2_GetActor_ReturnValue, enum class EOakElementalType CallFunc_GetSpellElement_ReturnedElement, class UWwiseEvent* CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, bool CallFunc_DoesSpellHavePartSoft_ReturnValue, class AActor* CallFunc_K2_GetActor_ReturnValue1, enum class EOakElementalType CallFunc_GetSpellElement_ReturnedElement1, class UWwiseEvent* CallFunc_Map_Find_Value1, bool CallFunc_Map_Find_ReturnValue1)
{
	...
	Parms.CallFunc_DoesSpellHavePartSoft_ReturnValue = CallFunc_DoesSpellHavePartSoft_ReturnValue;
