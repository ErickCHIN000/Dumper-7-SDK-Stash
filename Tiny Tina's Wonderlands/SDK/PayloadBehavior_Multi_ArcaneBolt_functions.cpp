...
// BlueprintGeneratedClass PayloadBehavior_Multi_ArcaneBolt.PayloadBehavior_Multi_ArcaneBolt_C
// (None)

class UClass* UPayloadBehavior_Multi_ArcaneBolt_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PayloadBehavior_Multi_ArcaneBolt_C");

	return Clss;
}


// PayloadBehavior_Multi_ArcaneBolt_C PayloadBehavior_Multi_ArcaneBolt.Default__PayloadBehavior_Multi_ArcaneBolt_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPayloadBehavior_Multi_ArcaneBolt_C* UPayloadBehavior_Multi_ArcaneBolt_C::GetDefaultObj()
{
	static class UPayloadBehavior_Multi_ArcaneBolt_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPayloadBehavior_Multi_ArcaneBolt_C*>(UPayloadBehavior_Multi_ArcaneBolt_C::StaticClass()->DefaultObject);
