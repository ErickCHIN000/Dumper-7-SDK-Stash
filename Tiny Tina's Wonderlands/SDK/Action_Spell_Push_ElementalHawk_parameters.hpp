...
struct UAction_Spell_Push_ElementalHawk_C_OnBegin_Params
{
public:
...
struct UAction_Spell_Push_ElementalHawk_C_ExecuteUbergraph_Action_Spell_Push_ElementalHawk_Params
{
public:
	...
	enum class EOakElementalType                 CallFunc_GetSpellElement_ReturnedElement1;         // 0x60(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_E6B[0x7];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	class UWwiseEvent*                           CallFunc_Map_Find_Value;                           // 0x68(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UWwiseEvent*                           CallFunc_Map_Find_Value1;                          // 0x78(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FDialogConversation                   CallFunc_FinishTriggerDialog_Conversation1;        // 0x4CC(0xC)(NoDestructor, HasGetValueTypeHash)
	int32                                        CallFunc_FinishTriggerDialog_SequenceID1;          // 0x4D8(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_FinishTriggerDialog_ReturnValue1;         // 0x4DC(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
