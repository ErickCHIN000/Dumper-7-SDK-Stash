...
class UClass* ULightProjData_IceSpike_Mod_04_Child_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LightProjData_IceSpike_Mod_04_Child_C");

	return Clss;
}


// LightProjData_IceSpike_Mod_04_Child_C LightProjData_IceSpike_Mod_04_Child.Default__LightProjData_IceSpike_Mod_04_Child_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ULightProjData_IceSpike_Mod_04_Child_C* ULightProjData_IceSpike_Mod_04_Child_C::GetDefaultObj()
{
	static class ULightProjData_IceSpike_Mod_04_Child_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ULightProjData_IceSpike_Mod_04_Child_C*>(ULightProjData_IceSpike_Mod_04_Child_C::StaticClass()->DefaultObject);
...
void ULightProjData_IceSpike_Mod_04_Child_C::OnBegin(class ULightProjectile* Projectile, class AActor* CallFunc_GetTarget_ReturnValue, bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("LightProjData_IceSpike_Mod_04_Child_C", "OnBegin");

	Params::ULightProjData_IceSpike_Mod_04_Child_C_OnBegin_Params Parms{};
