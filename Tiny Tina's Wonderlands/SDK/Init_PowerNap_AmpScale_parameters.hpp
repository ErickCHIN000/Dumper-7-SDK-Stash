...
struct UInit_PowerNap_AmpScale_C_CalculateAttributeInitialValue_Params
{
public:
	...
	class UAbility_PowerNap_C*                   K2Node_DynamicCast_AsAbility_Power_Nap;            // 0x50(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
