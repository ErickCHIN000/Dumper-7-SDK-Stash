...
// BlueprintGeneratedClass Passive_Barbarian_03.Passive_Barbarian_03_C
// (None)

class UClass* UPassive_Barbarian_03_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Passive_Barbarian_03_C");

	return Clss;
}


// Passive_Barbarian_03_C Passive_Barbarian_03.Default__Passive_Barbarian_03_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPassive_Barbarian_03_C* UPassive_Barbarian_03_C::GetDefaultObj()
{
	static class UPassive_Barbarian_03_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPassive_Barbarian_03_C*>(UPassive_Barbarian_03_C::StaticClass()->DefaultObject);
...
// Function Passive_Barbarian_03.Passive_Barbarian_03_C.OnActivated
// (Event, Protected, BlueprintEvent)
// Parameters:

void UPassive_Barbarian_03_C::OnActivated()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Passive_Barbarian_03_C", "OnActivated");
...
void UPassive_Barbarian_03_C::ExecuteUbergraph_Passive_Barbarian_03(int32 EntryPoint, const struct FGameResourcePoolReference& CallFunc_GetResourcePoolByResource_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("Passive_Barbarian_03_C", "ExecuteUbergraph_Passive_Barbarian_03");

	Params::UPassive_Barbarian_03_C_ExecuteUbergraph_Passive_Barbarian_03_Params Parms{};
