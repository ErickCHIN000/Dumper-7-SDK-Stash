...
class UBP_CE_Rogue_FromTheShadows_C : public UOakAction_CoordinatedEffect
{
public:
	...
	static class UBP_CE_Rogue_FromTheShadows_C* GetDefaultObj();

	void OnBegin(class AActor* Actor);
	void OnEnd(enum class EGbxActionEndState ActionEndState, class AActor* Actor);
	void ExecuteUbergraph_BP_CE_Rogue_FromTheShadows(int32 EntryPoint, enum class EGbxActionEndState K2Node_Event_ActionEndState, class AActor* K2Node_Event_Actor, class AActor* K2Node_Event_Actor1);
};
