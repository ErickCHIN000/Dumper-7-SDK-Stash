...
// BlueprintGeneratedClass Condition_Shield_Rune_Mind.Condition_Shield_Rune_Mind_C
// (None)

class UClass* UCondition_Shield_Rune_Mind_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Condition_Shield_Rune_Mind_C");

	return Clss;
}


// Condition_Shield_Rune_Mind_C Condition_Shield_Rune_Mind.Default__Condition_Shield_Rune_Mind_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCondition_Shield_Rune_Mind_C* UCondition_Shield_Rune_Mind_C::GetDefaultObj()
{
	static class UCondition_Shield_Rune_Mind_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCondition_Shield_Rune_Mind_C*>(UCondition_Shield_Rune_Mind_C::StaticClass()->DefaultObject);

	return Default;
}


// Function Condition_Shield_Rune_Mind.Condition_Shield_Rune_Mind_C.EvaluateCondition
// (Event, Protected, HasOutParams, BlueprintCallable, BlueprintEvent, Const)
// Parameters:
// class UObject*                     Context                                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UObject*                     OptionalContext                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor)
// bool                               FoundMindRune                                                    (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
